...
class ReportHelper
{
    public function list_view($id, $data, $report_title, $link = '')
    {
        ...
        <div class="graph_box">
            ...
            <?php if (count($data) > 0) { ?>
                <table id="dbt_<?php echo $id; ?>" class="table table-responsive table-condensed" id="tblQInfo" aria-label="Detailed Report Data Table">
                <caption class="sr-only">Report List</caption>
                    <thead>
                    <tr class="d-none">
    ...
    <?php } ?>
    <?php if (count($data) > 0) { ?>
    <table id="report_data" class="table-rpt-border table table-responsive table-condensed" aria-label="Detailed Report Data Table">
    <caption class="sr-only">Report Data</caption>
    <thead>
    <tr>
    <th aria-hidden="true" scope="col"></th>
    </tr>
