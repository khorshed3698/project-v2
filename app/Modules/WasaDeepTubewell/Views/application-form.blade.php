            ...
            <div class="box-body">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h5><strong>APPLICATION FOR DEEP TUBEWELL</strong></h5>
                    </div>
                            ...
                            <div class="panel-body">
                                <div class="" id="InstituteApplication">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                {!! Form::text('institute_owner_name','',['class' => 'form-control input-md','id'=>'institute_owner_name','placeholder'=>'Institution Owner Name']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            {!! Form::label('head_of_institute','Head of Institute :',['class'=>'col-md-6 ']) !!}
                                            <div class="col-md-6">
                                                {!! Form::text('head_of_institute', '',['class' => 'form-control
                                ...
                                <div class="" id="IndividualApplication">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6">
                                            <div class="col-md-12">
                                                <label class="radio-inline col-md-3">{!! Form::radio('niddobpassporttype','nid', '', ['class'=>'custom_readonly required', 'id' => 'niddobpassporttype','onclick' => 'NidDobPassport(this.value)']) !!}
                                                    Nid</label>
                                                <label class="radio-inline col-md-3">{!! Form::radio('niddobpassporttype', 'dob', '', ['class'=>'custom_readonly required', 'id' => 'niddobpassporttype','onclick' => 'NidDobPassport(this.value)']) !!}
                                                    Birth Cert.</label>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-10">
                                            {!! Form::textarea('install_address','',['class' => 'form-control input-md','id'=>'install_address','style'=>'height: 60px;','placeholder'=>'Type Adress']) !!}
                                        </div>
                                    </div>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::textarea('mouza_name','',['class' => 'form-control input-md','id'=>'mouza_name','style'=>'height: 60px;','placeholder'=>'Mouza Name']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        {!! Form::label('rs_book_no','R. S. Book No. :',['class'=>'text-left col-md-6']) !!}
                                        <div class="col-md-6">
                                            {!! Form::text('rs_book_no','',['class' => 'form-control input-md','id'=>'rs_book_no','placeholder'=>'Type R. S. Book No.']) !!}
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::text('cs_book_no','',['class' => 'form-control input-md','id'=>'cs_book_no','placeholder'=>'Type C. S. Book No']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        {!! Form::label('sa_book_no','S. A. Book No. :',['class'=>'text-left col-md-6']) !!}
                                        <div class="col-md-6">
                                            {!! Form::text('sa_book_no','',['class' => 'form-control input-md','id'=>'sa_book_no','placeholder'=>'Type S. A. Book No.']) !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::text('average_demand','',['class' => 'form-control input-md onlyNumber','id'=>'average_demand' ]) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::select('screen_diameter',[],'',['class' => 'form-control input-md','id'=>'screen_diameter']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        {!! Form::label('power_of_pump','Power of Pump (kw/hp) :',['class'=>'text-left col-md-6 ']) !!}
                                        <div class="col-md-6">
                                            {!! Form::select('power_of_pump',[],'',['class' => 'form-control input-md','id'=>'power_of_pump']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::text('daily_running_time','',['class' => 'form-control input-md onlyNumber','id'=>'daily_running_time' ]) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        {!! Form::label('depth','Depth of the Deep-Tubewell (feet) :',['class'=>'text-left col-md-6 ']) !!}
                                        <div class="col-md-6">
                                            {!! Form::text('depth','',['class' => 'form-control input-md onlyNumber','id'=>'depth' ]) !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>{!! Form::select('conn_type[]',[''=>'Select','0'=>'Water Connection','1'=>'Sewerage Connection'],'',['class' => 'form-control input-md onlyNumber']) !!}</td>
                                            <td>{!! Form::text('account_no[]','',['class' => 'form-control input-md onlyNumber']) !!}</td>
                                            <td>{!! Form::text('diameter[]','',['class' => 'form-control input-md onlyNumber']) !!}</td>
                                            <td>{!! Form::text('conn_date','',['class' => 'form-control input-md onlyNumber']) !!}</td>
                                            <td>{!! Form::select('arrears_paid[]',['yes'=>'Yes','1'=>'No'],'',['class' => 'form-control input-md onlyNumber']) !!}</td>
                                        </tr>
                                        <tr>
                                            <td>{!! Form::select('conn_type[]',[''=>'Select','0'=>'Water Connection','1'=>'Sewerage Connection'],'',['class' => 'form-control input-md onlyNumber']) !!}</td>
                                            <td>{!! Form::text('account_no[]','',['class' => 'form-control input-md onlyNumber']) !!}</td>
...
//                option += '<label class="radio-inline"><input type="radio" id="app_type_'+row[element_id]+'"  value="' + id + '" onclick="ApplicationType(this.value)"/>'+ value +'</lebel>';
                ...
                option += '<input class="required" style="float:left;margin-left:5px" id="application_type_' + row[element_id] + '" type="radio" value="' + id + '" name="application_type" onclick="ApplicationType(this.value)"><label style="margin-left:5px" for="application_type_' + row[element_id] + '">' + value + '</label>';
