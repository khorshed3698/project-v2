            ...
            <div class="box-body">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h5><strong>Application for Waiver Condition 8</strong></h5>
                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div id="ref_app_tracking_no_div" class="col-md-12  {{$errors->has('ref_app_tracking_no') ? 'has-error': ''}}">
                                                {!! Form::label('ref_app_tracking_no','Please provide your Waiver Condition 7 permission tracking no :',['class'=>'col-md-5 text-left required-star']) !!}
                                                <div class="col-md-7">
                                                    <div class="input-group">
                                                        {!! Form::text('ref_app_tracking_no', Session::get('waiver.ref_wvr_app_tracking_no'), ['data-rule-maxlength'=>'100', 'class' => 'form-control  input-sm', Session::get('waiver.ref_app_tracking_no') ? 'readonly':'' ]) !!}
                                                        ...
                                                        <span class="input-group-btn">
                                                            @if(Session::get('waiver'))
                                                                ...
                                                                <a href="{{ Session::get('waiver.certificate_link') }}" target="_blank" rel="noopener" class="btn btn-success btn-sm">View Certificate</a>

                                                            @else
                                                                <button type="submit" class="btn btn-success btn-sm cancel" value="searchWaiverinfo" name="searchWaiverinfo" id="searchWaiverinfo">Load Waiver Condition 7 Permission Data</button>
                                                            @endif
                                                        </span>
                                                    </div>
                                                    <small class="text-danger">N.B.: Once you save or submit the application, the waiver condition 7 permission tracking no cannot be changed anymore.</small>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div class="col-md-7">
                                                    ...
                                                    {!! Form::text('ref_app_approve_date', !empty(Session::get('waiver.approved_date')) ? date('d-M-Y', strtotime(Session::get('waiver.approved_date'))) : '', ['class'=>'form-control input-md', 'id' => 'ref_app_approve_date', 'readonly']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 {{$errors->has('ref_office_app_tracking_no') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('ref_office_app_tracking_no', Session::get('waiver.ref_app_tracking_no'), ['class' => 'form-control input-md', 'readonly']) !!}
                                                    {!! $errors->first('ref_office_app_tracking_no','<span class="help-block">:message</span>') !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 {{$errors->has('ref_office_app_approved_date') ? 'has-error': ''}}">
                                                {!! Form::label('ref_office_app_approved_date','Approved date',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    <div class="input-group date">
                                                        {!! Form::text('ref_office_app_approved_date', Session::get('waiver.ref_office_app_approved_date'), ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy',  'readonly']) !!}
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                    </div>
                                                    {!! $errors->first('ref_office_app_approved_date','<span class="help-block">:message</span>') !!}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('approved_permission_start_date') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group date">
                                                    {!! Form::text('approved_permission_start_date', Session::get('waiver.approved_permission_start_date'), ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy',  'readonly']) !!}
                                                    <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                </div>
                                        ...
                                        <div class="col-md-6 {{$errors->has('approved_permission_end_date') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                <div class="input-group date">
                                                    {!! Form::text('approved_permission_end_date', Session::get('waiver.approved_permission_end_date'), ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy', 'readonly']) !!}
                                                    <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('approved_permission_duration') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('approved_permission_duration', Session::get('waiver.approved_permission_duration'), ['class' => 'form-control input-md', 'readonly']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('approved_permission_duration_amount') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('approved_permission_duration_amount', Session::get('waiver.approved_permission_duration_amount'), ['class' => 'form-control input-md', 'readonly']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_company_name') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_company_name', (Session::get('waiver.c_company_name') ? Session::get('waiver.c_company_name') : ''), ['class'=>'form-control required input-md cusReadonly bigInputField', 'data-rule-maxlength'=>'255', 'id'=>"c_company_name", 'readonly']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('c_origin_country_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        'class' => 'form-control input-md cusReadonly', 'readonly'=>"readonly",]) !!}
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 {{$errors->has('c_org_type') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        ['class' => 'form-control cusReadonly input-md','placeholder' => 'Select One', 'id' => 'c_org_type', 'readonly'=>"readonly",]) !!}
                                                ...
                                                <div class="col-md-6 has-feedback {{ $errors->has('c_flat_apart_floor') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_flat_apart_floor', Session::get('waiver.c_flat_apart_floor'), ['class'=>'form-control input-md cusReadonly', 'data-rule-maxlength'=>'40', 'id'=>"c_flat_apart_floor", 'readonly'=>"readonly",]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_house_plot_holding') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_house_plot_holding', Session::get('waiver.c_house_plot_holding'), ['class'=>'form-control input-md cusReadonly', 'data-rule-maxlength'=>'40', 'id'=>"c_house_plot_holding", 'readonly'=>"readonly",]) !!}
                                                ...
                                                <div class="col-md-6  {{$errors->has('c_post_zip_code') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        'class' => 'form-control input-md cusReadonly', 'id' => 'c_post_zip_code', 'readonly'=>"readonly",]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 has-feedback {{ $errors->has('c_street') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_street', Session::get('waiver.c_street'), ['class'=>'form-control input-md cusReadonly','data-rule-maxlength'=>'40', 'id' => 'c_street', 'readonly'=>"readonly",]) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('c_email') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_email', Session::get('waiver.c_email'), ['class' => 'form-control input-md email cusReadonly', 'id' => 'c_email', 'readonly'=>"readonly",]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_city') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_city', Session::get('waiver.c_city'),['class' => 'form-control input-md cusReadonly', 'id' => 'c_city', 'readonly'=>"readonly",]) !!}
                                                ...
                                                <div class="col-md-6  {{$errors->has('c_telephone') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_telephone', Session::get('waiver.c_telephone'),['data-rule-maxlength'=>'20',  'class' => 'form-control input-md cusReadonly', 'id' => 'c_telephone', 'readonly'=>"readonly",]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_state_province') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_state_province', Session::get('waiver.c_state_province'),['class' => 'form-control input-md cusReadonly', 'id' => 'c_state_province', 'readonly'=>"readonly",]) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('c_fax') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_fax', Session::get('waiver.c_fax'), ['class' => 'form-control input-md cusReadonly', 'id' => 'c_fax', 'readonly'=>"readonly",]) !!}
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 {{$errors->has('c_major_activity_brief') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7" style="width: 79.8%">
                                                        {!! Form::textarea('c_major_activity_brief', Session::get('waiver.c_major_activity_brief'),['class' => 'bigInputField form-control input-md cusReadonly maxTextCountDown', 'size'=>'1x2', 'id' => 'c_major_activity_brief','data-charcount-maxlength'=>'200', 'readonly'=>"readonly",]) !!}
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('local_company_name') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('local_company_name', Session::get('waiver.local_company_name'), ['class'=>'form-control input-md cusReadonly bigInputField', 'data-rule-maxlength'=>'255', 'id'=>"local_company_name", 'readonly'=>"readonly",]) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('local_company_name_bn') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('local_company_name_bn', Session::get('waiver.local_company_name_bn'), ['class'=>'form-control input-md cusReadonly bigInputField', 'data-rule-maxlength'=>'255', 'id'=>"local_company_name_bn", 'readonly'=>"readonly",]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_division_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_division_id', $divisions, Session::get('waiver.ex_office_division_id'), ['class' => 'form-control required cusReadonly  input-md', 'id' => 'ex_office_division_id', 'onchange'=>"getDistrictByDivisionId('ex_office_division_id', this.value, 'ex_office_district_id', ". Session::get('waiver.ex_office_district_id') .")", 'readonly'=>"readonly"]) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_district_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_district_id', $district_eng, Session::get('waiver.ex_office_district_id'), ['class' => 'form-control required cusReadonly  input-md', 'id' => 'ex_office_district_id' ,'placeholder' => 'Select division first', 'onchange'=>"getThanaByDistrictId('ex_office_district_id', this.value, 'ex_office_thana_id', ". Session::get('waiver.ex_office_thana_id') .")", 'readonly'=>"readonly"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_thana_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_thana_id', $thana_eng, Session::get('waiver.ex_office_thana_id'), ['class' => 'form-control required  input-md cusReadonly','placeholder' => 'Select district first', 'id' => 'ex_office_thana_id', 'readonly'=>"readonly"]) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_post_office') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_post_office', Session::get('waiver.ex_office_post_office'), ['class' => 'form-control input-md cusReadonly', 'readonly'=>"readonly"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_post_code') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_post_code', Session::get('waiver.ex_office_post_code'), ['class' => 'form-control required cusReadonly input-md post_code_bd', 'readonly'=>"readonly"]) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_address') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_address', Session::get('waiver.ex_office_address'), ['maxlength'=>'150','class' => 'form-control required cusReadonly input-md', 'readonly'=>"readonly"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_telephone_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_telephone_no', Session::get('waiver.ex_office_telephone_no'), ['maxlength'=>'20','class' => 'form-control cusReadonly input-md phone_or_mobile', 'readonly'=>"readonly"]) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_mobile_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_mobile_no', Session::get('waiver.ex_office_mobile_no'), ['class' => 'form-control required cusReadonly input-md helpText15' ,'id' => 'ex_office_mobile_no', 'readonly'=>"readonly"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_fax_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_fax_no', Session::get('waiver.ex_office_fax_no'), ['class' => 'form-control cusReadonly input-md', 'readonly'=>"readonly"]) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_email') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_email', Session::get('waiver.ex_office_email'), ['class' => 'form-control required cusReadonly email input-md', 'readonly'=>"readonly"]) !!}
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 {{$errors->has('activities_in_bd') ? 'has-error': ''}}" id="courtesy_service_reason_div">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        'size'=>'10x3','data-charcount-maxlength'=>'250', 'readonly'=>"readonly"]) !!}
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 {{$errors->has('comprehensive_income_start_date') ? 'has-error': ''}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div id="" class="input-group date">
                                                                    {!! Form::text('comprehensive_income_start_date', Session::get('waiver.comprehensive_income_start_date'), ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy',  'readonly']) !!}
                                                        ...
                                                        <div class="col-md-6 {{$errors->has('comprehensive_income_end_date') ? 'has-error': ''}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                <div id="" class="input-group date">
                                                                    {!! Form::text('comprehensive_income_end_date', Session::get('waiver.comprehensive_income_end_date'), ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'duration_end_date','readonly']) !!}
                                                                    <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                                </div>
                                                                <span class="text-danger" style="font-size: 12px; font-weight: bold" id="date_compare_error"></span>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 {{$errors->has('comprehensive_income_duration') ? 'has-error': ''}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                {!! Form::text('comprehensive_income_duration', Session::get('waiver.comprehensive_income_duration'), ['class' => 'form-control input-md', 'readonly', 'id' => 'desired_duration']) !!}
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Report Data Table">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('total_revenue', Session::get('waiver.total_revenue'), ['class' => 'form-control total_investment_item input-md number','id'=>'total_revenue' , 'onKeyUp'=>"totalRevenue(this.value)",'readonly']) !!}
                                                                                </td>
                                                                                <td>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Report Data Table">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('total_expense', Session::get('waiver.total_expense'), ['class' => 'form-control total_investment_item input-md number','id'=>'total_expense', 'onKeyUp'=>"totalExpense(this.value)",'readonly']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def",'readonly']) !!}
                                                                                </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Report Data Table">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('total_comprehensive_income', Session::get('waiver.total_comprehensive_income'), ['class' => 'form-control input-md number','id'=>'total_comprehensive_income', 'readonly']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def",'readonly']) !!}
                                                                                </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Report Data Table">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('fixed_assets',Session::get('waiver.fixed_assets'), ['class' => 'form-control input-md number','readonly']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def",'readonly']) !!}
                                                                                </td>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Report Data Table">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('current_assets', Session::get('waiver.current_assets'), ['class' => 'form-control input-md number','readonly']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def",'readonly']) !!}
                                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table aria-label="Detailed Bank Balance Report">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('bank_balance', Session::get('waiver.bank_balance'), ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','readonly']) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def",'readonly']) !!}
                                                                            </td>
                                                                ...
                                                                <td>
                                                                    <table aria-label="Detailed Cash Balance Report">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('cash_balance', Session::get('waiver.cash_balance'), ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','readonly']) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def",'readonly']) !!}
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table aria-label="Detailed Fixed Liabilities Report">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('fixed_liabilities',Session::get('waiver.fixed_liabilities'), ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','readonly']) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def",'readonly']) !!}
                                                                            </td>
                                                                ...
                                                                <td>
                                                                    <table aria-label="Detailed Current Liabilities Report">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('current_liabilities', Session::get('waiver.current_liabilities'), ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','readonly']) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def",'readonly']) !!}
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table aria-label="Detailed Equility Report">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('equility', Session::get('waiver.equility'), ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','readonly']) !!}
                                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table aria-label="Detailed Report Data Table">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @if(Session::get('waiver.profit_loss'))
                                                                            <td>
                                                                                {!! Form::radio('profit_loss', 'Profit', Session::get('waiver.profit_loss') == 'Profit', ['id' => 'profit_chk', 'class' => 'float-left margin_left_110','disabled']) !!}
                                                                                {!! Form::label('profit_chk', 'Profit', ['class' => 'float-left margin_left_10']) !!}

                                                                            </td>
                                                                            <td>
                                                                                {!! Form::radio('profit_loss', 'Loss', Session::get('waiver.profit_loss') == 'Loss', ['id' => 'loss_chk', 'class' => 'float-left margin_left_40','disabled']) !!}
                                                                                {!! Form::label('loss_chk', 'Loss', ['class' => 'float-left margin_left_10']) !!}
                                                                            </td>
                                                                            <input type="hidden" name="profit_loss" value="{{Session::get('waiver.profit_loss')}}">
                                                                        @else
                                                                            <td>
                                                                                <span class="float-left margin_left_10">Not Specific</span>
                                                                            </td>
                                                                        @endif
                                                            ...
                                                            <td>
                                                                <table aria-label="Detailed Accumulated Profit/Loss Report">
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            {!! Form::text('acc_profit_loss', Session::get('waiver.acc_profit_loss'), ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','readonly']) !!}
                                                                        </td>
                                    ...
                                    <div class="form-group clearfix">
                                        <div class="col-md-12" style="padding: 0">
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered" aria-label="Detailed Proposed organization Report" width="100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            {!! Form::text('local_executive', Session::get('waiver.local_executive'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'local_executive','readonly']) !!}
                                                            {!! $errors->first('local_executive','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('local_stuff', Session::get('waiver.local_stuff'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'local_stuff','readonly']) !!}
                                                        ...
                                                        <td>
                                                            {!! Form::text('foreign_executive', Session::get('waiver.foreign_executive'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'foreign_executive','readonly']) !!}
                                                            {!! $errors->first('foreign_executive','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('foreign_stuff', Session::get('waiver.foreign_stuff'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'foreign_stuff','readonly']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('est_initial_expenses') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('est_initial_expenses', Session::get('waiver.est_initial_expenses'),['class' => 'form-control cusReadonly input-md number', 'id' => 'est_initial_expenses','readonly']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('est_monthly_expenses') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('est_monthly_expenses', Session::get('waiver.est_monthly_expenses'),['class' => 'form-control cusReadonly input-md number', 'id' => 'est_monthly_expenses','readonly']) !!}
...
<script>
    ...
    function uploadDocument(targets, id, vField, isRequired) {
        ...
        try{
            ...
            var action = "{{url('/waiver-condition-7/upload-document')}}";
    ...
    function totalExpensetotalExpense(total_expense){
    ...
    let sessionLastTrNo = '{{ Session::get('waiver.ref_app_tracking_no') }}';
    ...
    $(document).ready(function() {
        ...
        form.steps({
            ...
            onStepChanging: function (event, currentIndex, newIndex) {
                if(newIndex == 1){
                   if(sessionLastTrNo == ''){
                       alert('Please, load Waiver Condition 7 Permission data.');
                       return false;
                   }
                }
