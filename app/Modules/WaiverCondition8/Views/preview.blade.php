...
<script>
    ...
    jQuery(function () {
        jQuery('#submitFromPreviewBtn').click(function (e) {
            window.opener.document.getElementById("WaiverForm").setAttribute("target", "_self");
            window.opener.jQuery("#WaiverForm").submit();
            window.close();
        });
    });
...
//        return jQuery(this).find('option:selected').text();
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery("#WaiverForm-p-4").css({"display": "block"});
