...
@if($basicInfo)
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <fieldset class="scheduler-border">
                <legend class="scheduler-border">Information of Principal Promoter/ Chairman/ Managing Director/ State
                    CEO:
                </legend>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6 {{$errors->has('ceo_country_id') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input class="form-control input-md" type="text" value="{{ $basicInfo->ceo_country }}"
                                       readonly>
                        ...
                        <div class="col-md-6 {{$errors->has('ceo_dob') ? 'has-error': ''}}">
                            ...
                            <div class=" col-md-7">
                                <div class="datepicker input-group date" data-date-format="dd-mm-yyyy">
                                    <input class="form-control input-md" type="text"
                                           value="{{ date('d-M-Y', strtotime($basicInfo->ceo_dob)) }}" readonly>
                    ...
                    <div class="row">
                        @if($basicInfo->ceo_country_id == 18)
                            <div class="col-md-6 {{$errors->has('ceo_nid') ? 'has-error': ''}}">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control input-md" type="text" value="{{ $basicInfo->ceo_nid }}"
                                           readonly>
                        ...
                        @else
                            <div class="col-md-6 {{$errors->has('ceo_passport_no') ? 'has-error': ''}}">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control input-md" type="text"
                                           value="{{ $basicInfo->ceo_passport_no }}" readonly>
                        ...
                        <div class="col-md-6 {{$errors->has('ceo_designation') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input class="form-control input-md" type="text"
                                       value="{{ $basicInfo->ceo_designation }}" readonly>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6 {{$errors->has('ceo_full_name') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input class="form-control input-md" type="text" value="{{ $basicInfo->ceo_full_name }}"
                                       readonly>
                        ...
                        @if($basicInfo->ceo_country_id == 18)
                            <div class="col-md-6 {{$errors->has('ceo_district_id') ? 'has-error': ''}}">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control input-md" type="text"
                                           value="{{ $basicInfo->ceo_district_name }}" readonly>
                        ...
                        @else
                            <div class="col-md-6 {{$errors->has('ceo_city') ? 'has-error': ''}}">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control input-md" type="text" value="{{ $basicInfo->ceo_city }}"
                                           readonly>
                    ...
                    <div class="row">
                        @if($basicInfo->ceo_country_id == 18)
                            <div class="col-md-6 {{$errors->has('ceo_thana_id') ? 'has-error': ''}}">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control input-md" type="text"
                                           value="{{ $basicInfo->ceo_thana_name }}" readonly>
                        ...
                        @else
                            <div class="col-md-6 {{$errors->has('ceo_state') ? 'has-error': ''}}">
                                ...
                                <div class="col-md-7">
                                    <input class="form-control input-md" type="text" value="{{ $basicInfo->ceo_state }}"
                                           readonly>
                        ...
                        <div class="col-md-6 {{$errors->has('ceo_post_code') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input class="form-control input-md" type="text" value="{{ $basicInfo->ceo_post_code }}"
                                       readonly>
                ...
                <div class="form-group custom-input">
                    <div class="row">
                        <div class="col-md-6 {{$errors->has('ceo_address') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input class="form-control input-md" type="text" value="{{ $basicInfo->ceo_address }}"
                                       readonly>
                        ...
                        <div class="col-md-6 {{$errors->has('ceo_telephone_no') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input id="ceo_telephone_no" class="form-control input-md" type="text"
                                       value="{{ $basicInfo->ceo_telephone_no }}" readonly>
                ...
                <div class="form-group custom-input">
                    <div class="row">
                        <div class="col-md-6 {{$errors->has('ceo_mobile_no') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input id="ceo_mobile_no" class="form-control input-md" type="text"
                                       value="{{ $basicInfo->ceo_mobile_no }}" readonly>
                        ...
                        <div class="col-md-6 {{$errors->has('ceo_father_name') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input class="form-control input-md" type="text"
                                       value="{{ $basicInfo->ceo_father_name }}" readonly>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6 {{$errors->has('ceo_email') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input class="form-control input-md" type="text" value="{{ $basicInfo->ceo_email }}"
                                       readonly>
                        ...
                        <div class="col-md-6 {{$errors->has('ceo_mother_name') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input class="form-control input-md" type="text"
                                       value="{{ $basicInfo->ceo_mother_name }}" readonly>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6 {{$errors->has('ceo_fax_no') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input class="form-control input-md" type="text" value="{{ $basicInfo->ceo_fax_no }}"
                                       readonly>
                        ...
                        <div class="col-md-6 {{$errors->has('ceo_spouse_name') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input class="form-control input-md" type="text"
                                       value="{{ $basicInfo->ceo_spouse_name }}" readonly>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-6 {{$errors->has('ceo_gender') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input class="form-control input-md" type="text" value="{{ $basicInfo->ceo_gender }}"
                                       readonly>
                            </div>
                        </div>
                    </div>
                ...
                <div class="form-group custom-input">
                    <div class="row">
                        <div class="col-md-6 {{$errors->has('office_telephone_no') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input id="office_telephone_no" class="form-control input-md" type="text"
                        ...
                        <div class="col-md-6 {{$errors->has('office_mobile_no') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-7">
                                <input id="office_mobile_no" class="form-control input-md" type="text"
