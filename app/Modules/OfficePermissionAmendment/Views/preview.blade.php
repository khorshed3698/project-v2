...
<script language="javascript">
    ...
    jQuery(function () {
        jQuery('#submitFromPreviewBtn').click(function (e) {
            window.opener.document.getElementById("OfficePermissionAmendmentForm").setAttribute("target", "_self");
            window.opener.jQuery("#OfficePermissionAmendmentForm").submit();
            window.close();
        });
    });
...
//        return jQuery(this).find('option:selected').text();
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery("#OfficePermissionAmendmentForm-p-4").css({"display": "block"});
