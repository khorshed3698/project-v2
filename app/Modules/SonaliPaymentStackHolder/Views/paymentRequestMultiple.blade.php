...
<RequestInformation>
 <Authentication>
<ApiAccessUserId>{{ config('payment.spg_settings_stack_holder.user_id') }}</ApiAccessUserId>
...
<ReturnUrl>{{ config('payment.spg_settings_stack_holder.return_url_m') }}</ReturnUrl>
