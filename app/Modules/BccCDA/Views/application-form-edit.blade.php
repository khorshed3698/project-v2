        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        {!! Form::text('applicant_name', !empty($appData->applicant_name) ? $appData->applicant_name:'',['class' => 'form-control input-md','size'=>'5x1','maxlength'=>'200']) !!}
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="form-group">
                <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        {!! Form::select('suggested_building_use',[], '',['class' => 'form-control input-md']) !!}
                    </div>
                </div>
                <div class="col-md-6">
                    {!! Form::label('suggested_building_living_usage','৩.১। প্রস্তাবিত ইমারতের বসবাসের ধরণ :',['class'=>' col-md-6']) !!}
                    <div class="col-md-6">
                        {!! Form::select('suggested_building_living_usage',[],'',['class' => 'form-control input-md','placeholder'=>'Select Building Usage First']) !!}
                    </div>
                </div>
            </div>
            {{--first panel end--}}
            ...
            <div class="form-group">
                ...
                <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            {!! Form::text('total_land_area', !empty($appData->total_land_area) ? $appData->total_land_area:'',['class' => 'form-control input-md enbnNumber']) !!}
                        </div>
                    </div>
                            ...
                            <div class="row ">
                                <div class="col-md-3 col-xs-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-4" style="margin-top:5px;">
                                            {!! Form::text('arm_size_south', !empty($appData->arm_size_south) ? $appData->arm_size_south:'',['class' => 'form-control enbnNumber input-md']) !!}
                                        </div>
                                ...
                                <div class="col-md-3 col-xs-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-4" style="margin-top:5px;">
                                            {!! Form::text('arm_size_north', !empty($appData->arm_size_north) ? $appData->arm_size_north:'',['class' => 'form-control input-md enbnNumber']) !!}
                                        </div>
                                        <label class="col-md-3 col-xs-3" style="margin-left:-15px;margin-top:12px;">
                                            মিটার
                                        </label>
                                ...
                                <div class="col-md-3 col-xs-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-4" style="margin-top:5px;">
                                            {!! Form::text('arm_size_east', !empty($appData->arm_size_east) ? $appData->arm_size_east:'',['class' => 'form-control enbnNumber input-md']) !!}
                                        </div>
                                        <label class="col-md-3 col-xs-3" style="margin-left:-15px;margin-top:12px;">
                                            মিটার
                                        </label>
                                ...
                                <div class="col-md-3 col-xs-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-4" style="margin-top:5px;">
                                            {!! Form::text('arm_size_west', !empty($appData->arm_size_west) ? $appData->arm_size_west:'',['class' => 'form-control enbnNumber input-md']) !!}
                                        </div>
                                        <label class="col-md-3 col-xs-3" style="margin-left:-15px;margin-top:12px;">
                                            মিটার
                                        </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            {!! Form::text('projects_total_area', !empty($appData->projects_total_area) ? $appData->projects_total_area:'',['class' => 'form-control enbnNumber input-md']) !!}
                        </div>

                        {!! Form::label('','ঘ)আবাসিক ভবনের ক্ষেত্রে প্রতি তলায় আবাস/এ্যাপার্টমেন্ট/ফ্ল্যাটের সংখ্যা:',['class'=>'col-md-6']) !!}
                        <div class="col-md-2">
                            {!! Form::text('flat_per_floor', !empty($appData->flat_per_floor) ? $appData->flat_per_floor:'',['class' => 'form-control enbnNumber input-md']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('','ঙ) প্রকল্পের মোট আবাসন এককের সংখ্যা :',['class'=>'col-md-4']) !!}
                        <div class="col-md-2">
                            {!! Form::text('total_accommodation_unit', !empty($appData->total_accommodation_unit) ? $appData->total_accommodation_unit:'',['class' => 'form-control enbnNumber input-md']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('','চ) জমির মোট ভূ-পৃষ্ঠস্থ আচ্ছাদিত অংশের ক্ষেত্রফল (বর্গমিটার)',['class'=>'col-md-5']) !!}
                        <div class="col-md-2">
                            {!! Form::text('total_ground_area', !empty($appData->total_ground_area) ? $appData->total_ground_area:'',['class' => 'form-control input-md']) !!}
                        </div>
                        {!! Form::label('','যাহা ভূমির :',['class'=>'col-md-2']) !!}
                        <div class="col-md-2">
                            {!! Form::text('percent_ground_area', !empty($appData->percent_ground_area) ? $appData->percent_ground_area:'',['class' => 'form-control input-md']) !!}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            {!! Form::text('plinth_total_floor', !empty($appData->plinth_total_floor) ? $appData->plinth_total_floor:'',['class' => 'form-control input-md']) !!}
                        </div>
                        {!! Form::label('','এবং বেসমেন্ট ফ্লোরের সংখ্যা :',['class'=>'col-md-3']) !!}
                        <div class="col-md-2">
                            {!! Form::text('basement_total_floor', !empty($appData->basement_total_floor) ? $appData->basement_total_floor:'',['class' => 'form-control input-md']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            {!! Form::text('previous_build_number', !empty($appData->previous_build_number) ? $appData->previous_build_number:'',['class' => 'form-control input-md enbnNumber']) !!}
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            {!! Form::text('new_build_number',  !empty($appData->new_build_number) ? $appData->new_build_number:'',['class' => 'form-control input-md enbnNumber']) !!}
                        </div>
                        {!! Form::label('','মিটার',['class'=>' col-md-1']) !!}
                    </div>
                    <div class="form-group">
                            ...
                            <div class="row ">
                                <div class="col-md-3 col-xs-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-4" style="margin-top:5px;">
                                            {!! Form::text('open_space_front',  !empty($appData->open_space_front) ? $appData->open_space_front:'',['class' => 'form-control enbnNumber input-md']) !!}
                                        </div>
                                        <label class="col-md-3 col-xs-3" style="margin-left:-15px;margin-top:12px;">
                                            মিটার
                                        </label>
                                ...
                                <div class="col-md-3 col-xs-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-4" style="margin-top:5px;">
                                            {!! Form::text('open_space_back',  !empty($appData->open_space_back) ? $appData->open_space_back:'',['class' => 'form-control input-md enbnNumber']) !!}
                                        </div>
                                        <label class="col-md-3 col-xs-3" style="margin-left:-15px;margin-top:12px;">
                                            মিটার
                                        </label>
                                ...
                                <div class="col-md-3 col-xs-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-4" style="margin-top:5px;">
                                            {!! Form::text('open_space_left',  !empty($appData->open_space_left) ? $appData->open_space_left:'',['class' => 'form-control enbnNumber input-md']) !!}
                                        </div>
                                        <label class="col-md-3 col-xs-3" style="margin-left:-15px;margin-top:12px;">
                                            মিটার
                                        </label>
                                ...
                                <div class="col-md-3 col-xs-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-4" style="margin-top:5px;">
                                            {!! Form::text('open_space_right',  !empty($appData->open_space_right) ? $appData->open_space_right:'',['class' => 'form-control enbnNumber input-md']) !!}
                                        </div>
                                        <label class="col-md-3 col-xs-3" style="margin-left:-15px;margin-top:12px;">
                                            মিটার
                                        </label>
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="text-align:center">
                                <input type="text" id="sum" value="{{!empty($appData->total) ? $appData->total:''}}"
                                       name="total" class="form-control input-md"></td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            {!! Form::select('owner_documents',$yesnona, !empty($appData->owner_documents) ? $appData->owner_documents:'',['class' => 'form-control enbnNumber input-md','placeholder'=>'Select One']) !!}
                        </div>
                        {!! Form::label('','২। সরকার কর্তৃক বরাদ্দহকৃত জমি হয়লে ইহার দলিলাদি ও অনুমতিপত্র',['class'=>'col-md-4']) !!}
                        <div class="col-md-2">
                            {!! Form::select('gov_allocated_land_doc',$yesnona, !empty($appData->gov_allocated_land_doc) ? $appData->gov_allocated_land_doc:'',['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            {!! Form::select('fee_receipt',$yesnona, !empty($appData->fee_receipt) ? $appData->fee_receipt:'',['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                        </div>
                        {!! Form::label('','৪। ভুমি ব্যবহারের ছাড়পত্র (প্রযোজ্য ক্ষেত্রে)',['class'=>'col-md-4']) !!}
                        <div class="col-md-2">
                            {!! Form::select('land_usage_exemption',$yesnona, !empty($appData->land_usage_exemption) ? $appData->land_usage_exemption:'',['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            {!! Form::select('special_project_exemption',$yesnona, !empty($appData->special_project_exemption) ? $appData->special_project_exemption:'',['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                        </div>
                        {!! Form::label('','৬। ইনডেমনিটি বন্ড (প্রযোজ্য ক্ষেত্রে)',['class'=>'col-md-4']) !!}
                        <div class="col-md-2">
                            {!! Form::select('indempty_bond',$yesnona, !empty($appData->indempty_bond) ? $appData->indempty_bond:'',['class' => 'form-control input-md ','placeholder'=>'Select One']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            {!! Form::select('soil_test_report',$yesnona, !empty($appData->soil_test_report) ? $appData->soil_test_report:'',['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                        </div>
                        {!! Form::label('','৮। Floor Area Ratio (FAR) এর হিসাব',['class'=>'col-md-4']) !!}
                        <div class="col-md-2">
                            {!! Form::select('far_calculation',$yesnona, !empty($appData->far_calculation) ? $appData->far_calculation:'',['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            {!! Form::select('all_designs',$yesnona, !empty($appData->all_designs) ? $appData->all_designs:'',['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                        </div>
                        {!! Form::label('','১০। বিধি মোতাবেক গৃহীত ব্যবস্থা',['class'=>'col-md-4']) !!}
                        <div class="col-md-2">
                            {!! Form::select('action_taken',$yesnona, !empty($appData->action_taken) ? $appData->action_taken:'',['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-10 col-md-offset-1 col-xs-10 col-xs-offset-1">
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            {!! Form::select('authority_exmption',$yesnona, !empty($appData->authority_exmption) ? $appData->authority_exmption:'',['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                {!! Form::checkbox('accept_terms',1,!empty($appData->thana_name) ? $appData->thana_name:'', array('id'=>'accept_terms', 'class'=>'required')) !!}
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#suggested_building_use').on('keydown', function (el) {
            ...
            let selected_value = '{{!empty($appData->suggested_building_use) ? $appData->suggested_building_use:''}}';
            ; // for callback
        ...
        $("#suggested_building_use").on("change", function () {
            ...
            if (suggested_building_use_id) {
                ...
                let selected_value = '{{!empty($appData->suggested_building_living_usage) ? $appData->suggested_building_living_usage:''}}'; // for callback
                let calling_id = $(this).attr('id');// for callback
        ...
        $('#city_corporation').on('keydown', function (el) {
            ...
            let e = $(this);
            let api_url = "{{$cda_bcc_service_url}}/get-list";
            let selected_value = '{{!empty($appData->city_corporation) ? $appData->city_corporation:''}}'; // for callback
            let calling_id = $(this).attr('id');// for callback
    ...
    function usageDependantCallbackResponse(response, [calling_id, selected_value, element_id, element_name, element_calling_id, element_details, dependant_select_id]) {
        ...
        if (response.status === 200) {
            $.each(response.data.resonse.result.data, function (key, row) {
                let id = row[element_id] + '@' + row[element_calling_id] + '@' + row[element_name] + '@' + row[element_details] + '@' + row[element_details];
