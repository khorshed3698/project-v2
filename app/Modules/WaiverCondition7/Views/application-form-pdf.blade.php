                ...
                <div class="panel panel-info"  id="inputForm">
                    ...
                    <div class="panel-body">
                        ...
                        <div id="ep_form" class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <table aria-label="Detailed Report Information about the proposed branch/liaison/representative office" width="100%" cellpadding="10">
                                        <thead>
                                            <tr class="d-none">
                                                {{-- <th aria-hidden="true" scope="col"></th> --}}
                                            </tr>
                                                ...
                                                <div class="row" style="padding: 5px">
                                                    <table aria-label="Detailed Report Government Fee Payment" class="table table-striped table-bordered">
                                                        ...
                                                        <tr>
                                                            <td>Contact name :
                                                                <span>
                                                                    {{ (!empty($appInfo->gfp_contact_name)) ? $appInfo->gfp_contact_name :''  }}
                                                                </span>
                                                            </td>
                                                            <td>Contact email :
