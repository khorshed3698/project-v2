            ...
            <div class="box-body">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h5><strong>Application for Waiver Condition 7</strong></h5>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="panel-body">

                        {!! Form::open(array('url' => 'waiver-condition-7/store','method' => 'post','id' => 'WaiverForm','enctype'=>'multipart/form-data', 'files' => true, 'role'=>'form')) !!}
                                                ...
                                                <div id="ref_app_tracking_no_div" class="col-md-12  {{$errors->has('ref_app_tracking_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="col-md-6">
                                                                ...
                                                                {{-- {!! Form::text('ref_app_approve_date', !empty(Session::get('brInfo.ref_app_approve_date')) ? date('d-M-Y', strtotime(Session::get('brInfo.ref_app_approve_date'))) : '', ['class'=>'form-control input-md datepicker', 'id' => 'ref_app_approve_date', 'placeholder'=>'Pick from datepicker']) !!} --}}
                                                                {!! Form::text('ref_app_approve_date', !empty(Session::get('waiver.ref_app_approve_date')) ? date('d-M-Y', strtotime(Session::get('waiver.ref_app_approve_date'))) : '', ['class'=>'form-control input-md ', 'id' => 'ref_app_approve_date', 'readonly']) !!}
                                    ...
                                    <div class="panel-body">
                                                            ...
                                                            <div class="col-md-6 {{$errors->has('comprehensive_income_start_date') ? 'has-error': ''}}">
                                                                ...
                                                                <div class="col-md-7">
                                                                    <div id="duration_start_datepicker" class="input-group date">
                                                                        {!! Form::text('comprehensive_income_start_date', '', ['class' => 'form-control input-md date required', 'placeholder'=>'dd-mm-yyyy', 'id' => 'duration_start_date']) !!}
                                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                                    </div>
                                                ...
                                                <div id="investment_review">
                                                    <fieldset class="scheduler-border">
                                                            ...
                                                            <table class="table table-striped table-bordered" aria-label="Detailed Investment Report">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <table aria-label="Detailed Total Revenue Report">
                                                                                ...
                                                                                <tr>
                                                                                    <td>
                                                                                        {!! Form::text('total_revenue', '', ['class' => 'form-control total_investment_item input-md number required validate-number','id'=>'total_revenue' , 'onKeyUp'=>"totalRevenue(this.value)"]) !!}
                                                                                    </td>
                                                                                    <td>
                                                                        ...
                                                                        <td>
                                                                            <table aria-label="Detailed Report Total Expense">
                                                                                <tr>
                                                                                    <th aria-hidden="true" scope="col"></th>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                                                                        {!! Form::text('total_expense', '', ['class' => 'form-control total_investment_item input-md number required validate-number','id'=>'total_expense', 'onKeyUp'=>"totalExpense(this.value)"]) !!}
                                                                                    </td>
                                                                                    <td>
                                                                                        {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                    </td>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <table aria-label="Detailed Report Total Comprehensive Income">
                                                                                <tr>
                                                                                    <th aria-hidden="true" scope="col"></th>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                                                                        {!! Form::text('total_comprehensive_income', '', ['class' => 'form-control input-md number required validate-number','id'=>'total_comprehensive_income', 'readonly']) !!}
                                                                                    </td>
                                                                                    <td>
                                                                                        {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                    </td>
                                                            ...
                                                            <table class="table table-striped table-bordered" aria-label="Detailed Report Data Table">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <table aria-label="Detailed Report Fixed Assets">
                                                                                <tr>
                                                                                    <th aria-hidden="true" scope="col"></th>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                                                                        {!! Form::text('fixed_assets', '', ['class' => 'form-control input-md number required validate-number']) !!}
                                                                                    </td>
                                                                                    <td>
                                                                                        {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                    </td>
                                                                        ...
                                                                        <td>
                                                                            <table aria-label="Detailed Report Current Assets">
                                                                                <tr>
                                                                                    <th aria-hidden="true" scope="col"></th>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td>
                                                                                        {!! Form::text('current_assets', '', ['class' => 'form-control input-md number required validate-number']) !!}
                                                                                    </td>
                                                                                    <td>
                                                                                        {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                    </td>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped table-bordered" aria-label="Detailed Report Data Table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Report Bank Balance">
                                                                            <tr>
                                                                                <th aria-hidden="true" scope="col"></th>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('bank_balance', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required validate-number']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                </td>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Report Cash Balance">
                                                                            <tr>
                                                                                <th aria-hidden="true" scope="col"></th>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('cash_balance', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required validate-number']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                </td>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped table-bordered" aria-label="Detailed Report Data Table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Report Fixed Liabilities">
                                                                            <tr>
                                                                                <th aria-hidden="true" scope="col"></th>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('fixed_liabilities', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required validate-number']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                </td>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Report Current Liabilities">
                                                                            <tr>
                                                                                <th aria-hidden="true" scope="col"></th>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('current_liabilities', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required validate-number']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                </td>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-striped table-bordered" aria-label="Detailed Report Data Table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Report Equility">
                                                                            <tr>
                                                                                <th aria-hidden="true" scope="col"></th>
                                                                            </tr>
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('equility', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required validate-number']) !!}
                                                                                </td>
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <table aria-label="Detailed Report Accumulated">
                                                                        <tr>
                                                                            <th aria-hidden="true" scope="col"></th>
                                                                        </tr>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                {!! Form::radio('profit_loss',"Profit",null, array('id'=>'profit_chk', 'class'=>"float-left margin_left_110 required")) !!}
                                                                                {!! Form::label('profit_chk','Profit',[ 'id'=> 'profit_chk', 'class'=> "float-left margin_left_10"]) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::radio('profit_loss',"Loss",null, array('id'=>'loss_chk', 'class'=>"float-left margin_left_40 required")) !!}
                                                                ...
                                                                <td>
                                                                    <table aria-label="Detailed Report Accumulated Profit/Loss">
                                                                        <tr>
                                                                            <th aria-hidden="true" scope="col"></th>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('acc_profit_loss', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required validate-number']) !!}
                                                                            </td>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="col-md-12" style="padding: 0">
                                                <div class="table-responsive">
                                                    <table class="table table-striped table-bordered" aria-label="Detailed Report Proposed organization" width="100%">
