            ...
            <div class="box-body">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h5><b>Application for Waiver Condition 7</b></h5>
                        </div>
                    ...
                    <div class="panel-body">
                        {!! Form::open(array('url' => 'waiver-condition-7/store','method' => 'post','id' => 'WaiverForm','enctype'=>'multipart/form-data', 'method' => 'post', 'files' => true, 'role'=>'form')) !!}
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div id="ref_app_tracking_no_div" class="col-md-12  {{$errors->has('ref_app_tracking_no') ? 'has-error': ''}}">
                                                            {!! Form::label('ref_app_tracking_no','Please provide your Branch office permission tracking No. New/Extension:',['class'=>'col-md-6 text-left required-star']) !!}
                                                            <div class="col-md-6">
                            ...
                            <fieldset>
                                ...
                                @include('WaiverCondition7::basic-info')
                                        ...
                                        <div class="panel panel-info">
                                            ...
                                            <div class="panel-body">
                                                            ...
                                                            <div class="col-md-6 {{$errors->has('comprehensive_income_start_date') ? 'has-error': ''}}">
                                                                ...
                                                                <div class="col-md-7">
                                                                    <div id="duration_start_datepicker" class="required input-group date">
                                                                        {!! Form::text('comprehensive_income_start_date', empty($appInfo->comprehensive_income_start_date) ? '' : date('d-M-Y', strtotime($appInfo->comprehensive_income_start_date)), ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'duration_start_date', 'required']) !!}
                                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6 {{$errors->has('comprehensive_income_end_date') ? 'has-error': ''}}">
                                                                ...
                                                                <div class="col-md-7">
                                                                    <div id="duration_end_datepicker" class="required input-group date">
                                                                        {!! Form::text('comprehensive_income_end_date', empty($appInfo->comprehensive_income_end_date) ? '' : date('d-M-Y', strtotime($appInfo->comprehensive_income_end_date)), ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'duration_end_date', 'required']) !!}
                                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6 {{$errors->has('comprehensive_income_duration') ? 'has-error': ''}}">
                                                                ...
                                                                <div class="col-md-7">
                                                                    {!! Form::text('comprehensive_income_duration', $appInfo->comprehensive_income_duration, ['class' => 'form-control input-md', 'readonly', 'id' => 'desired_duration']) !!}
                                                ...
                                                <div id="investment_review">
                                                    <fieldset class="scheduler-border">
                                                        <legend class="scheduler-border required-star">Investment</legend>
                                                        <div class="table-responsive">
                                                            <table aria-label="Detailed Investment Report" class="table table-striped table-bordered">
                                                                <thead>
                                                                    <tr class="d-none">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Total Revenue Report">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('total_revenue', $appInfo->total_revenue, ['class' => 'form-control total_investment_item input-md number required validate-number','id'=>'total_revenue' , 'onKeyUp'=>"totalRevenue(this.value)"]) !!}
                                                                                </td>
                                                                                <td>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Total Expense Report">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('total_expense', $appInfo->total_expense, ['class' => 'form-control total_investment_item input-md number required validate-number','id'=>'total_expense', 'onKeyUp'=>"totalExpense(this.value)"]) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Total Comprehensive Income Report">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('total_comprehensive_income', $appInfo->total_comprehensive_income, ['class' => 'form-control input-md number required validate-number','id'=>'total_comprehensive_income', 'readonly']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Fixed Assets Report">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('fixed_assets', $appInfo->fixed_assets, ['class' => 'form-control input-md number required validate-number']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                </td>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Current Assets Report">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('current_assets', $appInfo->current_assets, ['class' => 'form-control input-md number required validate-number']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Bank Balance Report">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('bank_balance', $appInfo->bank_balance, ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required validate-number']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                </td>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Cash Balance Report">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('cash_balance', $appInfo->cash_balance, ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required validate-number']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Fixed Liabilities Report">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('fixed_liabilities', $appInfo->fixed_liabilities, ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required validate-number']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                </td>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Current Liabilities Report">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('current_liabilities', $appInfo->current_liabilities, ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required validate-number']) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                                </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Equility Report">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('equility', $appInfo->equility, ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required validate-number']) !!}
                                                                                </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <table aria-label="Detailed Report Data Table">
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    {!! Form::radio('profit_loss',"Profit",$appInfo->profit_loss == 'Profit' ? 'Profit' : null , array('id'=>'profit_chk', 'class'=>"float-left margin_left_110 required")) !!}
                                                                                    {!! Form::label('profit_chk','Profit',[ 'id'=> 'profit_chk', 'class'=> "float-left margin_left_10"]) !!}
                                                                                </td>
                                                                                <td>
                                                                                    {!! Form::radio('profit_loss',"Loss",$appInfo->profit_loss == 'Loss' ? 'Loss' : null, array('id'=>'loss_chk', 'class'=>"float-left margin_left_40 required")) !!}
                                                                    ...
                                                                    <td>
                                                                        <table aria-label="Detailed Accumulated Profit/Loss Report">
                                                                            ...
                                                                            <tr>
                                                                                <td>
                                                                                    {!! Form::text('acc_profit_loss', $appInfo->acc_profit_loss, ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required validate-number']) !!}
                                                                                </td>
                            ...
                            <fieldset>
                                ...
                                @if($viewMode != 'off')
                                    @include('WaiverCondition7::doc-tab')
                                @endif
                            ...
                            @if(ACL::getAccsessRight('WaiverCondition7','-E-') && $viewMode != "on" && $appInfo->status_id != 6 && Auth::user()->user_type == '5x505')
...
<script>
    ...
    function CategoryWiseDocLoad(office_type) {
        ...
        if(office_type != 0 && office_type != ''){
            ...
            $.ajax({
                type: "POST",
                url: '/waiver-condition-7/getDocList',
                dataType: "json",
    ...
    $(document).ready(function(){
                ...
                if(newIndex == 2){
                    if (!validateNumberInputs()) {
                        swal({
                            type: 'error',
                            title: 'Oops...',
                            text: 'All numeric values must be greater than or equal to 0'
                        });
                        return false;
                    }
                }
        ...
        $('.finish').on('click', function (e) {
            if (form.valid()) {
                ...
                popupWindow = window.open('<?php echo URL::to('/waiver-condition-7/preview'); ?>', 'Sample', '');
            } else {
                return false;
            }
        });
        ...
        $('.validate-number').on('change keyup', function() {
            const value = parseFloat($(this).val());
            if (isNaN(value) || value < 0) {
                $(this).addClass('error');
            } else {
