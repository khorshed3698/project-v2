...
@section('content')
            ...
            <div class="box">
                <div id="paymentPanel" class="panel panel-default" style="display: none;">
                    <div class="panel-body">
                        ...
                        {!! Form::open(array('url' => '/new-connection-dpdc/payment-demand','method' => 'post','id' => 'NameClearanceForm','role'=>'form','enctype'=>'multipart/form-data')) !!}
    ...
    <script type="text/javascript">
        ...
        function checkBpdbStatus() {
            ...
            $.ajax({
                url: '/new-connection-dpdc/check-payment-info-demand',
                type: "POST",
                data: {
                    enc_app_id: app_id
                },
