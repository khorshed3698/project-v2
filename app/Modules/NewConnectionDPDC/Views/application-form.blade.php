<?php
$accessMode = ACL::getAccsessRight('NewConnectionDPDC');
                            ...
                            <div class="panel-body">
                                <div class="row col-md-12 text-center" style="margin-bottom:10px;">
                                    ...
                                    <div class="col-md-6 {{$errors->has('consumer_type') ? 'has-error': ''}}">
                                        <label class="radio-inline">{!! Form::radio('consumer_type','P', false,
                                        ['id' => 'personal_type','onchange'=>'application_type(this.value)']) !!}
                                            Personal</label>
                                        <label class="radio-inline">{!! Form::radio('consumer_type', 'O', true,
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7 {{$errors->has('organization_name') ? 'has-error': ''}}">
                                                    {!! Form::text('organization_name', '',['class' => 'form-control input-sm','id'=>'organization_name']) !!}
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7 {{$errors->has('proprietor_name') ? 'has-error': ''}}">
                                                    {!! Form::text('proprietor_name', '',['class' => 'form-control input-sm','id'=>'proprietor_name']) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_name') ? 'has-error': ''}}">
                                                {!! Form::text('applicant_name', '',['class' => 'form-control input-sm','id'=>'applicant_name']) !!}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_spouse_name') ? 'has-error': ''}}">
                                                {!! Form::text('applicant_spouse_name', '',['class' => 'form-control input-sm','id'=>'applicant_spouse_name']) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_father_name') ? 'has-error': ''}}">
                                                {!! Form::text('applicant_father_name', '',['class' => 'form-control input-sm','id'=>'applicant_father_name']) !!}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('union') ? 'has-error': ''}}">
                                                {!! Form::text('applicant_mother_name', '',['class' => 'form-control input-sm','id'=>'applicant_mother_name']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6" id="organization_2">
                                            ...
                                            <div class="col-md-7 {{$errors->has('pr_date_of_birth') ? 'has-error': ''}}">
                                                <div class="datepicker input-group date">
                                                    {!! Form::text('pr_date_of_birth', '',['class' => 'form-control input-sm','id'=>'pr_date_of_birth']) !!}
                                                    <span class="input-group-addon"><span
                                                                class="fa fa-calendar"></span></span>
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="col-md-4">
                                                    {!! Form::select('identity', ['nid'=>'National ID','passport'=>'Passport'], 'nid', ['class' =>
                                                ...
                                                <div id="nid">
                                                    <div class="col-md-5">
                                                        <div class=" {{$errors->has('nid_number') ? 'has-error': ''}}"
                                                            ...
                                                            {!! Form::text('nid_number', '',['class' => 'form-control input-sm onlyNumber','id'=>'nid_number','placeholder'=>'Enter NID']) !!}
                                                            {!! $errors->first('nid_number','<span class="help-block">:message</span>')
                                                            !!}
                                                        </div>
                                                        <div class=" {{$errors->has('confirm_nid_number') ? 'has-error': ''}}">
                                                            {!! Form::text('confirm_nid_number', '',['class' => 'form-control input-sm onlyNumber','id'=>'confirm_nid_number', 'placeholder'=>'Confirm NID Number']) !!}
                                                ...
                                                <div id="passport"
                                                    ...
                                                    {!! Form::text('passport', '',['class' => 'form-control input-sm','id'=>'passport_id']) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_gender') ? 'has-error': ''}}">
                                                {!! Form::select('applicant_gender', [''=>'Select
                                                Gender','male'=>'Male','female'=>'Female'], '', ['class' =>
                                                'form-control','id'=>'applicant_gender']) !!}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('photo') ? 'has-error': ''}}">
                                                ...
                                                <span style="color:#993333;">[N.B. Supported file extension is
                                                    pdf,png,jpg,jpeg.Max size less than 150KB]</span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('post_code') ? 'has-error': ''}}">
                                                {!! Form::text('post_code', '',['class' => 'form-control input-sm onlyNumber']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('mobile_no') ? 'has-error': ''}}">
                                                {!! Form::text('mobile_no', '',['class' => 'form-control input-sm','id'=>'mobile_no']) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('connection_house_no') ? 'has-error': ''}}">
                                                {!! Form::text('connection_house_no', '',['class' => 'form-control input-sm ']) !!}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('connection_lane_no') ? 'has-error': ''}}">
                                                {!! Form::text('connection_lane_no', '',['class' => 'form-control input-sm']) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('connection_section') ? 'has-error': ''}}">
                                                {!! Form::text('connection_section', '',['class' => 'form-control
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('connection_block') ? 'has-error': ''}}">
                                                {!! Form::text('connection_block', '',['class' => 'form-control input-sm']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('connection_post_code') ? 'has-error': ''}}">
                                                {!! Form::text('connection_post_code', '',['class' => 'form-control input-sm onlyNumber']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('connection_email') ? 'has-error': ''}}">
                                                {!! Form::text('connection_email', '',['class' => 'form-control input-sm email'])
                                                !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('connection_telephone') ? 'has-error': ''}}">
                                                {!! Form::text('connection_telephone', '',['class' => 'form-control
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('connection_mobile') ? 'has-error': ''}}">
                                                {!! Form::text('connection_mobile', '',['class' => 'form-control input-sm','id'=>'connection_mobile']) !!}
                                ...
                                <div class="form-group">
                                    <div class="checkbox">
                                        <label>
                                            ...
                                            'class'=>'required')) !!}
                                            I/We the undersigned declared hereby I/we shall obey the "Electricity act-
                                            1990 of the peoples republic of Bangladesh and the tariff 1989" approved by
                                            the ministry of energy and mineral resources of Bangladesh along with all
                                            amendments and agree to other Terms of Service and Privacy Policy of DPDC.
                                        </label>
                                    </div>
                                </div>
                            </div>
