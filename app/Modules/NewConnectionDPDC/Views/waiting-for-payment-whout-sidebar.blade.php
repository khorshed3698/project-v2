...
?>
        ...
        <div class="col-md-12">
            ...
            <div id="loading_wating">
                ...
                <Span class="alert alert-success" id="loding-msg"><i class="fa fa-spinner fa-spin"></i>  <span
                            id="loding-msg-text">Connecting to DPDC Server.</span></Span>
            </div>
            ...
            <div class="box">
                <div id="paymentPanel" class="panel panel-default" style="display: none;">
                    <div class="panel-body">
                        ...
                        {!! Form::open(array('url' => '/new-connection-dpdc/payment','method' => 'post','id' => 'NameClearanceForm','role'=>'form','enctype'=>'multipart/form-data')) !!}
    ...
    <script type="text/javascript">
        ...
        function checkDPDCStatus() {
            var app_id = $('#enc_app_id').val();

            $.ajax({
                url: '/new-connection-dpdc/check-payment-info',
                type: "POST",
                data: {
                    enc_app_id: app_id
                },
