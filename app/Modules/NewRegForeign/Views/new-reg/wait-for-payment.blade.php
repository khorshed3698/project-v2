            ...
            <div class="box">
                <div id="paymentPanel" class="panel panel-default" style="display: none;">
                    <div class="panel-body">
                        ...
                        {!! Form::open(array('url' => '/new-reg-foreign/new-reg/payment','method' => 'post','id' => 'NewReg','role'=>'form','enctype'=>'multipart/form-data')) !!}
...
@section('footer-script')
    ...
    <script>
        function callajaxfunction() {
            ...
            $.ajax({
                type: "get",
                url:'/new-reg-foreign/check-rjsc-application-status',
                data: {
                    appid: applicationid
                },
        ...
        function checkdocstatus(applicationid) {
            ...
            $.ajax({
                type: "get",
                url:'/new-reg-foreign/check-rjsc-doc-status',
                data: {
                    appid: applicationid
                },
                success: function (response) {
        ...
        function paymentstatus(applicationid) {
            ...
            $.ajax({
                type: "get",
                url:'/new-reg-foreign/check-rjsc-payment-status',
                data: {
                    appid: applicationid
                },
                success: function (response) {
