        ...
        <div class="box-body">
            ...
            <div class="panel panel-info">
                <div class="panel-heading">
                    <h5><b>foreitnARTICLES OF ASSOCIATION</b></h5>
                    {{--<div class="row">
                ...
                <div class="panel-body">
                    <fieldset>
                        <div class="panel panel-info">
                            <div class="panel-heading"><strong>ForeignA. General information</strong></div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                : {{\App\Modules\NewRegForeign\Controllers\GetCompanyForeignController::getCompanyNameBysubimmsionNo($appInfo->submission_no)}}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
