<div class="panel panel-info">
    {!! Form::open(array('url' => '/new-reg-foreign/rjsc-particular-save', 'method' => 'post', 'files' => true, 'role' => 'form', 'id'=> 'particular_form')) !!}
    {{ csrf_field() }}
    <div class="panel-heading"><strong>55555. Particular Subscriber foreign</strong></div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::select('district_id['.$i.']',$districts,$par_value->district_id,['class' => 'form-control input-md']) !!}
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::select('district_id[1]',$districts,'',['class' => 'form-control input-md']) !!}
                                            {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    {!! Form::select('agreement_district_id',$districts,$appInfo->agreement_witness_district_id,['class' => 'form-control input-md required','placeholder' => 'Select One','required' => 'required']) !!}
                                                    {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                                </div>
                                            </div>
                                        </div>
    ...
    $(document).ready(function () {
        $(document).on('click','#add_column',function () {
            ...
            $('#particular_body').append('<tr>\n' +
                ...
                '                                    </div>\n' +
                '                                    <div class="col-md-9">\n' +
                '                                        {!! Form::select("district_id[]",$districts,'',['class' => 'form-control input-md','placeholder' => '']) !!} \n' +
                '                                        \n' +
                '                                    </div>\n' +
                '                                </div>\n' +
                '                            </td>\n' +
