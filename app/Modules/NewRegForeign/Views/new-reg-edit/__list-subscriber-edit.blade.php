<div class="panel panel-info">
    ...
    <div class="">
        ...
        <div class="col-md-6 text-right">
            ...
            <a href="{{ url('/new-reg-delete-subscriber/next/edit/'.\App\Libraries\Encryption::encodeId($appInfo->id).'/'.\App\Libraries\Encryption::encodeId($appInfo->entity_type_id))}}" class="btn btn-info" id="continuebtn">Save and Continue</a>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-8">
                                            {!! Form::text('corporation_body_name', '', ['class' => 'form-control required input-md','placeholder' => 'Name','id'=>'section_one_user_name']) !!}
                                            {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::number('tin_no', '', ['class' => 'form-control input-md','placeholder' => 'TIN(xxxxxxxx)If Required','id'=> 'section_two_tin']) !!}
                                            {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                        </div>
                                        <div class="col-md-4"></div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                        {!! Form::label('','1. Name',['class'=>'col-md-4 text-left required-star']) !!}
                                        <div class="col-md-8">
                                            {!! Form::text('corporation_body_name', '', ['class' => 'form-control required input-md corporation_body_name', 'id'=>'corporation_body_name', 'placeholder' => 'Name']) !!}
                                            {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                        {!! Form::label('','12. TIN(XXXXXXXXXXXX)If Required',['class'=>'col-md-4 text-left ']) !!}
                                        <div class="col-md-4">
                                            {!! Form::number('tin_no', '', ['class' => 'form-control input-md section_two_tin_edit', 'id'=>'tin_no', 'placeholder' => 'TIN(xxxxxxxx)If Required']) !!}
                                            {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                        </div>
                                        <div class="col-md-4"></div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('subscriber_photo') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="file" class = 'form-control required input-md' name ='subscriber_photo' value="" onchange = "subscriberPhotoValidation(this)" id='subscriber_photo_enter'>
