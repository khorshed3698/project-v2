                ...
                <div class="row">
                    <div class="col-md-10   col-md-offset-1">
                        ...
                        <div class="text-left">
                            ...
                            <p>
                                <strong>Please print the bordered section bellow and then sign on the paper and finally upload
                                    the signed scan copy of MOA  and Form-IX as .zip format</strong>
                            </p>
                            <p>
                                    ...
                                    @foreach($subscribers as $subscriber)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                ...
                                                @endif
                                                <br>
                                                Nationality:@if($subscriber->original_nationality_id !="")
                                                    {{$nationality[$subscriber->original_nationality_id]}}
                                                @endif
                                                <br>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;">
                                                @if($photopath !="")
                                                    @if(file_exists(public_path().'/'.$photopath) )
                                                        <img height="50px" width="90px" src="{{$photopath}}">
                                                    @endif
                                                @endif
                                            </td>
