        ...
        <div class="box">
            <div class="box-body">
                <div class="row">
                    ...
                    <p><strong>{{\App\Modules\NewReg\Controllers\GetCompanyForeignController::getCompanyNameBysubimmsionNo($appInfo->submission_no)}}</strong>, hereby gives you notice, in accordance with Section 77 of the Companies</p>
