        ...
        <div class="box">
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <p>Name of the Company: {{\App\Modules\NewReg\Controllers\GetCompanyForeignController::getCompanyNameBysubimmsionNo($appInfo->submission_no)}}</p>
                        ...
                        <p>being the Secretary/a Director of {{\App\Modules\NewReg\Controllers\GetCompanyForeignController::getCompanyNameBysubimmsionNo($appInfo->submission_no)}}</p>
