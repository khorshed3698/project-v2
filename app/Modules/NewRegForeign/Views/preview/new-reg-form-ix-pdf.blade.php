    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-body">
                ...
                <div class="row">
                    <p>Name of the Company: <strong>{{\App\Modules\NewReg\Controllers\GetCompanyForeignController::getCompanyNameBysubimmsionNo($appInfo->submission_no)}}</strong></p>
                    <p>Consent of act as Director/Directors of the <strong>{{\App\Modules\NewReg\Controllers\GetCompanyForeignController::getCompanyNameBysubimmsionNo($appInfo->submission_no)}}</strong> to be</p>
                    ...
                    <p>of the <strong>{{\App\Modules\NewReg\Controllers\GetCompanyForeignController::getCompanyNameBysubimmsionNo($appInfo->submission_no)}}</strong></p>
