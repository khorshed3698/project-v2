                            ...
                            <tr>
                                <td width="100%">
                                    <p style="width: 450px; display: table;">
                                        ...
                                        <span style="display: table-cell;"><strong>{{\App\Modules\NewReg\Controllers\GetCompanyForeignController::getCompanyNameBysubimmsionNo($appInfo->submission_no)}}</strong></span>
                                    </p>
                                </td>
                            </tr>
                            <tr style="margin-left: 40px;">
                                <td>
                                    <span>Declaration of compliance with the requirements of the companies act, 1994 made pursuant to section 25 (2) on behalf of a company proposed to be Registered as the
                                        {{\App\Modules\NewReg\Controllers\GetCompanyForeignController::getCompanyNameBysubimmsionNo($appInfo->submission_no)}} Presented for filing by {{ $appInfo->declaration_name }} </span>
                                </td>
                            </tr>
