                    ...
                    <div class="col-md-10   col-md-offset-1">
                        ...
                        <div class="text-left">
                            <p>Contract By Directors to take and pay for qualification shares in
                                <strong>{{\App\Modules\NewReg\Controllers\GetCompanyForeignController::getCompanyNameBysubimmsionNo($appInfo->submission_no)}}</strong>
                                to be signed and
                        ...
                        <div id="agreementfooter" class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <p>Address: <strong>{{  $appInfo->agreement_witness_address }}
                                        , {{$districts[$appInfo->agreement_witness_district_id]}}</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
