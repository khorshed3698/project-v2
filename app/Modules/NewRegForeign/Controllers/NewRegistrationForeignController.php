...
class NewRegistrationForeignController extends Controller
{
...
//                Session::flash('success', 'Successfully updated the Application!');
           ...
           // dd($application_id);
            ...
            return redirect('process/licence-applications/company-registration-foreign/view/'.$application_id.'/'.Encryption::encodeId($this->process_type_id).'#step1');
