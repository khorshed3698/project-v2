                ...
                @if(!empty($resubmissionInfo->file_link_1))
                    <div class="col-md-6">
                        <a target="_blank" class="btn btn-info"
                           href="{{isset($resubmissionInfo->file_link_1) ? $resubmissionInfo->file_link_1 : "" }}">See
                            File 1</a>
                    </div>
                @endif
            </div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                @if(!empty($resubmissionInfo->file_link_2))
                    <div class="col-md-6">
                        <a target="_blank" class="btn btn-info"
                           href="{{isset($resubmissionInfo->file_link_2) ? $resubmissionInfo->file_link_2 : "" }}">See
                            File 2</a>
                    </div>
                @endif
            </div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                @if(!empty($resubmissionInfo->file_link_3))
                    <div class="col-md-6">
                        <a target="_blank" class="btn btn-info"
                           href="{{isset($resubmissionInfo->file_link_3) ? $resubmissionInfo->file_link_3 : "" }}">See
                            File 3</a>
                    </div>
                @endif
            </div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                @if(!empty($resubmissionInfo->file_link_4))
                    <div class="col-md-6">
                        <a target="_blank" class="btn btn-info"
                           href="{{isset($resubmissionInfo->file_link_4) ? $resubmissionInfo->file_link_4 : "" }}">See
                            File 4</a>
                    </div>
                @endif
            </div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                @if(!empty($resubmissionInfo->file_link_5))
                    <div class="col-md-6">
                        <a target="_blank" class="btn btn-info"
                           href="{{isset($resubmissionInfo->file_link_5) ? $resubmissionInfo->file_link_5 : "" }}">See
                            File 5</a>
                    </div>
                @endif
            </div>
