...
<div class="col-md-12">
    <div class="panel panel-primary" id="inputForm">
        <div class="panel-heading">
            <h5>বসবাস বা ব্যবহার সনদপত্রের আবেদন ফরম (Occupancy Certificate) - সম্পূর্ন সমাপ্ত</h5>
        </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <label class="checkbox-inline required-star">
                                {!! Form::checkbox('IsApprovedRA',1,false, array('id'=>'IsApprovedRA', 'class'=>'required')) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6 {{$errors->has('ApplicationDate') ? 'has-error': ''}}">
                            ...
                            <div class=" col-md-7">
                                <div class="datepicker input-group date"
                                    ...
                                    {!! Form::text('ApplicationDate', '', ['class'=>'form-control input-md required', 'id' => 'ApplicationDate', 'placeholder'=>'Pick from datepicker']) !!}
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('PermitNo', null,['class' => 'form-control onlyNumber engOnly input-md required','id'=>'PermitNo']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6 {{$errors->has('ConstructionCompletedDate') ? 'has-error': ''}}">
                            ...
                            <div class=" col-md-7">
                                <div class="datepicker input-group date"
                                     data-date-format="dd-mm-yyyy">
                                    {!! Form::text('ConstructionCompletedDate', '', ['class'=>'form-control input-md required', 'id' => 'ConstructionCompletedDate', 'placeholder'=>'Pick from datepicker']) !!}
                                    <span class="input-group-addon"><span
                                                class="fa fa-calendar"></span></span>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                {!! Form::select('CityCorporationId', $city_corporation, 0, ['class' => 'form-control required']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('BS', null,['class' => 'form-control onlyNumber engOnly input-md required','id'=>'BS']) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            {!! Form::label('RS','আর. এস. নং',['class'=>'text-left col-md-5 required-star']) !!}
                            <div class="col-md-7">
                                {!! Form::text('RS', null,['class' => 'form-control onlyNumber engOnly input-md required','id'=>'RS']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('RoadName', null,['class' => 'form-control input-md required','id'=>'RoadName']) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            {!! Form::label('PlotArea','বাহুর মাপ সহ জমি/প্লটের পরিমাণ',['class'=>'text-left col-md-5 required-star']) !!}
                            <div class="col-md-7">
                                {!! Form::text('PlotArea', null,['class' => 'form-control onlyNumber engOnly input-md required','id'=>'PlotArea']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                {!! Form::textarea('PlotDesc', null,['class' => 'form-control input-md required','id'=>'PlotDesc']) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                <div id="signature-pad" class="signature-pad">
                                    ...
                                    <input required type="hidden" data-rule-signature="true" name="Signature" id="Signature" value="">
                                    <input type="hidden" name="investor_signature_name" id="investor_signature_name">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-xs-12">
                        <table class="table table-bordered table-hover">
                            ...
                            <tr id="coveredAreaDetailsRow_0">
                                <td width="20%"> {!! Form::select('FloorTypeId[]',[],'',[ 'class'=>' form-control required','id'=>'FloorTypeId_1']) !!}</td>
                                <td width="20%">{!! Form::select('FloorUseId[]',[], '', [ 'class' => 'form-control required', 'id'=>'FloorUseId']) !!}</td>
                                <td>{!! Form::text('FloorUse[]','',['class' => 'form-control required input-md FloorUse', 'id'=>'FloorUse']) !!}</td>
                                <td>{!! Form::text('PartialCompletion[]','',['class' => 'form-control required input-md onlyNumber engOnly PartialCompletion', 'id'=>'PartialCompletion', 'onkeyup'=>"calculateTotalArea.call(this)"]) !!}</td>
                                <td>{!! Form::text('FullCompletion[]','',['class' => 'form-control required input-md onlyNumber engOnly FullCompletion', 'id'=>'FullCompletion', 'onkeyup'=>"calculateTotalArea.call(this)"]) !!}</td>
                                <td>{!! Form::text('FloorTotalArea[]','',['readonly'=>'readonly', 'class' => 'form-control input-md FloorTotalArea enbnNumber required FloorTotalArea', 'id'=>'FloorTotalArea_1']) !!}</td>
                            ...
                            <tr>
                                ...
                                <td>
                                    {!! Form::text('building_FloorTotalArea_area', null,['readonly'=>'readonly', 'class' => 'form-control input-md','id'=>'building_FloorTotalArea_area']) !!}
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6 {{$errors->has('UserName') ? 'has-error': ''}}">
                                ...
                                <div class="col-md-7">
                                    {!! Form::text('UserName', \App\Libraries\CommonFunction::getUserFullName(), ['class' => 'form-control input-md required', 'readonly'=>'readonly']) !!}
    ...
    $(document).ready(function () {
        ...
        form.steps({
            ...
            onStepChanging: function (event, currentIndex, newIndex) {
                ...
                if (newIndex == 1) {
                    if($("#Signature").val() == '') {
                        swal({type: 'error', text: "সাক্ষর প্রদান করুন"});
                        return false;
                    }
                }
        ...
        try {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    let newInput = $('<label class="saved_file_' + id + '" id="label_' + id + '"><br/><strong>File: ' + fileNameArr[l - 1] + ' <a href="javascript:void(0)" class="filedelete" docid="' + id + '" ><span class="btn btn-xs btn-danger"><i class="fa fa-times"></i></span> </a></strong></label>');
    ...
    function checkboxCallbackResponse(response, [calling_id, selected_value, element_id, element_name, element_calling_id, element_details, dependant_select_id]) {
        ...
        if (response.responseCode === 200) {
            $.each(response.data, function (key, row) {
                ...
                option += '<input type="checkbox" name="buildingSubClassList[' + key + ']" value="' + id + '"> ' + value + '  ';
                option += '</label>';
            })
        } else {
            console.log(response.status)
