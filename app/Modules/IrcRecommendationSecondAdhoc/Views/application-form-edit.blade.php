                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {!! Form::text('ins_apc_half_yearly_import_other', 
                                                                $appInfo->ins_apc_half_yearly_import_other, 
                                                                [
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="panel panel-info">
                                            ...
                                            <div class="panel-body">
                                                @if($viewMode == 'off')
                                                    <div class="table-responsive">
                                                        <table aria-label="detailed info" id="directorList"
                                                               class="table table-striped table-bordered dt-responsive"
                                                               cellspacing="0" width="100%">
                                                            <thead>
                                                            <tr>
        ...
        form.steps({
            ...
            onStepChanging: function (event, currentIndex, newIndex) {
                ...
                if (newIndex == 2) {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo url(); ?>/irc-recommendation-second-adhoc/production-info",
                        async: false,
                        data: {
                            _token: _token,
                            application_id: application_id,
