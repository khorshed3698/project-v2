                                    ...
                                    <div class="panel-body">
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <div class="table-responsive">
                                                <table aria-label="detailed info" class="table table-striped table-bordered" cellspacing="0"
                                                    ...
                                                    <tbody id="manpower">
                                                    <tr>
                                                        <th scope="col" class="alert alert-info" colspan="3">Local (Bangladesh only)
                                                        </th>
                                                        <th scope="col" class="alert alert-info" colspan="3">Foreign (Abroad country)
                                                        </th>
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <fieldset class="scheduler-border" id="annual_raw">
                                                ...
                                                <table aria-label="detailed info" class="table table-striped table-bordered table-responsive" cellspacing="0" width="100%" id="productionRawTbl">
                                                    <thead>
                                                    <tr>
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <fieldset class="scheduler-border" id="annual_ins_raw">
                                                ...
                                                <table aria-label="detailed info" class="table" width="100%">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="text-right">Others </td>
                                                        <td>
                                                            {!! Form::text('ins_apc_half_yearly_import_other', 
                                                                Session::get('loadIRCInspectionData.apc_half_yearly_import_other', 0), 
                                                                [
                                                                    'class' => 'form-control input-md number',
                                                                    'id' => 'ins_apc_half_yearly_import_other',
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {!! Form::text('ins_apc_half_yearly_import_grand_total', null,
                                                                ['class' => 'form-control input-md',
                                                                'readonly', 'id' => 'ins_apc_half_yearly_import_grand_total'
                                                                ]) 
                                                            !!}
                                                        </td>
                                                    </tr>
...
<script type="text/javascript">
    ...
    function calculateAddRowTotal(className, totalShowFieldId) {
        ...
        if(totalShowFieldId == 'ins_apc_half_yearly_import_total'){
            $("#ins_apc_half_yearly_import_total_in_word").val('');
    ...
    // Import Capacity for six month others value calculate
    function calculateTotal() {
        let otherImport = parseFloat($('#ins_apc_half_yearly_import_other').val()) || 0;
        let importTotal = parseFloat($('#ins_apc_half_yearly_import_total').val()) || 0;        
        $('#ins_apc_half_yearly_import_grand_total').val(otherImport + importTotal);
    }
