                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_name') ? 'has-error': ''}}">
                                                {!! Form::text('applicant_name', '',['class' => 'form-control
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('father_name_or_organization') ? 'has-error': ''}}">
                                                {!! Form::text('father_name_or_organization', '',['class' => 'form-control input-md',
                                                    'id'=>'father_name_or_organization','placeholder'=>'Father name']) !!}
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_mother_name') ? 'has-error': ''}}">
                                                {!! Form::text('applicant_mother_name', '',['class' => 'form-control
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_husband_or_wife_name') ? 'has-error': ''}}">
                                                {!! Form::text('applicant_husband_or_wife_name', '',['class' => 'form-control
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_post_office') ? 'has-error': ''}}">
                                                {!! Form::text('applicant_post_office', '',['class' => 'form-control
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_district') ? 'has-error': ''}}">
                                                {!! Form::select('applicant_district', ['1'=>'Dhaka','2'=>'Comilla'],'', ['placeholder' => 'Select One',
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_nid_no') ? 'has-error': ''}}">
                                                {!! Form::text('applicant_nid_no', '',['class' => 'form-control nid onlyNumber
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_post_code') ? 'has-error': ''}}">
                                                {!! Form::text('applicant_post_code', '',['class' => 'form-control
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_tin') ? 'has-error': ''}}">
                                                {!! Form::text('applicant_tin', '',['class' => 'form-control
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('mobile_no') ? 'has-error': ''}}">
                                                {!! Form::text('mobile_no', '',['class' => 'form-control onlyNumber
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('house_or_dag_no') ? 'has-error': ''}}">
                                                {!! Form::text('house_or_dag_no', '',['class' => 'form-control
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('plot_no') ? 'has-error': ''}}">
                                                {!! Form::text('plot_no', '',['class' => 'form-control
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('av_lane_road_no') ? 'has-error': ''}}">
                                                {!! Form::text('av_lane_road_no', '',['class' => 'form-control
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('block') ? 'has-error': ''}}">
                                                {!! Form::text('block', '',['class' => 'form-control
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('thana') ? 'has-error': ''}}">
                                                {!! Form::select('thana', ['1'=>'Dhanmondi','2'=>'Shahbag'],'', ['placeholder' => 'Select One',
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="col-md-7 {{$errors->has('existing_account_no') ? 'has-error': ''}}">
                                                {!! Form::text('existing_account_no', '',['class' => 'form-control
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-8 {{$errors->has('connection_type') ? 'has-error': ''}}">
                                                {!! Form::select('connection_type', [],'',['class' => 'form-control input-md docloader','id'=>'connection_type']) !!}
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-8 {{$errors->has('plot_no') ? 'has-error': ''}}">
                                                {!! Form::text('load','',['class' => 'form-control
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-8 {{$errors->has('phase') ? 'has-error': ''}}">
                                                {!! Form::select('phase', [],'', ['class' => 'form-control input-md docloader','id'=>'phase']) !!}
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="col-md-8 {{$errors->has('tariff') ? 'has-error': ''}}">
                                                {!! Form::select('tariff', [],'', ['placeholder' => 'Select One',
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7 {{$errors->has('meter') ? 'has-error': ''}}">
                                                    {!! Form::text('meter', 1,['class' => 'form-control
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_signature') ? 'has-error': ''}}">
                                                <input type="file" name="applicant_signature" flag="img" id="applicant_signature"
                                                       class="required"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_nid_pdf') ? 'has-error': ''}}">
                                                ...
                                                {!! $errors->first('applicant_nid','<span class="help-block">:message</span>')
                                                !!}
                                                <span style="color:#993333;">[N.B. Supported file extension is
                                                    pdf,png,jpg,jpeg.Max size less than 300KB]</span>
                                                <div id="preview_nid">
                                                    <input type="hidden" value="" id="validate_field_nid"
                                                           name="validate_field_nid" class="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_land_pdf') ? 'has-error': ''}}">
                                                ...
                                                <span style="color:#993333;">[N.B. Supported file extension is
                                                    pdf,png,jpg,jpeg.Max size less than 300KB]</span>
                                                <div id="preview_land">
                                                    <input type="hidden" value="" id="validate_field_land"
                                                           name="validate_field_land" class="required">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
