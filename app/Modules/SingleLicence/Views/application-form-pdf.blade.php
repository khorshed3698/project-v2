                                    ...
                                    <table width="100%" cellpadding="10">
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding: 5px;" >
                                                ...
                                                <span> {{ (!empty($basicAppInfo->company_id)) ? $userCompanyList[0]->company_name : 'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="padding: 5px;" >
                                                ...
                                                <span> {{ (!empty($basicAppInfo->company_id)) ? $userCompanyList[0]->company_name_bn : 'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="padding: 5px;" >
                                                ...
                                                <span>{{ (!empty($basicAppInfo->department_id)) ? $departmentList[$basicAppInfo->department_id]:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                ...
                                                Country of Origin :
                                                <span> {{ (!empty($basicAppInfo->country_of_origin_id)) ? $countries[$basicAppInfo->country_of_origin_id]:'N/A'  }}</span>
                                            </td>

                                            <td width="50%" style="padding: 5px;" >
                                                Type of the organization :
                                                <span>{{ (!empty($basicAppInfo->organization_type_id)) ? $eaOrganizationType[$basicAppInfo->organization_type_id]:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                Status of the organization :
                                                <span> {{ (!empty($basicAppInfo->organization_status_id)) ? $eaOrganizationStatus[$basicAppInfo->organization_status_id]:'N/A'  }}</span>
                                            </td>

                                            <td width="50%" style="padding: 5px;" >
                                                Ownership status :
                                                <span>{{ (!empty($basicAppInfo->ownership_status_id)) ? $eaOwnershipStatus[$basicAppInfo->ownership_status_id]:'N/A'  }}</span>
                                            </td>
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                Business sector :
                                                <span> {{ (!empty($basicAppInfo->business_sector_id)) ? $sectors[$basicAppInfo->business_sector_id]:'N/A'  }}</span>
                                            </td>

                                            <td width="50%" style="padding: 5px;" >

                                                Sub sector:
                                                <span>{{ (!empty($basicAppInfo->business_sub_sector_id)) ? $sub_sectors[$basicAppInfo->business_sub_sector_id] :'N/A'  }}</span>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2" style="padding: 5px;" >
                                                ...
                                                <span>{{ (!empty($basicAppInfo->major_activities)) ? $basicAppInfo->major_activities :'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-md-12">
                                    <table width="100%" cellpadding="10">
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                Country :
                                                <span> {{ (!empty($basicAppInfo->ceo_country_id)) ? $countries[$basicAppInfo->ceo_country_id]:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                Date of Birth :
                                                <span>{{ (!empty($basicAppInfo->ceo_dob)) ? date('d-M-Y', strtotime($basicAppInfo->ceo_dob)):'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            @if($basicAppInfo->ceo_country_id == 18)
                                                <td width="50%" style="padding: 5px;">
                                                    NID No. :
                                                    <span>{{ (!empty($basicAppInfo->ceo_nid)) ? $basicAppInfo->ceo_nid:'N/A'  }}</span>
                                                </td>
                                            @else
                                                <td width="50%" style="padding: 5px;">
                                                    Passport No. :
                                                    <span>{{ (!empty($basicAppInfo->ceo_passport_no)) ? $basicAppInfo->ceo_passport_no:'N/A'  }}</span>
                                                </td>
                                            @endif

                                            <td width="50%" style="padding: 5px;" >
                                                Designation :
                                                <span>{{ (!empty($basicAppInfo->ceo_designation)) ? $basicAppInfo->ceo_designation:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                Full Name :
                                                <span> {{ (!empty($basicAppInfo->ceo_full_name)) ? $basicAppInfo->ceo_full_name:'N/A'  }}</span>
                                            </td>
                                            @if($basicAppInfo->ceo_country_id == 18)
                                                <td width="50%" style="padding: 5px;" >
                                                    District/City/State :
                                                    <span>{{ (!empty($basicAppInfo->ceo_district_id)) ? $districts[$basicAppInfo->ceo_district_id]:'N/A'  }}</span>
                                                </td>
                                            @else
                                                <td width="50%" style="padding: 5px;" >
                                                    City :
                                                    <span>{{ (!empty($basicAppInfo->ceo_city)) ? $basicAppInfo->ceo_city:'N/A'  }}</span>
                                                </td>
                                            @endif
                                        </tr>
                                        <tr>
                                            @if($basicAppInfo->ceo_country_id == 18)
                                                <td width="50%" style="padding: 5px;" >
                                                    Police Station/Town :
                                                    <span> {{ (!empty($basicAppInfo->ceo_thana_id)) ? $thana_eng[$basicAppInfo->ceo_thana_id]:'N/A'  }}</span>
                                                </td>
                                            @else
                                                <td width="50%" style="padding: 5px;" >
                                                    State/Province :
                                                    <span>{{ (!empty($basicAppInfo->ceo_state)) ? $basicAppInfo->ceo_state:'N/A'  }}</span>
                                                </td>
                                            @endif

                                            <td width="50%" style="padding: 5px;" >
                                                Post/Zip Code :
                                                <span>{{ (!empty($basicAppInfo->ceo_post_code)) ? $basicAppInfo->ceo_post_code:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                House,Flat/Apartment,Road :
                                                <span> {{ (!empty($basicAppInfo->ceo_address)) ? $basicAppInfo->ceo_address:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                Telephone No :
                                                <span>{{ (!empty($basicAppInfo->ceo_telephone_no)) ? $basicAppInfo->ceo_telephone_no:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                Mobile No :
                                                <span> {{ (!empty($basicAppInfo->ceo_mobile_no)) ? $basicAppInfo->ceo_mobile_no:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                Father's Name :
                                                <span> {{ (!empty($basicAppInfo->ceo_father_name)) ? $basicAppInfo->ceo_father_name:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" style="padding: 5px;">
                                                Email :
                                                <span>{{ (!empty($basicAppInfo->ceo_email)) ? $basicAppInfo->ceo_email:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                Mother's Name :
                                                <span>{{ (!empty($basicAppInfo->ceo_mother_name)) ? $basicAppInfo->ceo_mother_name:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                Fax No :
                                                <span>{{ (!empty($basicAppInfo->ceo_fax_no)) ? $basicAppInfo->ceo_fax_no:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                Spouse name :
                                                <span>{{ (!empty($basicAppInfo->ceo_spouse_name)) ? $basicAppInfo->ceo_spouse_name:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-md-12">
                                    <table width="100%" cellpadding="10">
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                Division :
                                                <span> {{ (!empty($basicAppInfo->office_division_id)) ? $divisions[$basicAppInfo->office_division_id]:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                District :
                                                <span> {{ (!empty($basicAppInfo->office_district_id)) ? $districts[$basicAppInfo->office_district_id]:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                Police Station :
                                                <span> {{ (!empty($basicAppInfo->office_thana_id)) ? $thana_eng[$basicAppInfo->office_thana_id]:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                Post Office :
                                                <span> {{ (!empty($basicAppInfo->office_post_office)) ? $basicAppInfo->office_post_office:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                Post Code :
                                                <span>{{ (!empty($basicAppInfo->office_post_code)) ? $basicAppInfo->office_post_code:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                House,Flat/Apartment,Road :
                                                <span> {{ (!empty($basicAppInfo->office_address)) ? $basicAppInfo->office_address:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                Telephone No :
                                                <span>{{ (!empty($basicAppInfo->office_telephone_no)) ? $basicAppInfo->office_telephone_no:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                Mobile No :
                                                <span> {{ (!empty($basicAppInfo->office_mobile_no)) ? $basicAppInfo->office_mobile_no:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" style="padding: 5px;">
                                                Fax No :
                                                <span>{{ (!empty($basicAppInfo->office_fax_no)) ? $basicAppInfo->office_fax_no:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;">
                                                Email :
                                                <span>{{ (!empty($basicAppInfo->office_email)) ? $basicAppInfo->office_email:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="col-md-12">
                                    <table width="100%" cellpadding="10">
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                District :
                                                <span> {{ (!empty($basicAppInfo->factory_district_id)) ? $districts[$basicAppInfo->factory_district_id]:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                Police Station :
                                                <span> {{ (!empty($basicAppInfo->factory_thana_id)) ? $thana_eng[$basicAppInfo->factory_thana_id]:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                Post Office :
                                                <span> {{ (!empty($basicAppInfo->factory_post_office)) ? $basicAppInfo->factory_post_office:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                Post Code :
                                                <span>{{ (!empty($basicAppInfo->factory_post_code)) ? $basicAppInfo->factory_post_code:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                House,Flat/Apartment,Road :
                                                <span> {{ (!empty($basicAppInfo->factory_address)) ? $basicAppInfo->factory_address:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                Telephone No :
                                                <span>{{ (!empty($basicAppInfo->factory_telephone_no)) ? $basicAppInfo->factory_telephone_no:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;" >
                                                Mobile No :
                                                <span> {{ (!empty($basicAppInfo->factory_mobile_no)) ? $basicAppInfo->factory_mobile_no:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                Fax No :
                                                <span>{{ (!empty($basicAppInfo->factory_fax_no)) ? $basicAppInfo->factory_fax_no:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td style="padding: 5px;">
                                                Email :
                                                <span>{{ (!empty($basicAppInfo->factory_email)) ? $basicAppInfo->factory_email:'N/A'  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;" >
                                                Mouja No. :
                                                <span>{{ (!empty($basicAppInfo->factory_mouja)) ? $basicAppInfo->factory_mouja:'N/A'  }}</span>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="3">
                                                        {{$appInfo->finance_src_loc_total_financing_2}}
                                                    </td>
