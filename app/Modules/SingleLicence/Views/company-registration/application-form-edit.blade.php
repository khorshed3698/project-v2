            ...
            <div class="box-body" id="inputForm">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="form-body panel-body">
                        ...
                        {!! Form::hidden('app_id', Encryption::encodeId($appInfoCompanyReg->single_licence_ref_id) ,['class' => 'form-control input-md required', 'id'=>'app_id']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('country_of_origin_id',$countries, $appInfoCompanyReg->country_of_origin_id,['class'=>'form-control input-md required', 'id' => 'country_of_origin_id']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('organization_type_id') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('organization_type_id', $eaOrganizationType, $appInfoCompanyReg->organization_type_id, ['class' => 'form-control required input-md ','id'=>'organization_type_id']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('organization_status_id') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('organization_status_id', $eaOrganizationStatus, $appInfoCompanyReg->organization_status_id, ['class' => 'form-control input-md required','id'=>'organization_status_id']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('ownership_status_id') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('ownership_status_id', $eaOwnershipStatus, $appInfoCompanyReg->ownership_status_id, ['class' => 'form-control required input-md ','id'=>'ownership_status_id']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('business_sector_id') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('business_sector_id', $sectors, $appInfoCompanyReg->business_sector_id, ['class' => 'form-control required input-md','id'=>'business_sector_id']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('business_sub_sector_id') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('business_sub_sector_id', $sub_sectors, $appInfoCompanyReg->business_sub_sector_id, ['class' => 'form-control required input-md','id'=>'business_sub_sector_id']) !!}
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12 {{$errors->has('major_activities') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-9 maxTextCountDown">
                                                {!! Form::textarea('major_activities', $appInfoCompanyReg->major_activities, ['class' => 'form-control input-md bigInputField', 'size' =>'5x2','data-rule-maxlength'=>'240', 'placeholder' => 'Maximum 240 characters','maxlength'=>'200']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('office_division_id') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('office_division_id', $divisions, $appInfoCompanyReg->office_division_id, ['class' => 'form-control required input-md', 'id' => 'office_division_id', 'onchange'=>"getDistrictByDivisionId('office_division_id', this.value, 'office_district_id')"]) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('office_district_id') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('office_district_id', $districts, $appInfoCompanyReg->office_district_id, ['class' => 'form-control input-md required','placeholder' => 'Select division first', 'onchange'=>"getThanaByDistrictId('office_district_id', this.value, 'office_thana_id')"]) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('office_thana_id') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('office_thana_id',$thana, $appInfoCompanyReg->office_thana_id, ['class' => 'form-control input-md required','placeholder' => 'Select district first']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('office_post_office') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('office_post_office', $appInfoCompanyReg->office_post_office, ['class' => 'form-control input-md required']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('office_post_code') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('office_post_code', $appInfoCompanyReg->office_post_code, ['class' => 'form-control input-md post_code_bd required']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('office_address') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('office_address', $appInfoCompanyReg->office_address, ['maxlength'=>'80','class' => 'form-control input-md required']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('office_telephone_no') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('office_telephone_no', $appInfoCompanyReg->office_telephone_no, ['maxlength'=>'20','class' => 'form-control input-md phone_or_mobile']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('office_mobile_no') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('office_mobile_no', $appInfoCompanyReg->office_mobile_no, ['class' => 'form-control input-md required phone_or_mobile' ,'id' => 'office_mobile_no']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('office_fax_no') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('office_fax_no',  $appInfoCompanyReg->office_fax_no, ['class' => 'form-control input-md']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('office_email') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('office_email', $appInfoCompanyReg->office_email, ['class' => 'form-control email input-md required']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('business_objective') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('business_objective', $appInfoCompanyReg->business_objective, ['class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('min_no_director') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::number('min_no_director', $appInfoCompanyReg->min_no_director , ['class' => 'form-control input-md required']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('authorized_capital') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::number('authorized_capital', $appInfoCompanyReg->authorized_capital , ['class' => 'onlyNumber form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('max_no_director') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::number('max_no_director', $appInfoCompanyReg->max_no_director , ['class' => 'form-control input-md required onlyNumber']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('number_of_shares') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('number_of_shares', $appInfoCompanyReg->number_of_shares , ['class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('quorum_agm_egm') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('quorum_agm_egm', $appInfoCompanyReg->quorum_agm_egm , ['class' => 'form-control input-md required']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('quorum_bod_meeting') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('quorum_bod_meeting', $appInfoCompanyReg->quorum_bod_meeting , ['class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('duration_chairman') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::number('duration_chairman', $appInfoCompanyReg->duration_chairman , ['class' => 'form-control input-md required onlyNumber']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('duration_md') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::number('duration_md', $appInfoCompanyReg->duration_md , ['class' => 'form-control input-md required onlyNumber']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('value_each_share') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('value_each_share', $appInfoCompanyReg->value_each_share , ['class' => 'onlyNumber form-control input-md required']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('q_shares_number') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('q_shares_number', $appInfoCompanyReg->q_shares_number , ['class' => 'onlyNumber form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('q_shares_value') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('q_shares_value', $appInfoCompanyReg->q_shares_value , ['class' => 'form-control input-md required']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12 {{ $errors->has('q_shares_witness_agreement') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('q_shares_witness_agreement', $appInfoCompanyReg->q_shares_witness_agreement , ['class' => 'form-control input-md required']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-offset-2 col-md-9 {{ $errors->has('q_shares_witness_name') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-5">
                                                {!! Form::text('q_shares_witness_name', $appInfoCompanyReg->q_shares_witness_name , ['class' => 'form-control input-md required']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-offset-2 col-md-9 {{ $errors->has('q_shares_witness_address') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-5">
                                                {!! Form::text('q_shares_witness_address', $appInfoCompanyReg->q_shares_witness_address , ['class' => 'form-control input-md required']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('witnesses_name') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('witnesses_name', $appInfoCompanyReg->witnesses_name , ['class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('witnesses_address') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('witnesses_address', $appInfoCompanyReg->witnesses_address , ['class' => 'form-control input-md required']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('witnesses_phone') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('witnesses_phone', $appInfoCompanyReg->witnesses_phone , ['class' => 'onlyNumber form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('witnesses_national_id') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('witnesses_national_id', $appInfoCompanyReg->witnesses_national_id , ['class' => 'onlyNumber form-control input-md required']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('declaration_signed_country') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('declaration_signed_country', $countries, $appInfoCompanyReg->declaration_signed_country , ['class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('declaration_signed_designation') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('declaration_signed_designation', $appInfoCompanyReg->declaration_signed_designation , ['class' => 'form-control input-md required']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 {{ $errors->has('declaration_signed_district') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('declaration_signed_district', $districts, $appInfoCompanyReg->declaration_signed_district, ['class' => 'form-control required  input-md','id'=>'declaration_signed_district']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('declaration_signed_full_name') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('declaration_signed_full_name', $appInfoCompanyReg->declaration_signed_full_name , ['class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('declaration_signed_zip_code') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::number('declaration_signed_zip_code', $appInfoCompanyReg->declaration_signed_zip_code , ['class' => 'form-control input-md required']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('declaration_signed_town') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('declaration_signed_town', $thana, $appInfoCompanyReg->declaration_signed_town, ['class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('declaration_signed_telephone') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('declaration_signed_telephone', $appInfoCompanyReg->declaration_signed_telephone , ['class' => 'form-control input-md']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('declaration_signed_house') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('declaration_signed_house', $appInfoCompanyReg->declaration_signed_house , ['class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('declaration_signed_fax') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('declaration_signed_fax', $appInfoCompanyReg->declaration_signed_fax , ['class' => 'form-control input-md']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('declaration_signed_mobile') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('declaration_signed_mobile', $appInfoCompanyReg->declaration_signed_mobile , ['class' => 'onlyNumber form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('declaration_signed_momorandum') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                @if($viewMode == 'off')
                                                <input name="declaration_signed_momorandum_file" class="input-md {{!empty($appInfoCompanyReg->declaration_signed_momorandum)?'':' required'}}"
                                                ...
                                                <div id="declaration_signed_momorandum_preview" class="uploadbox">
                                                    <input type="hidden" class="travelFileRequired"
                                                           ...
                                                           name="declaration_signed_momorandum" value="{{$appInfoCompanyReg->declaration_signed_momorandum}}"/>
                                                </div>
                                                @endif
                                                @if(!empty($appInfoCompanyReg->declaration_signed_momorandum))
                                                    <div class="save_file pdl-10">
                                                        <a target="_blank" class="documentUrl show-in-view" title=""
                                                           href="{{URL::to('/uploads/'. $appInfoCompanyReg->declaration_signed_momorandum)}}">
                                                            <i
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{ $errors->has('declaration_signed_email') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::email('declaration_signed_email', $appInfoCompanyReg->declaration_signed_email , ['class' => 'email form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{ $errors->has('declaration_signed_article') ? 'has-error' : ''}}">
                                            ...
                                            <div class="col-md-7">
                                                @if($viewMode == 'off')
                                                <input name="declaration_signed_article_file" class="input-md {{!empty($appInfoCompanyReg->declaration_signed_article)?'':' required'}}"
                                                ...
                                                <div id="declaration_signed_article_preview" class="uploadbox">
                                                    <input type="hidden" class="travelFileRequired"
                                                           ...
                                                           name="declaration_signed_article" value="{{$appInfoCompanyReg->declaration_signed_article}}"/>
                                                </div>
                                                @endif
                                                @if(!empty($appInfoCompanyReg->declaration_signed_article))
                                                    <div class="save_file pdl-10">
                                                        <a target="_blank" class="documentUrl show-in-view" title=""
                                                           href="{{URL::to('/uploads/'. $appInfoCompanyReg->declaration_signed_article)}}">
                                                            <i
                                                                    class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                                            Open File
                                                        </a>
                        ...
                        @if(ACL::getAccsessRight('SingleLicence','-E-') && $viewMode == "off")
