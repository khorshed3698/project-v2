                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            {{--@if(!in_array($appInfoBank->status_id,[-1,5,6]))--}}
                                {{--<a href="#"--}}
                    ...
                    <div class="form-body">
                        ...
                        <div class="panel-body">
                            {!! Form::open(array('url' => '/single-licence/bank-account/add','method' => 'post','id' => 'BankAccountForm','role'=>'form','enctype'=>'multipart/form-data')) !!}
                            <input type="hidden" value="{{$usdValue->bdt_value}}" id="crvalue">
                            <input type="hidden" name="mode" value="{{$viewMode}}">
                            {!! Form::hidden('app_id', Encryption::encodeId($appInfoBank->single_licence_ref_id) ,['class' => 'form-control input-md required', 'id'=>'app_id']) !!}
                            {!! Form::hidden('curr_process_status_id', $appInfoBank->status_id,['class' => 'form-control input-md required', 'id'=>'process_status_id']) !!}
                            <div class="selectInputBank form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::select('bank_id',$banks, $appInfoBank->bank_id,['class'=>'form-control input-md required', 'id' => 'bank_id']) !!}
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::select('bank_branch_id',$bankBranches, $appInfoBank->bank_branch_id,['class'=>'form-control input-md required', 'id' => 'bank_branch_id']) !!}
                            ...
                            <fieldset>
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body readOnlyCl">
                                        ...
                                        @if(!in_array($appInfoBank->status_id, [0,-1,1,2,5,6]) && $appInfoBank->department_id != '')
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-12 {{$errors->has('department_id') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::select('department_id', $departmentList, $appInfoBank->department_id, ['class' => 'form-control required input-md ','id'=>'department_id']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-12 form-group {{$errors->has('company_name') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('company_name', $appInfoBank->company_name, ['class' => 'form-control input-md required', 'readonly']) !!}
                                                ...
                                                <div class="col-md-12 form-group {{$errors->has('company_name_bn') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('company_name_bn', $appInfoBank->company_name_bn, ['class' => 'form-control input-md required', 'readonly']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('country_of_origin_id',$countries, $appInfoBank->country_of_origin_id,['class'=>'form-control input-md required', 'id' => 'country_of_origin_id']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('organization_type_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('organization_type_id', $eaOrganizationType, $appInfoBank->organization_type_id, ['class' => 'form-control required input-md ','id'=>'organization_type_id']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('organization_status_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('organization_status_id', $eaOrganizationStatus, $appInfoBank->organization_status_id, ['class' => 'form-control required input-md ','id'=>'organization_status_id']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ownership_status_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ownership_status_id', $eaOwnershipStatus, $appInfoBank->ownership_status_id, ['class' => 'form-control required input-md ','id'=>'ownership_status_id']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('business_sector_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('business_sector_id', $sectors, $appInfoBank->business_sector_id, ['class' => 'form-control  input-md','id'=>'business_sector_id']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('business_sub_sector_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('business_sub_sector_id', $sub_sectors, $appInfoBank->business_sub_sector_id, ['class' => 'form-control required input-md','id'=>'business_sub_sector_id']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="form-group col-md-12 {{$errors->has('major_activities') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-9">
                                                        {!! Form::textarea('major_activities', $appInfoBank->major_activities, ['class' => 'form-control input-md bigInputField', 'size' =>'5x2','data-rule-maxlength'=>'240', 'placeholder' => 'Maximum 240 characters']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ceo_country_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ceo_country_id', $countries, $appInfoBank->ceo_country_id, ['class' => 'form-control required input-md ','id'=>'ceo_country_id']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ceo_dob') ? 'has-error': ''}}">
                                                    ...
                                                    <div class=" col-md-7">
                                                        <div class="datepicker input-group date" data-date-format="dd-mm-yyyy">
                                                            {!! Form::text('ceo_dob', ($appInfoBank->ceo_dob == '0000-00-00' ? '' : date('d-M-Y', strtotime($appInfoBank->ceo_dob))), ['class'=>'form-control input-md', 'id' => 'ceo_dob', 'placeholder'=>'Pick from datepicker']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div id="ceo_passport_div" class="col-md-6 hidden {{$errors->has('ceo_passport_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_passport_no', $appInfoBank->ceo_passport_no, ['maxlength'=>'20',
                                                ...
                                                <div id="ceo_nid_div" class="col-md-6 {{$errors->has('ceo_nid') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_nid', $appInfoBank->ceo_nid, ['maxlength'=>'20',
                                                ...
                                                <div class="col-md-6 {{$errors->has('ceo_designation') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_designation', $appInfoBank->ceo_designation,
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ceo_full_name') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_full_name', $appInfoBank->ceo_full_name, ['maxlength'=>'80',
                                                ...
                                                <div id="ceo_district_div" class="col-md-6 {{$errors->has('ceo_district_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ceo_district_id',$districts, $appInfoBank->ceo_district_id, ['maxlength'=>'80','class' => 'form-control input-md']) !!}
                                                ...
                                                <div id="ceo_city_div" class="col-md-6 hidden {{$errors->has('ceo_city') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_city', $appInfoBank->ceo_city,['class' => 'form-control input-md']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 hidden {{$errors->has('ceo_state') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_state', $appInfoBank->ceo_state,['class' => 'form-control input-md']) !!}
                                                ...
                                                <div id="ceo_thana_div" class="col-md-6 {{$errors->has('ceo_thana_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ceo_thana_id',[], $appInfoBank->ceo_thana_id, ['maxlength'=>'80','class' => 'form-control input-md','placeholder' => 'Select district first']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ceo_post_code') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_post_code', $appInfoBank->ceo_post_code, ['maxlength'=>'80','class' => 'form-control input-md required engOnly']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ceo_address') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_address', $appInfoBank->ceo_address, ['maxlength'=>'80','class' => 'form-control input-md required']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ceo_telephone_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_telephone_no', $appInfoBank->ceo_telephone_no, ['maxlength'=>'20','class' => 'form-control input-md phone_or_mobile']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ceo_mobile_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_mobile_no', $appInfoBank->ceo_mobile_no, ['class' => 'form-control input-md required phone_or_mobile']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ceo_father_name') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_father_name', $appInfoBank->ceo_father_name, ['class' => 'form-control textOnly input-md required']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ceo_email') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_email', $appInfoBank->ceo_email, ['class' => 'form-control email input-md required']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ceo_mother_name') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_mother_name', $appInfoBank->ceo_mother_name, ['class' => 'form-control textOnly required input-md']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ceo_fax_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_fax_no', $appInfoBank->ceo_fax_no, ['class' => 'form-control input-md']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ceo_spouse_name') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ceo_spouse_name', $appInfoBank->ceo_spouse_name, ['class' => 'form-control textOnly input-md']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('office_division_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('office_division_id', $divisions, $appInfoBank->office_division_id, ['class' => 'form-control imput-md required','id' => 'office_division_id']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('office_district_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('office_district_id', $districts, $appInfoBank->office_district_id, ['class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('office_thana_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('office_thana_id',[''], $appInfoBank->office_thana_id, ['class' => 'form-control input-md required']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('office_post_office') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('office_post_office', $appInfoBank->office_post_office, ['class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('office_post_code') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('office_post_code', $appInfoBank->office_post_code, ['class' => 'form-control input-md ']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('office_address') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('office_address', $appInfoBank->office_address, ['maxlength'=>'80','class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('office_telephone_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('office_telephone_no', $appInfoBank->office_telephone_no, ['maxlength'=>'20','class' => 'form-control input-md phone_or_mobile']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('office_mobile_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('office_mobile_no', $appInfoBank->office_mobile_no, ['class' => 'form-control input-md required phone_or_mobile']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('office_fax_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('office_fax_no', $appInfoBank->office_fax_no, ['class' => 'form-control input-md']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('office_email') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('office_email', $appInfoBank->office_email, ['class' => 'form-control email input-md required']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('factory_district_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('factory_district_id', $districts, $appInfoBank->factory_district_id, ['class' => 'form-control input-md']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('factory_thana_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('factory_thana_id',[''], $appInfoBank->factory_thana_id, ['class' => 'form-control input-md']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('factory_post_office') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('factory_post_office', $appInfoBank->factory_post_office, ['class' => 'form-control input-md']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('factory_post_code') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('factory_post_code', $appInfoBank->factory_post_code, ['class' => 'form-control input-md number']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('factory_address') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('factory_address', $appInfoBank->factory_address, ['maxlength'=>'80','class' => 'form-control input-md']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('factory_telephone_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('factory_telephone_no', $appInfoBank->factory_telephone_no, ['maxlength'=>'20','class' => 'form-control input-md phone_or_mobile']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('factory_mobile_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('factory_mobile_no', $appInfoBank->factory_mobile_no, ['class' => 'form-control input-md phone_or_mobile']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('factory_fax_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('factory_fax_no', $appInfoBank->factory_fax_no, ['class' => 'form-control input-md']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('factory_email') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('factory_email', $appInfoBank->factory_email, ['class' => 'form-control email input-md']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('factory_mouja') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('factory_mouja', $appInfoBank->factory_mouja, ['class' => 'form-control input-md']) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('tin_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('tin_no', $appInfoBank->tin_no, ['class' => 'form-control input-md number','id'=>'tin_no']) !!}
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <div id="tin_file_preview" class="uploadbox">
                                                            <input type="hidden" class="" id="tin_file_name"
                                                                   name="tin_file_name" value="{{$appInfoBank->tin_file_name}}">
                                                        </div>

                                                    @if(!empty($appInfoBank->tin_file_name) && $viewMode == 'off')
                                                            <div id="remove_file_1">
                                                            <a href="/uploads/{{$appInfoBank->tin_file_name}}" target="_blank" ><span class=" btn-success btn-sm" >Download</span></a>
                                                        ...
                                                        @endif
                                                        @if( $viewMode == 'on')
                                                            @if(!empty($appInfoBank->tin_file_name))
                                                                <a href="/uploads/{{$appInfoBank->tin_file_name}}" target="_blank" ><span class=" btn-success btn-sm" >Download</span></a>
                                                            @else
                                                                No file is attached!
                                                             @endif
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 {{$errors->has('trade_licence') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('trade_licence', $appInfoBank->trade_licence, ['class' => 'form-control input-md number','id'=>'trade_licence']) !!}
                                                        <span class=" btn-success btn-sm" style="display:inline">verified</span>
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <div id="trade_file_preview" class="uploadbox">
                                                            <input type="hidden" class="" id="trade_file_name"
                                                                   name="trade_file_name" value="{{$appInfoBank->trade_file_name}}">
                                                        </div>
                                                        @if(!empty($appInfoBank->trade_file_name) && $viewMode == 'off')
                                                            <div id="remove_file_2">
                                                                <a href="/uploads/{{$appInfoBank->trade_file_name}}" target="_blank"><span class=" btn-success btn-sm" >Download</span></a>
                                                        ...
                                                        @endif
                                                        @if( $viewMode == 'on')
                                                            @if(!empty($appInfoBank->trade_file_name))
                                                                <a href="/uploads/{{$appInfoBank->trade_file_name}}" target="_blank"><span class=" btn-success btn-sm" >Download</span></a>
                                                            @else
                                                                No file is attached!
                                                            @endif
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('incorporation_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('incorporation_no', $appInfoBank->incorporation_no, ['class' => 'form-control input-md number','id'=>'incorporation_no','style'=>"display:inline"]) !!}
                                                        <span class=" btn-success btn-sm" style="display:inline">verified</span>
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <div id="incorporation_file_preview" class="uploadbox">
                                                            <input type="hidden" class=""
                                                                   ...
                                                                   name="incorporation_file_name" value="{{$appInfoBank->incorporation_file_name}}">
                                                        </div>
                                                        @if(!empty($appInfoBank->incorporation_file_name) && $viewMode == 'off')
                                                            <div id="remove_file_3">
                                                                <a href="/uploads/{{$appInfoBank->incorporation_file_name}}" target="_blank"><span class=" btn-success btn-sm" >Download</span></a>
                                                        ...
                                                        @endif
                                                        @if( $viewMode == 'on')
                                                            @if(!empty($appInfoBank->incorporation_file_name))
                                                                <a href="/uploads/{{$appInfoBank->incorporation_file_name}}" target="_blank"><span class=" btn-success btn-sm" >Download</span></a>
                                                            @else
                                                                No file is attached!
                                                            @endif
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <div id="mem_association_preview" class="uploadbox">
                                                            <input type="hidden" class=""
                                                                   ...
                                                                   name="mem_association_file_name" value="{{$appInfoBank->mem_association_file_name}}">
                                                        </div>
                                                        @if(!empty($appInfoBank->mem_association_file_name) && $viewMode == 'off')
                                                            <div id="remove_file_4">
                                                                <a href="/uploads/{{$appInfoBank->mem_association_file_name}}" target="_blank"><span class=" btn-success btn-sm" >Download</span></a>
                                                        ...
                                                        @endif
                                                        @if( $viewMode == 'on')
                                                            @if(!empty($appInfoBank->mem_association_file_name))
                                                                <a href="/uploads/{{$appInfoBank->mem_association_file_name}}" target="_blank"><span class=" btn-success btn-sm" >Download</span></a>
                                                            @else
                                                                No file is attached!
                                                            @endif
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <div id="art_association_preview" class="uploadbox">
                                                            <input type="hidden" class=""
                                                                   ...
                                                                   name="art_association_file_name" value="{{$appInfoBank->art_association_file_name}}">
                                                        </div>
                                                        @if(!empty($appInfoBank->art_association_file_name) && $viewMode == 'off')
                                                            <div id="remove_file_5">
                                                                <a href="/uploads/{{$appInfoBank->art_association_file_name}}" target="_blank"><span class=" btn-success btn-sm" >Download</span></a>
                                                        ...
                                                        @endif
                                                        @if( $viewMode == 'on')
                                                            @if(!empty($appInfoBank->art_association_file_name))
                                                                <a href="/uploads/{{$appInfoBank->art_association_file_name}}" target="_blank"><span class=" btn-success btn-sm" >Download</span></a>
                                                            @else
                                                                No file is attached!
                                                            @endif
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <div id="list_share_holder_n_director_preview"
                                                            ...
                                                            <input type="hidden" class=""
                                                                   ...
                                                                   name="list_share_holder_n_director_file_name" value="{{$appInfoBank->list_share_holder_n_director_file_name}}">
                                                        </div>
                                                        @if(!empty($appInfoBank->list_share_holder_n_director_file_name) && $viewMode == 'off')
                                                            <div id="remove_file_6">
                                                                <a href="/uploads/{{$appInfoBank->list_share_holder_n_director_file_name}}" target="_blank"><span class=" btn-success btn-sm" >Download</span></a>
                                                        ...
                                                        @endif
                                                        @if( $viewMode == 'on')
                                                            @if(!empty($appInfoBank->list_share_holder_n_director_file_name))
                                                                <a href="/uploads/{{$appInfoBank->list_share_holder_n_director_file_name}}" target="_blank"><span class=" btn-success btn-sm" >Download</span></a>
                                                            @else
                                                                No file is attached!
                                                            @endif
                                  ...
                                  <!--  {{--<div class="form-group">--}}
                                        {{--<div class="row">--}}
                                            {{--<div class="col-md-12">--}}
                                                ...
                                                {{--<div class="col-md-3">--}}
                                                    {{--{!! Form::text('tin_number', $appInfoBank->tin_number, ['data-rule-maxlength'=>'40','class' => 'tin_number form-control input-md','id'=>'tin_number']) !!}--}}
                                                ...
                                                {{--<div class="col-md-3">--}}
                                                    ...
                                                    {{--<div class="save_file" style="margin-top: 5px">--}}
                                                        {{--<?php if(!empty($appInfoBank->tin_file_path)){ ?>--}}
                                                        {{--<a target="_blank" class="btn btn-xs btn-primary show-in-view" title="Registration Copy"--}}
                                                           {{--href="{{URL::to('uploads/'.$appInfoBank->tin_file_path)}}"><i class="fa fa-file-pdf-o"></i> TIN Certificate Copy</a>--}}
                                                        {{--<input type="hidden" value="<?php--}}
                                                        {{--if ($appInfoBank->tin_file_path != '') {--}}
                                                            {{--echo $appInfoBank->tin_file_path;--}}
                                                        {{--}--}}
                                                        {{--?>" id="tin_file_path"--}}
                                                               {{--name="tin_file_path"/>--}}
                                                        {{--<?php } ?>--}}
        ...
        $("#ceo_district_id").change(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.responseCode == 1) {
                        $.each(response.data, function (id, value) {
                            if (id == '{{ $appInfoBank->ceo_thana_id }}'){
        ...
        $("#office_district_id").change(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.responseCode == 1) {
                        $.each(response.data, function (id, value) {
                            if (id == '{{ $appInfoBank->office_thana_id }}'){
                                option += '<option value="'+ id + '" selected>' + value + '</option>';
                            }else {
                                option += '<option value="' + id + '">' + value + '</option>';
                            }
        ...
        $("#factory_district_id").change(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.responseCode == 1) {
                        $.each(response.data, function (id, value) {
                            if (id == '{{ $appInfoBank->factory_thana_id }}'){
                                option += '<option value="'+ id + '" selected>' + value + '</option>';
                            }else {
                                option += '<option value="' + id + '">' + value + '</option>';
                            }
