        ...
        <div class="box" id="inputForm">
            <div class="box-body">
                ...
                @if($viewMode == 'on' && in_array(Auth::user()->user_type, ['5x505']) && in_array($appInfo->status_id, [17,31]))
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            {!! Form::open(array('url' => 'work-permit-new/conditionalApproveStore','method' => 'post','id' => 'WorkPermitPayment','enctype'=>'multipart/form-data',
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h5><b>Application for Work Permit New</b></h5>
                        </div>
                        <div class="pull-right">
                            @if (isset($appInfo) && $appInfo->status_id == -1)
                                <a href="{{ asset('assets/images/SampleForm/work_permit_new.pdf') }}" target="_blank" rel="noopener" class="btn btn-warning">
                            ...
                            @if(!in_array($appInfo->status_id,[-1,5,6,22]))
                                <a href="/work-permit-new/app-pdf/{{ Encryption::encodeId($appInfo->id)}}"
                    ...
                    <div class="panel-body">
                            ...
                            <fieldset class="scheduler-border">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::label('approved_duration_amount','Payable amount (BDT)',['class'=>'text-left  col-md-5']) !!}
                                            <div class="col-md-7">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('last_vr') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    <label class="radio-inline">{!! Form::radio('last_vr','yes', ($appInfo->last_vr == 'yes') ? true : false, ['class'=>' cusReadonly required helpTextRadio', 'id' => 'yes', 'onclick' => 'lastVisaRecommendation(this.value)']) !!}
                                                        Yes</label>
                                                    <label class="radio-inline">{!! Form::radio('last_vr', 'no', ($appInfo->last_vr == 'no') ? true : false, ['class'=>' cusReadonly required', 'id' => 'no', 'onclick' => 'lastVisaRecommendation(this.value)']) !!}
                                                        No</label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div id="ref_app_tracking_no_div"
                                                ...
                                                {!! Form::label('ref_app_tracking_no','Please give your approved Visa Recommendation No.',['class'=>'col-md-5 text-left required-star']) !!}
                                                <div class="col-md-7">
                                            ...
                                            <div id="date_of_arrival_div"
                                                ...
                                                <div class="col-md-7">
                                                    <div class="date_of_arrival input-group date">
                                                        {!! Form::text('date_of_arrival', (!empty($appInfo->date_of_arrival) ? date('d-M-Y', strtotime($appInfo->date_of_arrival)) : ''), ['class' => 'form-control required input-md date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div id="expiry_date_of_op_div"
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="datepicker input-group date">
                                                            {!! Form::text('expiry_date_of_op', (!empty($appInfo->expiry_date_of_op) ? date('d-M-Y', strtotime($appInfo->expiry_date_of_op)) : ''), ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                            <span class="input-group-addon"><span
                                                                        class="fa fa-calendar"></span></span>
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('duration_start_date') ? 'has-error': ''}}">
                                                    {!! Form::label('duration_start_date','Start Date',['class'=>'text-left required-star col-md-5']) !!}
                                                    <div class="col-md-7">
                                                        <div id="duration_start_datepicker" class="input-group date">
                                                            {!! Form::text('duration_start_date', (!empty($appInfo->duration_start_date ) ? date('d-M-Y', strtotime($appInfo->duration_start_date)) : ''), ['class' => 'form-control required input-md date', 'placeholder'=>'dd-mm-yyyy', 'readOnly']) !!}
                                                            <span class="input-group-addon"><span
                                                                        class="fa fa-calendar"></span></span>
                                                        </div>
                                                ...
                                                <div class="col-md-6 {{$errors->has('duration_end_date') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div id="duration_end_datepicker" class="input-group date">
                                                            {!! Form::text('duration_end_date', (!empty($appInfo->duration_end_date ) ? date('d-M-Y', strtotime($appInfo->duration_end_date)) : ''), ['class' => 'form-control required input-md date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                            <span class="input-group-addon"><span
                                                                        class="fa fa-calendar"></span></span>
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('desired_duration') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('desired_duration', $appInfo->desired_duration, ['class' => 'form-control required input-md', 'readonly']) !!}
                        ...
                        <fieldset>
                            {{--Basic Information--}}
                            @include('WorkPermitNew::basic-info')
                                ...
                                <div class="panel-body">
                                    <fieldset class="scheduler-border">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 {{$errors->has('investor_photo') ? 'has-error': ''}}">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('emp_passport_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('emp_passport_no', $appInfo->emp_passport_no, ['data-rule-maxlength'=>'20', 'class' => 'form-control input-md cusReadonly']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('emp_personal_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('emp_personal_no', $appInfo->emp_personal_no, ['data-rule-maxlength'=>'20', 'class' => 'form-control input-md cusReadonly']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('emp_date_of_birth') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="datepickerDob input-group date">
                                                            {!! Form::text('emp_date_of_birth', (!empty($appInfo->emp_date_of_birth ) ? date('d-M-Y', strtotime($appInfo->emp_date_of_birth)) : ''), ['class' => 'form-control required cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        </div>
                                    ...
                                    <fieldset class="scheduler-border">
                                        ...
                                        <div class="table-responsive">
                                            <table id="" class="table table-striped table-bordered" aria-label="Detailed Compensation and Benefit Report"
                                                   width="100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('basic_local_amount')?'has-error':'' }}">
                                                            {!! Form::text('basic_local_amount',$viewMode == 'on' ? \App\Libraries\CommonFunction::convertToBdtAmount($appInfo->basic_local_amount) : $appInfo->basic_local_amount, ['data-rule-maxlength'=>'40','class' => 'form-control required basic_salary_amount cusReadonly input-md numberNoNegative cb_req_field', 'id' => 'basic_local_amount']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('overseas_local_currency_id')?'has-error':'' }}">
                                                            {!! Form::select('overseas_local_currency_id', $currencies, $appInfo->overseas_local_currency_id, ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md', 'id' => 'overseas_local_currency_id']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('house_local_currency_id')?'has-error':'' }}">
                                                            {!! Form::select('house_local_currency_id', $currencies, $appInfo->house_local_currency_id, ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field', 'id' => 'house_local_currency_id']) !!}                                                            
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('conveyance_payment_type_id')?'has-error':'' }}">
                                                            {!! Form::select('conveyance_payment_type_id', $paymentMethods, $appInfo->conveyance_payment_type_id, ['data-rule-maxlength'=>'40', 'class' => 'form-control cusReadonly input-md cb_req_field', 
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('conveyance_local_currency_id')?'has-error':'' }}">
                                                            {!! Form::select('conveyance_local_currency_id', $currencies, $appInfo->conveyance_local_currency_id, ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field', 'id' => 'conveyance_local_currency_id']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('medical_local_currency_id')?'has-error':'' }}">
                                                            {!! Form::select('medical_local_currency_id', $currencies, $appInfo->medical_local_currency_id, ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field', 'id' => 'medical_local_currency_id']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('ent_local_currency_id')?'has-error':'' }}">
                                                            {!! Form::select('ent_local_currency_id', $currencies, $appInfo->ent_local_currency_id, ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field', 'id' => 'ent_local_currency_id']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('bonus_local_currency_id')?'has-error':'' }}">
                                                            {!! Form::select('bonus_local_currency_id', $currencies, $appInfo->bonus_local_currency_id, ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field', 'id' => 'bonus_local_currency_id']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5">
                                                        <div class="{{ $errors->has('other_benefits')?'has-error':'' }}">
                                                            {!! Form::textarea('other_benefits', $appInfo->other_benefits, ['class' => 'form-control cusReadonly input-md bigInputField', 'data-charcount-maxlength' => '250', 'size' =>'5x1','data-rule-maxlength'=>'250', 'placeholder' => 'Maximum 250 characters', 'id' => 'other_benefits']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_division_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_division_id', $divisions, $appInfo->ex_office_division_id, ['class' => 'form-control cusReadonly input-md required', 'id' => 'ex_office_division_id', 'onchange'=>"getDistrictByDivisionId('ex_office_division_id', this.value, 'ex_office_district_id', ". $appInfo->ex_office_district_id .")"]) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_district_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_district_id', $district_eng, $appInfo->ex_office_district_id, ['class' => 'form-control cusReadonly input-md required','placeholder' => 'Select division first', 'onchange'=>"getThanaByDistrictId('ex_office_district_id', this.value, 'ex_office_thana_id', ". $appInfo->ex_office_thana_id .")"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_thana_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_thana_id', $thana_eng, $appInfo->ex_office_thana_id, ['class' => 'form-control cusReadonly input-md required', 'placeholder' => 'Select district first']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_mobile_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_mobile_no',$appInfo->ex_office_mobile_no, ['class' => 'form-control cusReadonly input-md phone_or_mobile helpText15 required' ,'id' => 'ex_office_mobile_no']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('nature_of_business') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::number('auth_capital', $appInfo->auth_capital, ['class' => 'form-control cusReadonly input-md numberNoNegative']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('paid_capital') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::number('paid_capital', $appInfo->paid_capital, ['class' => 'form-control cusReadonly numberNoNegative input-md']) !!}
                                            ...
                                            <div class="col-md-12 {{$errors->has('travel_history') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="radio-inline">
                                                        {!! Form::radio('travel_history','yes', ($appInfo->travel_history == 'yes') ? true : false, ['class'=>'travel_history cusReadonly required helpTextRadio', 'id' => 'travel_history_yes', 'onclick' => 'checkTravelHistory(this.value)']) !!}
                                                        Yes
                                                    </label>
                                                    <label class="radio-inline">
                                                        {!! Form::radio('travel_history', 'no', ($appInfo->travel_history == 'no') ? true : false, ['class'=>'travel_history cusReadonly required', 'id' => 'travel_history_no', 'onclick' => 'checkTravelHistory(this.value)']) !!}
                                                        No
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div id="travel_employment_period" hidden>
                                        <fieldset class="scheduler-border">
                                            ...
                                            <table id="travelPeriodTable"
                                                   ...
                                                   aria-label="Detailed Report Data Table" width="100%">
                                                <thead>
                                                        ...
                                                        <tr id="travelPeriodTableRow{{$inc}}">
                                                            <td>
                                                                ...
                                                                <div class="datepickerTraHisStart{{$inc}} input-group date">
                                                                    {!! Form::text("th_emp_duration_from[$inc]", (!empty($record->th_emp_duration_from) ? date('d-M-Y', strtotime($record->th_emp_duration_from)) : ''), ['class' => 'form-control cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                                    <span class="input-group-addon"><span
                                                                                class="fa fa-calendar"></span></span>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="datepickerTraHisEnd{{$inc}} input-group date">
                                                                    {!! Form::text("th_emp_duration_to[$inc]", (!empty($record->th_emp_duration_to) ? date('d-M-Y', strtotime($record->th_emp_duration_to)) : ''), ['class' => 'form-control cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                                    <span class="input-group-addon"><span
                                                                                class="fa fa-calendar"></span></span>
                                                                </div>
                                                            ...
                                                            <td>
                                                                {!! Form::select("th_visa_type_id[$inc]", $travelVisaType, $record->th_visa_type_id, ['class' => 'form-control cusReadonly input-md visited_req_field prev_tr_visa','placeholder' => 'Select one', 'onchange'=>"TravelHistoryVisaType(this.value)"]) !!}
                                                                {!! $errors->first('th_visa_type_id','<span class="help-block">:message</span>') !!}
                                                                <div class="form-group col-sm-12" id="TRAVEL_VISA_OTHERS" hidden>
                                                            ...
                                                            <td>
                                                                @if(!($appInfo->last_vr == 'yes' && (!empty($appInfo->ref_app_tracking_no))))
                                                                    <?php if ($inc == 0) { ?>
                                                    ...
                                                    <tr id="travelPeriodTableRow">
                                                        <td>
                                                            <div class="datepickerTraHisStart0 input-group date">
                                                                {!! Form::text('th_emp_duration_from[]', '', ['class' => 'form-control cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                                <span class="input-group-addon"><span
                                                                            class="fa fa-calendar"></span></span>
                                                            </div>
                                                            {!! $errors->first('th_emp_duration_from','<span class="help-block">:message</span>') !!}
                                                        ...
                                                        <td>
                                                            <div class="datepickerTraHisEnd0 input-group date">
                                                                {!! Form::text('th_emp_duration_to[]', '', ['class' => 'form-control cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                                <span class="input-group-addon"><span
                                                                            class="fa fa-calendar"></span></span>
                                                            </div>
                                                            {!! $errors->first('th_emp_duration_to','<span class="help-block">:message</span>') !!}
                                                        ...
                                                        <td>
                                                            {!! Form::select('th_visa_type_id[]', $travelVisaType, '', ['class' => 'form-control cusReadonly input-md visited_req_field','placeholder' => 'Select one', 'onchange'=>"TravelHistoryVisaType(this.value)"]) !!}
                                                            {!! $errors->first('th_visa_type_id[]','<span class="help-block">:message</span>') !!}
                                                            <div class="form-group col-sm-12" id="TRAVEL_VISA_OTHERS" hidden>
                                                                {!! Form::textarea('th_visa_type_others[]', null, ['data-rule-maxlength'=>'240', 'placeholder'=>'Specify others visa type availed', 'class' => 'form-control cusReadonly bigInputField input-md',
                                                                'size'=>'5x1','data-charcount-maxlength'=>'200']) !!}
                                                            </div>
                                                        </td>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('th_visit_with_emp_visa') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="radio-inline">
                                                        {!! Form::radio('th_visit_with_emp_visa','yes', ($appInfo->th_visit_with_emp_visa == 'yes') ? true : false, ['class'=>'visited_req_field cusReadonly helpTextRadio', 'id' => 'th_visit_with_emp_visa_yes', 'onclick' => 'thVisitWithEmpVisa(this.value)']) !!}
                                                        Yes
                                                    </label>
                                                    <label class="radio-inline">
                                                        {!! Form::radio('th_visit_with_emp_visa', 'no', ($appInfo->th_visit_with_emp_visa == 'no') ? true : false, ['class'=>'visited_req_field cusReadonly', 'id' => 'th_visit_with_emp_visa_no', 'onclick' => 'thVisitWithEmpVisa(this.value)']) !!}
                                                        No
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-12 {{$errors->has('th_emp_work_permit') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label class="radio-inline">
                                                            {!! Form::radio('th_emp_work_permit','yes', ($appInfo->th_emp_work_permit == 'yes') ? true : false, ['class'=>'th_reveived_emp_visa cusReadonly visited_with_emp_visa_req helpTextRadio', 'id' => 'th_emp_work_permit_yes', 'onclick' => 'checkReceivedWorkPermit(this.value)']) !!}
                                                            Yes
                                                        </label>
                                                        <label class="radio-inline">
                                                            {!! Form::radio('th_emp_work_permit', 'no', ($appInfo->th_emp_work_permit == 'no') ? true : false, ['class'=>'th_reveived_emp_visa cusReadonly visited_with_emp_visa_req', 'id' => 'th_emp_work_permit_no', 'onclick' => 'checkReceivedWorkPermit(this.value)']) !!}
                                                            No
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('th_emp_tin_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('th_emp_tin_no', $appInfo->th_emp_tin_no, ['class' => 'form-control cusReadonly number input-md travelFileRequired']) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('th_emp_wp_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('th_emp_wp_no', $appInfo->th_emp_wp_no, ['class' => 'form-control cusReadonly input-md travelFileRequired']) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('th_emp_org_name') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('th_emp_org_name', $appInfo->th_emp_org_name, ['class' => 'form-control cusReadonly input-md travelFileRequired ']) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('th_emp_org_address') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::textarea('th_emp_org_address', $appInfo->th_emp_org_address, ['data-rule-maxlength'=>'500', 'placeholder'=>'Contact address', 'class' => 'form-control cusReadonly bigInputField input-md travelFileRequired maxTextCountDown',
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('th_org_district_id') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::select('th_org_district_id', $district_eng, $appInfo->th_org_district_id, ['class' => 'form-control cusReadonly input-md travelFileRequired ',  'id' => 'th_org_district_id', 'onchange'=>"getThanaByDistrictId('th_org_district_id', this.value, 'th_org_thana_id',". $appInfo->th_org_thana_id .")"]) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('th_org_thana_id') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::select('th_org_thana_id', $thana_eng, $appInfo->th_org_thana_id, ['class' => 'form-control cusReadonly input-md travelFileRequired ', 'placeholder' => 'Select district first']) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('th_org_post_office') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('th_org_post_office', $appInfo->th_org_post_office, ['class' => 'form-control cusReadonly input-md travelFileRequired']) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('th_org_post_code') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('th_org_post_code', $appInfo->th_org_post_code, ['data-rule-maxlength'=>'20','class' => 'form-control cusReadonly post_code_bd input-md travelFileRequired ']) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{ $errors->has('th_org_telephone_no') ? 'has-error' : ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('th_org_telephone_no', $appInfo->th_org_telephone_no, ['class'=>'input-md cusReadonly phone_or_mobile form-control travelFileRequired ', 'data-rule-maxlength'=>'40',
                                                            ]) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('th_org_email') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::email('th_org_email', $appInfo->th_org_email, ['class' => 'form-control cusReadonly input-md email travelFileRequired']) !!}
                        ...
                        @if(ACL::getAccsessRight('WorkPermitNew','-E-') && $viewMode != "on" && $appInfo->status_id != 6 && Auth::user()->user_type == '5x505')
...
//                                alert("Image size must be " + requiredSize);
    ...
    var sessionLastVR = '{{ $appInfo->last_vr }}';
...
//        });
        ...
        $('input[name=last_vr]:checked').trigger('click');
    ...
    @if ($viewMode == 'on')
    $('#WorkPermitNewForm .stepHeader').hide();
    $('#WorkPermitNewForm :input').attr('disabled', true);
    $('#WorkPermitNewForm').find('.MoreInfo').attr('disabled', false);
    ...
    $('#WorkPermitNewForm :input[type=file]').hide();
    $('.addTableRows').hide();
...
<script>
    ...
    $(function () {
        var totalRosws = $('#travel_employment_period').find('tbody').find('tr');
