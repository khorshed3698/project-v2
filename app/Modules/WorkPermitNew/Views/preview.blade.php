...
<script language="javascript">
    ...
    jQuery(function () {
        jQuery('#submitFromPreviewBtn').click(function (e) {
            window.opener.document.getElementById("WorkPermitNewForm").setAttribute("target", "_self");
            window.opener.jQuery("#WorkPermitNewForm").submit();
            window.close();
        });
    });
...
//        return jQuery(this).find('option:selected').text();
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery("#WorkPermitNewForm-p-5").css({"display": "block"});
