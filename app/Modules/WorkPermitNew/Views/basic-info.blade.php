            ...
            <div class="form-group custom-input">
                <div class="row">
                    ...
                    <div class="col-md-6 {{$errors->has('ceo_telephone_no') ? 'has-error': ''}}">
                        ...
                        <div class="col-md-7">
                            <input id="ceo_telephone_no" class="form-control input-md helpText15" type="text" value="{{ $basicInfo->ceo_telephone_no }}" readonly>
            ...
            <div class="form-group custom-input">
                <div class="row">
                    <div class="col-md-6 {{$errors->has('ceo_mobile_no') ? 'has-error': ''}}">
                        ...
                        <div class="col-md-7">
                            <input id="ceo_mobile_no" class="form-control input-md helpText15" type="text" value="{{ $basicInfo->ceo_mobile_no }}" readonly>
            ...
            <div class="form-group custom-input">
                <div class="row">
                    <div class="col-md-6 {{$errors->has('office_telephone_no') ? 'has-error': ''}}">
                        ...
                        <div class="col-md-7">
                            <input id="office_telephone_no" class="form-control input-md helpText15" type="text" value="{{ $basicInfo->office_telephone_no }}" readonly>
                    ...
                    <div class="col-md-6 {{$errors->has('office_mobile_no') ? 'has-error': ''}}">
                        ...
                        <div class="col-md-7">
                            <input id="office_mobile_no" class="form-control input-md helpText15" type="text" value="{{ $basicInfo->office_mobile_no }}" readonly>
