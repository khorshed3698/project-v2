        ...
        <fieldset>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('applicant_name', null,['class' => 'form-control bigInputField input-md','size'=>'5x1','maxlength'=>'200']) !!}
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('applicant_mobile_no', null,['class' => 'form-control onlyNumber input-md mobile', 'placeholder'=>'e.g. 01756656565']) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                {!! Form::textarea('suggested_use_land_plot', null,['class' => 'form-control input-md']) !!}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        {!! Form::text('suggested_use_land_plot', null,['class' => 'form-control input-md ']) !!}
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-12 col-xs-12">
                        ...
                        <div class="row ">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-5">
                                        {!! Form::text('land_area', null,['class' => 'form-control input-md enbnNumber']) !!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    {!! Form::label('max_floor_area','খ) যে কোন তলার / ফ্লোরের সর্বোচ্চ ক্ষেত্রফল (বর্গমিটার)',['class'=>'text-left col-md-7 ']) !!}
                                    <div class="col-md-5">
                                        {!! Form::text('max_floor_area', null,['class' => 'form-control input-md enbnNumber']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group col-xs-12">
                        <div class="row ">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="col-md-6">
                                    {!! Form::label('total_floor_area','গ) সর্বমোট ফ্লোরের ক্ষেত্রফল (বর্গমিটার) ',['class'=>'text-left col-md-7 ']) !!}
                                    <div class="col-md-5">
                                        {!! Form::text('total_floor_area', null,['class' => 'form-control input-md enbnNumber']) !!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    {!! Form::label('total_plinth_floor','ঘ) প্লিন্থ (Plinth) এর উপর সর্বমোট ফ্লোরের সংখ্যা',['class'=>'text-left col-md-7 ']) !!}
                                    <div class="col-md-5">
                                        {!! Form::text('total_plinth_floor', null,['class' => 'form-control input-md enbnNumber']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row ">
                            <div class="col-md-10 col-md-offset-1">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-5">
                                        {!! Form::text('basement_floor_no', null,['class' => 'form-control enbnNumber input-md ']) !!}
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-5">
                                        {!! Form::text('total_residential_flat_no', null,['class' => 'form-control input-md']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12" style="margin-top:15px;">
                    ...
                    <div class="col-md-4">
                        {!! Form::select('site_side_main_road',$yesno,'', ['placeholder' => 'Select One', 'class' => 'form-control col-md-5']) !!}
                    </div>
                            ...
                            <div class="col-md-4 col-xs-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-7" style="margin-top:5px;">
                                        {!! Form::select('natural_forrest',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xs-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-8" style="margin-top:5px;">
                                        {!! Form::select('mountain',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xs-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-8" style="margin-top:5px;">
                                        {!! Form::select('slope',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xs-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 " style="margin-top:5px;">
                                        {!! Form::select('pond',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-xs-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-8" style="margin-top:5px;">
                                        {!! Form::select('natural_wetlands',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-6">
                            <div class="row">
                                ...
                                <div class="col-md-8" style="margin-top:5px;">
                                    {!! Form::select('building',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-xs-6">
                            <div class="row">
                                ...
                                <div class="col-md-7" style="margin-top:5px;">
                                    {!! Form::select('historic_building',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-xs-6">
                            <div class="row">
                                ...
                                <div class="col-md-7" style="margin-top:5px;">
                                    {!! Form::select('site_side_lake',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-xs-6">
                            <div class="row">
                                ...
                                <div class="col-md-7" style="margin-top:5px;">
                                    {!! Form::select('site_side_park',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 " style="margin-top:25px;">
                    ...
                    <div class="col-md-4" style="margin-top:-10px;">
                        {!! Form::select('site_in_visually_characteristics_area',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-xs-3">
                            <div class="row">
                                ...
                                <div class="col-md-7" style="margin-top:5px;">
                                    {!! Form::select('airport',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-xs-3">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="margin-top:5px;">
                                    {!! Form::select('railway_station',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-xs-3">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="margin-top:5px;">
                                    {!! Form::select('bus_terminal',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3 col-xs-3">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="margin-top:5px;">
                                    {!! Form::select('river_port',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-xs-12">
                                {!! Form::select('flood_prone_area',$yesno ,null,['class' => 'form-control input-md','placeholder'=>'Select One']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-7">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-xs-4">
                                {!! Form::select('road_center_to_site',['উঁচু '=>'উঁচু ','নিচু '=>'নিচু'], null,['class' => 'form-control input-md ','placeholder'=>'Select One']) !!}
                            </div>
                            <div class="col-md-2 col-xs-4">
                                {!! Form::text('road_center_to_site_meter', null,['class' => 'form-control input-md enbnNumber']) !!}
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-xs-4 ">
                                {!! Form::text('total_building_site', null,['class' => 'form-control input-md enbnNumber']) !!}
                            </div>
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-xs-3">
                                {!! Form::text('buildings_total_floor_area', null,['class' => 'form-control input-md enbnNumber']) !!}
                            </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-2 col-xs-4">
                                {!! Form::text('total_electricity_demand', null,['class' => 'form-control input-md enbnNumber']) !!}
                            </div>
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-xs-4">
                                {!! Form::text('total_water_demand', null,['class' => 'form-control input-md enbnNumber']) !!}
                            </div>
                ...
                <div class="col-md-12">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-xs-4">
                                {!! Form::text('total_development_time_in_month', null,['class' => 'form-control input-md enbnNumber']) !!}
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-xs-4">
                                {!! Form::text('total_development_stage', null,['class' => 'form-control input-md enbnNumber']) !!}
                            </div>
                    ...
                    <div class="col-md-2">
                        <div class="row">
                            <div class="col-md-6 col-xs-3">
                                {!! Form::text('total_development_stage_month', null,['class' => 'form-control input-md enbnNumber']) !!}
                            </div>
                    ...
                    <div class="form-group col-xs-12">
                        <div class="row ">
                            <div class="col-md-10 col-md-offset-1" style="margin-top:10px;">
                                ...
                                <div class="col-md-2">
                                    {!! Form::select('owner_purchase_deed',$yesnona, null,['class' => 'form-control col-md-2 input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                        <div class="row ">
                            <div class="col-md-10 col-md-offset-1" style="margin-top:10px;">
                                ...
                                <div class="col-md-2">
                                    {!! Form::select('govt_assigned_land_deed',$yesnona, null,['class' => 'form-control col-md-2 input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                        <div class="row ">
                            <div class="col-md-10 col-md-offset-1" style="margin-top:10px;">
                                ...
                                <div class="col-md-2">
                                    {!! Form::select('paid_fee_and_prove',$yesnona, null,['class' => 'form-control col-md-2 input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                        <div class="row ">
                            <div class="col-md-10 col-md-offset-1" style="margin-top:10px;">
                                ...
                                <div class="col-md-2">
                                    {!! Form::select('land_usage_exemption',$yesnona, null,['class' => 'form-control col-md-2 input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                        <div class="row ">
                            <div class="col-md-10 col-md-offset-1" style="margin-top:10px;">
                                ...
                                <div class="col-md-2">
                                    {!! Form::select('far_calculation',$yesnona, null,['class' => 'form-control col-md-2 input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                        <div class="row ">
                            <div class="col-md-10 col-md-offset-1" style="margin-top:10px;">
                                ...
                                <div class="col-md-2">
                                    {!! Form::select('all_design_and_documents_detail',$yesnona, null,['class' => 'form-control col-md-2 input-md','placeholder'=>'Select One']) !!}
                                </div>
                            </div>
                    ...
                    <div class="form-group col-xs-12">
                                    ...
                                    <div class="card-block">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-4 col-xs-12 datepicker">
                                                {!! Form::text('submission_date', null,['class' => 'form-control input-md']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-block text-right">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8 col-xs-12 pull-right">
                                                {!! Form::file('applicantSignature', ['class'=>'form-control input-md required','flag'=>'img','id' => 'applicantSignature','onchange'=>"uploadDocument('preview_applicantSignature', this.id, 'validate_field_applicantSignature',1) , imagePreview(this)"]) !!}
                                                ...
                                                <div id="preview_applicantSignature">
                                                    {!! Form::hidden('validate_field_applicantSignature','', ['class'=>'form-control input-md', 'id' => 'validate_field_applicantSignature']) !!}
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    {!! Form::text('applicant_name_2', null,['class' => 'form-control input-md']) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('applicant_address','ঠিকানা :',['class'=>'col-md-6 col-xs-12']) !!}
                                                <div class="col-md-6 col-xs-12">
                                                    {!! Form::text('applicant_address', null,['class' => 'form-control input-md']) !!}
                                                </div>
                                            </div>

                                            <div class="form-group col-md-9 pull-right">
                                                {!! Form::label('technical_person_name','(২) কারিগরি ব্যাক্তিবর্গের (স্থপতি/পুরকৌশলী)নাম :') !!}
                                                {!! Form::text('technical_person_name', null,['class' => 'form-control input-md']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group col-xs-12">
                            <div class="row ">
                                <div class="col-md-10 col-md-offset-1" style="margin-top:10px;">
                                    <hr>
                                    {!! Form::label('','আমি/আমরা প্রত্যয়ন করিতেছি যে, উপরোক্ত বর্ণিত প্রকল্প/নির্মাণের সহিত আমি/আমরা জরিত হইয়াছি। এই ব্যাপারে উক্ত প্রকল্পের সহিত আমরা সংশ্লিষ্টতার প্রত্যয়ন করিতাছি।',['class'=>'text-left']) !!}
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-block pull-left">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8">
                                                    {!! Form::file('architectSignature', ['class'=>'form-control input-md required','flag'=>'img','id' => 'architectSignature','onchange'=>"uploadDocument('preview_architectSignature', this.id, 'validate_field_architectSignature',1) , imagePreview(this)"]) !!}
                                                    <span id="span_architectSignature"
                                                          style="font-size: 12px; font-weight: bold;color:#993333">*** Maximum file size 150kb and file extension should be only jpg/jpeg/png</span>
                                                    <div id="preview_architectSignature">
                                                        {!! Form::hidden('validate_field_architectSignature','', ['class'=>'form-control input-md', 'id' => 'validate_field_architectSignature']) !!}
                                                    </div>
                                                    <div class="col-md-5" style="position:relative;margin-bottom: 5px;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-xs-12">
                                                    {!! Form::text('architect_name', null,['class' => 'form-control input-md']) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('architect_address','ঠিকানা :',['class'=>'col-md-4 col-xs-12']) !!}
                                                <div class="col-md-8 col-xs-12">
                                                    {!! Form::text('architect_address', null,['class' => 'form-control input-md']) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('architect_phone','ফোন নম্বর :',['class'=>'col-md-4 col-xs-12']) !!}
                                                <div class="col-md-8 col-xs-12">
                                                    {!! Form::text('architect_phone', null,['class' => 'form-control input-md enbnNumber']) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('registration_no','নিবন্ধন নম্বর :',['class'=>'col-md-4 col-xs-12']) !!}
                                                <div class="col-md-8 col-xs-12">
                                                    {!! Form::text('registration_no', null,['class' => 'form-control input-md']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        <div class="card-block text-right">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 pull-right">
                                                    {!! Form::file('civilEngineerSignature', ['class'=>'form-control input-md required','flag'=>'img','id' => 'civilEngineerSignature','onchange'=>"uploadDocument('preview_civilEngineerSignature', this.id, 'validate_field_civilEngineerSignature',1) , imagePreview(this)"]) !!}
                                                    <span id="span_civilEngineerSignature"
                                                          style="font-size: 12px; font-weight: bold;color:#993333">*** Maximum file size 150kb and file extension should be only jpg/jpeg/png</span>
                                                    <div id="preview_civilEngineerSignature">
                                                        {!! Form::hidden('validate_field_civilEngineerSignature','', ['class'=>'form-control input-md', 'id' => 'validate_field_civilEngineerSignature']) !!}
                                                    </div>
                                                    <div class="col-md-5 pull-right"
                                                         style="position:relative;margin-bottom: 5px;">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-8 col-xs-12">
                                                    {!! Form::text('civil_engineer_name', null,['class' => 'form-control input-md']) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('civil_engineer_address','ঠিকানা :',['class'=>'col-md-4 col-xs-12']) !!}
                                                <div class="col-md-8 col-xs-12">
                                                    {!! Form::text('civil_engineer_address', null,['class' => 'form-control input-md']) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('civil_engineer_phone','ফোন নম্বর :',['class'=>'col-md-4 col-xs-12']) !!}
                                                <div class="col-md-8 col-xs-12">
                                                    {!! Form::text('civil_engineer_phone', null,['class' => 'form-control input-md enbnNumber']) !!}
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                {!! Form::label('civil_engineer_registration_no','নিবন্ধন নম্বর :',['class'=>'col-md-4 col-xs-12']) !!}
                                                <div class="col-md-8 col-xs-12">
                                                    {!! Form::text('civil_engineer_registration_no', null,['class' => 'form-control input-md']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
