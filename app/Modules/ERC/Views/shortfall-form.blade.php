                ...
                <div class="box-body">
                    <div class="panel panel-info">
                        <div class="panel-heading clearfix">
                            <strong>ERC Shortfall Form: </strong>
                            <div class="pull-right">
                                <a class="btn btn-sm btn-info"
                                   href="/process/licence-applications/erc/view/{{\App\Libraries\Encryption::encodeId($data->ref_id)}}/{{\App\Libraries\Encryption::encodeId($process_type_id)}}"
                                   role="button" aria-expanded="false" aria-controls="collapseExample">
                                    View Application
                                </a>
                            </div>
                        </div>
                        {!! Form::open(array('url' => '/licence-applications/erc/shortfall-form/store','enctype'=>'multipart/form-data','method' => 'post','id' => 'ccieshortfall','role'=>'form')) !!}
