...
@section('content')
            ...
            <div class="box">
                <div id="paymentPanel" class="panel panel-default" style="display: none;">
                    <div class="panel-body">
                        {!! Form::open(array('url' => '/licence-applications/erc/payment','method' => 'post','id' => 'NameClearanceForm','role'=>'form','enctype'=>'multipart/form-data')) !!}
    ...
    <script type="text/javascript">
        ...
        function checkCcieStatus() {
            ...
            $.ajax({
                url: '/licence-applications/erc/check-payment-info',
                type: "POST",
                data: {
                    enc_app_id: app_id
                },
