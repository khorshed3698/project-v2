...
<script language="javascript">
    ...
    jQuery(function () {
        jQuery('#submitFromPreviewBtn').click(function (e) {
            window.opener.document.getElementById("OfficePermissionCancelForm").setAttribute("target", "_self");
            window.opener.jQuery("#OfficePermissionCancelForm").submit();
            window.close();
        });
    });
...
//        return jQuery(this).find('option:selected').text();
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery("#OfficePermissionCancelForm-p-4").css({"display": "block"});
