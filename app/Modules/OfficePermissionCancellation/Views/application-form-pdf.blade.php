            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12" style="text-align: center">
                        ...
                        Application for Office Permission Cancellation
                    </div>
                </div>
                <div class="panel panel-info"  id="inputForm">
                    <div class="panel-heading">Application for Office Permission Cancellation</div>
                    <div class="panel-body">
                        <table aria-label="Detailed Report Application for Office Permission Cancellation" width="100%">
                            <tr>
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <table aria-label="Detailed Report Basic Information" width="100%" cellpadding="10">
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding: 5px;">
                                                Date of cancellation : <span>{{ (!empty($appInfo->date_of_office_permission)) ? $appInfo->date_of_office_permission : '' }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="padding: 5px;">
                                                Date of cancellation : <span>{{ (!empty($appInfo->effect_date)) ? $appInfo->effect_date : '' }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="padding: 5px;">
                                                Remarks : <span>{{ (!empty($appInfo->applicant_remarks)) ? $appInfo->applicant_remarks : '' }}</span>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div id="ep_form" class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <table aria-label="Detailed Report Office Type" width="100%" cellpadding="10">
                                        <thead>
                                            <tr class="d-none">
                                                {{-- <th aria-hidden="true"  scope="col"></th> --}}
                                            </tr>
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;">
                                                Office Type :
                                                <span>{{ (!empty($appInfo->office_type)) ? $officeType[$appInfo->office_type] : '' }}</span>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                        ...
                        @if((in_array($appInfo->status_id, [15, 16, 25]) && Auth::user()->user_type == '5x505') || (in_array(Auth::user()->user_type, ['1x101', '2x202', '4x404'])))
                            <div id="ep_form" class="panel panel-info">
                                <div class="panel-heading">Cancellation Effect Date</div>
                                <div class="panel-body">
                                    <div class="col-md-12">
                                        <table aria-label="Detailed Report Cancellation Effect Date" width="100%" cellpadding="10">
                                            <thead>
                                                <tr class="d-none">
                                                    {{-- <th aria-hidden="true"  scope="col"></th> --}}
                                                </tr>
                                            ...
                                            <tr>
                                                <td width="50%" style="padding: 5px;">
                                                    Cancellation Effect Date :
                                                    <span>{{ (!empty($appInfo->approved_effect_date)) ? $appInfo->approved_effect_date : '' }}</span>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
                        ...
                        <div id="ep_form" class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <table aria-label="Detailed Information about the principal company" width="100%" cellpadding="10">
                                        <thead>
                                            <tr class="d-none">
                                                {{-- <th aria-hidden="true"  scope="col"></th> --}}
                                            </tr>
                        ...
                        <div id="ep_form" class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                    ...
                                    <table aria-label="Detailed Report Information about the proposed Branch" width="100%" cellpadding="10">
                                        <thead>
                                            <tr class="d-none">
                                                {{-- <th aria-hidden="true"  scope="col"></th> --}}
                                            </tr>
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding: 5px;">
                                                Period of validity :
                                                <span>{{ (!empty($appInfo->period_validity)) ? $appInfo->period_validity:''  }}</span>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
...
{{--                        --}}{{-- Service Fee Payment --}}
{{--                        <div id="ep_form" class="panel panel-info">--}}
{{--                            <div class="panel-heading">Service Fee Payment</div>--}}
{{--                            <div class="panel-body">--}}
{{--                                <div class="col-md-12">--}}
{{--                                    <table aria-label="Detailed Report Data Table" width="100%" cellpadding="10">--}}
{{--                                        <thead>
...
{{--                                            <td width="50%" style="padding: 5px;" >--}}
{{--                                                Contact address :--}}
{{--                                                <span>{{ (!empty($appInfo->auth_cell_number)) ? $appInfo->auth_cell_number : '' }}</span>--}}
{{--                                            </td>--}}
{{--                                        </tr>--}}
{{--                                        <tr>--}}
{{--                                            <td width="50%" style="padding: 5px;" >--}}
...
{{--                                            <td width="50%" style="padding: 5px;" >--}}
{{--                                                VAT/ TAX :--}}
{{--                                                <span>{{ (!empty($appInfo->sfp_vat_tax)) ? $appInfo->sfp_vat_tax : '' }}</span>--}}
{{--                                            </td>--}}
{{--                                        </tr>--}}
{{--                                        <tr>--}}
{{--                                            <td width="50%" style="padding: 5px;" >--}}
{{--                                                Bank Charge :--}}
{{--                                                <span>{{ (!empty($appInfo->sfp_bank_charge)) ? $appInfo->sfp_bank_charge : '' }}</span>--}}
{{--                                            </td>--}}
{{--                                            <td width="50%" style="padding: 5px;" >--}}
{{--                                                Total Amount :--}}
...
{{--                                        <tr>--}}
{{--                                            <td colspan="2" style="padding: 5px;">--}}
{{--                                                <strong class="text-info">Authorized person of the organization: </strong>--}}
{{--                                            </td>--}}
{{--                                        </tr>--}}
{{--                                        <tr>--}}
{{--                                            <td width="50%" style="padding: 5px;" >--}}
{{--                                                Full Name :--}}
{{--                                                <span>{{ (!empty($appInfo->auth_name)) ? $appInfo->auth_name : '' }}</span>--}}
{{--                                            </td>--}}
{{--                                            <td width="50%" style="padding: 5px;" >--}}
{{--                                                Email :--}}
                                    ...
                                    <div class="panel-body">
                                        <div class="col-md-12">
                                            <div class="row" style="padding: 5px">
                                                <table aria-label="Detailed Service & Government Fee Payment" class="table table-striped table-bordered">
                                                    <tr>
                                                        {{-- <th aria-hidden="true"  scope="col"></th> --}}
                                                    </tr>
                                                    <tr>
