    ...
    <div class="col-md-12">
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="pull-left">
                    <h5><strong>Application for Office Permission New</strong></h5>
                </div>
...
{{--                    </a>--}}
                    ...
                    @if(!in_array($appInfo->status_id,[-1,5,6]))
                        <a href="/office-permission-cancellation/app-pdf/{{ Encryption::encodeId($appInfo->id)}}"
            ...
            <div class="panel-body">
                ...
                <div class="panel panel-info" id="basic_instruction_review">
                    <div class="panel-heading">
{{--                        @if($appInfo->basic_instruction_review == 1)--}}
{{--                            <img src="{{ url('assets/images/new-icon-gif-8.jpg') }}" height="50px" alt="new-icon-gif-8">--}}
{{--                        @endif--}}
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-5 col-xs-6">
                                        <span class="v_label">Date of office permission</span>
                                        <span class="pull-right">&#58;</span>
                                    </div>
                                    <div class="col-md-7 col-xs-6">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-7 col-xs-6">
                                        {{ !empty($appInfo->effect_date) ? date('d-M-Y', strtotime($appInfo->effect_date)) : '' }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-7 col-xs-6">
                                        {{ (!empty($appInfo->applicant_remarks)) ? $appInfo->applicant_remarks : ''  }}
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="panel panel-info" id="office_type_review">
                    <div class="panel-heading">
{{--                        @if($appInfo->office_type_review == 1)--}}
{{--                            <img src="{{ url('assets/images/new-icon-gif-8.jpg') }}" height="50px" alt="new-icon-gif-8">--}}
{{--                        @endif--}}
                        <strong>Office type</strong></div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
...
{{--                                @endif--}}
                        ...
                        <div id="capital_of_company_review">
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">
{{--                                    @if($appInfo->capital_of_company_review == 1)--}}
{{--                                        <img src="{{ url('assets/images/new-icon-gif-8.jpg') }}" height="50px" alt="new-icon-gif-8">--}}
{{--                                    @endif--}}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-5 col-xs-6">
                                                <span class="v_label">(i) Authorized capital</span>
                                                <span class="pull-right">&#58;</span>
                                            </div>
                                            <div class="col-md-7 col-xs-6">
                                                {{ (!empty($appInfo->authorized_capital)) ? $appInfo->authorized_capital : '' }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-5 col-xs-6">
                                                <span class="v_label">ii) Paid up capital</span>
                                                <span class="pull-right">&#58;</span>
                                            </div>
                                            <div class="col-md-7 col-xs-6">
                                                {{ (!empty($appInfo->paid_up_capital)) ? $appInfo->paid_up_capital:''  }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div id="ep_form" class="panel panel-info">
                    <div class="panel-heading">
                        <strong>Information about the proposed Branch/Liaison/Representative Office</strong>
                    </div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div id="local_address_review">
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">
{{--                                    @if($appInfo->local_address_review == 1)--}}
{{--                                        <img src="{{ url('assets/images/new-icon-gif-8.jpg') }}" height="50px" alt="new-icon-gif-8">--}}
{{--                                    @endif--}}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-xs-6">
                                                {{ (!empty($appInfo->ex_division_name))? $appInfo->ex_division_name :''  }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-xs-6">
                                                {{ (!empty($appInfo->ex_district_name))? $appInfo->ex_district_name :''  }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-xs-6">
                                                {{ (!empty($appInfo->ex_thana_name))? $appInfo->ex_thana_name :''  }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <div id="activities_in_bd_review">
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">
{{--                                    @if($appInfo->activities_in_bd_review == 1)--}}
{{--                                        <img src="{{ url('assets/images/new-icon-gif-8.jpg') }}" height="50px" alt="new-icon-gif-8">--}}
{{--                                    @endif--}}
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-5 col-xs-6">
                                                <span class="v_label">Date of first commencement</span>
                                                <span class="pull-right">&#58;</span>
                                            </div>
                                            <div class="col-md-7 col-xs-6">
                                                {{ (!empty($appInfo->first_commencement_date)) ? $appInfo->first_commencement_date : '' }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-5 col-xs-6">
                                                <span class="v_label">Target date of operation of the proposed office</span>
                                                <span class="pull-right">&#58;</span>
                                            </div>
                                            <div class="col-md-7 col-xs-6">
                                                {{ (!empty($appInfo->operation_target_date)) ? $appInfo->operation_target_date:''  }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="period_of_permission_review">
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">
{{--                                    @if($appInfo->period_of_permission_review == 1)--}}
{{--                                        <img src="{{ url('assets/images/new-icon-gif-8.jpg') }}" height="50px" alt="new-icon-gif-8">--}}
{{--                                    @endif--}}
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12">
                                                <span class="v_label">Start and effective date</span>
                                                <span>&#58;</span>
                                            </div>
                                            <div class="col-md-12 col-xs-12">
                                                {{ (!empty($appInfo->period_start_date)) ? $appInfo->period_start_date : '' }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-xs-12">
                                                {{ (!empty($appInfo->period_end_date)) ? $appInfo->period_end_date : '' }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="row">
                                            <div class="col-md-12 col-xs-12">
                                                <span class="v_label">Period of validity</span>
                                                <span>&#58;</span>
                                            </div>
                                            <div class="col-md-12 col-xs-12">
                                                {{ (!empty($appInfo->period_validity)) ? $appInfo->period_validity : '' }}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="organizational_set_up_review">
                            <fieldset class="scheduler-border">
                                <legend class="scheduler-border">
{{--                                    @if($appInfo->organizational_set_up_review == 1)--}}
{{--                                        <img src="{{ url('assets/images/new-icon-gif-8.jpg') }}" height="50px" alt="new-icon-gif-8">--}}
{{--                                    @endif--}}
                                    Proposed organizational set up of the Office with expatriate and local man power
                                    ratio
                                </legend>
                                <div class="table-responsive">
                                    <table aria-label="Detailed Report Proposed organization" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        <thead>
                                        <tr>
...
{{--                        @endif--}}
                    ...
                    <div class="panel-body">
                        <table aria-label="Detailed Report Necessary document" class="table table-striped table-bordered table-hover ">
                            <thead>
                            <tr>
                                <th>No.</th>
                ...
                <div class="mb0 panel panel-info" id="declaration_review">
                    <div class="panel-heading">
