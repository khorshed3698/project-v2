            ...
            <div class="box-body">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h5><strong>Application for Office Permission Cancellation</strong></h5>
                        </div>
                    ...
                    <div class="panel-body">
                        ...
                        <input type="hidden" name="ref_app_approve_date" value="{{ (Session::get('opcInfo.approved_date') ? Session::get('opcInfo.approved_date') : '') }}">

                        <h3 class="stepHeader">Basic Instruction</h3>
                        <fieldset>
                            <legend class="d-none">Basic Instruction</legend>
                            <div class="panel panel-info">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('is_approval_online') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    <label class="radio-inline">{!! Form::radio('is_approval_online','yes', (Session::get('opcInfo.is_approval_online') == 'yes' ? true :false), ['class'=>'cusReadonly required helpTextRadio', 'id' => 'yes', 'onclick' => 'isApprovalOnline(this.value)']) !!}  Yes</label>
                                                    <label class="radio-inline">{!! Form::radio('is_approval_online', 'no', (Session::get('opcInfo.is_approval_online') == 'no' ? true :false), ['class'=>'cusReadonly required', 'id'=>'no', 'onclick' => 'isApprovalOnline(this.value)']) !!}  No</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div id="ref_app_tracking_no_div" class="col-md-12 hidden {{$errors->has('ref_app_tracking_no') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="input-group">
                                                        {!! Form::text('ref_app_tracking_no', Session::get('opcInfo.ref_app_tracking_no'), ['data-rule-maxlength'=>'100', 'class' => 'form-control cusReadonly input-sm']) !!}
                                                        {!! $errors->first('ref_app_tracking_no','<span class="help-block">:message</span>') !!}
                                                        <span class="input-group-btn">
                                                            @if(Session::get('opcInfo'))
                                                                <button type="submit" class="btn btn-danger btn-sm" value="clean_load_data" name="actionBtn">Clear Loaded Data</button>
                                                                <a href="{{ Session::get('opcInfo.certificate_link') }}" target="_blank" rel="noopener" class="btn btn-success btn-sm">View Certificate</a>
                                                            @else
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('date_of_office_permission') ? 'has-error': ''}}">
                                                {!! Form::label('date_of_office_permission', 'Date of office permission', ['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    <div class="datepicker input-group date ">
                                                        {!! Form::text('date_of_office_permission', (Session::get('opcInfo.approved_date') ? date('d-M-Y', strtotime(Session::get('opcInfo.approved_date'))) : ''), ['class' => 'form-control cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('effect_date') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="datepicker input-group date ">
                                                        {!! Form::text('effect_date', null, ['class' => 'required form-control input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'effect_date']) !!}
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div id="applicant_remarks_div" class="col-md-12 {{$errors->has('applicant_remarks') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::textarea('applicant_remarks', '', ['data-rule-maxlength'=>'240', 'placeholder'=>'Remarks', 'class' => 'form-control maxTextCountDown',
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('office_type') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('office_type', $officeType, Session::get('opcInfo.office_type'), ['placeholder' => 'Select One',
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_company_name') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_company_name', Session::get('opcInfo.c_company_name'), ['class'=>'form-control input-md cusReadonly bigInputField', 'data-rule-maxlength'=>'255', 'id'=>"c_company_name"]) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('c_origin_country_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('c_origin_country_id', $countries,Session::get('opcInfo.c_origin_country_id'), ['placeholder' => 'Select One',
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                {{--<div class="col-md-6 {{$errors->has('c_country_id') ? 'has-error': ''}}">--}}
                                                    ...
                                                    {{--<div class="col-md-7">--}}
                                                        {{--{!! Form::select('c_country_id', $countries,Session::get('opcInfo.c_country_id'), ['placeholder' => 'Select One',--}}
                                                ...
                                                <div class="col-md-6 {{$errors->has('c_org_type') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('c_org_type', $organizationTypes, Session::get('opcInfo.c_org_type'),
                                                        ['class' => 'form-control input-md cusReadonly readonly-select','placeholder' => 'Select One', 'id' => 'c_org_type']) !!}
                                                ...
                                                <div class="col-md-6 has-feedback {{ $errors->has('c_flat_apart_floor') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_flat_apart_floor', Session::get('opcInfo.c_flat_apart_floor'), ['class'=>'form-control input-md cusReadonly', 'data-rule-maxlength'=>'40', 'id'=>"c_flat_apart_floor"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_house_plot_holding') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_house_plot_holding', Session::get('opcInfo.c_house_plot_holding'), ['class'=>'form-control input-md cusReadonly', 'data-rule-maxlength'=>'40', 'id'=>"c_house_plot_holding"]) !!}
                                                ...
                                                <div class="col-md-6  {{$errors->has('c_post_zip_code') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_post_zip_code', Session::get('opcInfo.c_post_zip_code'), ['data-rule-maxlength'=>'80',
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 has-feedback {{ $errors->has('c_street') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_street', Session::get('opcInfo.c_street'), ['class'=>'form-control input-md cusReadonly','data-rule-maxlength'=>'40', 'id' => 'c_street']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('c_email') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_email', Session::get('opcInfo.c_email'), ['class' => 'form-control input-md email cusReadonly', 'id' => 'c_email']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_city') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_city', Session::get('opcInfo.c_city'),['class' => 'form-control input-md cusReadonly', 'id' => 'c_city']) !!}
                                                ...
                                                <div class="col-md-6  {{$errors->has('c_telephone') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_telephone', Session::get('opcInfo.c_telephone'),['data-rule-maxlength'=>'20',  'class' => 'form-control input-md cusReadonly', 'id' => 'c_telephone']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_state_province') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_state_province', Session::get('opcInfo.c_state_province'),['class' => 'form-control input-md cusReadonly', 'id' => 'c_state_province']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('c_fax') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_fax', Session::get('opcInfo.c_fax'), ['class' => 'form-control input-md cusReadonly', 'id' => 'c_fax']) !!}
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 {{$errors->has('c_major_activity_brief') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7" style="width: 79.8%">
                                                        {!! Form::textarea('c_major_activity_brief', Session::get('opcInfo.c_major_activity_brief'),['class' => 'bigInputField form-control input-md cusReadonly maxTextCountDown', 'size'=>'1x2', 'id' => 'c_major_activity_brief','data-charcount-maxlength'=>'200']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('authorized_capital') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('authorized_capital', Session::get('opcInfo.authorized_capital'),['class' => 'form-control number input-md cusReadonly', 'id'=>'authorized_capital']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('paid_up_capital') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('paid_up_capital', Session::get('opcInfo.paid_up_capital'),['class' => 'form-control number input-md cusReadonly', 'id' => 'paid_up_capital']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('local_company_name') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('local_company_name', Session::get('opcInfo.local_company_name'), ['class'=>'form-control input-md cusReadonly', 'data-rule-maxlength'=>'255', 'id'=>"local_company_name"]) !!}
...
{{--                                                <div class="col-md-7">--}}
{{--                                                    {!! Form::text('local_company_name_bn', Session::get('opcInfo.local_company_name_bn'), ['class'=>'form-control input-md cusReadonly', 'data-rule-maxlength'=>'255', 'id'=>"local_company_name_bn"]) !!}--}}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_division_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_division_id', $divisions, Session::get('opcInfo.ex_office_division_id'), ['class' => 'form-control cusReadonly input-md required readonly-select', 'id' => 'ex_office_division_id', 'placeholder' => 'Select One','onchange'=>"getDistrictByDivisionId('ex_office_division_id', this.value, 'ex_office_district_id', ". Session::get('opcInfo.ex_office_district_id') .")"]) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_district_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_district_id', $district_eng, Session::get('opcInfo.ex_office_district_id'), ['class' => 'form-control cusReadonly input-md required readonly-select','placeholder' => 'Select division first', 'onchange'=>"getThanaByDistrictId('ex_office_district_id', this.value, 'ex_office_thana_id', ". Session::get('opcInfo.ex_office_thana_id') .")"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_thana_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_thana_id', [], Session::get('opcInfo.ex_office_thana_id'), ['class' => 'form-control cusReadonly input-md required readonly-select','placeholder' => 'Select district first']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_post_office') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_post_office', Session::get('opcInfo.ex_office_post_office'), ['class' => 'form-control input-md cusReadonly']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_post_code') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_post_code', Session::get('opcInfo.ex_office_post_code'), ['class' => 'form-control cusReadonly input-md post_code_bd required']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_address') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_address', Session::get('opcInfo.ex_office_address'), ['maxlength'=>'150','class' => 'form-control cusReadonly input-md required']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_telephone_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_telephone_no', Session::get('opcInfo.ex_office_telephone_no'), ['maxlength'=>'20','class' => 'form-control cusReadonly input-md phone_or_mobile']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_mobile_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_mobile_no', Session::get('opcInfo.ex_office_mobile_no'), ['class' => 'form-control cusReadonly input-md helpText15 required' ,'id' => 'ex_office_mobile_no']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_fax_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_fax_no', Session::get('opcInfo.ex_office_fax_no'), ['class' => 'form-control cusReadonly input-md']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_email') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_email', Session::get('opcInfo.ex_office_email'), ['class' => 'form-control cusReadonly email input-md required']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-12 {{$errors->has('activities_in_bd') ? 'has-error': ''}}" id="courtesy_service_reason_div">
                                                    ...
                                                    <div class="col-md-6">
                                                        {!! Form::textarea('activities_in_bd', Session::get('opcInfo.activities_in_bd'), ['data-rule-maxlength'=>'250', 'id' => 'activities_in_bd', 'placeholder'=>'Write here', 'class' => 'form-control cusReadonly bigInputField input-md',
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('first_commencement_date') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="datepicker input-group date ">
                                                            {!! Form::text('first_commencement_date', (Session::get('opcInfo.first_commencement_date') ? date('d-M-Y', strtotime(Session::get('opcInfo.first_commencement_date'))) : ''), ['class' => 'form-control cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'first_commencement_date']) !!}
                                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        </div>
                                                ...
                                                <div class="col-md-6 {{$errors->has('operation_target_date') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="datepicker input-group date ">
                                                            {!! Form::text('operation_target_date', (Session::get('opcInfo.operation_target_date') ? date('d-M-Y', strtotime(Session::get('opcInfo.operation_target_date'))) : ''), ['class' => 'form-control cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'operation_target_date']) !!}
                                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-4 {{$errors->has('period_start_date') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="period_start_date datepicker input-group date ">
                                                            {!! Form::text('period_start_date', (Session::get('opcInfo.period_start_date') ? date('d-M-Y', strtotime(Session::get('opcInfo.period_start_date'))) : ''), ['class' => 'form-control cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'period_start_date']) !!}
                                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        </div>
                                                ...
                                                <div class="col-md-4 {{$errors->has('period_end_date') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="period_end_date datepicker input-group date ">
                                                            {!! Form::text('period_end_date', (Session::get('opcInfo.period_end_date') ? date('d-M-Y', strtotime(Session::get('opcInfo.period_end_date'))) : ''), ['class' => 'form-control cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'period_end_date']) !!}
                                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        </div>
                                                ...
                                                <div class="col-md-4 {{$errors->has('period_validity') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-12">
                                                        {!! Form::text('period_validity', Session::get('opcInfo.period_validity'), ['class' => 'form-control input-md cusReadonly', 'id' => 'period_validity']) !!}
                                        ...
                                        <div class="col-md-12" style="padding: 0">
                                            <div class="table-responsive">
                                                <table aria-label="Detailed Report Data Table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            {!! Form::text('local_executive', Session::get('opcInfo.local_executive'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number','id'=>'local_executive']) !!}
                                                            {!! $errors->first('local_executive','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('local_stuff', Session::get('opcInfo.local_stuff'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number','id'=>'local_stuff']) !!}
                                                            {!! $errors->first('local_stuff','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('local_total', Session::get('opcInfo.local_total'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md numberNoNegative','id'=>'local_total','readonly']) !!}
                                                            {!! $errors->first('local_total','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('foreign_executive', Session::get('opcInfo.foreign_executive'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number','id'=>'foreign_executive']) !!}
                                                            {!! $errors->first('foreign_executive','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('foreign_stuff', Session::get('opcInfo.foreign_stuff'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number','id'=>'foreign_stuff']) !!}
                                                            {!! $errors->first('foreign_stuff','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('foreign_total', Session::get('opcInfo.foreign_total'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md numberNoNegative','id'=>'foreign_total','readonly']) !!}
                                                            {!! $errors->first('foreign_total','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('manpower_total', Session::get('opcInfo.manpower_total'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number','id'=>'mp_total','readonly']) !!}
                                                            {!! $errors->first('manpower_total','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('manpower_local_ratio', Session::get('opcInfo.manpower_local_ratio'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number','id'=>'mp_ratio_local','readonly']) !!}
                                                            {!! $errors->first('manpower_local_ratio','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('manpower_foreign_ratio', Session::get('opcInfo.manpower_foreign_ratio'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number','id'=>'mp_ratio_foreign','readonly']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('est_initial_expenses') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('est_initial_expenses', Session::get('opcInfo.est_initial_expenses'),['class' => 'form-control cusReadonly input-md bigInputField', 'id' => 'est_initial_expenses']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('est_monthly_expenses') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('est_monthly_expenses', Session::get('opcInfo.est_monthly_expenses'),['class' => 'form-control cusReadonly input-md bigInputField', 'id' => 'est_monthly_expenses']) !!}
...
<script>
    ...
    var sessionLastOPN = '{{ Session::get('opcInfo.is_approval_online') }}';
