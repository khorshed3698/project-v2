...
<div class="panel panel-info" id="attachment_review">
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <table aria-label="Detailed Report Necessary document" class="table table-striped table-bordered display" width="100%">
            <thead>
                <tr>
                    <th>No.</th>
                            ...
                            <td colspan="2">
                                ...
                                @if(!empty($row->doc_file_path))
                                    <div class="save_file saved_file_{{$row->id}}">
                                        ...
                                        <?php if($viewMode != 'on') {?>
                                        <a href="javascript:void(0)" class="attachment_remove_btn" onclick="removeAttachedFile({!! $row->id !!}, {!! $row->doc_priority !!})"><span class="btn btn-xs btn-danger"><i class="fa fa-times"></i></span> </a>
                                        <?php } ?>
                                    </div>
                                @endif
