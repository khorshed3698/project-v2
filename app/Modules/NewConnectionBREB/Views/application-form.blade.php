                ...
                <div class="panel panel-primary">
                    ...
                    <fieldset>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('organization_name','',['class' => 'form-control input-sm']) !!}
                                ...
                                <div class="form-group">
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('fName', '',['class' => 'form-control input-sm']) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('mName', '',['class' => 'form-control input-sm']) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('sName', '',['class' => 'form-control input-sm']) !!}
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-7">
                                            <div class="datepickerDob input-group date">
                                                {!! Form::text('date_of_birth', '',['class' => 'form-control input-sm','readonly','style'=>'background:white;']) !!}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::select('nationality', ['1@বাংলাদেশী'=>'বাংলাদেশী','2@অন্যান্য'=>'অন্যান্য'], '', ['class' =>'form-control']) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('national_id', '',['class' => 'form-control input-sm nid bd_nid onlyNumber']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('passport', '',['class' => 'form-control input-sm']) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('mobile', '',['class' => 'form-control input-sm mobile onlyNumber','id'=>'mobile']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('phone', '',['class' => 'form-control input-sm onlyNumber telephone']) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::select('gender',  ['1@পুরুষ'=>'পুরুষ','2@নারী'=>'নারী'], '', ['class' =>'form-control']) !!}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 ">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('perm_post', '',['class' => 'form-control input-sm']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        {!! Form::label('perm_post_code','পোস্ট কোড (ইংরেজি):', ['class'=>'col-md-5']) !!}
                                        <div class="col-md-7">
                                            {!! Form::text('perm_post_code', '',['class' => 'form-control input-sm onlyNumber']) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('perm_road_no', '',['class' => 'form-control input-sm']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        {!! Form::label('perm_house_holding','বাড়ির নাম/হোল্ডিং নম্বর (বাংলা):', ['class'=>'col-md-5']) !!}
                                        <div class="col-md-7">
                                            {!! Form::text('perm_house_holding', '',['class' => 'form-control input-sm']) !!}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class=" col-md-12" style="font-size: 17px;">
                                            <div class="col-md-offset-3 col-md-6">
                                                {!! Form::checkbox('same_as_permanent',1,null,
                                                array('id'=>'same_as_permanent'))
                                                !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('cur_post', '',['class' => 'form-control input-sm']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        {!! Form::label('cur_post_code','পোস্ট কোড (ইংরেজি):', ['class'=>'col-md-5']) !!}
                                        <div class="col-md-7">
                                            {!! Form::text('cur_post_code', '',['class' => 'form-control input-sm onlyNumber']) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4 ">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('cur_road_no', '',['class' => 'form-control input-sm']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        {!! Form::label('cur_house_holding','বাড়ির নাম/হোল্ডিং নম্বর (বাংলা):', ['class'=>'col-md-5']) !!}
                                        <div class="col-md-7">
                                            {!! Form::text('cur_house_holding', '',['class' => 'form-control input-sm']) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-4 ">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('mouja', '',['class' => 'form-control input-sm ']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-4 ">
                                        {!! Form::label('dag_no','দাগ নম্বর (ইংরেজি):',['class'=>'col-md-5 text-left']) !!}
                                        <div class="col-md-7">
                                            {!! Form::text('dag_no', '',['class' => 'form-control input-sm ']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        {!! Form::label('khotian_no','খতিয়ান নম্বর (ইংরেজি):', ['class'=>'col-md-5']) !!}
                                        <div class="col-md-7">
                                            {!! Form::text('khotian_no', '',['class' => 'form-control input-sm ']) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-md-7 ">
                                            {!! Form::select('land_owner_type', ['1@নিজ/পৈত্রিক মালিকানাধীন'=>'নিজ/পৈত্রিক মালিকানাধীন','2@ভাড়াকৃত/লিজ (ব্যক্তি মালিকানাধীন)'=>'ভাড়াকৃত/লিজ (ব্যক্তি মালিকানাধীন)','3@ভাড়াকৃত/লিজ (সরকারী মালিকানাধীন)'=>'ভাড়াকৃত/লিজ (সরকারী মালিকানাধীন)'],'', ['placeholder' => 'নির্বাচন করুন',
                                ...
                                <div class="form-group">
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('land_owner_name', '',['class' => 'form-control input-sm']) !!}
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-md-7">
                                            <div class="input-group">
                                                {!! Form::text('service_drop_dist_consumer', '',['class' => 'form-control input-sm onlyNumber']) !!}
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="col-md-10">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::select('connection_type',['1@স্থায়ী সংযোগ'=>'স্থায়ী সংযোগ','2@অস্থায়ী সংযোগ'=>'অস্থায়ী সংযোগ','3@সাময়িক সংযোগ'=>'সাময়িক সংযোগ'], '', ['class' => 'form-control', 'placeholder'=>'নির্বাচন করুন']) !!}
                                        </div>
                                    </div>
                                </div>
                                <!--/panel-body-->
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-7">
                                            {!! Form::text('total_load_KW','',['class' => 'col-md-7 form-control input-md onlyNumber','placeholder' => '']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        {!! Form::label('phase','ফেজ :',['class'=>'col-md-5 text-left']) !!}
                                        <div class="col-md-7">
                                            {!! Form::select('phase', ['1@এক ফেইজ'=>'এক ফেইজ','2@তিন ফেইজ'=>'তিন ফেইজ'],'', ['placeholder' => 'নির্বাচন করুন','class' => 'form-control input-md']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        {!! Form::label('volt','ভোল্ট :', ['class'=>'col-md-5']) !!}
                                        <div class="col-md-7 ">
                                            {!! Form::select('volt', ['230@২৩০'=>'২৩০','400@৪০০'=>'৪০০','11000@১১কেভি'=>'১১কেভি','33000@৩৩কেভি'=>'৩৩কেভি'],'', ['placeholder' => 'নির্বাচন করুন','class' => 'form-control input-md']) !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div>
                                    {!! Form::textarea('location_remarks','',['class'=>'form-control input-sm', 'rows' => 2, 'cols' => 40]) !!}
                                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#same_as_permanent').on('change', function () {
            ...
            let perm_dist = $("#perm_dist").val()
            let perm_upazilla = $("#perm_upazilla").val()
            let perm_thana = $("#perm_thana").val()
            let perm_union = $("#perm_union").val()
            ...
            if (checkBox == true) {
                ...
                $("#cur_district").val('')
                $("#cur_district").trigger('')
                $("#cur_upazilla").val('')
                $("#cur_thana").val('')
                $("#cur_union").val('')
                $("#cur_village").val('')
                $("#cur_district").trigger("keydown")
                $("#cur_post").val('')
                $("#cur_post_code").val('')
                $("#cur_road_no").val('')
        ...
        $("same_as_permanent").trigger('click');
