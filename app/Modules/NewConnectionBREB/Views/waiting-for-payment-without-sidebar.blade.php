<?php
$accessMode = ACL::getAccsessRight('NewConectionBREB');
?>
    <style>
        #loading1 {
            width: 100%;
        ...
        <div class="col-md-12">
            ...
            <div id="loading_warn">
                ...
                <Span class="alert alert-success" id="loding-msg"><i class="fa fa-spinner fa-spin"></i>  <span
                            id="loding-msg-text">Connecting to BREB server.</span></Span>
            </div>
            ...
            <div class="box">
                <div id="paymentPanel" class="panel panel-default" style="display: none;">
                    <div class="panel-body">
                        ...
                        {!! Form::open(array('url' => '/new-connection-breb/payment','method' => 'post','id' => 'NameClearanceForm','role'=>'form','enctype'=>'multipart/form-data')) !!}
    ...
    <script type="text/javascript">
        ...
        function checkBrebStatus() {
            var app_id = $('#enc_app_id').val();

            $.ajax({
                url: '/new-connection-breb/check-payment-info',
                type: "POST",
                data: {
                    enc_app_id: app_id
                },
                ...
                success: function (response) {
                    if (response.responseCode == 1) {
                        if (response.status == -2 || response.status == -3) {
                            ...
                            myVar = setTimeout(checkBrebStatus, 5000);
                            ...
                            $('#paymentPanel').show();
                            document.getElementById("loading_warn").style.display = "none";
                            // alert(response.message);
                        } else {
