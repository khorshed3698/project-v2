...
@section('content')
                ...
                <div class="box-body" id="inputForm">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            {!! Form::open(array('url' => '/licence-application/bank-account/add','method' => 'post','id' => 'BankApplicationForm','role'=>'form','enctype'=>'multipart/form-data')) !!}
                            ...
                            <div class="form-body">
                                ...
                                <div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 {{$errors->has('factory_mobile_no') ? 'has-error': ''}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                {!! Form::text('factory_mobile_no', $basicAppInfo->factory_mobile_no, ['class' => 'form-control input-md']) !!}
                                                            ...
                                                            <div class="col-md-7">
                                                                ...
                                                                <div id="resolution_bank_preview" class="uploadbox">
                                                                    <input type="hidden" class="required"
                                                                           ...
                                                                           name="resolution_bank_file_name">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    {{--</div>--}}
                                    {{--</fieldset>--}}
                                    @if(ACL::getAccsessRight('BankAccount','-E-'))
    ...
    <script type="text/javascript">
        ...
        function makeBlank_values(id) {
            var file_id = id;
            console.log(file_id);
            document.getElementById(file_id + '_name').value = '';
            document.getElementById(file_id).value = '';
            var label = document.getElementById("label_" + file_id);
            console.log(label);
            label.remove();
            var list = document.getElementById(file_id + '_preview');
