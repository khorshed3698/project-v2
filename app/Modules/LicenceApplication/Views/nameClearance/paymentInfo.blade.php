...
<div class="form-group clearfix">
    <div class="row">
        <div class="col-md-6">
             {!! Form::label('rjsc_fee','RJSC Fee',['class'=>'col-md-5 text-left']) !!}
            <div class="col-md-7">
                <input name="rjsc_fee" class="form-control input-md" value="{{$applyPaymentfee->rjsc_fee}}" readonly>
            </div>
        </div>
        <div class="col-md-6">
...
<div class="form-group clearfix">
    <div class="row">
        <div class="col-md-6">
             {!! Form::label('rjsc_vat','RJSC VAT Fee',['class'=>'col-md-5 text-left']) !!}
            <div class="col-md-7">
                <input name="rjsc_vat" class="form-control input-md" value="{{$applyPaymentfee->rjsc_vat}}" readonly>
            </div>
        </div>
        <?php
        $totalamount = number_format($applyPaymentfee->rjsc_fee+ $applyPaymentfee->rjsc_vat + $ServicepaymentData->amount,2);
        ?>
        <div class="col-md-6">
...
{{--        <div class="col-md-6">--}}
{{--             {!! Form::label('rjsc_duty','RJSC Duty Fee',['class'=>'col-md-5 text-left']) !!}--}}
{{--              <div class="col-md-6">--}}
{{--                <input name="rjsc_duty" class="form-control input-md" value="{{$applyPaymentfee->rjsc_duty}}" readonly>--}}
{{--              </div>--}}
{{--        </div>--}}
    </div>
</div>
