...
<script language="javascript">
    ...
    jQuery(function () {
        jQuery('#submitFromPreviewBtn').click(function (e) {
            window.opener.document.getElementById("+{{$formId}}+").setAttribute("target", "_self");
            window.opener.jQuery("+{{$formId}}+").submit();
            window.close();
        });
    });
    ...
    window.opener.jQuery("#{{$formId}} :input[type=text]").each(function (index) {
        jQuery(this).attr("value", jQuery(this).val());
    });

    window.opener.jQuery("#{{$formId}} :input[type=number]").each(function (index) {
        jQuery(this).attr("value", jQuery(this).val());
    });
    ...
    window.opener.jQuery("#{{$formId}} :input[type=email]").each(function (index) {
        jQuery(this).attr("value", jQuery(this).val());
    });


    window.opener.jQuery("#{{$formId}} :input[type=radio]").each(function (index) {
        if(jQuery(this).is(':checked')){
            jQuery(this).attr("checked","checked");
        }
    });
    window.opener.jQuery("#{{$formId}} :input[type=checkbox]").each(function (index) {
        if(jQuery(this).is(':checked')){
            jQuery(this).attr("checked","checked");
        }
    });
    ...
    window.opener.jQuery(".select2-selection--single").css({"display": "none"});
...
//        return jQuery(this).find('option:selected').text();
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery(".select2-selection--single").css({"display": "block"});
        ...
        window.opener.jQuery("#{{$formId}}-p-{{$formStep}}").css({"display": "block"});
