...
@section('content')
                ...
                <div class="box-body" id="inputForm">
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-heading">
                            ...
                            <div class="pull-right wait_for_response" style="width: 40%;"></div>
                        </div>
                        ...
                        <div class="row" style="margin:15px 0 5px 0">
                            <div class="col-md-12">
                                <div class="col-md-7">
                                    ...
                                    <h5 class="row">Application for Trade Licence to Dhaka South City Corporation .</h5>
                                </div>
                        ...
                        <div class="form-body panel-body">
                            {!! Form::open(array('url' => 'licence-applications/trade-licence/store','method' => 'post','id' => 'trade_licence_form','role'=>'form','files' => true, 'enctype'=>'multipart/form-data')) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 {{ $errors->has('country') ? 'has-error' : ''}}">
                                                {!! Form::label('country', 'Country', ['class' => 'col-md-5 text-left required required-star']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::select('country', $countries, $basicInfo->ceo_country_id, ['class' => 'form-control input-md', 'readonly']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 {{ $errors->has('organization_name') ? 'has-error' : ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('organization_name', $basicInfo->company_name, ['class' => 'form-control input-md required', 'readonly']) !!}
                                            ...
                                            <div class="col-md-6 {{ $errors->has('spouse_name') ? 'has-error' : ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('spouse_name', $basicInfo->ceo_spouse_name, ['class' => 'form-control input-md']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 {{ $errors->has('applicant_name') ? 'has-error' : ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('applicant_name', $basicInfo->ceo_full_name, ['class' => 'form-control input-md', 'readonly']) !!}
                                            ...
                                            <div class="col-md-6 {{ $errors->has('applicant_email') ? 'has-error' : ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::email('applicant_email', $basicInfo->ceo_email, ['class' => 'form-control input-md email', 'readonly']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 {{ $errors->has('applicant_father') ? 'has-error' : ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('applicant_father', $basicInfo->ceo_father_name, ['class' => 'form-control input-md', 'readonly']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 {{ $errors->has('applicant_mother') ? 'has-error' : ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('applicant_mother', $basicInfo->ceo_mother_name, ['class' => 'form-control input-md', 'readonly']) !!}
                                            ...
                                            <div class="col-md-6 {{ $errors->has('applicant_dob') ? 'has-error' : ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="datepickerDob input-group date">
                                                        {!! Form::text('applicant_dob', !empty($basicInfo->ceo_dob) ? (date('d-M-Y', strtotime($basicInfo->ceo_dob))) : '', ['class' => 'form-control input-md', 'placeholder'=>'dd-mm-yyyy']) !!}
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body ">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 {{ $errors->has('business_name') ? 'has-error' : ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('business_name', null, ['class' => 'form-control input-md required', 'required']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 {{ $errors->has('business_zone') ? 'has-error' : ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::select('business_zone', $zones, null, ['class' => 'form-control input-md required','id'=>'business_zone']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 {{ $errors->has('authorised_capital') ? 'has-error' : ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::number('authorised_capital',  null, ['class' => 'form-control input-md required onlyNumber']) !!}
                                            ...
                                            <div class="col-md-6 {{ $errors->has('paidup_capital') ? 'has-error' : ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::number('paidup_capital',  null, ['class' => 'form-control input-md required onlyNumber']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 {{ $errors->has('business_category') ? 'has-error' : ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::select('business_category', $categories, null, ['class' => 'form-control input-md required','id'=>'business_category']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{ $errors->has('business_address') ? 'has-error' : ''}}">
                                                {!! Form::label('business_address', 'Signboard (Feet)', ['class' => 'col-md-3 text-left required-star']) !!}
                                                <div class="col-md-8">
                                                    <div class="col-md-5 {{ $errors->has('business_signboard_height') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-7 {{ $errors->has('business_signboard_width') ? 'has-error' : ''}}">
                            ...
                            <div id="docListDiv">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered table-hover ">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th colspan="2">Attached PDF file (Each File Maximum size
                                                            2MB)
                                                        </th>
                                                    </tr>
                                                    </thead>
                                                    ...
                                                    @foreach($document as $row)
                                                        <tr>
                                                            @if($i == 1)
                                                                <td {{($i == 1) ? 'rowspan=3 ' : ''}}>
                                                                    <div align="left">{!! $i !!}<?php echo $row->doc_priority == "1" ? "<span class='required-star'></span>" : ""; ?>
                                                                        <small>Please upload minimum <br>One file of this block</small>
                                                                    </div>
                                                                </td>
                                                            @endif
                                                            @if($i == 4)
                                                                <td {{($i == 4) ? 'rowspan=3 ' : ''}}>
                                                                    <div align="left">
                                                                        2<?php echo $row->doc_priority == "1" ? "<span class='required-star'></span>" : ""; ?>
                                                                        <small>Please upload minimum <br> One file of this block</small>
                                                                    </div>
                                                                </td>
                                                            @endif
                                                            ...
                                                            <td colspan="2">
                                                                ...
                                                                <input name="file<?php echo $row->id; ?>"
                                                                       ...
                                                                       data-doc_type="<?php echo $row->additional_field; ?>"
                                                                       type="file"
                                                                       size="20"
                                                                ...
                                                                @if(!empty($clrDocuments[$row->id]['file']))
                                                                    <div class="save_file saved_file_{{$row->id}}">
                                                                        <a target="_blank" class="documentUrl"
                                                                           href="{{URL::to('/uploads/'.(!empty($clrDocuments[$row->id]['file']) ? $clrDocuments[$row->id]['file'] : ''))}}"
                                                                           title="{{$row->doc_name}}">
                                ...
                                <div class="wait_for_response"></div>
                                ...
                                @if(ACL::getAccsessRight('TradeLicence','-E-'))
    ...
    <div id="payment_confirm" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <form method="POST"
                      action="http://192.168.152.131:8000/application-arrangement/update-application-process-status"
                      accept-charset="UTF-8" role="form">
                    <input name="_token" type="hidden" value="gnWjFO1uaSRNd21KnVGVGxrOIwIheSj7ESVEdRoy">
                    <div class="modal-body">
                        Trade licence fee Taka, Please confirm .
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-default" data-dismiss="modal"><span
                                    ...
                                    style="height: 56px; width: 56px; top: -22px; left: 8.26562px;"></span>Cancel
                        </button>
                    </div>
                </form>
            </div>
...
@section('footer-script')
    ...
    <script type="text/javascript">
        ...
        $('#trade_licence_form').on('submit', function (event) {

            var count_six = 0;
            var count_seven = 0;
            $("input[type=file]").each(function (index, item) {
                var doc_type_value = $(this).data("doc_type");
                if ($(item).val().length > 0 && doc_type_value === 6) {
                    count_six++;
                }
                if ($(item).val().length > 0 && doc_type_value === 7) {
                    count_seven++;
                }

            });

            if (count_six === 0 || count_seven === 0) {
                $('#file_upload_msg').html('<div class="alert alert-warning">\n' +
                    '<strong style="color: red;">Have to submit required file</strong> \n' +
                    '</div>');
                return false;
            } else {
                return true;
        ...
        function getDivisionThana(form_field_id, data) {
            $.ajax({
                type: "GET",
                url: "<?php echo url(); ?>/licence-applications/trade-licence/division-area/",
                data: data,
                success: function (response) {
                    var option = '<option value="">Select One</option>';
                    if (response.responseCode == 1) {
                        $.each(response.data, function (id, value) {
                            ...
                            option += '<option value="' + value.id + '">' + value.loc_name_bn + '</option>';
                        });
                    }
                    $("#" + form_field_id).html(option);
                }
