                        ...
                        <div>
                            ...
                            <fieldset>
                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div class="panel-body">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <table id="productionCostTbl" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
                                                            ...
                                                            <tr id="rowProCostCount{{$inc}}">
                                                                ...
                                                                <td>
                                                                    {!! Form::number("apc_hs_code[$inc]", '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number hscodes']) !!}

                                                                </td>

                                                                <td>
                                                                    <input type="number" id="apc_quantity_0" name="apc_quantity[0]" class="form-control quantity1 CalculateInputByBoxNo">


                                                                </td>

                                                                <td>
                                                                    <input type="number" id="apc_price_usd_0"  name="apc_price_usd[0]" class="form-control quantity1 CalculateInputByBoxNo">

                                                                </td>
                                                                <td>
                                                                    {!! Form::number("apc_value_taka[$inc]",'', ['class' => 'form-control input-md', 'id'=>'apc_value_taka_0']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-10 {{$errors->has('commercial_operation_date') ? 'has-error': ''}}">
                                                    {!! Form::label('commercial_operation_date','2. Target Date of Commercial Operation ',['class'=>'col-md-4 text-left']) !!}
                                                    <div class="col-md-5">
                                                        {!! Form::text('commercial_operation_date', '', ['class' => 'form-control input-md']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 {{$errors->has('local_sales') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-5">
                                                        {!! Form::text('local_sales', '', ['class' => 'form-control input-md number']) !!}
                                                ...
                                                <div class="col-md-4 {{$errors->has('foreign_sales') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-5">
                                                        {!! Form::text('foreign_sales', '', ['class' => 'form-control input-md number']) !!}
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th class="alert alert-info">Local (Million Taka/Million US$</th>
                                                            ...
                                                            <tr>
                                                                <th>(a) Fixed Investment</th>
                                                                <td>
                                                                    <table style="width:100%;">
                                                                        <tr>
                                                                            <td style="width:75%;">
                                                                                {!! Form::number('local_fixed_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'local_fixed_ivst']) !!}
                                                                                {!! $errors->first('local_fixed_ivst','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("local_fixed_ivst_ccy", $currencies, 107, ["placeholder" => "Select One","id"=>"local_fixed_ivst_ccy", "class" => "form-control input-md usd-def"]) !!}
                                                                                {!! $errors->first('local_fixed_ivst_ccy','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                <td>
                                                                    <table style="width:100%;">
                                                                        <tr>
                                                                            <td style="width:75%;">
                                                                                {!! Form::number('foreign_fixed_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'foreign_fixed_ivst']) !!}
                                                                                {!! $errors->first('foreign_fixed_ivst','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("foreign_fixed_ivst_ccy", $currencies, 107, ["placeholder" => "Select One","id"=>"foreign_fixed_ivst_ccy", "class" => "form-control input-md usd-def"]) !!}
                                                                                {!! $errors->first('foreign_fixed_ivst_ccy','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                <td>
                                                                    {!! Form::number('total_fixed_ivst_single', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'total_fixed_ivst_single','readonly']) !!}
                                                                    {!! $errors->first('total_fixed_ivst_single','<span class="help-block">:message</span>') !!}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td> &nbsp;&nbsp;&nbsp;&nbsp; Land</td>
                                                                <td>
                                                                    <table style="width:100%;">
                                                                        <tr>
                                                                            <td style="width:75%;">
                                                                                {!! Form::number('local_land_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'local_land_ivst']) !!}
                                                                                {!! $errors->first('local_land_ivst','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("local_land_ivst_ccy", $currencies, 107, ["placeholder" => "Select One","id"=>"local_land_ivst_ccy", "class" => "form-control input-md usd-def"]) !!}
                                                                ...
                                                                <td>
                                                                    <table style="width:100%;">
                                                                        <tr>
                                                                            <td style="width:75%;">
                                                                                {!! Form::number('foreign_land_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'foreign_land_ivst']) !!}
                                                                                {!! $errors->first('foreign_land_ivst','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("foreign_land_ivst_ccy", $currencies, 107, ["placeholder" => "Select One","id"=>"foreign_land_ivst_ccy", "class" => "form-control input-md usd-def"]) !!}
                                                                                {!! $errors->first('foreign_land_ivst_ccy','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                <td>
                                                                    {!! Form::number('total_land_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'total_land_ivst','readonly']) !!}
                                                                    {!! $errors->first('total_land_ivst','<span class="help-block">:message</span>') !!}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table style="width:100%;">
                                                                        <tr>
                                                                            <td style="width:75%;">
                                                                                {!! Form::number('local_machinery_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'local_machinery_ivst']) !!}
                                                                                {!! $errors->first('local_machinery_ivst','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("local_machinery_ivst_ccy", $currencies, 107, ["placeholder" => "Select One","id"=>"local_machinery_ivst_ccy", "class" => "form-control input-md usd-def"]) !!}
                                                                ...
                                                                <td>
                                                                    <table style="width:100%;">
                                                                        <tr>
                                                                            <td style="width:75%;">
                                                                                {!! Form::number('foreign_machinery_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'foreign_machinery_ivst']) !!}
                                                                                {!! $errors->first('foreign_machinery_ivst','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("foreign_machinery_ivst_ccy", $currencies, 107, ["placeholder" => "Select One","id"=>"foreign_machinery_ivst_ccy", "class" => "form-control input-md usd-def"]) !!}
                                                                                {!! $errors->first('foreign_machinery_ivst_ccy','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                <td>
                                                                    {!! Form::number('total_machinery_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'total_machinery_ivst','readonly']) !!}
                                                                    {!! $errors->first('total_machinery_ivst','<span class="help-block">:message</span>') !!}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td> &nbsp;&nbsp;&nbsp;&nbsp; Others</td>
                                                                <td>
                                                                    <table style="width:100%;">
                                                                        <tr>
                                                                            <td style="width:75%;">
                                                                                {!! Form::number('local_others_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'local_others_ivst']) !!}
                                                                                {!! $errors->first('local_others_ivst','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("local_others_ivst_ccy", $currencies, 107, ["placeholder" => "Select One","id"=>"local_others_ivst_ccy", "class" => "form-control input-md usd-def"]) !!}
                                                                ...
                                                                <td>
                                                                    <table style="width:100%;">
                                                                        <tr>
                                                                            <td style="width:75%;">
                                                                                {!! Form::number('foreign_others_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'foreign_others_ivst']) !!}
                                                                                {!! $errors->first('foreign_others_ivst','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("foreign_others_ivst_ccy", $currencies, 107, ["placeholder" => "Select One","id"=>"foreign_others_ivst_ccy", "class" => "form-control input-md usd-def"]) !!}
                                                                                {!! $errors->first('foreign_others_ivst_ccy','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                <td>
                                                                    {!! Form::number('total_others_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'total_others_ivst','readonly']) !!}
                                                                    {!! $errors->first('total_others_ivst','<span class="help-block">:message</span>') !!}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <th>(b) Working Capital (3 months)</th>
                                                                <td>
                                                                    <table style="width:100%;">
                                                                        <tr>
                                                                            <td style="width:75%;">
                                                                                {!! Form::number('local_wc_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'local_wc_ivst']) !!}
                                                                                {!! $errors->first('local_wc_ivst','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("local_wc_ivst_ccy", $currencies, 107, ["placeholder" => "Select One","id"=>"local_wc_ivst_ccy", "class" => "form-control input-md usd-def"]) !!}
                                                                ...
                                                                <td>
                                                                    <table style="width:100%;">
                                                                        <tr>
                                                                            <td style="width:75%;">
                                                                                {!! Form::number('foreign_wc_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'foreign_wc_ivst']) !!}
                                                                                {!! $errors->first('foreign_wc_ivst','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("foreign_wc_ivst_ccy", $currencies, 107, ["placeholder" => "Select One","id"=>"foreign_wc_ivst_ccy", "class" => "form-control input-md usd-def"]) !!}
                                                                                {!! $errors->first('foreign_wc_ivst_ccy','<span class="help-block">:message</span>') !!}
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                                <td>
                                                                    {!! Form::number('total_wc_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'total_wc_ivst','readonly']) !!}
                                                                    {!! $errors->first('total_wc_ivst','<span class="help-block">:message</span>') !!}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td> &nbsp;&nbsp;&nbsp;&nbsp; Total Investment (a+b)</td>
                                                                <td colspan="3">
                                                                    {!! Form::number('total_fixed_ivst', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'total_fixed_ivst','readonly']) !!}
                                                            ...
                                                            <tr>
                                                                <td> &nbsp;&nbsp;&nbsp;&nbsp; Total Investment (a+b)</td>
                                                                <td colspan="3">
                                                                    {!! Form::number('total_working_capital', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'total_working_capital','readonly']) !!}
                                                        ...
                                                        <div class="table-responsive">
                                                            ...
                                                            <table class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        {!! Form::number('finance_src_loc_equity_1', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'finance_src_loc_equity_1']) !!}
                                                                    ...
                                                                    <td>
                                                                        {!! Form::number('finance_src_loc_equity_2', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'finance_src_loc_equity_2']) !!}
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        {!! Form::number('finance_src_foreign_equity_1', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'finance_src_foreign_equity_1']) !!}
                                                                    ...
                                                                    <td>
                                                                        {!! Form::number('finance_src_foreign_equity_2', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'finance_src_foreign_equity_2']) !!}
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        {!! Form::number('finance_src_loc_loan_1', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number','id'=>'finance_src_loc_loan_1']) !!}
                                                                    ...
                                                                    <td rowspan="2" style="vertical-align: middle;text-align: center;">
                                                                        {!! Form::number('finance_src_total_loan', '', ['class' => 'form-control input-lg readOnly', 'size' =>'5x2','data-rule-maxlength'=>'240']) !!}
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        {!! Form::number('finance_src_foreign_loan_1', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number ','id'=>'finance_src_foreign_loan_1']) !!}
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3">
                                                                        {!! Form::number('finance_src_loc_total_financing_1', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number readOnly','id'=>'finance_src_loc_total_financing_5']) !!}
                                                                        {!! $errors->first('finance_src_loc_total_financing_1','<span class="help-block">:message</span>') !!}
                                                                    </td>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="public_utility_service[]" value="Land">Land
                                                        </label>
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="public_utility_service[]" value="Electricity">Electricity
                                                        </label>
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="public_utility_service[]" value="Gas">Gas
                                                        </label>
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="public_utility_service[]" value="Telephone">Telephone
                                                        </label>
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="public_utility_service[]" value="Road">Road
                                                        </label>
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="public_utility_service[]" value="Water">Water
                                                        </label>
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="public_utility_service[]" value="Drainage">Drainage
                                                        </label>
                                                        <label class="checkbox-inline">
                                                            <input type="checkbox" name="public_utility_service[]" value="Others" class="other_utility">Others
                                                        </label>
                                                        <label class="checkbox-inline">
                            ...
                            @if(ACL::getAccsessRight('LicenceApplication','-E-'))
                                ...
                                <button type="submit" class="btn btn-info btn-md pull-right"
                                        value="save" name="actionBtn">Submit
                                </button>
                            @endif
                            {!! Form::close() !!}
                        </div>
