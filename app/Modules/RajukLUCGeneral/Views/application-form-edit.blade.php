                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('applicant_name_en',!empty($appData->applicant_name_en) ?$appData->applicant_name_en: '',['class' => 'form-control input-md ','id'=>'applicant_name_en']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                {!! Form::label('applicant_name_bn',"Applicant's Name (Bangla):",['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('applicant_name_bn',!empty($appData->applicant_name_bn) ?$appData->applicant_name_bn: '',['class' => 'form-control input-md ','id'=>'applicant_name_bn']) !!}
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('land_owner_email',!empty($appData->land_owner_email) ?$appData->land_owner_email: '',['class' => 'form-control input-md email','id'=>'land_owner_email']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                {!! Form::label('land_owner_mobile',"Land Owner Mobile Number:",['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('land_owner_mobile',!empty($appData->land_owner_mobile) ?$appData->land_owner_mobile: '',['class' => 'form-control input-md bd_mobile','id'=>'land_owner_mobile']) !!}
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('present_address',!empty($appData->present_address) ?$appData->present_address: '',['class' => 'form-control input-md ','id'=>'present_address']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                {!! Form::label('nid_passport',"NID / Passport No.:",['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('nid_passport',!empty($appData->land_owner_mobile) ?$appData->land_owner_mobile: '',['class' => 'form-control input-md ','id'=>'nid_passport']) !!}
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('holding_no',!empty($appData->holding_no) ?$appData->holding_no: '',['class' => 'form-control input-md ','id'=>'holding_no']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#land_use').on('keydown', function (el) {
            ...
            let selected_value = '{{!empty($appData->land_use) ?$appData->land_use: ''}}'; // for callback
        ...
        $('#land_use').on('change', function (el) {
            ...
            let selected_value = '{{!empty($appData->land_use_sub_occupancy) ?json_encode($appData->land_use_sub_occupancy): ''}}'; // for callback
            let calling_id = $(this).attr('id'); // for callback
        ...
        $('#district_name').on('keydown', function (el) {
            ...
            let selected_value = '{{!empty($appData->district_name) ?$appData->district_name: ''}}'; // for callback
            let calling_id = $(this).attr('id'); // for callback
...
//                        var newInput = $('<label id="label_' + id + '"><br/><b>File: ' + fileNameArr[l - 1] + '</b></label>');
    ...
    function callbackResponseCheckBox(response, [calling_id, selected_value, element_id, element_name, dependent_section_id]) {
        var option = '';
        let jsonString = JSON.stringify(selected_value.replaceAll('&quot;',"'"));
        selected_value = JSON.parse(jsonString);
        ...
        if (response.responseCode === 200) {
            ...
            $.each(response.data, function (key, row) {
                ...
                if (selected_value.match(id)) {
                    option += '<label for="land_use_sub_occupancy_' + i + '"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" class="land_use_sub_occupancy" name="land_use_sub_occupancy[' + i + ']" id="land_use_sub_occupancy_' + i + '" value="' + id + '" checked>  <b>' +row[element_id]+'</b> '+ value + '  </label> ';
                } else {
                    console.log(id);
