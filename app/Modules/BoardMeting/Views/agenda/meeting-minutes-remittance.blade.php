...
<div style="text-align: center" class="text-center">
    ...
    <h4>{{$board_meeting_data->meting_number}}<sup>th</sup> Executive Council of BIDA Meeting Minutes</h4>
...
@foreach ($totalApplication as $appInfo)
    ...
    $applicatonData =  \App\Libraries\CommonFunction::getRemmitanceForMeetingMinutes($appInfo->process_id);
    ...
    <div style="page-break-after:always;">
        <div style="text-align: center" class="text-center">
            <span  style="font-weight: bold">Proposal {{$i++}} of {{$totalApplication->count()}}  {{$applicatonData->company_name}}	</span>
        </div>
        ...
        <table cellspacing="0" width="100%" aria-label="Detailed Report Data Table">
            ...
            <tr>
                ...
                <th style="border: 1px solid black;width: 45%"></th>
                <th style="border: 1px solid black;width: 5px"></th>
                <th ></th>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center; ">1</td>
                <td style="font-size: 15px">{{$getTableHeadingName[1]}}</td>
                <td style="border: 1px solid black;width: 10px;text-align: center;font-size: 15px" >:</td>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">2</td>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">3</td>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px"></td>
                <td style="font-size: 15px">{{$getTableHeadingName[4]}}</td>
                <td style="border: 1px solid black;width: 10px;text-align: center" >:</td>
                <td style="font-size: 15px">
                    <?php
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">4</td>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">5</td>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">6</td>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">7</td>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">8</td>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">9</td>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">10</td>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">11</td>
            ...
            <tr>
                <td style="border: 1px solid black;text-align: center;font-size: 15px">12</td>
                <td style="border: 1px solid black;width: 25px;font-size: 15px">{{$getTableHeadingName[14]}}</td>
                <td style="border: 1px solid black;width: 10px;text-align: center;font-size: 15px" >:</td>
                <td style="font-size: 15px">
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">13</td>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">14</td>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">15</td>
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">16</td>
                <td style="font-size: 15px">
            ...
            <tr>
                <td style="border: 1px solid black;width: 25px;text-align: center;font-size: 15px">17</td>
                <td style="border: 1px solid black;width: 25px;font-size: 15px">{{$getTableHeadingName[18]}}</td>
        ...
        <table width="100%" cellspacing="0" aria-label="Detailed Report Data Table">
            <thead>
            <tr>
                <th scope="col" >1</th>
        ...
        <table width="100%" cellspacing="0" aria-label="Detailed Report Data Table">
            ...
            <tr>
                ...
                <td style="font-size: 15px;">{{$appInfo->status_name}}</td>
                <td>Remarks</td>
                <td>{{$appInfo->bm_remarks}}</td>
            </tr>
            </tbody>
        </table>
    </div>
