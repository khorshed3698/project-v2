            ...
            <tr>
                ...
                <td style="">
                    ...
                    {{--@if(!empty($getWpnInfo->basic_local_amount) && $getWpnInfo->basic_local_amount != 0)--}}
                        {{--{{isset($getWpnInfo->basic_local_amount)?"Basic salary: BDT ". $getWpnInfo->basic_local_amount :''}}<br>--}}
                    {{--@endif--}}

                    {{--@if(!empty($getWpnInfo->house_local_amount) && $getWpnInfo->house_local_amount != 0)--}}
                        {{--{{isset($getWpnInfo->house_local_amount)?"House Accommodation: BDT ". $getWpnInfo->house_local_amount :''}}<br>--}}
                    {{--@endif--}}

                    {{--@if(!empty($getWpnInfo->conveyance_local_amount) && $getWpnInfo->conveyance_local_amount != 0)--}}
                        {{--{{isset($getWpnInfo->conveyance_local_amount)?"Conveyance arrangement: BDT". $getWpnInfo->conveyance_local_amount :''}}<br>--}}
                    {{--@endif--}}

                    {{--@if(!empty($getWpnInfo->ent_local_amount) && $getWpnInfo->ent_local_amount != 0)--}}
                        {{--{{isset($getWpnInfo->ent_local_amount)?"Entertainment: BDT". $getWpnInfo->ent_local_amount :''}}<br>--}}
                    {{--@endif--}}
                    {{--@if(!empty($getWpnInfo->overseas_local_amount) && $getWpnInfo->overseas_local_amount != 0)--}}
                        {{--{{isset($getWpnInfo->overseas_local_amount)?"Overseas allowance: BDT". $getWpnInfo->overseas_local_amount :''}}<br>--}}
                    {{--@endif--}}
                    {{--@if(!empty($getWpnInfo->medical_local_amount) && $getWpnInfo->medical_local_amount != 0)--}}
                        {{--{{isset($getWpnInfo->medical_local_amount)?"Medical allowance: BDT". $getWpnInfo->medical_local_amount :''}}<br>--}}
                    {{--@endif--}}
                    {{--@if(!empty($getWpnInfo->bonus_local_amount) && $getWpnInfo->bonus_local_amount != 0)--}}
                        {{--{{isset($getWpnInfo->bonus_local_amount)?"Annual Bonus: BDT". $getWpnInfo->bonus_local_amount :''}}--}}
                    {{--@endif--}}
