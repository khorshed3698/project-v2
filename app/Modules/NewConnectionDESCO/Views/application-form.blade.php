                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('authorized_person') ? 'has-error': ''}}">
                                                {!! Form::text('authorized_person','', ['placeholder' => 'Authorized Person',
                                               'class' => 'form-control input-md organization','id'=>'authorized_person']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('designation_authorized') ? 'has-error': ''}}">
                                                {!! Form::text('designation_authorized','', ['placeholder' => 'Designation of Authorized Person',
                                               'class' => 'form-control input-md organization','id'=>'designation_authorized']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('organization_name') ? 'has-error': ''}}">
                                                {!! Form::text('organization_name','', ['placeholder' => 'Organization Name',
                                               'class' => 'form-control input-md organization','id'=>'v']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('organization_type') ? 'has-error': ''}}">
                                               ...
                                               'class' => 'form-control input-md organization','id'=>'organization_type']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('ministry') ? 'has-error': ''}}">
                                               ...
                                               'class' => 'form-control input-md organization','id'=>'ministry']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('house_dag_no') ? 'has-error': ''}}">
                                                {!! Form::text('house_dag_no','', ['placeholder' => 'House/Dag Number',
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('plot_number') ? 'has-error': ''}}">
                                                {!! Form::text('plot_number','', ['placeholder' => 'Plot Number',
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('av_lane_number') ? 'has-error': ''}}">
                                                {!! Form::text('av_lane_number','', ['placeholder' => 'AV/LANE/Road Number ',
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('block_number') ? 'has-error': ''}}">
                                                {!! Form::text('block_number','', ['placeholder' => 'Block Number',
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('thana') ? 'has-error': ''}}">
                                                {!! Form::select('thana',[],'', ['placeholder' => 'Select from here',
                                               'class' => 'form-control input-md','id'=>'thana']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('mother_name') ? 'has-error': ''}}">
                                                {!! Form::text('section','', ['placeholder' => 'Section',
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('area') ? 'has-error': ''}}">
                                                {!! Form::select('area',[],'', ['placeholder' => 'Select From here',
                                               'class' => 'form-control input-md','id'=>'area']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('snd') ? 'has-error': ''}}">
                                                {!! Form::select('snd',[],'', [
                                               'class' => 'form-control input-md','id'=>'snd']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('bin') ? 'has-error': ''}}">
                                                {!! Form::text('post_office','', ['placeholder' => 'Post Office',
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('land_owner_name') ? 'has-error': ''}}">
                                                {!! Form::text('land_owner_name','', ['placeholder' => 'Land Owner Name ',
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('land_owner_father_name') ? 'has-error': ''}}">
                                                {!! Form::text('land_owner_father_name','', ['placeholder' => 'Land Owner\'s Father Name',
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('nid_number') ? 'has-error': ''}}">
                                                {!! Form::text('nid_number','', ['placeholder' => 'NID',
                                               'class' => 'form-control input-md onlyNumber','id'=>'nid_number']) !!}
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <button id="edit_nid"  type="button" class="btn btn-primary" style="display: none;"><i class="fa fa-edit"></i> Edit</button>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            ['class'=>'col-md-5']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('title_of_connection','', ['placeholder' => 'Title of the connection',
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('applicant_name') ? 'has-error': ''}}">
                                                {!! Form::text('applicant_name','', ['placeholder' => 'Name',
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('father_name') ? 'has-error': ''}}">
                                                {!! Form::text('father_name','', ['placeholder' => 'Father Name',
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            ['class'=>'col-md-5']) !!}
                                            <div class="col-md-7 {{$errors->has('mother_name') ? 'has-error': ''}}">
                                                {!! Form::text('mother_name','', ['placeholder' => 'Mother Name',
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('spouse_name') ? 'has-error': ''}}">
                                                {!! Form::text('spouse_name','', ['placeholder' => 'Spouse Name',
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('gender') ? 'has-error': ''}}">
                                                {!! Form::select('gender',['1@Male'=>'Male','2@Female'=>'Female'],'', ['placeholder' => 'Select',
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('etin') ? 'has-error': ''}}">
                                                {!! Form::text('etin','', ['placeholder' => 'E-TIN',
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('trade_license') ? 'has-error': ''}}">
                                                {!! Form::text('trade_license','', ['placeholder' => 'Trade License',
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 col-xs-12 ">
                                                {!! Form::file('signature', ['class'=>'form-control input-md required','flag'=>'img','id' => 'signature','onchange'=>"uploadDocument('preview_signature', this.id, 'validate_field_signature',1,'img') , imagePreview(this)"]) !!}
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('mobile') ? 'has-error': ''}}">
                                                {!! Form::text('mobile',Auth::user()->user_phone, ['placeholder' => 'Mobile',
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('email') ? 'has-error': ''}}">
                                                {!! Form::text('email',Auth::user()->user_email, ['placeholder' => 'Email','class' => 'form-control input-md email','id'=>'email']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        {!! Form::textarea('contact_address',  Auth::user()->road_no .  (!empty(Auth::user()->house_no) ? ', ' . Auth::user()->house_no : ''), ['class' => 'form-control input-md ', 'size' =>'5x2','data-rule-maxlength'=>'200', 'id'=>'contact_address', 'placeholder' => 'Address','maxlength'=>'200']) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('conn_type') ? 'has-error': ''}}">
                                                {!! Form::select('conn_type', [],'', ['placeholder' => 'Select One',
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            ['class'=>'col-md-5']) !!}
                                            <div class="col-md-7 {{$errors->has('conn_type') ? 'has-error': ''}}">
                                                {!! Form::text('load','', ['placeholder' => 'Load','class' => 'form-control input-md onlyNumber','id'=>'load']) !!}
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('phase') ? 'has-error': ''}}">
                                                {!! Form::select('phase', [],'', ['placeholder' => 'Select One',
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('voltage') ? 'has-error': ''}}">
                                                {!! Form::select('voltage', ['1'=>'230V','2'=>'400V'],'', ['placeholder' => 'Select One',
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('tariff_category') ? 'has-error': ''}}">
                                                {!! Form::select('tariff_category', [],'', ['placeholder' => 'Select One',
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 {{$errors->has('tariff') ? 'has-error': ''}}">
                                                {!! Form::select('tariff', [],'', ['class' => 'form-control input-md docloader','id'=>'tariff']) !!}
...
@include('LicenceApplication::fileupload-script')
...
<script src="{{ asset("assets/scripts/custom-js-stakeholder.js") }}"></script>
<script>
    ...
    $(document).ready(function () {
        ...
        $('#application_type').on('keydown', function (el) {
            ...
            var selected_value = 'Organization'; // for callback
    ...
    function callbackResponse(response, [calling_id, selected_value, element_id, element_name]) {
        ...
        if (response.responseCode === 200) {
            $.each(response.data, function (key, row) {
                ...
                if (selected_value.split('@')[0] == 'Organization') {
