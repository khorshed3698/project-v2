                                                            ...
                                                            <td>
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            {!! Form::radio('profit_loss',"Profit",null, array('id'=>'profit_chk', 'class'=>"float-left margin_left_110")) !!}
                                                                            {!! Form::label('profit_chk','Profit',[ 'id'=> 'profit_chk', 'class'=> "float-left margin_left_10"]) !!}
                                                                        </td>
                                                                        <td>
                                                                            {!! Form::radio('profit_loss',"Loss",null, array('id'=>'loss_chk', 'class'=>"float-left margin_left_40")) !!}
