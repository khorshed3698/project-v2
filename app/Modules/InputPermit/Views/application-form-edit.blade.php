            ...
            <div class="box-body">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(array('url' => 'waiver-condition-7/store','method' => 'post','id' => 'WaiverForm','enctype'=>'multipart/form-data',
                                                                ...
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                {!! Form::radio('profit_loss',"Profit",$appInfo->profit_loss == 'Profit' ? 'Profit' : null , array('id'=>'profit_chk', 'class'=>"float-left margin_left_110")) !!}
                                                                                {!! Form::label('profit_chk','Profit',[ 'id'=> 'profit_chk', 'class'=> "float-left margin_left_10"]) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::radio('profit_loss',"Loss",$appInfo->profit_loss == 'Loss' ? 'Loss' : null, array('id'=>'loss_chk', 'class'=>"float-left margin_left_40")) !!}
