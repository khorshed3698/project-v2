...
namespace App\Modules\SBaccount\Controllers;
...
class SBaccountController extends Controller
{
    ...
    {
        $this->process_type_id = 126;
        $this->aclName = 'SBaccount';
    }
    ...
    {
        if (!$request->ajax()) {
            return 'Sorry! this is a request without proper way. [SBAO-1001]';
        }
        ...
        try {
            ...
            $public_html = strval(view("SBaccount::application-form", compact('process_type_id', 'viewMode', 'mode', 'document', 'token', 'service_url', 'divisions','district','payment_config','basicAppInfo')));
