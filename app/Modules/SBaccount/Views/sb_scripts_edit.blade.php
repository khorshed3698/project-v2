...
<script>
    ...
    $(document).ready(function () {
        ...
        $(function () {
            ...
            $('#present_country').keydown()
            $('#permanent_country').keydown()
            $('#office_country').keydown()
            $('#entity_type').keydown()
            $('#identification_country').keydown()
        ...
        $('#entity_type').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->entity_type) ?$appData->entity_type: ''}}';
        ...
        $('#account_type').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->account_type) ?$appData->account_type: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
        ...
        $('#customer_category').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->customer_category) ?$appData->customer_category: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
        ...
        $('#customer_category').on('change', function (el) {
            ...
            var selected_value = '{{!empty($appData->customer_sub_category) ?$appData->customer_sub_category: ''}}';
        ...
        $('#account_operation').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->account_operation) ?$appData->account_operation: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "code"; //dynamic id for callback
            var element_name = "name"; //dynamic name for callback
            var data = '';
        ...
        $('#currency').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->currency) ?$appData->currency: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
        ...
        $('#nature_of_organization').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->nature_of_organization) ?$appData->nature_of_organization: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "id"; //dynamic id for callback
        ...
        $('#type_of_business').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->type_of_business) ?$appData->type_of_business: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "id"; //dynamic id for callback
        ...
        $('#nature_of_bus').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->nature_of_bus) ?$appData->nature_of_bus: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "id"; //dynamic id for callback
            var element_name = "name"; //dynamic name for callback
            var data = '';
        ...
        $('#sex').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->sex) ?$appData->sex: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "code"; //dynamic id for callback
        ...
        $('#nationality_personal').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->nationality_personal) ?$appData->nationality_personal: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
        ...
        $('#registration_country').on('keydown', function (el) {
            ...
            var e = $(this);
            var api_url = "{{$service_url}}/info/nationality";
            var selected_value = '{{!empty($appData->registration_country) ?$appData->registration_country: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "nationalityCode"; //dynamic id for callback
            var element_name = "nationalityName"; //dynamic name for callback
            var data = '';
        ...
        $('#present_country').on('keydown', function (el) {
            var key = el.which;
            if (typeof key !== "undefined") {
                return false;
            }
            ...
            var selected_value = '{{!empty($appData->present_country) ?$appData->present_country: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "code"; //dynamic id for callback
            var element_name = "name"; //dynamic name for callback
            var data = '';
        ...
        $('#office_country').on('keydown', function (el) {
            var key = el.which;
            if (typeof key !== "undefined") {
                return false;
            }
            ...
            var e = $(this);
            var api_url = "{{$service_url}}/info/country";
            var selected_value = '{{!empty($appData->office_country) ?$appData->office_country: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "code"; //dynamic id for callback
            var element_name = "name"; //dynamic name for callback
            var data = '';
        ...
        $('#permanent_country').on('keydown', function (el) {
            var key = el.which;
            if (typeof key !== "undefined") {
                return false;
            }
            ...
            var e = $(this);
            var api_url = "{{$service_url}}/info/country";
            var selected_value = '{{!empty($appData->permanent_country) ?$appData->permanent_country: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "code"; //dynamic id for callback
            var element_name = "name"; //dynamic name for callback
            var data = '';
        ...
        $('#identification_country').on('keydown', function (el) {
            var key = el.which;
            if (typeof key !== "undefined") {
                return false;
            }
            ...
            var e = $(this);
            var api_url = "{{$service_url}}/info/country";
            var selected_value = '{{!empty($appData->identification_country) ?$appData->identification_country: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "code"; //dynamic id for callback
            var element_name = "name"; //dynamic name for callback
            var data = '';
        ...
        $('#ac_nature').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->ac_nature) ?$appData->ac_nature: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "code"; //dynamic id for callback
            var element_name = "name"; //dynamic name for callback
            var data = '';
        ...
        $('#bank_district').on('change', function (el) {
            ...
            var selected_value = '{{!empty($appData->bank_branch) ?$appData->bank_branch: ''}}'; // for callback
        ...
        $('#resident').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->resident) ?$appData->resident: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "code"; //dynamic id for callback
        ...
        $('#occupation_code').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->occupation_code) ?$appData->occupation_code: ''}}'; // for callback // for callback
            var calling_id = $(this).attr('id'); // for callback
        ...
        $('#identification_doc').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->identification_doc) ?$appData->identification_doc: ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "code"; //dynamic id for callback
            var element_name = "type"; //dynamic name for callback
            var data = '';
    ...
    function callbackResponseCCategory(response, [calling_id, selected_value, element_id, element_name, data]) {
        ...
        if (response.responseCode === 200) {
            ...
            $.each(response.data, function (key, row) {
                if (data == '' || data == null) {
                    var id = row[element_id] + '@' + row[element_name] + '@' + row['subCategoryCode'] + '@' + row['subCategoryName'];
                } else {
                    var id = row[element_id] + '@' + row[data] + '@' + row[element_name];
                }
