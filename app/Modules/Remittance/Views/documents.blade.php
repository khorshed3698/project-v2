...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <table aria-label="Detailed Necessary document" class="table table-striped table-bordered display" width="100%">
                <thead>
                <tr class="d-none">
                                ...
                                @if($viewMode != 'on')
                                    <a class='btn btn-xs btn-primary' data-toggle='modal'
                                       ...
                                       data-action='{{ url('process/recent-attachment/'. \App\Libraries\Encryption::encodeId($row->id)) }}'>
                                        <i class='fa fa-file-pdf-o'></i> Recent attachment</a>
                                @endif
                            </td>
                            <td colspan="2">
                                ...
                                @if($row->additional_field == 1)
                                    <table aria-label="Detailed additional field">
                                        <tr class="d-none">
