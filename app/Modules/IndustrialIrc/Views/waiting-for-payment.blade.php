...
@section('content')
            ...
            <div class="box">
                <div id="paymentPanel" class="panel panel-default" style="display: none;">
                    <div class="panel-body">
                        {!! Form::open(array('url' => '/licence-applications/ccie/payment','method' => 'post','id' => 'NameClearanceForm','role'=>'form','enctype'=>'multipart/form-data')) !!}
    ...
    <script type="text/javascript">
        ...
        function checkCcieStatus() {
            var app_id = $('#enc_app_id').val();

            $.ajax({
                url: '/licence-applications/ccie/check-payment-info',
                type: "POST",
                data: {
                    enc_app_id: app_id
                },
                ...
                success: function (response) {
                    if (response.responseCode == 1) {
                        if (response.status == -2 || response.status == -3) {
                            ...
                            myVar = setTimeout(checkCcieStatus, 5000);
        ...
        $(document).ready(function () {
            checkCcieStatus();
            countDownTimer('Connecting to CCIE Server', 'Please wait to connect...', '2:02');
        });
