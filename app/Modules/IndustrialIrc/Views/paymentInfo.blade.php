<div class="form-group clearfix">
    <div class="row">
        <div class="col-md-6 {{$errors->has('sfp_contact_name') ? 'has-error': ''}}">
            ...
            <div class="col-md-7">
                {!! Form::text('sfp_contact_name', $appData->organization_name_en, ['class' => 'form-control input-md required','readonly']) !!}
        ...
        <div class="col-md-6 {{$errors->has('sfp_contact_email') ? 'has-error': ''}}">
            ...
            <div class="col-md-7">
                {!! Form::email('sfp_contact_email', $appData->organization_email, ['class' => 'form-control input-md email required','readonly']) !!}
...
<div class="form-group clearfix">
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="col-md-7">
                {!! Form::text('sfp_contact_phone', $appData->organization_mobile, ['class' => 'form-control input-md phone_or_mobile required','readonly']) !!}
...
<div class="form-group clearfix">
    <div class="row">
        <div class="col-md-6">
             {!! Form::label('brep_fee','Industriallrc Fee',['class'=>'col-md-5 text-left']) !!}
            <div class="col-md-7">
                <input name="brep_fee" class="form-control input-md" value="{{$applyPaymentfee}}" readonly>
            </div>
        </div>
        <div class="col-md-6">
...
<div class="form-group clearfix">
    <div class="row">
        <?php
            $totalamount = number_format($applyPaymentfee + $ServicepaymentData->amount,2);
        ?>
         <div class="col-md-6">
