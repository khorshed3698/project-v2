...
//                        var newInput = $('<label id="label_' + id + '"><br/><b>File: ' + fileNameArr[l - 1] + '</b></label>');
    ...
    $(document).ready(function () {
        ...
        $(function () {
            token = "{{$token}}";
            tokenUrl = '/bfscd-noc-proposed/get-refresh-token';
        ...
        $('#safety_firm').on('keydown', function (el) {
            ...
            let e = $(this);
            let api_url = "{{$bfscd_proposed_service_url}}/info/safety-firms";
            let selected_value = '{{!empty($appData->safety_firm) ? $appData->safety_firm : ''}}'; // for callback
        ...
        $('#owner_division').on('keydown', function (el) {
            ...
            $(this).after('<span class="loading_data">Loading...</span>');
            let e = $(this);
            let api_url = "{{$bfscd_proposed_service_url}}/info/divisions";
            let selected_value = '{{!empty($appData->owner_division) ? $appData->owner_division: ''}}'; // for callback
            let calling_id = $(this).attr('id');// for callback
            let element_id = "id";//dynamic id for callback
            let element_name = "value";//dynamic name for callback
            let element_calling_id = "";//dynamic name for callback
        ...
        $("#owner_division").on("change", function (el) {
            ...
            if (owner_division_id) {
                let e = $(this);
                let api_url = "{{$bfscd_proposed_service_url}}/info/districts/" + owner_division_id;
                let selected_value = '{{!empty($appData->owner_district) ? $appData->owner_district: ''}}'; // for callback
                let calling_id = $(this).attr('id');// for callback
        ...
        $("#owner_district").on("change", function (el) {
            ...
            if (owner_district_id) {
                let e = $(this);
                let api_url = "{{$bfscd_proposed_service_url}}/info/thanas/" + owner_district_id;
                let selected_value = '{{!empty($appData->owner_thana) ? $appData->owner_thana: ''}}'; // for callback
                let calling_id = $(this).attr('id');// for callback
        ...
        $('#proposed_building_division').on('keydown', function (el) {
            ...
            let e = $(this);
            let api_url = "{{$bfscd_proposed_service_url}}/info/divisions";
            let selected_value = '{{!empty($appData->proposed_building_division) ? $appData->proposed_building_division: ''}}'; // for callback
            let calling_id = $(this).attr('id');// for callback
            let element_id = "id";//dynamic id for callback
            let element_name = "value";//dynamic name for callback
            let element_calling_id = "";//dynamic name for callback
        ...
        $("#proposed_building_division").on("change", function (el) {
            ...
            if (proposed_building_division_id) {
                let e = $(this);
                let api_url = "{{$bfscd_proposed_service_url}}/info/districts/" + proposed_building_division_id;
                let selected_value = '{{!empty($appData->proposed_building_district) ? $appData->proposed_building_district: ''}}'; // for callback
                let calling_id = $(this).attr('id');// for callback
        ...
        $("#proposed_building_district").on("change", function (el) {
            ...
            if (proposed_building_district_id) {
                let e = $(this);
                let api_url = "{{$bfscd_proposed_service_url}}/info/thanas/" + proposed_building_district_id;
                let selected_value = '{{!empty($appData->proposed_building_thana) ? $appData->proposed_building_thana: ''}}'; // for callback
                let calling_id = $(this).attr('id');// for callback
        ...
        $('#council').on('keydown', function (el) {
            ...
            $(this).after('<span class="loading_data">Loading...</span>');
            let e = $(this);
            let api_url = "{{$bfscd_proposed_service_url}}/info/councils";
            let selected_value = '{{!empty($appData->council) ? $appData->council: ''}}'; // for callback
            let calling_id = $(this).attr('id');// for callback
            let element_id = "Id";//dynamic id for callback
            let element_name = "Value";//dynamic name for callback
            let element_calling_id = "";//dynamic name for callback
        ...
        $('#city_corporation').on('keydown', function (el) {
            ...
            $(this).after('<span class="loading_data">Loading...</span>');
            let e = $(this);
            let api_url = "{{$bfscd_proposed_service_url}}/info/city-corporations";
        ...
        $('.building_construction').on('keydown', function (el) {
            ...
            $(this).after('<span class="loading_data">Loading...</span>');
            let e = $(this);
            let api_url = "{{$bfscd_proposed_service_url}}/info/building-creating-types";
        ...
        $('.building_use').on('keydown', function (el) {
            ...
            $(this).after('<span class="loading_data">Loading...</span>');
            let e = $(this);
            let api_url = "{{$bfscd_proposed_service_url}}/info/building-classes";
            let selected_value = $(this).attr("data-value"); // for callback
            let calling_id = $(this).attr('id');// for callback
            let element_id = "id";//dynamic id for callback
            let element_name = "bn_name";//dynamic name for callback
        ...
        $('.building_use_type').on('keydown', function (el) {
            ...
            $(this).after('<span class="loading_data">Loading...</span>');
            let e = $(this);
            let api_url = "{{$bfscd_proposed_service_url}}/info/building-usages";
            let selected_value = $(this).attr("data-value"); // for callback
            let calling_id = $(this).attr('id');// for callback
            let element_id = "id";//dynamic id for callback
            let element_name = "bn_name";//dynamic name for callback
        ...
        $('.floor').on('keydown', function (el) {
            ...
            $(this).after('<span class="loading_data">Loading...</span>');
            let e = $(this);
            let api_url = "{{$bfscd_proposed_service_url}}/info/floors";
            let selected_value = $(this).attr("data-value"); // for callback
            let calling_id = $(this).attr('id');// for callback
            let element_id = "id";//dynamic id for callback
            let element_name = "bn_name";//dynamic name for callback
        ...
        $('.electric_line').on('keydown', function (el) {
            ...
            $(this).after('<span class="loading_data">Loading...</span>');
            let e = $(this);
            let api_url = "{{$bfscd_proposed_service_url}}/info/overhead-electric-line";
            let selected_value = $(this).attr("data-value"); // for callback
            let calling_id = $(this).attr('id');// for callback
            let element_id = "id";//dynamic id for callback
            let element_name = "value";//dynamic name for callback
        ...
        $('#nearby_division').on('keydown', function (el) {
            ...
            let e = $(this);
            let api_url = "{{$bfscd_proposed_service_url}}/info/divisions";
            let selected_value = '{{!empty($appData->nearby_division) ? $appData->nearby_division : ''}}'; // for callback
            let calling_id = $(this).attr('id');// for callback
            let element_id = "id";//dynamic id for callback
            let element_name = "value";//dynamic name for callback
            let element_calling_id = "";//dynamic name for callback
        ...
        $("#nearby_division").on("change", function (el) {
            ...
            if (nearby_division_id) {
                let e = $(this);
                let api_url = "{{$bfscd_proposed_service_url}}/info/districts/" + nearby_division_id;
                let selected_value = '{{!empty($appData->nearby_district) ? $appData->nearby_district : ''}}'; // for callback
                let calling_id = $(this).attr('id');// for callback
        ...
        $("#nearby_district").on("change", function (el) {
            ...
            if (nearby_district_id) {
                let e = $(this);
                let api_url = "{{$bfscd_proposed_service_url}}/info/thanas/" + nearby_district_id;
                let selected_value = '{{!empty($appData->nearby_tahan) ? $appData->nearby_tahan : ''}}'; // for callback
                let calling_id = $(this).attr('id');// for callback
        ...
        $("#nearby_tahan").on("change", function (el) {
            ...
            if (nearby_tahan_id) {
                let e = $(this);
                let api_url = "{{$bfscd_proposed_service_url}}/info/fire-stations/" + nearby_district_id + "/" + nearby_tahan_id;
                let selected_value = '{{!empty($appData->nearby_fire_station) ? $appData->nearby_fire_station : ''}}'; // for callback
                let calling_id = $(this).attr('id');// for callback
