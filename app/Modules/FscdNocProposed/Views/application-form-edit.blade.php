                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            {!! Form::text('building_height['.$inc.']',!empty($appData->building_height[$key]) ? $appData->building_height[$key] : '',['class' => 'form-control input-md onlyNumber required ','id'=>"building_height_$inc"]) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
...
@include('FscdNocProposed::noc-proposed-scripts-edit')