                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <table class="table table-striped table-bordered" cellspacing="0" width="100%" aria-label="Detailed Info">
                                        ...
                                        <tr>
                                            ...
                                            {{-- <td>Direct Export : {{ (!empty($appInfo->direct_export)) ? $appInfo->total_sales :''  }}</td>
                                            <td>Deemed Export : {{ (!empty($appInfo->deemed_export)) ? $appInfo->total_sales :''  }}</td> --}}
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%" aria-label="Detailed Info">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="text-center" scope="col">Price (BD)</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <table class="table table-striped table-bordered" cellspacing="0"
                                        ...
                                        <tr>
                                            <th colspan="7" scope="col">As per Local Procurement/ Collection</th>
                                        </tr>
                                        <tr>
                                            <td>Description of Machine</td>
                                            <td>Unit of Quantity</td>
