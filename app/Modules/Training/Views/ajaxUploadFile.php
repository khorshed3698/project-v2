...
$yFolder = "uploads/training/uploads/" . date("Y");
...
$ym = date("Y") . "/" . date("m") . "/";
$ym1 = "uploads/training/uploads/" . date("Y") . "/" . date("m");
if (!file_exists($ym1)) {
    mkdir($ym1, 0777, true);
...
//          $actual_image_name = $session_id."_".date("H_i_s").".".$ext;
                $actual_image_name = uniqid("BSCIC_OPN_", true) . "." . $ext;
