        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <div class="pull-left">
                        <b> <i class="fa fa-list"></i> {!! trans('Training::messages.evaluation') !!} </b>
                    </div>
                    <div class="pull-right">
                        @if(TrACL::getAccsessRight('TrainingEvaluation','A'))
                            <a class="" href="{{ url('training/evaluation/create') }}">
                                {!! Form::button('<i class="fa fa-plus"></i> <b>'.trans('Training::messages.evaluation').'</b> </b>', array('type' => 'button', 'class' => 'btn btn-default')) !!}
                            </a>
                        @endif
                    </div>
    ...
    <script>
        ...
        $('#list').DataTable({
            ...
            ajax: {
                ...
                url: '/training/evaluation/get-schedule-list',
                method: 'get',
            },
            columns: [
