                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-10 {{ $errors->has('course_description') ? 'has-error' : '' }}">
                                            {!! Form::textarea('course_description', $tr_data->course_description, ['class' => 'form-control input-md required']) !!}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('is_active') ? 'has-error' : '' }}">
                                            ...
                                            <img src="{{ asset('uploads/training/course/'.$tr_data->course_image) }}"
                                                class="course_image_thumbnail" alt="">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-8 {{ $errors->has('is_active') ? 'has-error' : '' }}">
                                            <label>{!! Form::radio('is_active', '1',$tr_data->is_active == 1 ? 'checked' : '', ['class' => 'required', 'id' => 'yes']) !!} Active</label>
                                            <label>{!! Form::radio('is_active', '0',$tr_data->is_active == 0 ? 'checked' : '', ['class' => ' required', 'id' => 'no']) !!} Inactive</label>
