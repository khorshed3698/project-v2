...
@section('content')
            ...
            <div class="box">
                <div id="paymentPanel" class="panel panel-default" style="display: none;">
                    <div class="panel-body">
                        {!! Form::open(array('url' => '/new-connection-bpdb/payment','method' => 'post','id' => 'NameClearanceForm','role'=>'form','enctype'=>'multipart/form-data')) !!}
    ...
    <script type="text/javascript">
        ...
        function checkBpdbStatus() {
            ...
            $.ajax({
                url: '/new-connection-bpdb/check-payment-info',
                type: "POST",
                data: {
                    enc_app_id: app_id
                },
        ...
        $(document).ready(function () {
            checkBpdbStatus();
            countDownTimer('Connecting to BPDB Server', 'Please wait to connect...', '2:02');
        });
    </script>
