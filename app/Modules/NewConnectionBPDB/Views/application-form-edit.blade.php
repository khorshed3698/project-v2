        ...
        <div class="box" id="inputForm">
            <div class="box-body">
                ...
                <div class="panel panel-primary">
                    ...
                    <input type="hidden" name="bpdb_traking_num"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-md-offset-3">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                Type','1'=>'Personal','2'=>'Organization'], $appData->application_type,
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6" id="connectionName">
                                                ...
                                                <div
                                                        class="col-md-7 ">
                                                    {!! Form::text('connection_name', $appData->connection_name,['class'
                                            ...
                                            <div class="col-md-6" id="organizationName">
                                                ...
                                                <div
                                                    ...
                                                    $appData->organization_name,['class' => 'form-control
                                                    input-sm']) !!}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6" id="applicant_spouse">
                                                ...
                                                ['class'=>'col-md-5']) !!}
                                                <div
                                                        class="col-md-7 {{$errors->has('applicant_spouse_name') ? 'has-error': ''}}">
                                                    {!! Form::text('applicant_spouse_name',
                                                    $appData->applicant_spouse_name,['class' => 'form-control input-sm']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group" style="">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div
                                                        class="col-md-7 {{$errors->has('applicant_name_english') ? 'has-error': ''}}">
                                                    {!! Form::text('applicant_name_english',
                                                    $appData->applicant_name_english,['class' => 'form-control
                                                    input-sm','id'=>'applicant_name_english']) !!}
                                                    {!! $errors->first('applicant_name_english','<span
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('nation_id', $appData->nation_id,['class' =>
                                                    'form-control input-sm onlyNumber']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group" style="">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div
                                                        class="col-md-7">
                                                    {!! Form::text('applicant_name_bangla',
                                                    $appData->applicant_name_bangla,['class' => 'form-control
                                                    input-sm']) !!}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('applicant_passport_no',
                                                    $appData->applicant_passport_no,['class' => 'form-control input-sm']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group" style="">
                                        <div class="row">
                                            <div class="col-md-6" id="app_father_name">
                                                ...
                                                !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('father_name', $appData->father_name,['class' =>
                                                    'form-control input-sm']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6" id="designation">
                                                ...
                                                <div
                                                        class="col-md-7">
                                                    {!! Form::text('authorized_person_designation',
                                                    $appData->authorized_person_designation,['class' => 'form-control
                                                    input-sm']) !!}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div
                                                        class="col-md-7">
                                                    {!! Form::text('applicant_mobile_no',
                                                    $appData->applicant_mobile_no,['class' => 'form-control input-sm mobile
                                                    onlyNumber']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group" style="">
                                        <div class="row">
                                            <div class="col-md-6" id="app_mother_name">
                                                ...
                                                !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('mother_name', $appData->mother_name,['class' =>
                                                    'form-control input-sm']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                Sex','male'=>'Male','female'=>'Female'], $appData->sex, ['class' =>
                                                'form-control']) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            !!}
                                            <div class="col-md-7">
                                                <div class="datepickerDob input-group date" data-date-format="dd-mm-yyyy">
                                                    {!! Form::text('date_of_birth', $appData->date_of_birth,['class' =>
                                                    'form-control input-sm']) !!}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                !!}
                                                <span style="color:#993333;">[N.B. Supported file extension is png,jpg,jpeg.Max size less than 150KB.]</span>
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::label('signature','Signature :', ['class'=>'col-md-5 required-star
                                            ']) !!}
                                            <div class="col-md-7">
                                                <input type="file" name="signature" id="signature" flag="img"
                                ...
                                <div class="form-group" style="">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('house_no', $appData->house_no,['class' => 'form-control
                                                input-sm','id'=>'house_no']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            {!! Form::label('lane_no','Lane/Road No', ['class'=>'col-md-5 ']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('lane_no', $appData->lane_no,['class' => 'form-control
                                                input-sm','id'=>'lane_no']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group" style="">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('union', $appData->union,['class' => 'form-control
                                                input-sm']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('block', $appData->block,['class' => 'form-control
                                                input-sm']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group" style="">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('district', [],$appData->district,['placeholder' =>
                                                'Select One',
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('post_code', $appData->post_code,['class' =>
                                                'form-control input-sm onlyNumber','id'=>'post_code']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group" style="">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('thana', [], $appData->thana, ['placeholder' => 'Select
                                                One',
                                                'class' => 'form-control input-md']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('email', $appData->email,['class' => 'form-control
                                                input-sm email']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group" style="">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            !!}
                                            <div class="col-md-7 {{$errors->has('permanet_house_no') ? 'has-error': ''}}">
                                                {!! Form::text('permanet_house_no', $appData->permanet_house_no,['class'
                                                => 'form-control input-sm']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            {!! Form::label('lane_no','Lane/Road No', ['class'=>'col-md-5']) !!}
                                            <div class="col-md-7 {{$errors->has('permanet_lane_no') ? 'has-error': ''}}">
                                                {!! Form::text('permanet_lane_no', $appData->permanet_lane_no,['class'
                                                => 'form-control input-sm']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group" style="">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            !!}
                                            <div class="col-md-7">
                                                {!! Form::text('permanet_union', $appData->permanet_union,['class' =>
                                                'form-control input-sm']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            !!}
                                            <div class="col-md-7">
                                                {!! Form::text('permanet_block', $appData->permanet_block,['class' =>
                                                'form-control input-sm ']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group" style="">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div
                                                    class="col-md-7">
                                                {!! Form::text('permanet_post_code',
                                                $appData->permanet_post_code,['class' => 'form-control input-sm
                                                onlyNumber']) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                One',
                                                'class' => 'form-control input-md','id'=>'permanet_thana']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            {!! Form::label('permanet_email','Email', ['class'=>'col-md-5']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('permanet_email', $appData->permanet_email,['class' =>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class=" col-md-6" style="font-size: 17px;">
                                            <div class="col-md-offset-5 col-md-7">
                                                {!! Form::checkbox('same_as_mailing',1,(isset($appData->same_as_mailing)
                                                == 1 ? true : false), array('id'=>'same_as_mailing',
                                                'onclick'=>'samaAsMailingFunction()')) !!}
                                ...
                                <div class="form-group" style="">
                                    <div class="row">
                                        <div class="col-md-6">
                                            {!! Form::label('connection_house_no','House/Plot No', ['class'=>'col-md-5
                                            ']) !!}
                                            <div
                                                    class="col-md-7 ">
                                                {!! Form::text('connection_house_no',
                                                $appData->connection_house_no,['class' => 'form-control input-sm
                                                ']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="form-group" style="">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div
                                                    class="col-md-7">
                                                {!! Form::text('connection_lane_no',
                                                $appData->connection_lane_no,['class' => 'form-control
                                                input-sm']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                ...
                                <div class="form-group" style="">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div
                                                    class="col-md-7">
                                                {!! Form::text('connection_union', $appData->connection_union,['class'
                                                => 'form-control input-sm']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('esu', [],'', ['placeholder' => 'Select One',
                                                'class' => 'form-control input-md']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group" style="">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div
                                                    class="col-md-7">
                                                {!! Form::text('connection_block', $appData->connection_block,['class'
                                                => 'form-control input-sm']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            text-left']) !!}
                                            <div class="col-md-7">
                                                {!! Form::select('connection_area', ['1'=>'Connection
                                                Area'],$appData->connection_area, ['placeholder' => 'Select One',
                                                'class' => 'form-control input-md']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group" style="">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div
                                                    class="col-md-7">
                                                {!! Form::text('connection_post_code',
                                                $appData->connection_post_code,['class' => 'form-control input-sm
                                                onlyNumber']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div
                                                    class="col-md-7">
                                                {!! Form::text('connection_mobile_no',
                                                $appData->connection_mobile_no,['class' => 'form-control input-sm mobile
                                                onlyNumber']) !!}
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class=" col-md-12">
                                            <table class="table table-bordered table-hover" id="loadDetails">
                                                ...
                                                <tbody>
                                                @if(count($appData->description_of_load) > 0)
                                                    <?php $inc = 0; ?>
                                                    @foreach($appData->description_of_load as $key => $value)
                                                        <?php
                                                        //dump($appData->description_of_load[$key]);
                                                        //dump($appData->description_of_load[0]);
                                                        $lkey = ($key + 1);
                                                        ?>
                                                        <tr id="loadDetailsRow{{$inc}}">
                                                            <td>{!!
                                                            Form::select('description_of_load[]',[],$appData->description_of_load[$key],['class'
                                                            => 'form-control input-md description_of_load
                                                            required','placeholder' => 'Select One',
                                                            'id'=>'description_of_load_'.$lkey,'data-value'=>$value])
                                                            !!}
                                                                {!! $errors->first('','<span
                                                                    class="help-block">:message</span>') !!}</td>

                                                            <td>{!!
                                                            Form::select('load_per_item[]',[],$appData->load_per_item[$key],['class'
                                                            =>
                                                            'form-control input-md load_per_item
                                                            required','placeholder' => 'Select One',
                                                            'id'=>'load_per_item_'.$lkey,'data-value'=>$appData->load_per_item[$key]])
                                                            !!}
                                                                {!! $errors->first('','<span
                                                                    class="help-block">:message</span>') !!}</td>
                                                            <td> {!!
                                                            Form::text('no_of_item[]',$appData->no_of_item[$key],['class'
                                                            => 'col-md-7 form-control input-md no_of_item onlyNumber
                                                            required','placeholder' => '', 'id'=>'no_of_item_'.$lkey])
                                                            !!}
                                                            </td>
                                                            <td> {!!
                                                            Form::text('total_load[]',$appData->total_load[$key],['class'
                                                            => 'col-md-7 form-control input-md total_load','placeholder'
                                                            => '', 'id'=>'total_load_'.$lkey,'readonly']) !!}</td>
                                                            <td style="vertical-align: middle; text-align: center">
                                                                <?php if ($inc == 0) { ?>
                                                                <a class="btn btn-sm btn-primary addTableRows"
                                                                   onclick="addTableRowbpdb('loadDetails', 'loadDetailsRow0');"><i
                                                                            class="fa fa-plus"></i></a>
                                                                <?php } else { ?>
                                                                @if($viewMode != 'on')
                                                                    <a href="javascript:void(0);"
                                                                       class="btn btn-sm btn-danger removeRow"
                                                                       onclick="removeTableRow('loadDetails','loadDetailsRow{{$inc}}');">
                                                                        <i class="fa fa-times"
                                                ...
                                                @else
                                                    <tr id="loadDetailsRow">
                                                        <td>{!!
                                                            Form::select('description_of_load[]',$descriptionLoad,null,['class'
                                                            => 'form-control input-md description_of_load','placeholder'
                                                            => 'Select One', 'id'=>'description_of_load_1']) !!}
                                                            {!! $errors->first('','<span
                                                                class="help-block">:message</span>') !!}</td>
                                                        <td> {!! Form::text('load_per_item[]','',['class' => 'col-md-7
                                                            form-control input-md load_per_item
                                                            onlyNumber','placeholder' => '', 'id'=>'load_per_item_1'])
                                                            !!}</td>
                                                        <td> {!! Form::text('no_of_item[]','',['class' => 'col-md-7
                                                            form-control input-md no_of_item onlyNumber','placeholder'
                                                            => '', 'id'=>'no_of_item_1']) !!}</td>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#permanet_district').on('keydown', function (el) {
            ...
            var e = $(this);
            var api_url = "{{$bpdb_service_url}}/district";
            var selected_value = '{{isset($appData->permanet_district) ? $appData->permanet_district : ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "DIST_CODE"; //dynamic id for callback
            var element_name = "DIST_DESC"; //dynamic name for callback
            var data = '';
        ...
        $("#permanet_district").on("change", function () {
            ...
            if (districtId) {
                var e = $(this);
                var api_url = "{{$bpdb_service_url}}/thana" + '/' + districtId;
                var selected_value = '{{isset($appData->permanet_thana) ? $appData->permanet_thana : ''}}'; // for callback
                var calling_id = $(this).attr('id');
        ...
        $("#connection_district").on("change", function () {
            ...
            if (checkBox == true) {
                if (document_onload_status == 1) {
                    selected_value = '{{isset($appData->connection_thana) ? $appData->connection_thana : ''}}';
                } else {
        ...
        $('#bpdb_zone').on('keydown', function (el) {
            ...
            var selected_value = '{{isset($appData->bpdb_zone) ? $appData->bpdb_zone : ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
        ...
        $('#connection_area').on('keydown', function (el) {
            ...
            var selected_value = '{{isset($appData->connection_area) ? $appData->connection_area : ''}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
        ...
        $('.description_of_load ').on('keydown', function (el) {
            ...
            var calling_id = this.id; // for callback
        ...
        $(document).on('change', ".description_of_load", function () {
            ...
            if (desc_load_id) {
                ...
                var selected_value = $("#load_per_item_" + d_id).attr("data-value");// for callback
        ...
        $("#bpdb_zone").on("change", function () {
            ...
            if (bpdbZone) {
                ...
                var selected_option = '{{isset($appData->esu) ? $appData->esu : ''}}'; // for callback
                var selected_value = selected_option.replace('amp;', '');
                var calling_id = $(this).attr('id');
