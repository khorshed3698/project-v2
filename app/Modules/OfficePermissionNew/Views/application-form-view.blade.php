...
{{--                    </a>--}}
                    ...
                    @if(!in_array($appInfo->status_id,[-1,5,6]))
                        <a href="/office-permission-new/app-pdf/{{ Encryption::encodeId($appInfo->id)}}" target="_blank" class="btn btn-md btn-danger">
                    ...
                    <div class="panel-body">
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-5 col-xs-6">
                                            <span class="v_label">Activities in Bangladesh through the proposed branch/ liaison/
                                            representative office (Max. 250 characters)</span>
                                            <span class="pull-right">&#58;</span>
                                        </div>
                                        <div class="col-md-7 col-xs-6">
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="table-responsive">
                                <table aria-label="Detailed Proposed organization" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                    <tr>
