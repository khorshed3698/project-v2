            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12" style="text-align: center">
                        ...
                        Application for Office Permission New
                    </div>
                </div>
                <div class="panel panel-info" id="inputForm">
                    <div class="panel-heading">Application for Office Permission New</div>
                    <div class="panel-body">
                        <table aria-label="Detailed Application for Office Permission New" width="100%">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="padding: 5px;">Current Desk :
                                    <span>@if($appInfo->desk_id != 0) {{$appInfo->desk_name}} @else
                                            Applicant @endif</span>
                                </td>
                            </tr>
                        </table>
                        ...
                        <div id="ep_form" class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <table aria-label="Detailed Report Information about the principal company" width="100%" cellpadding="10">
                                        <thead>
                                            <tr class="d-none">
                                                {{-- <th aria-hidden="true"  scope="col"></th> --}}
                                            </tr>
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;">
                                                ...
                                                <span>{{ (!empty($appInfo->c_company_name)) ? $appInfo->c_company_name : '' }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <strong class="text-info">Capital of Principal Company: (in US $):</strong>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" style="padding: 5px;">
                        ...
                        <div id="ep_form" class="panel panel-info">
                            <div class="panel-heading">Information about the proposed Branch/ Liaison/ Representative
                                Office
                            </div>
                            <div class="panel-body">
                                <div class="col-md-12">
                                    <table aria-label="Detailed Report Representative
                                Office" width="100%" cellpadding="10">
                                        <thead>
                                            <tr class="d-none">
                                                {{-- <th aria-hidden="true"  scope="col"></th> --}}
                                            </tr>
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding: 5px;">
                                                Activities in Bangladesh through the proposed
                                ...
                                <div class="col-md-12">
                                    <table aria-label="Detailed Report Data Table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            <td class="text-center" style="padding: 5px;" colspan="9">Proposed
                                                Organizational Set up of the Office with Expatriate and Local Man Power
                                                Ratio
                                            </td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="col-md-12">
                                    <table aria-label="Detailed Report Data Table" width="100%" cellpadding="10">
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding: 5px;">
                                                <strong class="text-info">
                                                    Establishment Expenses and Operational Expenses of the Office (in US
                                                    Dollar)
                                                </strong>
                                            </td>
                                        </tr>
