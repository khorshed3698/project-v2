...
<script language="javascript">
    ...
    jQuery(function () {
        jQuery('#submitFromPreviewBtn').click(function (e) {
            window.opener.document.getElementById("OfficePermissionNewForm").setAttribute("target", "_self");
            window.opener.jQuery("#OfficePermissionNewForm").submit();
            window.close();
        });
    });
...
//        return jQuery(this).find('option:selected').text();
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery("#OfficePermissionNewForm-p-4").css({"display": "block"});
