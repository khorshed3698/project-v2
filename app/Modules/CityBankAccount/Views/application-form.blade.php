<?php
$accessMode = ACL::getAccsessRight('CityBankAccount');
        ...
        <div class="box" id="inputForm">
            <div class="box-body">
                ...
                <div class="panel panel-info">
                    ...
                    {!! Form::open(array('url' => 'city-bank-account/store','method' => 'post', 'class' =>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('bank_name','City Bank Limited',['class' => 'form-control input-md ','id'=>'bank_name','readonly']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                ...
                                <div class="form-group" style="margin-top: 10px;">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('bank_branch',[''=>'Select District First'],'',['class' => 'form-control input-md search-box','id'=>'bank_branch']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('account_title_bn','',['class' => 'form-control input-md ','id'=>'account_title_bn','placeholder'=>'Title of Account (In Bangla)']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                            {!! Form::label('account_title_en','Title of Account (In English: Block Letter) :',['class'=>'text-left col-md-5']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('account_title_en','',['class' => 'form-control input-md ','id'=>'account_title_en','placeholder'=>'Title of Account (In English) ']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            {!! Form::label('ac_nature','Nature of Account:',['class'=>'text-left col-md-5']) !!}
                                            <div class="col-md-7">
                                                {!! Form::select('ac_nature',[],'',['class' => 'form-control input-md search-box','id'=>'ac_nature']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                            {!! Form::label('customer_category','Category:',['class'=>'text-left col-md-5']) !!}
                                            <div class="col-md-7">
                    ...
                    <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('organization_name_en',\App\Libraries\CommonFunction::getCompanyNameById(Auth::user()->working_company_id),['class' => 'form-control input-md ','id'=>'organization_name_en','placeholder'=>'Name of the Organization (In English)']) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('nature_of_organization',[],'',['class' => 'form-control input-md ','id'=>'nature_of_organization']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('vat_reg_no','',['class' => 'form-control input-md ','id'=>'vat_reg_no','placeholder'=>'Enter VAT Registration Number/BIN']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                            {!! Form::label('tax_no','Tax ID Number (E-TIN) :',['class'=>'text-left col-md-5']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('tax_no','',['class' => 'form-control input-md ','id'=>'tax_no','placeholder'=>'Enter Tax ID Number (E-TIN)']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('tl_no','',['class' => 'form-control input-md ','id'=>'tl_no','placeholder'=>'Enter Trade License Number']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                            {!! Form::label('tl_date','Date of Trade License :',['class'=>'text-left col-md-5']) !!}
                                            <div class="datepicker col-md-7">
                                                {!! Form::text('tl_date', '',['class' => 'form-control
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="datepickerFuture col-md-7">
                                                {!! Form::text('expiry_date', '',['class' => 'form-control
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('issue_authority','',['class' => 'form-control input-md ','id'=>'issue_authority','placeholder'=>'Enter Issuing Authority']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('registration_no','',['class' => 'form-control input-md ','id'=>'registration_no','placeholder'=>'Enter Registration number']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                            {!! Form::label('registration_date','Registration Date :',['class'=>'text-left col-md-5']) !!}
                                            <div class="datepicker col-md-7">
                                                {!! Form::text('registration_date', '',['class' => 'form-control
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="datepickerFuture col-md-7">
                                                {!! Form::text('reg_expiry_date', '',['class' => 'form-control
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('registration_country',[],'',['class' => 'form-control input-md search-box country-select','id'=>'registration_country']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('registration_authority','',['class' => 'form-control input-md ','id'=>'registration_authority','placeholder'=>'Enter Registration Authority']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                            {!! Form::label('registration_address','Registered Address :',['class'=>'text-left col-md-5']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('registration_address','',['class' => 'form-control input-md ','id'=>'registration_address','placeholder'=>'Enter Registered Address ']) !!}
                                            </div>
                                        </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                {!! Form::hidden('office_thana_code','',['class' => 'form-control input-md ','id'=>'office_thana_code']) !!}
                                {!! Form::hidden('office_dsp_code','',['class' => 'form-control input-md ','id'=>'office_dsp_code']) !!}
                                {!! Form::hidden('office_division','',['class' => 'form-control input-md ','id'=>'office_division']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::select('office_country',[],'',['class' => 'form-control input-md country-select','id'=>'office_country']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                {!! Form::label('office_post','Post Office :',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('office_post','',['class' => 'form-control input-md ','id'=>'office_post','placeholder'=>'Enter Post Office']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('office_thana','',['class' => 'form-control input-md ','id'=>'office_thana','placeholder'=>'Enter Thana/PS','readonly']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                {!! Form::label('office_dsp','District/State/Provence :',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('office_dsp','',['class' => 'form-control input-md ','id'=>'office_dsp','placeholder'=>'District/State/Provence :','readonly']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('office_road','',['class' => 'form-control input-md ','id'=>'office_road','placeholder'=>'Enter Road/Village']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                {!! Form::label('office_phone','Phone/Mobile Number :',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('office_phone','',['class' => 'form-control input-md ','id'=>'office_phone','placeholder'=>'Enter Phone/Mobile Number']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('office_email','',['class' => 'form-control input-md email','id'=>'office_email','placeholder'=>'Enter email Adddress']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('nature_of_bus',[],'',['class' => 'form-control input-md ','id'=>'nature_of_bus']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('yearly_turnover','',['class' => 'form-control input-md onlyNumber','id'=>'yearly_turnover','placeholder'=>'Enter Yearly Turnover']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                            {!! Form::label('human_resource','Number of human resource :',['class'=>'text-left col-md-5']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('human_resource','',['class' => 'form-control input-md onlyNumber','id'=>'human_resource','placeholder'=>'Enter Number of human resource']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('net_of_org','',['class' => 'form-control input-md ','id'=>'net_of_org','placeholder'=>'Enter Net assets of the organization']) !!}
                                            </div>
                                        </div>
                    ...
                    <fieldset>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('account_oper_person_en',$basicAppInfo->ceo_full_name,['class' => 'form-control input-md ','id'=>'account_oper_person_en','placeholder'=>'Account operating person Name(In English)']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                            {!! Form::label('profession','Profession (Details) :',['class'=>'text-left col-md-5']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('profession','',['class' => 'form-control input-md ','id'=>'profession','placeholder'=>'Enter Profession (Details)']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="datepicker col-md-7">
                                                {!! Form::text('date_of_birth',  (!empty($basicAppInfo->ceo_spouse_name) ? date('d-M-Y', strtotime($basicAppInfo->ceo_dob)) : ''),['class' => 'form-control
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('father_name',$basicAppInfo->ceo_father_name,['class' => 'form-control input-md ','id'=>'father_name','placeholder'=>'Enter Father Name']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('mothers_name',$basicAppInfo->ceo_mother_name,['class' => 'form-control input-md ','id'=>'mothers_name','placeholder'=>'Enter Mothers Name']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                            {!! Form::label('spouse_name','Spouse Name :',['class'=>'text-left col-md-5']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('spouse_name',$basicAppInfo->ceo_spouse_name,['class' => 'form-control input-md ','id'=>'spouse_name','placeholder'=>'Enter Spouse Name']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('sex',[],'',['class' => 'form-control input-md ','id'=>'sex']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('relation_with_org','',['class' => 'form-control input-md ','id'=>'relation_with_org','placeholder'=>'Enter Relation with Organization']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12">
                                            {!! Form::label('tax_id_no','Tax Id/ Tax Prayer :',['class'=>'text-left col-md-5']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('tax_id_no','',['class' => 'form-control input-md ','id'=>'tax_id_no','placeholder'=>'Enter Profession (Details)']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('monthly_income','',['class' => 'form-control input-md ','id'=>'monthly_income','placeholder'=>'Enter Monthly Income']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('source_of_fund','',['class' => 'form-control input-md ','id'=>'source_of_fund','placeholder'=>'Enter Source of Fund']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                {!! Form::hidden('present_thana_code','',['class' => 'form-control input-md ','id'=>'present_thana_code']) !!}
                                {!! Form::hidden('present_dsp_code','',['class' => 'form-control input-md ','id'=>'present_dsp_code']) !!}
                                {!! Form::hidden('present_division','',['class' => 'form-control input-md ','id'=>'present_division']) !!}
                                <fieldset class="scheduler-border">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::select('present_country',[],'',['class' => 'form-control input-md search-box country-select','id'=>'present_country']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                {!! Form::label('present_post','Post Office :',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('present_post','',['class' => 'form-control input-md ','id'=>'present_post','placeholder'=>'Enter Post Office']) !!}
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('present_dsp','',['class' => 'form-control input-md ','id'=>'present_dsp','placeholder'=>'District/State/Provence']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                {!! Form::label('present_thana','Thana/PS :',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('present_thana','',['class' => 'form-control input-md ','id'=>'present_thana','placeholder'=>'Enter Thana/PS']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('present_road','',['class' => 'form-control input-md ','id'=>'present_road','placeholder'=>'Enter Road/Village']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                {!! Form::label('present_phone','Phone/Mobile Number :',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('present_phone','',['class' => 'form-control input-md ','id'=>'present_phone','placeholder'=>'Enter Phone/Mobile Number']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('present_email','',['class' => 'form-control input-md email','id'=>'present_email','placeholder'=>'Enter email Adddress']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                </fieldset>
                                {!! Form::hidden('permanent_thana_code','',['class' => 'form-control input-md ','id'=>'permanent_thana_code']) !!}
                                {!! Form::hidden('permanent_dsp_code','',['class' => 'form-control input-md ','id'=>'permanent_dsp_code']) !!}
                                {!! Form::hidden('permanent_division','',['class' => 'form-control input-md ','id'=>'permanent_division']) !!}
                                <fieldset class="scheduler-border">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::select('permanent_country',[],'',['class' => 'form-control input-md search-box country-select','id'=>'permanent_country']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                {!! Form::label('permanent_post','Post Office :',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('permanent_post','',['class' => 'form-control input-md ','id'=>'permanent_post','placeholder'=>'Enter Post Office']) !!}
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('permanent_thana','',['class' => 'form-control input-md ','id'=>'permanent_thana','placeholder'=>'Enter Thana/PS']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                {!! Form::label('permanent_dsp','District/State/Provence :',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('permanent_dsp','',['class' => 'form-control input-md ','id'=>'permanent_dsp','placeholder'=>'District/State/Provence :']) !!}
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('permanent_road','',['class' => 'form-control input-md ','id'=>'permanent_road','placeholder'=>'Enter Road/Village']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-xs-12">
                                                {!! Form::label('permanent_phone','Phone/Mobile Number :',['class'=>'text-left col-md-5']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('permanent_phone','',['class' => 'form-control input-md ','id'=>'permanent_phone','placeholder'=>'Enter Phone/Mobile Number']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 col-xs-12">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('permanent_email','',['class' => 'form-control input-md email','id'=>'permanent_email','placeholder'=>'Enter email Adddress']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::select('identification_country',[],'',['class' => 'form-control input-md country-select','id'=>'identification_country']) !!}
                                            </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('identification_doc_no','',['class' => 'form-control input-md','id'=>'identification_doc_no','placeholder'=>'Identification Document Number']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-xs-12" id="identification_doc_date_issue_div">
                                            ...
                                            <div class="datepicker col-md-7">
                                                {!! Form::text('identification_doc_date_issue', '',['class' => 'form-control
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12" id="identification_doc_date_exp_div">
                                            ...
                                            <div class="datepicker col-md-7">
                                                {!! Form::text('identification_doc_date_exp', '',['class' => 'form-control
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-8">
                                                {!! Form::text('purpose_account','',['class' => 'form-control input-md ','id'=>'purpose_account','placeholder'=>'The purpose of opening an account of a foreign company / institution (If applicable)']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-8">
                                                {!! Form::text('regulatory_authority','',['class' => 'form-control input-md ','id'=>'regulatory_authority','placeholder'=>'Name of the concerned regulatory authority']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-8 col-xs-12" style="margin: 10px;">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('authorization_info',\App\Libraries\CommonFunction::getUserFullName(),['class' => 'form-control input-md ','id'=>'authorization_info','placeholder'=>'Enter Authorization information']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@include('CityBankAccount::city_bank_scripts_add')