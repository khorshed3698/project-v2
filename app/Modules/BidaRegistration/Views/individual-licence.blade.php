                        ...
                        <div class="panel-body">
                            <div class="container-fluid">
                                ...
                                <div class="row top-buffer">
                                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6 right-buffer">
                                        <a href="http://www.roc.gov.bd/" target="_blank" rel="noopener" class="col-md-12 col-lg-12 col-sm-12 col-xs-12 btn btn-green txt-style">
                                            <div class="licence_logo">
                                                <img class="img pull-left" src="{{ asset('assets/images/u34.png') }}" alt="licence_logo">
                                            </div>
                                    ...
                                    <div class="col-md-5 col-lg-5 col-sm-5 col-xs-5  left-buffer right-buffer">
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 btn-green txt-style ">
                                            ...
                                            @endif
                                            <a style="margin: 0px 2px" type="button" href="http://www.roc.gov.bd/site/page/3de99758-e1a5-4ba0-aa0d-c0077c1d98f6/%E0%A6%A8%E0%A6%BE%E0%A6%AE%E0%A7%87%E0%A6%B0-%E0%A6%9B%E0%A6%BE%E0%A7%9C%E0%A6%AA%E0%A6%A4%E0%A7%8D%E0%A6%B0-%E0%A6%AA%E0%A7%8D%E0%A6%B0%E0%A6%A6%E0%A6%BE%E0%A6%A8" target="_blank" rel="noopener" class="pull-right btn btn-default btn-primary btn-sm">Service Details</a>
                                        </div>
                                    </div>
                                ...
                                <div class="row top-buffer">
                                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6 right-buffer">
                                        <a href="https://www.sonalibank.com.bd/" target="_blank" rel="noopener" class="col-md-12 col-lg-12 col-sm-12 col-xs-12 btn btn-green txt-style">
                                            <div class="licence_logo">
                                                <img class="img pull-left" src="{{ asset('assets/images/u39.png') }}" alt="licence_logo">
                                            </div>
                                    ...
                                    <div class="col-md-5 col-lg-5 col-sm-5 col-xs-5  left-buffer right-buffer">
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 btn-green txt-style">
                                            ...
                                            @if($licenseApplications->cr_application != null)
                                                <a type="button" class="pull-right btn btn-default btn-success btn-sm">Applied</a>
                                            @endif
                                            <a  style="margin: 0px 2px" type="button" class="pull-right btn btn-default btn-primary btn-sm" href="http://www.roc.gov.bd/site/page/855dc577-3035-4ca4-b376-49c517099a3e/Entity-Registration" target="_blank" rel="noopener" >Service Details</a>
                                        </div>
                                    </div>
                                    <div class="col-md-1 col-lg-1 col-sm-1 col-xs-1  left-buffer">
                                        @if($licenseApplications->cr_application != null)
                                ...
                                <div class="row top-buffer">
                                    <div class="col-md-6 col-lg-6 col-sm-6 col-xs-6 right-buffer">
                                        <a href="http://nbr.gov.bd/" target="_blank" rel="noopener" class="col-md-12 col-lg-12 col-sm-12 col-xs-12 btn btn-green txt-style">
                                            <div class="licence_logo">
                                                <img class="img pull-left" src="{{ asset('assets/images/u34.png') }}" alt="licence_logo">
                                            </div>
                                    ...
                                    <div class="col-md-5 col-lg-5 col-sm-5 col-xs-5  left-buffer right-buffer">
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 btn-green txt-style">
                                            ...
                                            @if($licenseApplications->etin_application != null)
                                                <a type="button" class="pull-right btn btn-default btn-success btn-sm">Applied</a>
                                            @endif
                                            <a style="margin: 0px 2px" type="button" class="pull-right btn btn-default btn-primary btn-sm" href="http://nbr.gov.bd/" target="_blank" rel="noopener">Service Details</a>
                                        </div>
                                    </div>
                                    <div class="col-md-1 col-lg-1 col-sm-1 col-xs-1  left-buffer">
                                        @if($licenseApplications->etin_application != null)
                                    ...
                                    <div class="col-md-5 col-lg-5 col-sm-5 col-xs-5  left-buffer right-buffer">
                                        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 btn-green txt-style">
                                            ...
                                            @if($licenseApplications->tl_application != null)
                                                <a type="button" class="pull-right btn btn-default btn-success btn-sm">Applied</a>
                                            @endif
                                            <a style="margin: 0px 2px" type="button" class="pull-right btn btn-default btn-primary btn-sm" href="http://www.dhakasouthcity.gov.bd/" target="_blank" rel="noopener">Service Details</a>
                                        </div>
                                    </div>
                                    <div class="col-md-1 col-lg-1 col-sm-1 col-xs-1  left-buffer">
                                        @if($licenseApplications->tl_application != null)
