...
<div class="modal-footer" style="text-align:left;">
    <div class="table-responsive" style="height: 150px">
        <table id="directorListModal" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%" aria-label="Detailed Report Data Table">
            <thead>
            <tr>
                <th>#</th>
                <th>Name</th>
...
<script>
    ...
    // Function to enable buttons (if needed)
    function enableButtons() {
        // Example to re-enable buttons if needed (for after submission success or failure)
        document.getElementById('passport_save').disabled = false;
        document.getElementById('passport_save_close').disabled = false;
        document.getElementById('ETINVerifySave').disabled = false;
        document.getElementById('ETINVerifySaveBtn').disabled = false;
    }
