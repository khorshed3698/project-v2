    ...
    <div class="col-md-10 col-md-offset-1">
        ...
        <div class="form-group">
            <div class="{{$errors->has('l_machinery_imported_qty') ? 'has-error': ''}}">
                ...
                <div class="col-md-8">
                    {!! Form::text('l_machinery_imported_qty', $imported_machinery->l_machinery_imported_qty, ['class' => 'form-control input-md required number']) !!}
        ...
        <div class="form-group">
            <div class="{{$errors->has('l_machinery_imported_unit_price') ? 'has-error': ''}}">
                ...
                <div class="col-md-8">
                    {!! Form::text('l_machinery_imported_unit_price', $imported_machinery->l_machinery_imported_unit_price, ['class' => 'form-control input-md required number']) !!}
        ...
        <div class="form-group">
            <div class="{{$errors->has('l_machinery_imported_total_value') ? 'has-error': ''}}">
                ...
                <div class="col-md-8">
                    {!! Form::text('l_machinery_imported_total_value', $imported_machinery->l_machinery_imported_total_value, ['class' => 'form-control input-md required number']) !!}
