            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12" style="text-align: center">
                        <img src="{{ $logoPath }}" style="width: 100px" alt="BIDA Logo"/><br/>
                        <br>
                                    ...
                                    <table width="100%" cellpadding="10" aria-label="Detailed Report Data Table">
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;">
                                                ...
                                                <span>{{ (!empty($appInfo->organization_type_id)) ?$appInfo->organization_type_name:''  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;">
                                                Status of the organization :
                                                <span> {{ (!empty($appInfo->organization_status_id)) ? $appInfo->organization_status_name:''  }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" style="padding: 5px;">
                                                Ownership status :
                                                <span>{{ (!empty($appInfo->ownership_status_id)) ? $appInfo->ownership_status_name:''  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;">
                                                Country of Origin :
                                                <span> {{ (!empty($appInfo->country_of_origin_id)) ? $appInfo->country_of_origin_name:''  }}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="50%" style="padding: 5px;">
                                ...
                                <div class="col-md-12">
                                    <table width="100%" cellpadding="10" aria-label="Detailed Report Data Table">
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;">
                                                Country :
                                                <span> {{ (!empty($appInfo->ceo_country_id)) ? $appInfo->ceo_country_name:''  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;">
                                                Date of Birth :
                                        ...
                                        <tr>
                                            ...
                                            @if($appInfo->ceo_country_id == 18)
                                                <td width="50%" style="padding: 5px;">
                                                    District/City/State :
                                                    <span>{{ (!empty($appInfo->ceo_district_id)) ? $appInfo->ceo_district_name:''  }}</span>
                                                </td>
                                            @else
                                                <td width="50%" style="padding: 5px;">
                                                    City :
                                        ...
                                        <tr>
                                            @if($appInfo->ceo_country_id == 18)
                                                <td width="50%" style="padding: 5px;">
                                                    Police Station/Town :
                                                    <span> {{ (!empty($appInfo->ceo_thana_id)) ? $appInfo->ceo_thana_name:''  }}</span>
                                                </td>
                                            @else
                                                <td width="50%" style="padding: 5px;">
                                                    State/Province :
                                ...
                                <div class="col-md-12">
                                    <table width="100%" cellpadding="10" aria-label="Detailed Report Data Table">
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;">
                                                Division :
                                                <span> {{ (!empty($appInfo->office_division_id)) ? $appInfo->office_division_name:''  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;">
                                                District :
                                                <span> {{ (!empty($appInfo->office_district_id)) ? $appInfo->office_district_name:''  }}</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;">
                                                Police Station :
                                                <span> {{ (!empty($appInfo->office_thana_id)) ? $appInfo->office_thana_name:''  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;">
                                                Post Office :
                                ...
                                <div class="col-md-12">
                                    <table width="100%" cellpadding="10" aria-label="Detailed Report Data Table">
                                        ...
                                        <tr>
                                            <td width="50%" style="padding: 5px;">
                                                District :
                                                <span> {{ (!empty($appInfo->factory_district_id)) ? $appInfo->factory_district_name:''  }}</span>
                                            </td>
                                            <td width="50%" style="padding: 5px;">
                                                Police Station :
                                                <span> {{ (!empty($appInfo->factory_thana_id)) ? $appInfo->factory_thana_name:''  }}</span>
                                            </td>
                                        </tr>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div>1. Project Status
                                            :<span> {{ (!empty($appInfo->project_status_id)) ? $appInfo->project_status_name:''  }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        @else --}}
                                            <div class="col-md-3">
                                                {!! Form::label('direct_export','Foreign :',['class'=>'col-md-3 text-left']) !!}
                                                {{ (!empty($appInfo->direct_export)) ? $appInfo->direct_export :''  }}
                                            </div>
                                            <div class="col-md-3">
                                                {!! Form::label('deemed_export','Foreign :',['class'=>'col-md-3 text-left']) !!}
                                                        ...
                                                        <td>
                                                            <table style="width:100%;" aria-label="Detailed Report Data Table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        {{isset($currencies[$appInfo->local_land_ivst_ccy]) ? $appInfo->local_land_ivst_ccy_code:""}}
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <table style="width:100%;" aria-label="Detailed Report Data Table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        {{isset($currencies[$appInfo->local_building_ivst_ccy]) ? $appInfo->local_building_ivst_ccy_code:""}}
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <table style="width:100%;" aria-label="Detailed Report Data Table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        {{isset($currencies[$appInfo->local_machinery_ivst_ccy]) ? $appInfo->local_machinery_ivst_ccy_code:""}}
                                                        ...
                                                        <td>
                                                            <table style="width:100%;" aria-label="Detailed Report Data Table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        {{isset($currencies[$appInfo->local_others_ivst_ccy]) ? $appInfo->local_others_ivst_ccy_code:""}}
                                                        ...
                                                        <td>
                                                            <table style="width:100%;" aria-label="Detailed Report Data Table">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        {{isset($currencies[$appInfo->local_wc_ivst_ccy]) ? $appInfo->local_wc_ivst_ccy_code:""}}
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <label class="checkbox-inline">
                                            @if($appInfo->public_land == 1) <img src="{{ $checkLogo }}"
                                                                                 width="10" height="10" alt="Checked Icon"/> Land @endif
                                        </label>
                                        <label class="checkbox-inline">
                                            @if($appInfo->public_electricity == 1) <img src="{{ $checkLogo }}"
                                                                                        width="10" height="10" alt="Checked Icon"/>
                                            Electricity @endif
                                        </label>
                                        <label class="checkbox-inline">
                                            @if($appInfo->public_gas == 1) <img src="{{ $checkLogo }}"
                                                                                width="10" height="10" alt="Checked Icon"/> Gas @endif
                                        </label>
                                        <label class="checkbox-inline">
                                            @if($appInfo->public_telephone == 1) <img src="{{ $checkLogo }}"
                                                                                      width="10" height="10" alt="Checked Icon"/>
                                            Telephone @endif
                                        </label>
                                        <label class="checkbox-inline">
                                            @if($appInfo->public_road == 1) <img src="{{ $checkLogo }}"
                                                                                 width="10" height="10" alt="Checked Icon"/> Road @endif
                                        </label>
                                        <label class="checkbox-inline">
                                            @if($appInfo->public_water == 1) <img src="{{ $checkLogo }}"
                                                                                  width="10" height="10" alt="Checked Icon"/> Water @endif
                                        </label>
                                        <label class="checkbox-inline">
                                            @if($appInfo->public_drainage == 1) <img src="{{ $checkLogo }}"
                                                                                     width="10" height="10" alt="Checked Icon"/>
                                            Drainage @endif
                                        </label>
                                        <label class="checkbox-inline">
                                            @if($appInfo->public_others == 1) <img src="{{ $checkLogo }}"
                                                                                   width="10" height="10" alt="Checked Icon"/>Others @endif
                                        </label>
                                        {{--<label class="checkbox-inline">--}}
                                ...
                                <table class="table table-bordered dt-responsive" aria-label="Detailed Report Data Table">
                                    ...
                                    @foreach($listOfDirectors as $listOfDirector)
                                        <tr>
                                            ...
                                            <td>{{ (!empty($listOfDirector->l_director_nationality) ? $listOfDirector->nicename : '' ) }}</td>
                    ...
                    <div id="ep_form" class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        &nbsp; @if($appInfo->accept_terms == 1) <img src="{{ $checkLogo }}"
                                                                                     width="10" height="10" alt="Checked Icon"/> @else
                                            <img src="{{ $uncheckLogo }}" width="10" height="10" alt="Unchecked Icon"/> @endif
