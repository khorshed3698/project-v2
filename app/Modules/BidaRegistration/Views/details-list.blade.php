                                    ...
                                    <div class="table-responsive">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                ...
                                                <div class="pull-right">
                                                    @if((in_array($application_info->status_id, [-1,5])) && (Auth::user()->desk_id == 0)  && $viewMode != 'on')
                                                         <button type="button" class="btn btn-default" id="batch-delete"><i class="fa fa-trash" style="margin-right: 5px;"></i><b>Delete Selected</b></button>
                                            ...
                                            <div class="panel-body">
                                                <table id="importedMachineryList"
                                                    ...
                                                    <tr>
                                                        <th scope="col" colspan="5" style="text-align: right">Grand total:</th>
                                    ...
                                    <div class="table-responsive">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                ...
                                                <div class="pull-right">
                                                    @if((in_array($application_info->status_id, [-1,5])) && (Auth::user()->desk_id == 0) && $viewMode != 'on')
                                                        <button type="button" class="btn btn-default" id="batch-delete-local"><i class="fa fa-trash" style="margin-right: 5px;"></i><b>Delete Selected</b></button>
                                                        <a data-toggle="modal" data-target="#excelFileUploadModel" onclick="openModal(this)"
...
@section('footer-script')
    ...
    <script>
        ...
        $(function () {
            ...
            // imported machinery list and batch delete
            $(function () {
                var importedMachineryTable = $('#importedMachineryList').DataTable({
                    "footerCallback": function (row, data, start, end, display) {
                        var api = this.api(), data;
                        ...
                        // Update footer
                        $(api.column(5).footer()).html(pageTotalImported.toFixed(3));
                        $("#totalImported").html(totalImported.toFixed(3));
                    },
                    processing: true,
                    serverSide: false,
                ...
                $('#batch-delete').click(function() {
                    var selectedIds = [];
                    var table = $('#importedMachineryList').DataTable();
                    ...
                    if (confirmDelete) {
                        $.ajax({
                            url: '/bida-registration/batch-delete-imported-machinery',
                            type: 'POST',
                            data: {
                                _token: $('input[name="_token"]').val(),
                                ids: selectedIds
                            ...
                            success: function(response) {
                                $('#select-all-imported').prop('checked', false);
                                table.ajax.reload();
                            },
            ...
            // local machinery list and batch delete
            $(function () {
                var localMachineryTable = $('#localMachineryList').DataTable({
                    "footerCallback": function (row, data, start, end, display) {
                        var api = this.api(), data;
                        var intVal = function (i) {
                            return typeof i === 'string' ?
                        ...
                        // Update footer
                        $(api.column(5).footer()).html(pagetotalLocal.toFixed(3));
                    ...
                    columns: [
                        { data: 'checkbox-local', name: 'checkbox', orderable: false, searchable: false },
                        {data: 'sl', name: 'sl'},
                ...
                $('#batch-delete-local').click(function() {
                    var selectedIds = [];
                    var table = $('#localMachineryList').DataTable();
                    ...
                    if (confirmDelete) {
                        $.ajax({
                            url: '/bida-registration/batch-delete-local-machinery',
                            type: 'POST',
                            data: {
                                _token: $('input[name="_token"]').val(),
                                ids: selectedIds
                            ...
                            success: function(response) {
                                $('#select-all-local').prop('checked', false);
                                table.ajax.reload();
                            },
                            error: function(xhr, status, error) {
                                console.error(error);
