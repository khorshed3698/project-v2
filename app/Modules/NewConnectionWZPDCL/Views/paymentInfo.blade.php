...
<div class="form-group clearfix">
    <div class="row">
        <div class="col-md-6">
             {!! Form::label('DemandCostTotal','Demand Cost Total',['class'=>'col-md-5 text-left']) !!}
            <div class="col-md-7">
                <input name="DemandCostTotal" class="form-control input-md" value="{{$applyPaymentfee[0]->DemandCostTotal}}" readonly>
            </div>
        </div>
        <div class="col-md-6">
             {!! Form::label('Estimate Cost Total','Service Estimate Cost Total',['class'=>'col-md-5 text-left']) !!}
              <div class="col-md-6">
                <input name="EstimateCostTotal" class="form-control input-md" value="{{$applyPaymentfee[0]->EstimateCostTotal}}" readonly>
              </div>
        </div>
    </div>
</div>
<div class="form-group clearfix">
    <div class="row">
        <?php
            $totalamount = number_format($applyPaymentfee[0]->DemandCostTotal + $applyPaymentfee[0]->EstimateCostTotal,2);
        ?>
         <div class="col-md-6">
