        ...
        <div class="box" id="inputForm">
            <div class="box-body">
                ...
                <div class="panel panel-primary">
                                    ...
                                    <div class="row ">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('applicant_name', !empty($ceoInfo->ceo_full_name) ? $ceoInfo->ceo_full_name : '', ['class' => 'form-control input-md form-control name']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            {!! Form::label('name_in_bengali','Name (in Bengali) :', ['class' => 'col-md-5 col-xs-12']) !!}
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('name_in_bengali', '', ['class' => 'form-control input-md name','id'=>'name_in_bengali']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('father_name', !empty($ceoInfo->ceo_father_name) ? $ceoInfo->ceo_father_name : '', ['class' => 'form-control input-md name','id'=>'father_name']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            {!! Form::label('mother_name','Mother\'s Name :', ['class' => 'col-md-5 col-xs-12']) !!}
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('mother_name', !empty($ceoInfo->ceo_mother_name) ? $ceoInfo->ceo_mother_name : '', ['class' => 'form-control input-md name','id'=>'mother_name']) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 ">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('spouse_name', !empty($ceoInfo->ceo_spouse_name) ? $ceoInfo->ceo_spouse_name : '', ['class' => 'form-control input-md name']) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::select('applicant_gender', [],'', ['class' => 'form-control input-md','id'=>'applicant_gender']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 ">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('national_id', !empty($ceoInfo->ceo_nid) ? $ceoInfo->ceo_nid : '', ['class' => 'form-control input-md onlyNumber' ]) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 ">
                                            {!! Form::label('applicant_passport','Passport :', ['class' => 'col-md-5 col-xs-12']) !!}
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('applicant_passport', !empty($ceoInfo->ceo_passport_no) ? $ceoInfo->ceo_passport_no : '', ['class' => 'form-control input-md ']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('applicant_mobile', !empty($ceoInfo->ceo_mobile_no) ? $ceoInfo->ceo_mobile_no : '', ['class' => 'form-control input-md onlyNumber mobile']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class=" col-md-7 col-xs-12">
                                                <div class="datepickerDob input-group date"
                                                    ...
                                                    {!! Form::text('applicant_dob', '', ['class'=>'form-control input-md', 'id' => 'applicant_dob', 'placeholder'=>'Date of Birth','id'=>'applicant_dob']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 col-xs-12 ">
                                                {!! Form::file('signature', ['class'=>'form-control input-md required','flag'=>'img','id' => 'signature','onchange'=>"uploadDocument('preview_signature', this.id, 'validate_field_signature',1) , imagePreview(this)"]) !!}
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::file('photo', ['class'=>'form-control input-md required', 'id' => 'photo','flag'=>'img','onchange'=>"uploadDocument('preview_photo', this.id, 'validate_field_photo',1), imagePreview(this)"]) !!}
                                                <span id="span_photo"
                                                      style="font-size: 12px; font-weight: bold;color:#993333">*** Maximum file size 150kb and file extension should be only jpg/jpeg/png</span>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('mail_house_no', '', ['class' => 'form-control input-md','id'=>'mail_house_no']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            {!! Form::label('mail_road_no','LANE/Road No :',  ['class' => 'col-md-5 col-xs-12']) !!}
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('mail_road_no', '', ['class' => 'form-control input-md','id'=>'mail_road_no']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('mail_section', '', ['class' => 'form-control input-md','id'=>'mail_section']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            {!! Form::label('mail_block','Block :',  ['class' => 'col-md-5 col-xs-12']) !!}
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('mail_block', '', ['class' => 'form-control input-md','id'=>'mail_block']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 ">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('mail_post_code', '', ['class' => 'form-control input-md onlyNumber','id'=>'mail_post_code']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('mailing_email', '', ['class' => 'form-control email input-md','id'=>'mailing_email']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('mail_telephone',  '', ['class' => 'form-control input-md onlyNumber telephone','id'=>'mail_telephone']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7 col-xs-12">
                                                    {!! Form::text('conn_house_no', '', ['class' => 'form-control input-md','id'=>'conn_house_no']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                {!! Form::label('conn_road_no','LANE/Road No :',  ['class' => 'col-md-5 col-xs-12']) !!}
                                                <div class="col-md-7 col-xs-12">
                                                    {!! Form::text('conn_road_no', '', ['class' => 'form-control input-md','id'=>'conn_road_no']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7 col-xs-12">
                                                    {!! Form::text('conn_section', '', ['class' => 'form-control input-md','id'=>'conn_section']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                {!! Form::label('conn_block','Block :',  ['class' => 'col-md-5 col-xs-12']) !!}
                                                <div class="col-md-7 col-xs-12">
                                                    {!! Form::text('conn_block', '', ['class' => 'form-control input-md','id'=>'conn_block']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 ">
                                                ...
                                                <div class="col-md-7 col-xs-12">
                                                    {!! Form::text('conn_post_code', '', ['class' => 'form-control input-md onlyNumber','id'=>'conn_post_code']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7 col-xs-12">
                                                    {!! Form::select('conn_thana', [], '', ['class' => 'form-control input-md','id'=>'conn_thana','placeholder'=>'Select District first']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                {!! Form::label('conn_email','Email :', ['class' => 'col-md-5 col-xs-12']) !!}
                                                <div class="col-md-7 col-xs-12">
                                                    {!! Form::text('conn_email', '', ['class' => 'form-control email input-md','id'=>'conn_email']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7 col-xs-12">
                                                    {!! Form::text('conn_telephone',  '', ['class' => 'form-control input-md onlyNumber telephone','id'=>'conn_telephone']) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                {!! Form::label('conn_mobile','Mobile :', ['class' => 'col-md-5 col-xs-12']) !!}
                                                <div class="col-md-7 col-xs-12">
                                                    {!! Form::text('conn_mobile','', ['class' => 'form-control input-md mobile onlyNumber','id'=>'conn_mobile']) !!}
                                                </div>
                                            </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('org_or_shop_name', !empty($ceoInfo->company_name) ? $ceoInfo->company_name : '', ['class' => 'form-control input-md','id'=>'org_or_shop_name']) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            {!! Form::label('demand_load','Demand Load per Meter in Kilowatt :',['class' => 'col-md-5 col-xs-12']) !!}
                                            <div class="col-md-7 col-xs-12">
                                                {!! Form::text('demand_load', '', ['class' => 'form-control input-md ','id'=>'demand_load']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <fieldset>
                        <div class="panel panel-primary">
                            <div class="panel-heading"><strong>Declaration</strong>
                            </div>
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="row">
...
<script>
    ...
    $(document).ready(function () {
        ...
        @if(!empty($ceoInfo->ceo_dob))
        $('.datepickerDob').find('input').val('{{$ceoInfo->ceo_dob}}');
        @else
    ...
    $(document).ready(function () {
        ...
        $('#applicant_gender').on('keydown', function (el) {
            ...
            let selected_value = "{{ !empty($ceoInfo->ceo_gender) ? $ceoInfo->ceo_gender : ''}}"; // for callback
        ...
        $("#conn_district").on("change", function () {
            ...
            var selected_value = '';
            if (checkBox == true) {
                selected_value = $("#mail_thana").val(); // for callback
            }
            if (districtId) {
                var e = $(this);
                var api_url = "{{$wzpdcl_service_url}}/thana-list-by-district-id/" + districtId;
