                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-striped table-bordered" width="100%">
                            ...
                            <tr>
                                <th width="10%" rowspan="2" class="text-center">Form name</th>
                                <th width="30%" rowspan="2" class="text-center">Description</th>
                            ...
                            <?php $fileArray = array();
                            foreach ($filestatus as $ref_id){
//                                echo $ref_id->ref_id;
                                $fileArray[] = $ref_id->ref_id;
                            }
                            ?>
                            @foreach($appInfo as $info)
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        ...
                                        @if(isset($filestatus[$i]))
                                            {{$filestatus[$i]->ref_id}}--{{$info->id}}
                                        <?php $check = in_array($info->id, $fileArray);
                                        var_dump($check);
                                        ?>
                                        ...
                                        <input type="file"
                                               ...
                                               onchange="readFiles(this)" style="float: right"><div id="ok_{{$info->id}}"></div>
                    ...
                    <center>
                        <a href="/new-reg/get-pdf/check-all-pdf-files-up/{{ Encryption::encodeId($applicationId)}}" class="btn btn-success btn-xs documentUrl">
