            ...
            <div class="box-body">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <fieldset>
                            {!! Form::open(['url' => '/new-reg/save-reg-objecive','method' => 'post','files'=>true,'enctype='> 'multipart/form-data','id'=>'objectiveform']) !!}
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="panel panel-info">
                                        ...
                                        <div class="panel-body">
                                            <span>1.Entity Name</span><span style="margin-left: 200px;">{{\App\Modules\NewReg\Controllers\GetCompanyController::getCompanyNameBysubimmsionNo($appInfo->submission_no)}}</span><br>
