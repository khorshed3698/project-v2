    ...
    <section class="content" id="inputForm">
        ...
        @if($appInfo->sfp_payment_status == 3)
            ...
            <div class="pull-right">
                <a href="/spg/stack-holder/counter-payment-voucher/{{ Encryption::encodeId($appInfo->gf_payment_id)}}" target="_blank" class="userdefineBtn">
...
//                                                    echo '<h2>'.$sequence.'</h2>';
                        ...
                        <div class="panel-body">
                            @if ($appInfo->status_id==26)
                                <div class="panel panel-info pull-right" style="padding: 5px;max-width: 80%;overflow-x: hidden;margin: 0px;">
                            ...
                            <div class="tab-content">
                                <div id="control" class="tab-pane fade in active">
                                    @include('NewReg::new-reg-edit.control-edit')
                                </div>
                                <div id="step1" class="tab-pane fade">
                                    @include('NewReg::new-reg-edit.general-info-edit')
                                </div>
                                <div id="step2" class="tab-pane fade">
                                    @include('NewReg::new-reg-edit.particular-edit')
                                </div>
                               <div id="step3" class="tab-pane fade">
                                    @include('NewReg::new-reg-edit.list-subscriber-edit')
                                </div>

                                <div id="step4" class="tab-pane fade">
                                   @include('NewReg::new-reg-edit.witness-document-edit')
                               </div>
                              <div id="step5" class="tab-pane fade">
                                   @include('NewReg::new-reg-edit.declaration-upload-edit')
                               </div>
                               {{--<div id="step6" class="tab-pane fade">--}}
                                   {{--@include('NewReg::new-reg-edit.declaration-edit')--}}
                               {{--</div>--}}
                                {{--<div id="step7" class="tab-pane fade">--}}
                                   {{--@include('NewReg::new-reg-edit.notice-of-situation-edit')--}}
                               {{--</div>--}}
                                {{--<div id="step8" class="tab-pane fade">--}}
                                   {{--@include('NewReg::new-reg-edit.companies-act-edit')--}}
                               {{--</div>--}}
                                {{--<div id="step9" class="tab-pane fade">--}}
                                   {{--@include('NewReg::new-reg-edit.list-of-personal-edit')--}}
                               {{--</div>--}}
                                {{--<div id="step10" class="tab-pane fade">--}}
                                   {{--@include('NewReg::new-reg-edit.agreement-page-edit')--}}
                               {{--</div>--}}
                                {{--<div id="step11" class="tab-pane fade">--}}
                                   {{--@include('NewReg::new-reg-edit.particulars-page-edit')--}}
                               {{--</div>--}}
                                <div id="step12" class="tab-pane fade">
                                   @include('NewReg::new-reg-edit.memorandum-of-association-edit')
                               </div>
                                <div id="step13" class="tab-pane fade">
                                   @include('NewReg::new-reg-edit.articles-of-association-edit')
                               </div>
                                <div id="step14" class="tab-pane fade">
                                    @include('NewReg::new-reg-edit.documents-edit')
                                </div>
                            </div>
                        </div>
