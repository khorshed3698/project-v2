    ...
    <fieldset>
        ...
        {!! Form::open(array('url' => '/new-reg/rjsc-witness-save/', 'method' => 'post', 'files' => true, 'role' => 'form', 'id'=> 'witness_form_edit')) !!}
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-12 {{$errors->has('position_id') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-4">
                                {!! Form::select('position_id',$rjscCompanyPosition, (!empty($witnessDataFiled->position_id)) ? $witnessDataFiled->position_id : '',['class' => 'form-control input-md required','placeholder' => 'Select One']) !!}
                        ...
                        <div class="col-md-12 {{$errors->has('district_id') ? 'has-error': ''}}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        {!! Form::select('district_id',$districts,(!empty($witnessDataFiled->district_id) ? $witnessDataFiled->district_id : ''), ['class' => 'form-control input-md required','required' => 'required']) !!}
