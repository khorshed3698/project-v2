            ...
            <div class="box">
                <div class="box-body">
                    <div class="panel panel-info">
                        ...
                        {!! Form::open(array('url' => '/save-dec-upload-form', 'method' => 'post', 'files' => true, 'role' => 'form', 'id'=> 'formId')) !!}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('declaration_name') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::text('declaration_name', '', ['class' => 'form-control required input-md','placeholder' => 'Name']) !!}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('declaration_position_id') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::select('declaration_position_id',$rjscCompanyPosition, null,['class' => 'form-control input-md required','placeholder' => 'Select One']) !!}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('declaration_organization') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::text('declaration_organization', '', ['class' => 'form-control input-md','placeholder' => 'Organization']) !!}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('declaration_address') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::textarea('declaration_address', '', ['class' => 'form-control input-sm required','placeholder' => 'Address', 'rows' => 2, 'cols' => 1]) !!}
                                    ...
                                    <div class="col-md-12 {{$errors->has('declaration_district_id') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    {!! Form::select('declaration_district_id',$districts, null,['class' => 'form-control input-md required','placeholder' => 'Select One']) !!}
                        ...
                        <div class="panel-body">
                            {{--<div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('upload_doc_name_id') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::select('upload_doc_name_id',$rjscNrDocList, null,['class' => 'form-control input-md required','placeholder' => 'Select One']) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-2">
                                        {!! Form::number('memorandum_asso_no', '', ['class' => 'form-control required input-md']) !!}
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-2">
                                        {!! Form::number('article_asso_no', '', ['class' => 'form-control required input-md']) !!}
                                    </div>
                                    <div class="col-md-5"></div>
                                </div>
                            </div>
