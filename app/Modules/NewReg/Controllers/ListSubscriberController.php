...
use App\Modules\NewReg\Models\RjscTinVerify;
...
//        }
        ...
        try {
            ...
            $company_type=NewReg::where('id',$app_id)->first(['entity_type_id']);
            ...
            $subscriberData->usual_residential_district_id = $request->get('usual_residential_district_id');
            ...
            $subscriberData->permanent_address_district_id = $request->get('permanent_address_district_id');
            $subscriberData->mobile = $request->get('mobile');
            $subscriberData->email = $request->get('email');
            $subscriberData->present_nationality_id = $request->get('present_nationality_id');
            $subscriberData->original_nationality_id = $request->get('original_nationality_id');
//            $subscriberData->dob = $request->get('dob');
            ...
            $subscriberData->position = $request->get('position');
...
//            $subscriberData->appointment_date = $request->get('appointment_date');
            ...
            $sequence=NewReg::find(Encryption::decodeId($request->get('app_id')));
            $sequence->sequence = 4;
