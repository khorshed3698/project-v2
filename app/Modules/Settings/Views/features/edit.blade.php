...
<div class="col-lg-12">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            {!! Form::open(array('url' => '/settings/update-features/'.$encrypted_id,'method' => 'patch', 'class' => 'form-horizontal smart-form', 'id' => 'notice-info',
            ...
            <div class="form-group col-md-12 {{$errors->has('details') ? 'has-error' : ''}}">
                ...
                <div class="col-md-9">
                    {!! Form::textarea('description', $data->feature_description, ['class'=>'form-control bnEng required', 'id'=>'description_editor']) !!}
