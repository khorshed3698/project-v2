...
<div class="col-lg-12">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            {!! Form::open(array('url' => '/settings/store-user-manual','method' => 'post', 'class' => 'form-horizontal smart-form', 'id' => 'notice-info',
            ...
            <div class="form-group col-md-12 {{$errors->has('typeName') ? 'has-error' : ''}}">
                ...
                <div class="col-md-9">
                    {!! Form::text('typeName', '', ['class'=>'form-control bnEng required', 'size' => "10x5"]) !!}
            ...
            <div class="form-group col-md-12 {{$errors->has('details') ? 'has-error' : ''}}">
                ...
                <div class="col-md-9">
                    {!! Form::textarea('details', '', ['class'=>'form-control bnEng required', 'id'=>'details_editor']) !!}
            ...
            <div class="form-group col-md-8 {{$errors->has('pdfFile') ? 'has-error' : ''}}">
                ...
                <div class="col-md-7">
                    ...
                    {!! Form::file('pdfFile', ['class'=> !empty($logoInfo->logo)?'':'required', 'id' => 'pdfFile',
            ...
            <div class="form-group col-md-12 {{$errors->has('termsCondition') ? 'has-error' : ''}}">
                ...
                <div class="col-md-9">
                    {!! Form::textarea('termsCondition', '', ['class'=>'form-control bnEng required', 'id'=>'termsCondition_editor', 'rows' => 3, 'cols' => 40]) !!}
            ...
            <div class="form-group col-md-12 {{$errors->has('status') ? 'has-error' : ''}}">
                ...
                <div class="col-md-10">
                    <label>{!! Form::radio('status', '1', true, ['class'=>'cursor required', 'id' => 'yes']) !!} Active</label>
                    &nbsp;&nbsp;
                    <label>{!! Form::radio('status', '0', false, ['class'=>'cursor required', 'id' => 'no']) !!} Inactive</label>
                    &nbsp;&nbsp;
