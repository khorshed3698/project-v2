{!! Form::open(array('url' => '/settings/api-stakeholder-distribution','method' => 'post', 'class' => 'form-horizontal smart-form','id'=>'stakeholderDistribution',
        'enctype' =>'multipart/form-data', 'files' => 'true', 'role' => 'form')) !!}

<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span>
    </button>
    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-th-large"></i> New Stakeholder Payment Distribution</h4>
</div>
...
<div class="modal-body">
    ...
    <input name="process_type_id" type="hidden"
           value="{{ \App\Libraries\Encryption::encodeId($paymentConfig->process_type_id) }}">
    <input name="stackholder_id" type="hidden"
           value="{{ \App\Libraries\Encryption::encodeId($paymentConfig->stackholder_id) }}">
    {{--    <div class="row">--}}
    {{--        <div class="col-lg-12">--}}
    {{--            <div class="form-group col-md-12 {{$errors->has('sp_pay_stakeholder_id') ? 'has-error' : ''}}">--}}
    {{--                {!! Form::label('stakeholder_name','Stakeholder : ',['class'=>'col-md-4 text-right required-star']) !!}--}}
    {{--                <div class="col-md-8">--}}
    {{--                    {!! Form::text('stakeholder_name', null, ['class'=>'form-control required input-sm','placeholder'=>'Stakeholder Name']) !!}--}}
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group col-md-12 {{$errors->has('receiver_account_no') ? 'has-error' : ''}}">
                ...
                <div class="col-md-8">
                    {!! Form::text('receiver_account_no', null, ['class'=>'form-control required input-sm','placeholder'=>'Receiver Account No']) !!}
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group col-md-12 {{$errors->has('category') ? 'has-error' : ''}}">
                ...
                <div class="col-md-8">
                    {!! Form::text('category', null, ['class'=>'form-control required input-sm', 'placeholder'=>'Category']) !!}
        ...
        <div class="col-md-12">
            <div class="form-group col-md-12 {{$errors->has('status') ? 'has-error' : ''}}">
                ...
                <div class="col-md-8 {{$errors->has('status') ? 'has-error' : ''}}">
                    <label>{!! Form::radio('status', 1, true, ['class'=>'required', 'id' => 'yes']) !!} Active</label>
                    <label>{!! Form::radio('status', 0, false, ['class'=>' required', 'id' => 'no']) !!}
                        Inactive</label>
