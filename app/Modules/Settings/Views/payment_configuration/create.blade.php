    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h5><strong>New payment configuration </strong></h5>
            </div>

        {!! Form::open(array('url' => '/settings/store-payment-configuration','method' => 'post', 'class' => 'form-horizontal smart-form', 'id' => 'notice-info',
        ...
        <!-- /.panel-heading -->
            <div class="panel-body">
                ...
                <div class="form-group col-md-12 {{$errors->has('status') ? 'has-error' : ''}}">
                    ...
                    <div class="col-md-9">
                        <label>{!! Form::radio('status', '1', false, ['class'=>'cursor required', 'id' => 'active']) !!} Active</label>
                        &nbsp;&nbsp;
                        <label>{!! Form::radio('status', '0', true, ['class'=>'cursor required', 'id' => 'inactive']) !!} Inactive</label>
                        &nbsp;&nbsp;
