{!! Form::open(array('url' => '/settings/stakeholder-distribution','method' => 'post', 'class' => 'form-horizontal smart-form','id'=>'stakeholderDistribution',
        ...
        <div class="col-md-12">
            <div class="form-group col-md-12 {{$errors->has('status') ? 'has-error' : ''}}">
                ...
                <div class="col-md-8 {{$errors->has('fix_status') ? 'has-error' : ''}}">
                    <label>{!! Form::radio('fix_status', 1, true, ['class'=>'required', 'id'=>'fixed']) !!} Fixed</label>
                    <label>{!! Form::radio('fix_status', 0, false, ['class'=>' required', 'id'=>'un_fixed']) !!} Unfixed</label>
        ...
        <div class="col-md-12">
            <div class="form-group col-md-12 {{$errors->has('status') ? 'has-error' : ''}}">
                ...
                <div class="col-md-8 {{$errors->has('status') ? 'has-error' : ''}}">
                    ...
                    <label>{!! Form::radio('status', 0, false, ['class'=>' required', 'id' => 'no']) !!} Inactive</label>
