{!! Form::open(array('url' => '/settings/sector/store-sub-sector','method' => 'post', 'class' => 'form-horizontal smart-form','id'=>'subSectorForm',
        'enctype' =>'multipart/form-data', 'files' => 'true', 'role' => 'form')) !!}

<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
    <h4 class="modal-title" id="myModalLabel"> <i class="fa fa-th-large"></i> Create Sub Sector</h4>
</div>
...
<div class="modal-body">
    ...
    <div class="row">
        <div class="col-lg-12">
            <input name="sector_id" type="hidden" value="{{ \App\Libraries\Encryption::encodeId($sectorInfo->id) }}">
            <div class="form-group col-md-12 {{$errors->has('name') ? 'has-error' : ''}}">
                {!! Form::label('name','Name: ',['class'=>'col-md-2  required-star']) !!}
                <div class="col-md-10">
                    {!! Form::text('name', null, ['class'=>'form-control required input-sm','placeholder'=>'sub sector name']) !!}
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="form-group col-md-12 {{$errors->has('division_id') ? 'has-error' : ''}}">
                ...
                <div class="col-md-4">
                    {!! Form::select('division_id', $division_list, '', ['class'=>'form-control required input-sm','placeholder'=>'Select one']) !!}
