    ...
    <div class="col-lg-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h5> <strong>{!!trans('messages.area_edit')!!}</strong> </h5>
            </div><!-- /.panel-heading -->
            <?php
            ...
            <div class="panel-body">
                {!! Form::open(array('url' => '/settings/update-area/'.$id,'method' => 'patch', 'class' => 'form-horizontal', 'id' => 'area-info', 'enctype' =>'multipart/form-data', 'files' => 'true', 'role' => 'form')) !!}
                <div class="col-md-12 form-group {{$errors->has('area_type') ? 'has-error' : ''}}">
                    {!! Form::label('area_type','Area Type: ',['class'=>'col-md-3 control-label']) !!}
                    <div class="col-md-5">
                        <label>{!! Form::radio('area_type',  3,  $data->area_type == 3, ['class' => ' required area_type', 'id' => 'area_type_thana']) !!}
                            Thana </label>&nbsp;&nbsp;
                        <label>{!! Form::radio('area_type', 2, $data->area_type == 2, ['class' => 'required area_type', 'id' => 'area_type_district']) !!}
                            District </label>&nbsp;&nbsp;
                        <label> {!! Form::radio('area_type', 1,  $data->area_type == 1, ['class' => 'required area_type', 'id' => 'area_type_division']) !!}
                            Division</label>
                ...
                <div class="col-md-12 form-group {{$errors->has('division') ? 'has-error' : ''}}" id="division_div">
                ...
                <div class="col-md-12 form-group {{$errors->has('district') ? 'has-error' : ''}}" id="district_div">
                ...
                <div class="col-md-12 form-group{{$errors->has('area_nm') ? 'has-error' : ''}}">
                ...
                <div class="col-md-12 form-group{{$errors->has('area_nm_ban') ? 'has-error' : ''}}">
