        ...
        <div class="panel panel-primary">
            <div class="panel-group panel-primary">
                <div class="panel-heading">
                    <h5><strong> {!! trans('messages.branch') !!}</strong></h5>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    <div class="col-md-9">
                        {!! Form::open(array('url' => '/settings/store-branch','method' => 'post', 'class' => 'form-horizontal', 'id' => 'bank-info',
                        ...
                        <div class="form-group col-md-12 {{$errors->has('bank_id') ? 'has-error' : ''}}">
                            ...
                            <div class="col-md-8">
                                {!! Form::select('bank_id',$banks,'',['class'=>'form-control input-sm required', 'id' => 'bank_id']) !!}
                            </div>
                        </div>
                        ...
                        <div class="form-group col-md-12 {{$errors->has('district') ? 'has-error' : ''}}">
                            ...
                            <div class="col-md-8">
                                {!! Form::select('district', $districts,'',['class'=>'form-control input-md cusReadonly', 'id' => 'district', 'onchange'=>"getThanaByDistrictId('district', this.value, 'thana', " .")"]) !!}
                        ...
                        <div class="form-group col-md-12 {{$errors->has('district') ? 'has-error' : ''}}">
                            ...
                            <div class="col-md-8">
                                {!! Form::select('thana', [],'',['class'=>'form-control input-md cusReadonly', 'placeholder' => 'Select District First','id' => 'thana']) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        @if(ACL::getAccsessRight('settings','A'))
                            <button type="submit" class="btn btn-primary pull-right" id="isSubmit">
