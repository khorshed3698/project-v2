...
<div class="col-lg-12">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading" style="font-size: large;">
            <b> Dashboard Slider </b>
        </div>
        <!-- /.panel-heading -->
        <div class="panel-body">
            {!! Form::open(array('url' => '/settings/store-dashboard-slider','method' => 'post', 'class' => 'form-horizontal smart-form', 'id' => 'notice-info',
            ...
            <div class="form-group col-md-12 {{$errors->has('url') ? 'has-error' : ''}}">
                ...
                <div class="col-md-9">
                    {!! Form::text('url', '', ['class'=>'form-control bnEng', 'size' => "10x5"]) !!}
            ...
            <div class="form-group col-md-12"style="padding-top: 20px">
                <div class="col-md-6 {{$errors->has('status') ? 'has-error' : ''}}" style="padding: 0px">
                ...
                <div class="col-md-5 {{$errors->has('order') ? 'has-error' : ''}}" style="padding: 0px">
                    ...
                    <div class="col-md-8">
                        {!! Form::number('order', '', ['class'=>'form-control bnEng', 'min' => '0', 'size' => "10x5"]) !!}
