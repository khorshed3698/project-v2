...
@section('content')
    ...
    <div class="col-lg-12">
        ...
        {!! Form::open(array('url' => '/settings/update-regulatory-agency-details/'.$encrypted_id,'method' => 'post', 'class' => 'form-horizontal',
        ...
        <!-- /.panel-heading -->
            <div class="panel-body">
                <div class="form-group col-md-12 {{$errors->has('regulatory_agencies_id') ? 'has-error' : ''}} ">
                    ...
                    <div class="col-md-9">
                        {!! Form::select('regulatory_agencies_id', $regulatory_agency, null, ['class' => 'form-control readonly required']) !!}
                ...
                <div class="form-group col-md-12 {{$errors->has('service_name') ? 'has-error' : ''}}">
                    ...
                    <div class="col-md-9">
                        {!! Form::text('service_name', $data->service_name, ['class' => 'form-control', 'id' => 'service_name']) !!}
                ...
                <div class="form-group col-md-12 {{$errors->has('is_online') ? 'has-error' : ''}}">
                    ...
                    <div class="col-md-9">
                        <label class="radio-inline">{!! Form::radio('is_online', '1', $data->is_online == '1', ['class'=>'required', 'id' => 'is_online_yes']) !!} YES</label>
                        <label class="radio-inline">{!! Form::radio('is_online', '0', $data->is_online == '0', ['class'=>'required', 'id' => 'is_online_no']) !!} NO</label>
                ...
                <div class="form-group col-md-12 {{$errors->has('method_of_recv_service') ? 'has-error' : ''}}">
                    ...
                    <div class="col-md-9 maxTextCountDown">
                        {!! Form::textarea('method_of_recv_service', $data->method_of_recv_service, ['placeholder'=>'Write details Here', 'class' => 'form-control input-md',
                ...
                <div class="form-group col-md-12 {{$errors->has('who_get_service') ? 'has-error' : ''}}">
                    ...
                    <div class="col-md-9 maxTextCountDown">
                        {!! Form::textarea('who_get_service',$data->who_get_service, ['placeholder'=>'Write details Here', 'class' => 'form-control input-md',
                ...
                <div class="form-group col-md-12 {{$errors->has('documents') ? 'has-error' : ''}}">
                    ...
                    <div class="col-md-9 maxTextCountDown">
                        {!! Form::textarea('documents',$data->documents, ['placeholder'=>'Write details Here', 'class' => 'form-control input-md',
                ...
                <div class="form-group col-md-12 {{$errors->has('fees') ? 'has-error' : ''}}">
                    ...
                    <div class="col-md-9">
                        {!! Form::text('fees', $data->fees, ['class' => 'form-control', 'id' => 'fees']) !!}
