...
@section('page_heading', 'User Desk Creation')
...
<div class="col-lg-12">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            {!! Form::open(array('url' => '/settings/store-user-desk','method' => 'patch', 'class' => 'form-horizontal smart-form', 'id' => 'user-desk-form',
            ...
            <div class="form-group col-md-8 {{$errors->has('desk_name') ? 'has-error' : ''}}">
                ...
                <div class="col-md-7">
                    {!! Form::text('desk_name', '', ['class'=>'form-control required', 'data-rule-maxlength'=>'40']) !!}
            ...
            <div class="form-group col-md-8 {{$errors->has('desk_status') ? 'has-error' : ''}}">
                ...
                <div class="col-md-7">
                    <label>{!! Form::radio('desk_status', '1', true, ['class'=>'required']) !!} Active</label>
                    &nbsp;&nbsp;
                    <label>{!! Form::radio('desk_status', '0', false, ['class'=>'required']) !!} Inactive</label>
                </div>
            </div>
            ...
            <div class="form-group col-md-8 {{$errors->has('delegate_to_desk') ? 'has-error' : ''}}">
                ...
                <div class="col-md-7">
                    {!! Form::select('delegate_to_desk', $desks, '', ['class'=>'form-control', 'data-rule-maxlength'=>'40', 'placeholder' => 'Select One']) !!}
