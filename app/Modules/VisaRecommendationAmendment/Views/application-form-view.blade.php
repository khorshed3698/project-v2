...
{{--                        <a href="/visa-recommendation-amendment/app-pdf/{{ Encryption::encodeId($appInfo->id)}}"--}}
{{--                           target="_blank"--}}
                            ...
                            <div class="col-md-12">
                                ...
                                @else
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-xs-6">
                                            {{ (!empty($appInfo->manually_approved_vr_no)) ? $appInfo->manually_approved_vr_no : ''  }}
                                        </div>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-8 col-xs-9">
                                        <span class="v_label">
                                             Effective date of the previous VR
                                        </span>
                                        <span class="pull-right">&#58;</span>
                                    </div>
                                    <div class="col-md-4 col-xs-3">
                                        {{ (!empty($appInfo->issue_date_of_prev_vr)) ? date('d-M-Y', strtotime($appInfo->issue_date_of_prev_vr)) : ''  }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-xs-3">
                                        {{ (!empty($getAppType->name)) ? $getAppType->name : ''  }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4 app-common-green">
                                    {{ (!empty($appInfo->n_emp_name) ? $appInfo->n_emp_name : '&nbsp;') }}
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4 app-common-green">
                                    {{ (!empty($appInfo->n_emp_designation) ? $appInfo->n_emp_designation : '&nbsp;') }}
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4 app-common-green">
                                    {{ (!empty($appInfo->n_emp_passport_no) ? $appInfo->n_emp_passport_no : '&nbsp;') }}
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4 app-common-green">
                                    {{ (isset($appInfo->n_emp_nationality_name) ? $appInfo->n_emp_nationality_name : '&nbsp;') }}
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            @if($appInfo->app_type_id !=5)
                                <div class="col-md-12">
                                    <div style="border: 1px solid #ddd; border-top: none;padding: 5px;">Bangladesh
                                        embassy/
                                        high commission in abroad where recommendation letter to be sent:
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 app-common">
                                        <span class="v_label">Select desired country</span>
                                    </div>
                                    <div class="col-md-4 app-common-yellow">
                                        {{ (!empty($appInfo->mission_country_name))? $appInfo->mission_country_name :'&nbsp;'  }}
                                    </div>
                                    <div class="col-md-4 app-common-green">
                                        {{ (!empty($appInfo->n_mission_country_name) ? $appInfo->n_mission_country_name : '&nbsp;') }}
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4 app-common-green">
                                        {{ (isset($appInfo->n_high_commision_id) ? $appInfo->n_high_commision_name.','.$appInfo->n_high_commision_address : '&nbsp;')  }}
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                            @endif
                            ...
                            @if($appInfo->app_type_id == 5)
                                <div class="col-md-12">
                                    <div style="border: 1px solid #ddd; border-top: none;padding: 5px;">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4 app-common-green">
                                        {{ (!empty($appInfo->n_airport_name) ? $appInfo->n_airport_name : '&nbsp;') }}
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4 app-common-green">
                                        {{ (!empty($appInfo->n_visa_purpose_name) ? $appInfo->n_visa_purpose_name : '&nbsp;') }}
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                @if(!empty($appInfo->visa_purpose_others) || !empty($appInfo->n_visa_purpose_others))
                                    <div class="col-md-12">
                                        <div class="col-md-1"></div>
                                        <div class="col-md-3"></div>
                                        <div class="col-md-4 app-common-yellow">
                                            {{ (!empty($appInfo->visa_purpose_others))? $appInfo->visa_purpose_others :'&nbsp;'  }}
                                        </div>
                                        <div class="col-md-4 app-common-green">
                                            {{ (!empty($appInfo->n_visa_purpose_others) ? $appInfo->n_visa_purpose_others : '&nbsp;') }}
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                @endif
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 app-common">
                                        <span class="v_label">Arrival date</span>
                                    </div>
                                    <div class="col-md-4 app-common-yellow">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 app-common">
                                        <span class="v_label">Arrival time</span>
                                    </div>
                                    <div class="col-md-4 app-common-yellow">
                                        {{ (($appInfo->arrival_time != '00:00:00') ? date('H:i', strtotime($appInfo->arrival_time)) : '&nbsp;')  }}
                                    </div>
                                    <div class="col-md-4 app-common-green">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4 app-common-green">
                                        {{ (!empty($appInfo->n_arrival_flight_no) ? $appInfo->n_arrival_flight_no : '&nbsp;')  }}
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 app-common">
                                        <span class="v_label">Departure date</span>
                                    </div>
                                    <div class="col-md-4 app-common-yellow">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3 app-common">
                                        <span class="v_label">Departure time</span>
                                    </div>
                                    <div class="col-md-4 app-common-yellow">
                                        {{ (($appInfo->departure_time != '00:00:00') ? date('H:i', strtotime($appInfo->departure_time)) : '&nbsp;')  }}
                                    </div>
                                    <div class="col-md-4 app-common-green">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-4 app-common-green">
                                        {{ (!empty($appInfo->n_departure_flight_no) ? $appInfo->n_departure_flight_no : '&nbsp;')  }}
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-7 col-xs-6">
                                                            {{ ((!empty($appInfo->created_at)) ? date('d-M-Y', strtotime($appInfo->created_at)) : null) }}
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
