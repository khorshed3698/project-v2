...
<script language="javascript">
    ...
    jQuery(function () {
        jQuery('#submitFromPreviewBtn').click(function (e) {
            window.opener.document.getElementById("VisaRecommendationAmendmentForm").setAttribute("target", "_self");
            window.opener.jQuery("#VisaRecommendationAmendmentForm").submit();
            window.close();
        });
    });
...
//        return jQuery(this).find('option:selected').text();
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery("#VisaRecommendationAmendmentForm-p-4").css({"display": "block"});
        ...
        var is_approval_online = jQuery("input[name='is_approval_online']:checked").val();
