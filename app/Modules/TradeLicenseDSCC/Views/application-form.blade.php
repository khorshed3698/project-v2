                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-6">
                                                {!! Form::select('permanent_district',[],'',['class' => 'form-control input-md select2input','placeholder' => 'Select division first','id'=>'permanent_district','onchange'=>"getDistrictByDivisionCustom('permanent_police_station', this.value, 'permanent_police_station')"]) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-6">
                                                {!! Form::select('current_district',[],'',['class' => 'form-control input-md select2input','id'=>'current_district','placeholder' => 'Select division first','onchange'=>"getDistrictByDivisionCustom('police_station', this.value, 'police_station')"]) !!}
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-xs-12">
                                            ...
                                            <div class="col-md-6">
                                                {!! Form::select('police_station',[],'',['class' => 'form-control input-md select2input','id'=>'police_station','placeholder' => 'Select district first']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-xs-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        {!! Form::text('sector_or_section','',['class' => 'form-control input-md ','id'=>'sector_or_section']) !!}
                                                    </div>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-4 col-xs-12">
                                                    ...
                                                    <div class="col-md-6">
                                                        {!! Form::text('area_or_block','',['class' => 'form-control input-md ','id'=>'area_or_block']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-xs-12">
                                                    {!! Form::label('road','Road :',['class'=>'text-left col-md-6']) !!}
                                                    <div class="col-md-6">
                                                        {!! Form::text('road','',['class' => 'form-control input-md ','id'=>'road']) !!}
                                                    </div>
                                                </div>
                                                <div class="col-md-4 col-xs-12">
...
<script>
    ...
    $(document).ready(function () {
        ...
        // National ID & Passport Type Change Event
