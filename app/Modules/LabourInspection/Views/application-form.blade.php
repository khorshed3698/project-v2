                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('factory_name_en') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('factory_name_en','', ['class' => 'form-control input-md required','placeholder'=>'Name of Factory/Establishment', 'id' => 'factory_name']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('factory_name_bn') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('factory_name_bn', '', ['class' => 'form-control input-md required','placeholder'=>'Name of Factory/Establishment (in Bengali)', 'id' => 'factory_name_bn']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 {{$errors->has('correspondence_address_with_factory') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::textarea('correspondence_address_with_factory','',['class'=>'form-control input-md required','id'=>'correspondence_address_with_factory', 'placeholder'=>'Correspondence address with factory','maxlength' => 254, 'rows' => 2, 'cols' => 50]) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('layout_factory_mail_address') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('layout_factory_mail_address','',['class'=>'form-control input-md required','id'=>'layout_factory_mail_address', 'placeholder'=>'Correspondence email address with factory']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('owner_name') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('owner_name', '', ['class' => 'form-control input-md required','placeholder'=>'Name of Owner/Managing Director', 'id' => 'owner_name']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('owner_present_address') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::textarea('owner_present_address','',['class'=>'form-control input-md required','id'=>'owner_present_address', 'placeholder'=>'Present address of owner','maxlength' => 254, 'rows' => 3, 'cols' => 50]) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('owner_permanent_address') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::textarea('owner_permanent_address','',['class'=>'form-control input-md required','id'=>'owner_permanent_address', 'placeholder'=>'Permanent address of owner','maxlength' => 254, 'rows' => 3, 'cols' => 50]) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('nearest_railway_steamer_launch') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('nearest_railway_steamer_launch', '', ['class' => 'form-control input-md required','placeholder'=>'Nearest Railway Station/Steamer Ghat/Launch Ghat', 'id' => 'nearest_railway_steamer_launch']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('nearest_bus_stop') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('nearest_bus_stop', '', ['class' => 'form-control input-md','placeholder'=>'Nearest bus stop', 'id' => 'nearest_bus_stop']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('notify_authority_name') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('notify_authority_name', '', ['class' => 'form-control input-md', 'placeholder'=>'Name of Notifying Authority', 'id' => 'notify_authority_name']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('layout_load_bearing_capacity') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('layout_load_bearing_capacity', '', ['class' => 'form-control input-md', 'placeholder'=>'Capacity of building', 'id' => 'layout_load_bearing_capacity']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('building_plan_approval_date') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                <div class="datepicker input-group date"
                                                    ...
                                                    {!! Form::text('building_plan_approval_date', '', ['class'=>'form-control input-md date', 'id' => 'building_plan_approval_date', 'placeholder'=>'']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('nearest_railway_steamer_launch') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('building_plan_reference_no','',['class'=>'form-control input-md required','id'=>'building_plan_reference_no', 'placeholder'=>'Reference No.']) !!}
