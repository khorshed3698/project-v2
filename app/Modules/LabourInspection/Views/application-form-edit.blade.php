...
$electricity_type_arr = [
    '1' => 'Industrial',
    '2' => 'Residential',
];
$nature_of_the_building_arr = [
    '1' => 'Concrete Structured',
    '2' => 'Tin Shed',
];
$factory_organization_arr = [
    '1' => 'BGMEA',
    '2' => 'BTMEA',
];
?>
            ...
            <div class="box-body">
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        ...
                        <h5 class="">Form 77 - Dhara 3ko and 326 and, Bidhi 7(1), 354, 355(3), 356(2) and 357(1)</h5>
                    </div>
                    <div class="panel-body">
                        {!! Form::open(array('url' => 'licence-applications/labour-inspection-application/store','method' => 'post', 'class' =>'form-horizontal', 'id' => 'NewApplication',
                        ...
                        <input type="hidden" name="app_id"
                               value="{{ \App\Libraries\Encryption::encodeId($app_info->id) }}" id="app_id"/>
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <strong>Basic information of the factory</strong>
                            </div>
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('factory_name_en') ? 'has-error': ''}}">
                                            {!! Form::label('factory_name_en', 'Factory full name (English)',['class'=>'col-md-5 text-left required-star']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('factory_name_en',!empty($app_data->factory_name_en)?$app_data->factory_name_en:'', ['class' => 'form-control input-md required','placeholder'=>'Name of Factory/Establishment', 'id' => 'factory_name']) !!}
                                                {!! $errors->first('factory_name_en','<span class="help-block">:message</span>') !!}
                                            </div>
                                        </div>
                                        <div class="col-md-6 {{$errors->has('factory_name_bn') ? 'has-error': ''}}">
                                            {!! Form::label('factory_name_bn', 'Factory full name (Bengali)',['class'=>'col-md-5 text-left required-star']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('factory_name_bn', !empty($app_data->factory_name_bn)?$app_data->factory_name_bn:'', ['class' => 'form-control input-md required','placeholder'=>'Name of Factory/Establishment (in Bengali)', 'id' => 'factory_name_bn']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('factory_head_office_address') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::textarea('factory_head_office_address',!empty($app_data->factory_name_bn)?$app_data->factory_head_office_address:'',['class'=>'form-control input-md required','id'=>'factory_head_office_address', 'placeholder'=>'Factory Head Office Address','maxlength' => 254, 'rows' => 2, 'cols' => 50]) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('correspondence_address_with_factory') ? 'has-error': ''}}">
                                            {!! Form::label('correspondence_address_with_factory','Correspondence address with factory',['class'=>'col-md-5 text-left']) !!}
                                            <div class="col-md-7">
                                                {!! Form::textarea('correspondence_address_with_factory',!empty($app_data->factory_name_bn)?$app_data->correspondence_address_with_factory:'',['class'=>'form-control input-md required','id'=>'correspondence_address_with_factory', 'placeholder'=>'Correspondence address with factory','maxlength' => 254, 'rows' => 2, 'cols' => 50]) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('layout_factory_mail_address') ? 'has-error': ''}}">
                                            {!! Form::label('layout_factory_mail_address','Correspondence email address with factory',['class'=>'col-md-5 text-left']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('layout_factory_mail_address',!empty($app_data->layout_factory_mail_address)?$app_data->layout_factory_mail_address:'',['class'=>'form-control input-md required','id'=>'layout_factory_mail_address', 'placeholder'=>'Correspondence email address with factory']) !!}
                                                {!! $errors->first('layout_factory_mail_address','<span class="help-block">:message</span>') !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <strong>Identification of the owner</strong>
                            </div>
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('owner_name') ? 'has-error': ''}}">
                                            {!! Form::label('owner_name', 'Name of Owner/Managing Director',['class'=>'col-md-5 text-left required-star']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('owner_name', !empty($app_data->owner_name)?$app_data->owner_name:'', ['class' => 'form-control input-md required','placeholder'=>'Name of Owner/Managing Director', 'id' => 'owner_name']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('owner_present_address') ? 'has-error': ''}}">
                                            {!! Form::label('owner_present_address', 'Present address of owner',['class'=>'col-md-5 text-left required-star']) !!}
                                            <div class="col-md-7">
                                                {!! Form::textarea('owner_present_address',!empty($app_data->owner_present_address)?$app_data->owner_present_address:'',['class'=>'form-control input-md required','id'=>'owner_present_address', 'placeholder'=>'Present address of owner','maxlength' => 254, 'rows' => 3, 'cols' => 50]) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('owner_permanent_address') ? 'has-error': ''}}">
                                            {!! Form::label('owner_permanent_address', 'Permanent address of owner',['class'=>'col-md-5 text-left required-star']) !!}
                                            <div class="col-md-7">
                                                {!! Form::textarea('owner_permanent_address',!empty($app_data->owner_permanent_address)?$app_data->owner_permanent_address:'',['class'=>'form-control input-md required','id'=>'owner_permanent_address', 'placeholder'=>'Permanent address of owner','maxlength' => 254, 'rows' => 3, 'cols' => 50]) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('road_no_en') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('road_no_en', !empty($app_data->road_no_en)?$app_data->road_no_en:'', ['class' => 'form-control input-md required','placeholder'=>'Factory Road No.', 'id' => 'road_no_en']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('road_no_bn') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('road_no_bn', !empty($app_data->road_no_bn)?$app_data->road_no_bn:'', ['class' => 'form-control input-md','placeholder'=>'Factory Road No. (in Bengali)', 'id' => 'road_no_bn']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('holding_name_en') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('holding_name_en', !empty($app_data->holding_name_en)?$app_data->holding_name_en:'', ['class' => 'form-control input-md required','placeholder'=>'Name of House/Holding/Village/Mahalla', 'id' => 'holding_name_en']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('holding_name_bn') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('holding_name_bn', !empty($app_data->holding_name_bn)?$app_data->holding_name_bn:'', ['class' => 'form-control input-md','placeholder'=>'Name of House/Holding/Village/Mahalla (in Bengali)', 'id' => 'holding_name_bn']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('nearest_railway_steamer_launch') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('nearest_railway_steamer_launch', !empty($app_data->nearest_railway_steamer_launch)?$app_data->nearest_railway_steamer_launch:'', ['class' => 'form-control input-md required','placeholder'=>'Nearest Railway Station/Steamer Ghat/Launch Ghat', 'id' => 'nearest_railway_steamer_launch']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('nearest_bus_stop') ? 'has-error': ''}}">
                                            {!! Form::label('nearest_bus_stop', 'Nearest bus stop',['class'=>'col-md-5 text-left']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('nearest_bus_stop', !empty($app_data->nearest_bus_stop)?$app_data->nearest_bus_stop:'', ['class' => 'form-control input-md','placeholder'=>'Nearest bus stop', 'id' => 'nearest_bus_stop']) !!}
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <strong>Building renovation information</strong>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('notify_authority_name') ? 'has-error': ''}}">
                                            {!! Form::label('notify_authority_name', 'Name of Notifying Authority',['class'=>'col-md-5 text-left required-star']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('notify_authority_name', !empty($app_data->notify_authority_name)?$app_data->notify_authority_name:'', ['class' => 'form-control input-md', 'placeholder'=>'Name of Notifying Authority', 'id' => 'notify_authority_name']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('layout_load_bearing_capacity') ? 'has-error': ''}}">
                                            {!! Form::label('layout_load_bearing_capacity', 'Load carrying capacity of building',['class'=>'col-md-5 text-left required-star']) !!}
                                            <div class="col-md-7">
                                                {!! Form::text('layout_load_bearing_capacity', !empty($app_data->layout_load_bearing_capacity)?$app_data->layout_load_bearing_capacity:'', ['class' => 'form-control input-md', 'placeholder'=>'Capacity of building', 'id' => 'layout_load_bearing_capacity']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('building_plan_approval_date') ? 'has-error': ''}}">
                                            {!! Form::label('building_plan_approval_date', 'Date of Approval',['class'=>'col-md-5 text-left required-star']) !!}
                                            <div class="col-md-7">
                                                <div class="datepicker input-group date"
                                                     data-date-format="dd-mm-yyyy">
                                                    {!! Form::text('building_plan_approval_date', !empty($app_data->building_plan_approval_date)?$app_data->building_plan_approval_date:'', ['class'=>'form-control input-md date', 'id' => 'building_plan_approval_date', 'placeholder'=>'']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('nearest_railway_steamer_launch') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('building_plan_reference_no',!empty($app_data->building_plan_reference_no)?$app_data->building_plan_reference_no:'',['class'=>'form-control input-md required','id'=>'building_plan_reference_no', 'placeholder'=>'Reference No.']) !!}
                        ...
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <strong>Information regarding work environment</strong>
                            </div>
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="row">
...
{{--                                                    {{ dd($app_data->factory_machine_type,$app_data->factory_machine_measurement,$app_data->factory_machine_location,$app_data->factory_machine_amount) }}--}}
                                                    @foreach($app_data->factory_machine_type as $key => $value)
                                                        <tr id="factoryEnvironmentTableRow_{{$inc}}" data-number="{{$inc}}">
                                                            <td>
                                                                {!! Form::text('factory_machine_type[]', !empty($app_data->factory_machine_type[$key])?$app_data->factory_machine_type[$key]:'', ['class' => 'form-control input-md', 'placeholder'=>'Type of machine', 'id' => 'factory_machine_type_'.$key]) !!}
                                                            </td>
                                                            <td>
                                                                {!! Form::text('factory_machine_measurement[]', !empty($app_data->factory_machine_measurement[$key])?$app_data->factory_machine_measurement[$key]:'', ['class' => 'form-control input-md', 'placeholder'=>'Number/Measurement', 'id' => 'factory_machine_measurement_'.$key]) !!}
                                                            </td>
                                                            <td>
                                                                {!! Form::text('factory_machine_location[]', !empty($app_data->factory_machine_location[$key])?$app_data->factory_machine_location[$key]:'', ['class' => 'form-control input-md', 'placeholder'=>'Location', 'id' => 'factory_machine_location_'.$key]) !!}
                                                            </td>
                                                            <td>
                                                                {!! Form::text('factory_machine_amount[]', !empty($app_data->factory_machine_amount[$key])?$app_data->factory_machine_amount[$key]:'', ['class' => 'form-control input-md', 'placeholder'=>'Amount of load generated', 'id' => 'factory_machine_amount_'.$key]) !!}
                                                            </td>
                                                            <td>
                                                                <?php if ($inc == 0) { ?>
                                                                ...
                                                                <a href="javascript:void(0);"
                                                                   ...
                                                                   onclick="removeTableRow('factoryEnvironmentTable','factoryEnvironmentTableRow_{{$inc}}');">
                                                                    <i class="fa fa-times"
                                                ...
                                                @else
                                                    <tr id="factoryEnvironmentTableRow_0" data-number="0">
                                                        <td>
                                                            {!! Form::text('factory_machine_type[]', null, ['class' => 'form-control input-md', 'placeholder'=>'Type of machine', 'id' => 'factory_machine_type_0']) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('factory_machine_measurement[]', null, ['class' => 'form-control input-md', 'placeholder'=>'Number/Measurement', 'id' => 'factory_machine_measurement_0']) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('factory_machine_location[]', null, ['class' => 'form-control input-md', 'placeholder'=>'Location', 'id' => 'factory_machine_location_0']) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('factory_machine_amount[]', null, ['class' => 'form-control input-md', 'placeholder'=>'Amount of load generated', 'id' => 'factory_machine_amount_0']) !!}
                                                        </td>
                                                        <td>
                                                            <a href="javascript:void(0);"
                                                               class="btn btn-xs btn-primary addTableRows"
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="docListDiv">
                                            @include('LabourInspection::documents')
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function dependantCallbackResponse(response, [calling_id, selected_value, element_id, element_name, element_calling_id, dependant_select_id]) {
            ...
            $("#" + dependant_select_id).trigger('change');// multiple dropdown
            $("#" + calling_id).next().hide()
        }
        ...
        $('#license_type_id').on('keydown', function (el) {
            ...
            let selected_value = '{{!empty($app_data->license_type_id) ? $app_data->license_type_id:''}}'; // for callback
        ...
        $('#industry_id').on('keydown', function (el) {
            ...
            let selected_value = '{{!empty($app_data->industry_id) ? $app_data->industry_id:''}}'; // for callback
            let calling_id = $(this).attr('id');// for callback
            let element_id = "id";//dynamic id for callback
            let element_name = "nameEn";//dynamic name for callback
            let element_calling_id = "";//dynamic name for callback
        ...
        $('#electricity_type').on('keydown', function (el) {
            ...
            let selected_value = '{{!empty($app_data->electricity_type) ? $app_data->electricity_type:''}}'; // for callback
            let calling_id = $(this).attr('id');// for callback
            let element_id = "id";//dynamic id for callback
            let element_name = "nameEn";//dynamic name for callback
            let element_calling_id = "";//dynamic name for callback
        ...
        $('#division_id').on('keydown', function (el) {
            ...
            let selected_value = '{{!empty($app_data->division_id) ? $app_data->division_id:''}}';
            // for callback
            let calling_id = $(this).attr('id');// for callback
            let element_id = "id";//dynamic id for callback
        ...
        $("#division_id").on("change", function (el) {
            ...
            if (division_id) {
                ...
                let selected_value = '{{!empty($app_data->district_id) ? $app_data->district_id:''}}';
                let calling_id = $(this).attr('id');// for callback
        ...
        $("#district_id").on("change", function (el) {
            ...
            if (district_id) {
                ...
                let selected_value = '{{!empty($app_data->upazilla_id) ? $app_data->upazilla_id:''}}';
                let calling_id = $(this).attr('id');// for callback
        ...
        $("#upazilla_id").on("change", function (el) {
            ...
            if (upazilla_id) {
                ...
                let selected_value = '{{!empty($app_data->post_office) ? $app_data->post_office:''}}';
                let calling_id = $(this).attr('id');// for callback
    ...
    function addrowDife(tableID, templateRow) {
        ...
        if (rowCount < 8) {
            ...
            var idText = templateRow.replace('_0') + '_' + rowCount;
    ...
    function openManagingAuthorityModal() {
        ...
        $.ajax({
            type: 'post',
            url: "{{ url('licence-applications/labour-inspection-application/ajax/managing-authority-modal') }}",
            data: {
    ...
    function managementAuthorityFormSubmit(btn) {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ url('licence-applications/labour-inspection-application/ajax/managing-authority-form') }}",
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
