            ...
            <div class="box-body">
                ...
                @if($viewMode == 'on' && in_array(Auth::user()->user_type,['5x505']) && in_array($appInfo->status_id, [15, 32]))
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            {!! Form::open(array('url' => 'office-permission-extension/payment','method' => 'post','id' => 'OPEPayment','enctype'=>'multipart/form-data',
                ...
                @if($viewMode == 'on' && in_array(Auth::user()->user_type, ['5x505']) && in_array($appInfo->status_id, [17,31]))
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            {!! Form::open(array('url' => 'office-permission-extension/conditionalApproveStore','method' => 'post','id' => 'OPEPayment','enctype'=>'multipart/form-data',
                                    'method' => 'post', 'files' => true, 'role'=>'form')) !!}
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h5><b>Application for Office Permission Extension</b></h5>
                        </div>
                        <div class="pull-right">
                            ...
                            @if(!in_array($appInfo->status_id,[-1,5,6,22]))
                                <a href="/office-permission-extension/app-pdf/{{ Encryption::encodeId($appInfo->id)}}" target="_blank"
                    ...
                    <div class="panel-body">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 {{$errors->has('is_approval_online') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            ...
                                                            <label class="radio-inline">{!! Form::radio('is_approval_online','yes', ($appInfo->is_approval_online == 'yes' ? true :false), ['class'=>'cusReadonly helpTextRadio','id' => 'yes', 'onclick' => 'isApprovalOnline(this.value)']) !!}  Yes</label>
                                                            @endif
                                                            @if ($appInfo->is_approval_online == 'no')
                                                            <label class="radio-inline">{!! Form::radio('is_approval_online', 'no', ($appInfo->is_approval_online == 'no' ? true :false), ['class'=>'cusReadonly', 'id' => 'no', 'onclick' => 'isApprovalOnline(this.value)']) !!}  No</label>
                                                            @endif
                                                        </div>
                                                    </div>
                                    ...
                                    <fieldset class="scheduler-border" id="duration_div">
                                        <legend class="scheduler-border">Desired Permission</legend>
                                        <div class="form-group" style="margin-top:15px">
                                            <div class="row">
                                                <div class="col-md-12 {{$errors->has('is_remittance_allowed') ? 'has-error': ''}}">
                                                    {!! Form::label('is_remittance_allowed','Is outward remittance of any kind from Bangladesh sources will be allowed ?',['class'=>'col-md-7 text-left']) !!}
                                                    <div class="col-md-4">

                                                        <label class="radio-inline">{!! Form::radio('is_remittance_allowed','yes', ($appInfo->is_remittance_allowed == 'yes' ? 'checked' :''), ['class'=>'cusReadonly helpTextRadio','id' => 'yes']) !!}
                                                            Yes
                                                        </label>

                                                        <label class="radio-inline">{!! Form::radio('is_remittance_allowed', 'no', ($appInfo->is_remittance_allowed == 'no' ? 'checked' :''), ['class'=>'cusReadonly', 'id' => 'no']) !!}
                                                            No
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 {{$errors->has('duration_start_date') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div id="duration_start_datepicker" class="input-group date">
                                                            {!! Form::text('desired_start_date', !empty($appInfo->desired_start_date) ? date('d-M-Y', strtotime($appInfo->desired_start_date)) : '', ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'duration_start_date']) !!}
                                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        </div>
                                                ...
                                                <div class="col-md-6 {{$errors->has('duration_end_date') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div id="duration_end_datepicker" class="input-group date">
                                                            {!! Form::text('desired_end_date', !empty($appInfo->desired_end_date) ? date('d-M-Y', strtotime($appInfo->desired_end_date)) : '', ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'duration_end_date']) !!}
                                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('desired_duration') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('extension_year', $appInfo->extension_year, ['class' => 'form-control input-md', 'readonly', 'id' => 'desired_duration']) !!}
                                    ...
                                    <fieldset class="scheduler-border" id="inwardRemittanceDiv">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('last_remittance_year') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::selectRange('last_remittance_year',date('Y'), 1990, $appInfo->last_remittance_year,['class' => 'form-control input-md cusReadonly', 'id' => 'last_remittance_year', 'placeholder'=>'Select one']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('inward_remittance') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('inward_remittance', $appInfo->inward_remittance,['class' => 'form-control input-md', 'id' => 'inward_remittance']) !!}
                        ...
                        <fieldset>
                            ...
                            @include('OfficePermissionExtension::basic-info')
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_company_name') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_company_name', $appInfo->c_company_name, ['class'=>'form-control input-md cusReadonly required', 'data-rule-maxlength'=>'255', 'id'=>"c_company_name"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_org_type') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('c_org_type', $organizationTypes, $appInfo->c_org_type,['class' => 'form-control cusReadonly input-md','placeholder' => 'Select One', 'id' => 'c_org_type']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('local_company_name') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('local_company_name', $appInfo->local_company_name, ['class'=>'form-control input-md cusReadonly bigInputField', 'data-rule-maxlength'=>'255', 'id'=>"local_company_name"]) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('local_company_name_bn') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('local_company_name_bn', $appInfo->local_company_name_bn, ['class'=>'form-control input-md cusReadonly bigInputField', 'data-rule-maxlength'=>'255', 'id'=>"local_company_name_bn"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_division_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_division_id', $divisions, $appInfo->ex_office_division_id, ['class' => 'form-control cusReadonly required input-md', 'id' => 'ex_office_division_id', 'onchange'=>"getDistrictByDivisionId('ex_office_division_id', this.value, 'ex_office_district_id', ". $appInfo->ex_office_district_id .")"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_thana_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_thana_id', $thana_eng, $appInfo->ex_office_thana_id, ['class' => 'form-control required cusReadonly input-md']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_post_office') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_post_office', $appInfo->ex_office_post_office, ['class' => 'form-control cusReadonly input-md']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_email') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_email', $appInfo->ex_office_email, ['class' => 'form-control required cusReadonly input-md']) !!}
                                        ...
                                        <div class="col-md-12" style="padding:0">
                                            <div class="table-responsive">
                                                <table aria-label="Detailed Report Data Table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            {!! Form::text('local_executive', $appInfo->local_executive, ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'local_executive']) !!}
                                                            {!! $errors->first('local_executive','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('local_stuff', $appInfo->local_stuff, ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'local_stuff']) !!}
                                                        ...
                                                        <td>
                                                            {!! Form::text('foreign_executive', $appInfo->foreign_executive, ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'foreign_executive']) !!}
                                                            {!! $errors->first('foreign_executive','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('foreign_stuff', $appInfo->foreign_stuff, ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'foreign_stuff']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('est_initial_expenses') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('est_initial_expenses', $appInfo->est_initial_expenses,['class' => 'form-control input-md number', 'id' => 'est_initial_expenses']) !!}
                        ...
                        <fieldset>
                            ...
                            @if($viewMode != 'off')
                                @include('OfficePermissionExtension::doc-tab')
                            @endif
                        </fieldset>
                        ...
                        @if(ACL::getAccsessRight('OfficePermissionExtension','-E-') && $viewMode != "on" && $appInfo->status_id != 6 && Auth::user()->user_type == '5x505')
...
//            $(".cusReadonly").prop('readonly', false);
//            $(".cusReadonly option:not(:selected)").prop('disabled', false);
//            $(".cusReadonly:radio:not(:checked)").attr('disabled', false);
//            $(".cusReadonlyPhoto").attr('disabled', false);
...
//
    ...
    @if ($viewMode == 'on')
    $('#OfficePermissionExtensionForm .stepHeader').hide();
    $('#OfficePermissionExtensionForm :input').attr('disabled', true);
    $('#OfficePermissionExtensionForm').find('.MoreInfo').attr('disabled', false);
    ...
    $('#OfficePermissionExtensionForm :input[type=file]').hide();
    $('.addTableRows').hide();
