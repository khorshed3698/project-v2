...
{{--                    </a>--}}
                    ...
                    @if(!in_array($appInfo->status_id,[-1,5,6]))
                        <a href="/office-permission-extension/app-pdf/{{ Encryption::encodeId($appInfo->id)}}" target="_blank" class="btn btn-md btn-danger">
                    ...
                    <fieldset class="scheduler-border">
                        ...
                        <div class="row">
                            <div class="col-md-7 col-xs-6">
                                <span class="v_label">Is outward remittance of any kind from Bangladesh sources will be allowed?</span>
                                <span class="pull-right">&#58;</span>
                            </div>
                            <div class="col-md-5 col-xs-6">
                                {{ (!empty($appInfo->approved_is_remittance_allowed)) ? ucfirst($appInfo->approved_is_remittance_allowed) : '' }}
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h5 style="padding-left: 0;"><strong>Extension time:</strong></h5>
                            </div>
                        </div>
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        @if($appInfo->is_approval_online == 'no')
                            <div class="row">
                                <div class="col-md-5 col-xs-6">
                                    <span class="v_label">Manually approved office permission reference no.</span>
                                    <span class="pull-right">&#58;</span>
                                </div>
                                <div class="col-md-7 col-xs-6">
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5 col-xs-6">
                                    {{ (!empty($appInfo->is_remittance_allowed)) ? ucfirst($appInfo->is_remittance_allowed) : '' }}
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-md-12">
                                    <h5 style="padding-left: 0px;"><strong>Extension time:</strong></h5>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-xs-6">
                                            {{ (!empty($appInfo->desired_start_date)) ? $appInfo->desired_start_date : '' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-xs-6">
                                            {{ (!empty($appInfo->desired_end_date)) ? $appInfo->desired_end_date:''  }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        ...
                                        <div class="col-md-7 col-xs-6">
                                            {{ (!empty($appInfo->extension_year)) ? $appInfo->extension_year : '' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-5 col-xs-6">
                                            <span class="v_label">Last remittance year</span>
                                            <span class="pull-right">&#58;</span>
                                        </div>
                                        <div class="col-md-7 col-xs-6">
                                            {{ (!empty($appInfo->last_remittance_year)) ? $appInfo->last_remittance_year : '' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-5 col-xs-6">
                                            <span class="v_label">Inward remittance</span>
                                            <span class="pull-right">&#58;</span>
                                        </div>
                                        <div class="col-md-7 col-xs-6">
                                            {{ (!empty($appInfo->inward_remittance)) ? $appInfo->inward_remittance:''  }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-5 col-xs-6">
                                            <span class="v_label">Effective date of first office permission</span>
                                            <span class="pull-right">&#58;</span>
                                        </div>
                                        <div class="col-md-7 col-xs-6">
