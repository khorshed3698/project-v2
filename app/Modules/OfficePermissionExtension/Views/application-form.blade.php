<?php
$accessMode = ACL::getAccsessRight('OfficePermissionExtension');
            ...
            <div class="box-body">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h5><strong>Application for Office Permission Extension</strong></h5>
                        </div>
                        <div class="pull-right">
                            <a href="{{ asset('assets/images/SampleForm/office_permission_extension.pdf') }}" target="_blank" rel="noopener" class="btn btn-warning">
                    ...
                    <div class="panel-body">
                        {!! Form::open(array('url' => 'office-permission-extension/store','method' => 'post','id' => 'OfficePermissionExtensionForm','enctype'=>'multipart/form-data',
                        ...
                        <input type="hidden" name="ref_app_approve_date" value="{{ (Session::get('opeInfo.approved_date') ? Session::get('opeInfo.approved_date') : '') }}">
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('is_approval_online') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    <label class="radio-inline">{!! Form::radio('is_approval_online','yes', (Session::get('opeInfo.is_approval_online') == 'yes' ? true :false), ['class'=>'cusReadonly required helpTextRadio', 'id'=>'yes', 'onclick' => 'isApprovalOnline(this.value)']) !!}  Yes</label>
                                                    <label class="radio-inline">{!! Form::radio('is_approval_online', 'no', (Session::get('opeInfo.is_approval_online') == 'no' ? true :false), ['class'=>'cusReadonly required', 'id'=>'no','onclick' => 'isApprovalOnline(this.value)']) !!}  No</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div id="ref_app_tracking_no_div" class="col-md-12 hidden {{$errors->has('ref_app_tracking_no') ? 'has-error': ''}}">
                                                {!! Form::label('ref_app_tracking_no','Please provide your office permission tracking No.',['class'=>'col-md-5 text-left required-star']) !!}
                                                <div class="col-md-7">
                                                    <div class="input-group">
                                                        {!! Form::text('ref_app_tracking_no', Session::get('opeInfo.ref_app_tracking_no'), ['data-rule-maxlength'=>'100', 'class' => 'form-control cusReadonly input-sm']) !!}
                                                        {!! $errors->first('ref_app_tracking_no','<span class="help-block">:message</span>') !!}
                                                        <span class="input-group-btn">
                                                            @if(Session::get('opeInfo'))
                                                                <button type="submit" class="btn btn-danger btn-sm" value="clean_load_data" name="actionBtn">Clear Loaded Data</button>

                                                                <a href="{{ Session::get('opeInfo.certificate_link') }}" target="_blank" rel="noopener" class="btn btn-success btn-sm">View Certificate</a>

                                                            @else
                                                                <button type="submit" class="btn btn-success btn-sm cancel" value="searchOPNinfo" name="searchOPNinfo" id="searchOPNinfo">Load Office Permission Data</button>
                                                            @endif
                                                        </span>
                                                    </div>
                                    ...
                                    <fieldset class="scheduler-border hidden" id="duration_div">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-12 {{$errors->has('is_remittance_allowed') ? 'has-error': ''}}">
                                                    {!! Form::label('is_remittance_allowed','Is outward remittance of any kind from Bangladesh sources will be allowed ?',['class'=>'col-md-7 text-left required-star']) !!}
                                                    <div class="col-md-4">
                                                        <label class="radio-inline">{!! Form::radio('is_remittance_allowed','yes','', ['class'=>'cusReadonly required helpTextRadio', 'id'=>'yes']) !!}  Yes</label>
                                                        <label class="radio-inline">{!! Form::radio('is_remittance_allowed', 'no','', ['class'=>'cusReadonly required', 'id'=>'no','checked'=>"checked"]) !!}  No</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h5 style="padding-left: 10px;"><strong>Extension time:</strong></h5>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('duration_start_date') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div id="duration_start_datepicker" class="input-group date">
                                                            {!! Form::text('desired_start_date', '', ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'duration_start_date']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('duration_end_date') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div id="duration_end_datepicker" class="input-group date">
                                                            {!! Form::text('desired_end_date', '', ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'duration_end_date']) !!}
                                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('desired_duration') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('extension_year', '', ['class' => 'form-control input-md', 'readonly', 'id' => 'desired_duration']) !!}
                                    ...
                                    <fieldset class="scheduler-border hidden" id="inwardRemittanceDiv">
                                        <legend class="scheduler-border">Inward remittance of last 1 year (Encashment)</legend>
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('last_remittance_year') ? 'has-error': ''}}">
                                                    {!! Form::label('last_remittance_year','Last remittance year :',['class'=>'text-left col-md-5']) !!}
                                                    <div class="col-md-7">
                                                        {!! Form::selectRange('last_remittance_year',date('Y'), 1990, Session::get('opeInfo.last_remittance_year'),['class' => 'form-control input-md', 'id' => 'last_remittance_year', 'placeholder'=>'Select one']) !!}
                                                        {!! $errors->first('last_remittance_year','<span class="help-block">:message</span>') !!}
                                                    </div>
                                                </div>
                                                <div class="col-md-6 {{$errors->has('inward_remittance') ? 'has-error': ''}}">
                                                    {!! Form::label('inward_remittance','Inward Remittance:',['class'=>'text-left col-md-5']) !!}
                                                    <div class="col-md-7">
                                                        {!! Form::text('inward_remittance', '',['class' => 'form-control input-md bigInputField', 'id' => 'inward_remittance']) !!}
                                                        {!! $errors->first('inward_remittance','<span class="help-block">:message</span>') !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 {{$errors->has('office_type') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::select('office_type', $officeType, Session::get('opeInfo.office_type'), ['placeholder' => 'Select One',
                                                    'class' => 'form-control input-md cusReadonly', 'id' => 'office_type', 'onchange' => "CategoryWiseDocLoad(this.value)"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_company_name') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_company_name', (Session::get('opeInfo.c_company_name') ? Session::get('opeInfo.c_company_name') : $company_info->c_company_name), ['class'=>'form-control required input-md cusReadonly bigInputField', 'data-rule-maxlength'=>'255', 'id'=>"c_company_name"]) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('c_origin_country_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('c_origin_country_id', $countries,Session::get('opeInfo.c_origin_country_id'), ['placeholder' => 'Select One',
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 {{$errors->has('c_org_type') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('c_org_type', $organizationTypes, Session::get('opeInfo.c_org_type'),
                                                ...
                                                <div class="col-md-6 has-feedback {{ $errors->has('c_flat_apart_floor') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_flat_apart_floor', Session::get('opeInfo.c_flat_apart_floor'), ['class'=>'form-control input-md cusReadonly', 'data-rule-maxlength'=>'40', 'id'=>"c_flat_apart_floor"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_house_plot_holding') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_house_plot_holding', Session::get('opeInfo.c_house_plot_holding'), ['class'=>'form-control input-md cusReadonly', 'data-rule-maxlength'=>'40', 'id'=>"c_house_plot_holding"]) !!}
                                                ...
                                                <div class="col-md-6  {{$errors->has('c_post_zip_code') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_post_zip_code', Session::get('opeInfo.c_post_zip_code'), ['data-rule-maxlength'=>'80',
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 has-feedback {{ $errors->has('c_street') ? 'has-error' : ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_street', Session::get('opeInfo.c_street'), ['class'=>'form-control input-md cusReadonly','data-rule-maxlength'=>'40', 'id' => 'c_street']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('c_email') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_email', Session::get('opeInfo.c_email'), ['class' => 'form-control input-md email cusReadonly', 'id' => 'c_email']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_city') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_city', Session::get('opeInfo.c_city'),['class' => 'form-control input-md cusReadonly', 'id' => 'c_city']) !!}
                                                ...
                                                <div class="col-md-6  {{$errors->has('c_telephone') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_telephone', Session::get('opeInfo.c_telephone'),['data-rule-maxlength'=>'20',  'class' => 'form-control input-md cusReadonly', 'id' => 'c_telephone']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('c_state_province') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_state_province', Session::get('opeInfo.c_state_province'),['class' => 'form-control input-md cusReadonly', 'id' => 'c_state_province']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('c_fax') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('c_fax', Session::get('opeInfo.c_fax'), ['class' => 'form-control input-md cusReadonly', 'id' => 'c_fax']) !!}
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 {{$errors->has('c_major_activity_brief') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7" style="width: 79.8%">
                                                        {!! Form::textarea('c_major_activity_brief', Session::get('opeInfo.c_major_activity_brief'),['class' => 'bigInputField form-control input-md cusReadonly maxTextCountDown', 'size'=>'1x2', 'id' => 'c_major_activity_brief','data-charcount-maxlength'=>'200']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('authorized_capital') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('authorized_capital', Session::get('opeInfo.authorized_capital'),['class' => 'form-control number input-md cusReadonly', 'id'=>'authorized_capital']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('paid_up_capital') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('paid_up_capital', Session::get('opeInfo.paid_up_capital'),['class' => 'form-control number input-md cusReadonly', 'id' => 'paid_up_capital']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('local_company_name') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('local_company_name', Session::get('opeInfo.local_company_name'), ['class'=>'form-control input-md cusReadonly bigInputField', 'data-rule-maxlength'=>'255', 'id'=>"local_company_name"]) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('local_company_name_bn') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('local_company_name_bn', Session::get('opeInfo.local_company_name_bn'), ['class'=>'form-control input-md cusReadonly bigInputField', 'data-rule-maxlength'=>'255', 'id'=>"local_company_name_bn"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_division_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_division_id', $divisions, Session::get('opeInfo.ex_office_division_id'), ['class' => 'form-control required cusReadonly input-md', 'id' => 'ex_office_division_id', 'onchange'=>"getDistrictByDivisionId('ex_office_division_id', this.value, 'ex_office_district_id', ". Session::get('opeInfo.ex_office_district_id') .")"]) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_district_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_district_id', $district_eng, Session::get('opeInfo.ex_office_district_id'), ['class' => 'form-control required cusReadonly input-md', 'id' => 'ex_office_district_id' ,'placeholder' => 'Select division first', 'onchange'=>"getThanaByDistrictId('ex_office_district_id', this.value, 'ex_office_thana_id', ". Session::get('opeInfo.ex_office_thana_id') .")"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_thana_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_thana_id', [], '', ['class' => 'form-control required cusReadonly input-md','placeholder' => 'Select district first', 'id' => 'ex_office_thana_id']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_post_office') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_post_office', Session::get('opeInfo.ex_office_post_office'), ['class' => 'form-control input-md cusReadonly']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_post_code') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_post_code', Session::get('opeInfo.ex_office_post_code'), ['class' => 'form-control required cusReadonly input-md post_code_bd']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_address') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_address', Session::get('opeInfo.ex_office_address'), ['maxlength'=>'150','class' => 'form-control required cusReadonly input-md']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_telephone_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_telephone_no', Session::get('opeInfo.ex_office_telephone_no'), ['maxlength'=>'20','class' => 'form-control cusReadonly input-md phone_or_mobile']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_mobile_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_mobile_no', Session::get('opeInfo.ex_office_mobile_no'), ['class' => 'form-control required cusReadonly input-md helpText15' ,'id' => 'ex_office_mobile_no']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_fax_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_fax_no', Session::get('opeInfo.ex_office_fax_no'), ['class' => 'form-control cusReadonly input-md']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_email') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_email', Session::get('opeInfo.ex_office_email'), ['class' => 'form-control required cusReadonly email input-md']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-12 {{$errors->has('activities_in_bd') ? 'has-error': ''}}" id="courtesy_service_reason_div">
                                                    ...
                                                    <div class="col-md-6">
                                                        {!! Form::textarea('activities_in_bd', Session::get('opeInfo.activities_in_bd'), ['data-rule-maxlength'=>'250', 'id' => 'activities_in_bd', 'placeholder'=>'Write here', 'class' => 'form-control cusReadonly bigInputField input-md maxTextCountDown',
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('first_commencement_date') ? 'has-error': ''}}">
                                                    {!! Form::label('first_commencement_date','Effective date of first office permission:',['class'=>'text-left col-md-5']) !!}
                                                    <div class="col-md-7">
                                                        <div class="datepicker input-group date ">
                                                            {!! Form::text('first_commencement_date', (Session::get('opeInfo.first_commencement_date') ? date('d-M-Y', strtotime(Session::get('opeInfo.first_commencement_date'))) : ''), ['class' => 'form-control cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'first_commencement_date']) !!}
                                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        </div>
                                                ...
                                                <div class="col-md-6 {{$errors->has('operation_target_date') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="datepicker input-group date ">
                                                            {!! Form::text('operation_target_date', (Session::get('opeInfo.operation_target_date') ? date('d-M-Y', strtotime(Session::get('opeInfo.operation_target_date'))) : ''), ['class' => 'form-control cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy', 'id' => 'operation_target_date']) !!}
                                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        </div>
                                        ...
                                        <div class="col-md-12" style="padding: 0">
                                            <div class="table-responsive">
                                                <table aria-label="Detailed Report Data Table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            {!! Form::text('local_executive', Session::get('opeInfo.local_executive'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'local_executive']) !!}
                                                            {!! $errors->first('local_executive','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('local_stuff', Session::get('opeInfo.local_stuff'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'local_stuff']) !!}
                                                            {!! $errors->first('local_stuff','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('local_total', Session::get('opeInfo.local_total'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'local_total','readonly']) !!}
                                                            {!! $errors->first('local_total','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('foreign_executive', Session::get('opeInfo.foreign_executive'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'foreign_executive']) !!}
                                                            {!! $errors->first('foreign_executive','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('foreign_stuff', Session::get('opeInfo.foreign_stuff'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'foreign_stuff']) !!}
                                                            {!! $errors->first('foreign_stuff','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('foreign_total', Session::get('opeInfo.foreign_total'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'foreign_total','readonly']) !!}
                                                            {!! $errors->first('foreign_total','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('manpower_total', Session::get('opeInfo.manpower_total'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'mp_total','readonly']) !!}
                                                            {!! $errors->first('manpower_total','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('manpower_local_ratio', Session::get('opeInfo.manpower_local_ratio'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'mp_ratio_local','readonly']) !!}
                                                            {!! $errors->first('manpower_local_ratio','<span class="help-block">:message</span>') !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('manpower_foreign_ratio', Session::get('opeInfo.manpower_foreign_ratio'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md number required','id'=>'mp_ratio_foreign','readonly']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('est_initial_expenses') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('est_initial_expenses', Session::get('opeInfo.est_initial_expenses'),['class' => 'form-control cusReadonly input-md number', 'id' => 'est_initial_expenses']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('est_monthly_expenses') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('est_monthly_expenses', Session::get('opeInfo.est_monthly_expenses'),['class' => 'form-control cusReadonly input-md number', 'id' => 'est_monthly_expenses']) !!}
...
<script>
    function CategoryWiseDocLoad(office_type) {
        ...
        if(office_type != 0 && office_type != ''){
            ...
            $.ajax({
                type: "POST",
                url: '/office-permission-extension/getDocList',
                dataType: "json",
...
//            console.log('Unknown Visa Type');
    ...
    function uploadDocument(targets, id, vField, isRequired) {
        ...
        try{
            ...
            var action = "{{url('/office-permission-extension/upload-document')}}";
    ...
    function isApprovalOnline(value) {
        if (value == 'yes') {
            ...
            $("#inwardRemittanceDiv").removeClass('hidden');
            $("#period_of_employment_div").removeClass('hidden');
            $("#expiry_date_last_wp_div").removeClass('hidden');
            $("#desired_duration_div").removeClass('hidden');
        } else if(value == 'no') {
            ...
            $("#inwardRemittanceDiv").addClass('hidden');
            $("#period_of_employment_div").addClass('hidden');
            $("#expiry_date_last_wp_div").addClass('hidden');
            $("#desired_duration_div").addClass('hidden');
        }
    }
    var sessionLastOPN = '{{ Session::get('opeInfo.is_approval_online') }}';
...
//        $(".cusReadonly:radio:not(:checked)").attr('disabled', true);
    ...
    $(document).ready(function(){
        ...
        var form = $("#OfficePermissionExtensionForm").show();
        ...
        $('.finish').on('click', function (e) {
            if (form.valid()) {
                ...
                popupWindow = window.open('<?php echo URL::to('/office-permission-extension/preview'); ?>', 'Sample', '');
            } else {
                return false;
            }
        });
...
<script>
    $(function () {
        ...
        $('input[name="is_remittance_allowed"]').change(function () {
            if ($(this).val() === 'yes') {
                $('#office_type option[value!="1"]').prop('disabled', true);
                $('#office_type').val(1).find('option[value="2"], option[value="3"]').prop('disabled', true);
            } else {
                $('#office_type option').prop('disabled', false);
            }
        });

        // Initialize the state based on the initial value of is_remittance_allowed
        $('input[name="is_remittance_allowed"]:checked').trigger('change');
