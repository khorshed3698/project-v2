...
<div class="modal-body">
    ...
    <div class="table-responsive">
        <table id="localMachineryTable" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%" aria-label="Detailed Report Data Table">
            <thead>
            <tr>
            ...
            <tr id="localMachineryTableRow" data-number="1">
                ...
                <td class="light-yellow">
                    {!! Form::text('l_machinery_local_qty[]', '', ['class' => 'form-control input-md number', 'id' => 'l_machinery_local_qty0', 'readonly']) !!}
                    {!! $errors->first('l_machinery_local_qty','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-yellow">
                    {!! Form::text('l_machinery_local_unit_price[]', '', ['class' => 'form-control input-md number', 'id' => 'l_machinery_local_unit_price0', 'readonly']) !!}
                    {!! $errors->first('l_machinery_local_unit_price','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-yellow">
                    {!! Form::text('l_machinery_local_total_value[]', '', ['class' => 'form-control input-md number', 'id' => 'l_machinery_local_total_value0', 'readonly']) !!}
                ...
                <td class="light-green">
                    {!! Form::text('n_l_machinery_local_qty[]', '', ['class' => 'form-control input-md number', 'id' => 'n_l_machinery_local_qty0', 'readonly']) !!}
                    {!! $errors->first('n_l_machinery_local_qty','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-green">
                    {!! Form::text('n_l_machinery_local_unit_price[]', '', ['class' => 'form-control input-md number', 'id' => 'n_l_machinery_local_unit_price0', 'readonly']) !!}
                    {!! $errors->first('n_l_machinery_local_unit_price','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-green">
                    {!! Form::text('n_l_machinery_local_total_value[]', '', ['class' => 'form-control input-md number', 'id' => 'n_l_machinery_local_total_value0', 'readonly']) !!}
...
<script>
    ...
    $(document).ready(function () {
        ...
        function validateRows() {
            ...
            $('#localMachineryTable tbody tr').each(function () {
                const row = $(this);
                ...
                row.find('input[name^="l_machinery_local_qty"], input[name^="l_machinery_local_unit_price"], input[name^="l_machinery_local_total_value"], input[name^="n_l_machinery_local_qty"], input[name^="n_l_machinery_local_unit_price"], input[name^="n_l_machinery_local_total_value"]').each(function () {
        ...
        function formSubmit() {
            ...
            $.ajax({
                ...
                dataType: 'json',
                beforeSend: function () {
                    $("#localMachineryForm #machinery_create_btn").html('<i class="fa fa-cog fa-spin"></i> Loading...');
                    $("#localMachineryForm #machinery_create_btn").prop('disabled', true);
                },
                success: function (data) {
                    if (data.success === false) {
                        info_err.hide().empty();
                        ...
                        info_err.slideDown('slow');
                        info_err.delay(2000).slideUp(1000, function () {
                            $("#localMachineryForm #machinery_create_btn").html('Submit');
                            $("#localMachineryForm #machinery_create_btn").prop('disabled', false);
                        });
                    }
                    if (data.success === true) {
                        info_suc.hide().empty();
