    ...
    <div class="table-responsive">
        <table id="directorTable" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%" aria-label="Detailed Report Data Table">
            ...
            <tr>
                ...
                <td class="light-yellow">
                    {!! Form::text('l_machinery_imported_qty', $getImportedMachinery->l_machinery_imported_qty, ['class' => 'form-control input-md number', 'id' => 'l_machinery_imported_qty']) !!}
                    {!! $errors->first('l_machinery_imported_qty','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-yellow">
                    {!! Form::text('l_machinery_imported_unit_price', $getImportedMachinery->l_machinery_imported_unit_price, ['class' => 'form-control input-md number', 'id' => 'l_machinery_imported_unit_price']) !!}
                    {!! $errors->first('l_machinery_imported_unit_price','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-yellow">
                    {!! Form::text('l_machinery_imported_total_value', $getImportedMachinery->l_machinery_imported_total_value, ['class' => 'form-control input-md number', 'id' => 'l_machinery_imported_total_value']) !!}
                ...
                <td class="light-green">
                    {!! Form::text('n_l_machinery_imported_qty', $getImportedMachinery->n_l_machinery_imported_qty, ['class' => 'form-control input-md number', 'id' => 'n_l_machinery_imported_qty']) !!}
                    {!! $errors->first('n_l_machinery_imported_qty','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-green">
                    {!! Form::text('n_l_machinery_imported_unit_price', $getImportedMachinery->n_l_machinery_imported_unit_price, ['class' => 'form-control input-md number', 'id' => 'n_l_machinery_imported_unit_price']) !!}
                    {!! $errors->first('n_l_machinery_imported_unit_price','<span class="help-block">:message</span>') !!}
                </td>
                <td class="light-green">
                    {!! Form::text('n_l_machinery_imported_total_value', $getImportedMachinery->n_l_machinery_imported_total_value, ['class' => 'form-control input-md number', 'id' => 'n_l_machinery_imported_total_value']) !!}
    ...
    $(document).ready(function () {
        ...
        function validateRows() {
            ...
            $('#directorTable tbody tr').each(function () {
                ...
                $(this).find('input:not([name^="n_"]):not([name="amendment_type"]):not([name="im_id"])').each(function() {
                    let value = $(this).val().trim();
                    if (value !== '') {
                ...
                $(this).find('input:not([name="amendment_type"]):not([name="im_id"])').each(function() {
                    let value = $(this).val().trim();
                    if (value !== '') {
                        isAllNotFilled = true;
                    }
