...
<style>
    ...
    .th_org_telephone_no, .sfp_contact_phone {
                    ...
                    <div class="panel-body">
                        ...
                        <fieldset>
                            ...
                            <div class="visa_type_box">
                                ...
                                <small class="text-danger">N.B.: Once you save or submit the application, the visa
                                    type cannot be changed anymore.
                                </small>
                                <div id="tab" class="visaTypeTab" data-toggle="buttons">
                                    @foreach($app_category as $category)
                                        @if($appInfo->app_type_id == $category->id)
                                            <a href="#tab{{$category->id}}"
                                               class="showInPreview btn btn-md btn-info @if($appInfo->app_type_id == $category->id) disabled active @else disabled @endif"
                                               data-toggle="tab">
                                                {!! Form::radio('app_type_id', $category->id, ($appInfo->app_type_id == $category->id) ? true :false, ['class'=>'badgebox required', 'id'=>'app_type_id','onchange' => "TypeWiseDocLoad(this.value, '$category->attachment_key')"]) !!}  {{ $category->name }}
                                ...
                                <div class="tab-content visaTypeTabContent">
                                    @foreach($app_category as $category)
                                        @if($appInfo->app_type_id == $category->id)
                                            <div class="tab-pane visaTypeTabPane fade @if($appInfo->app_type_id == $category->id) in active @endif"
                                                 id="tab{{$category->id}}">
                                                <div class="col-sm-12">
                                                    <h3 class="page-header">You have selected {{$category->name}}.
                                                        Please read the following instructions:</h3>
                                                    {!! $category->app_instruction !!}
                                                    <div class="form-group">
                                                        <div class="checkbox">
                                                            <label>
                                                                {!! Form::checkbox('agree_with_instruction',1, ($appInfo->agree_with_instruction == 1) ? true : false, array('id'=>'eTypeChecked', 'class'=>'required')) !!}
                            ...
                            @foreach($app_category as $category)
                                @if($appInfo->app_type_id == $category->id)
                                    <h4 id="selected_visa_type" style="margin-top: 0; display: none;">
                        ...
                        <fieldset>
                            ...
                            @include('VisaRecommendation::basic-info')
                                ...
                                <div class="panel-body">
                                    <div class="" id="embassy_info_area">
                                        <fieldset class="scheduler-border">
                                            <legend class="scheduler-border">Embassy/ high commission of Bangladesh in
                                                abroad where recommendation letter to be sent:
                                            </legend>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('mission_country_id') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::select('mission_country_id', $countriesWithoutBD, $appInfo->mission_country_id,
                                                            ['class' => 'bigInputField form-control input-md embassy_info_req_field','placeholder' => 'Select One', 'onchange'=>"getEmbassyByCountryId(this, 'high_commision_id',".$appInfo->high_commision_id.")"]) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('high_commision_id') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::select('high_commision_id', [], $appInfo->high_commision_id, ['placeholder' => 'Select One', 'class' => 'bigInputField form-control input-md embassy_info_req_field']) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::select('airport_id', $airports, $appInfo->airport_id,['class' => 'form-control input-md oa_req_field', 'placeholder' => 'Select One']) !!}
                                                    ...
                                                    <div id="visit_purpose_div"
                                                        ...
                                                        <div style="margin-top: 10px;" class="col-md-7 col-md-offset-5" id="PURPOSE_OTHERS" hidden>
                                                            {!! Form::textarea('visa_purpose_others', $appInfo->visa_purpose_others, ['data-rule-maxlength'=>'200', 'placeholder'=>'Specify others purpose', 'id'=> 'visa_purpose_others', 'class' => 'form-control bigInputField input-md maxTextCountDown',
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    @if($appInfo->business_category == 2)
                                                        <div class="col-md-12 {{$errors->has('emp_marital_status') ? 'has-error': ''}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                <label class="radio-inline">{!! Form::radio('emp_marital_status', 'married', ($appInfo->emp_marital_status == 'married' ? true : false), ['id' => 'married', 'onclick' => 'maritalStatusWiseSpouseInfoShow(this.value)']) !!}
                                                                    Married</label>
                                                                <label class="radio-inline">{!! Form::radio('emp_marital_status', 'unmarried', ($appInfo->emp_marital_status == 'unmarried' ? true : false), ['id' => 'unmarried', 'onclick' => 'maritalStatusWiseSpouseInfoShow(this.value)']) !!}
                                                                    Unmarried</label>
                                                            </div>
                                                        </div>
                                                    @endif
                                    ...
                                    <fieldset class="scheduler-border" id="compensation_benefit_area">
                                        ...
                                        <table aria-label="Detailed Compensation and Benefit" id="compensation_table"
                                               class="table table-striped table-bordered display" style="width: 100%">
                                            <thead>
                                            <tr style="background-color:#fcf8e3 !important;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('basic_payment_type_id')?'has-error':'' }}">
                                                        {!! Form::select('basic_payment_type_id', $paymentMethods, $appInfo->basic_payment_type_id, ['data-rule-maxlength'=>'40','class' => 'form-control input-md cb_req_field']) !!}
                                                        {!! $errors->first('basic_payment_type_id','<span class="help-block">:message</span>') !!}
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="{{ $errors->has('basic_local_amount')?'has-error':'' }}">
                                                        {!! Form::number('basic_local_amount', $appInfo->basic_local_amount, ['data-rule-maxlength'=>'40','class' => 'form-control input-md numberNoNegative basic_local_amount cb_req_field', 'step' => '0.01']) !!}
                                                        {!! $errors->first('basic_local_amount','<span class="help-block">:message</span>') !!}
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="{{ $errors->has('basic_local_currency_id')?'has-error':'' }}">
                                                        {!! Form::select('basic_local_currency_id', $currencies, $appInfo->basic_local_currency_id, ['data-rule-maxlength'=>'40','class' => 'form-control input-md cb_req_field']) !!}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('overseas_payment_type_id')?'has-error':'' }}">
                                                        {!! Form::select('overseas_payment_type_id', $paymentMethods, $appInfo->overseas_payment_type_id, ['data-rule-maxlength'=>'40','class' => 'form-control input-md', 
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('overseas_local_amount')?'has-error':'' }}">
                                                        {!! Form::number('overseas_local_amount', $appInfo->overseas_local_amount, ['data-rule-maxlength'=>'40','class' => 'form-control input-md numberNoNegative', 'step' => '0.01', 
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('overseas_local_currency_id')?'has-error':'' }}">
                                                        {!! Form::select('overseas_local_currency_id', $currencies, $appInfo->overseas_local_currency_id, ['data-rule-maxlength'=>'40','class' => 'form-control input-md', 'id' => 'overseas_local_currency_id']) !!}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('house_payment_type_id')?'has-error':'' }}">
                                                        {!! Form::select('house_payment_type_id', $paymentMethods, $appInfo->house_payment_type_id, ['data-rule-maxlength'=>'40','class' => 'form-control input-md', 
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('house_local_amount')?'has-error':'' }}">
                                                        {!! Form::number('house_local_amount', $appInfo->house_local_amount, ['data-rule-maxlength'=>'40','class' => 'form-control input-md numberNoNegative', 'step' => '0.01', 
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('house_local_currency_id')?'has-error':'' }}">
                                                        {!! Form::select('house_local_currency_id', $currencies, $appInfo->house_local_currency_id, ['data-rule-maxlength'=>'40','class' => 'form-control input-md', 'id' => 'house_local_currency_id']) !!}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('conveyance_payment_type_id')?'has-error':'' }}">
                                                        {!! Form::select('conveyance_payment_type_id', $paymentMethods, $appInfo->conveyance_payment_type_id, ['data-rule-maxlength'=>'40', 'class' => 'form-control input-md', 
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('conveyance_local_amount')?'has-error':'' }}">
                                                        {!! Form::number('conveyance_local_amount', $appInfo->conveyance_local_amount, ['data-rule-maxlength'=>'40','class' => 'form-control input-md numberNoNegative', 'step' => '0.01', 
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('conveyance_local_currency_id')?'has-error':'' }}">
                                                        {!! Form::select('conveyance_local_currency_id', $currencies, $appInfo->conveyance_local_currency_id, ['data-rule-maxlength'=>'40','class' => 'form-control input-md', 'id' => 'conveyance_local_currency_id']) !!}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('medical_payment_type_id')?'has-error':'' }}">
                                                        {!! Form::select('medical_payment_type_id', $paymentMethods, $appInfo->medical_payment_type_id, ['data-rule-maxlength'=>'40','class' => 'form-control input-md', 
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('medical_local_amount')?'has-error':'' }}">
                                                        {!! Form::number('medical_local_amount', $appInfo->medical_local_amount, ['data-rule-maxlength'=>'40','class' => 'form-control input-md numberNoNegative', 'step' => '0.01', 
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('medical_local_currency_id')?'has-error':'' }}">
                                                        {!! Form::select('medical_local_currency_id', $currencies, $appInfo->medical_local_currency_id, ['data-rule-maxlength'=>'40','class' => 'form-control input-md', 'id' => 'medical_local_currency_id']) !!}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('ent_payment_type_id')?'has-error':'' }}">
                                                        {!! Form::select('ent_payment_type_id', $paymentMethods, $appInfo->ent_payment_type_id, ['data-rule-maxlength'=>'40','class' => 'form-control input-md', 
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('ent_local_amount')?'has-error':'' }}">
                                                        {!! Form::number('ent_local_amount', $appInfo->ent_local_amount, ['data-rule-maxlength'=>'40','class' => 'form-control input-md numberNoNegative', 'step' => '0.01', 
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('ent_local_currency_id')?'has-error':'' }}">
                                                        {!! Form::select('ent_local_currency_id', $currencies, $appInfo->ent_local_currency_id, ['data-rule-maxlength'=>'40','class' => 'form-control input-md', 'id' => 'ent_local_currency_id']) !!}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('bonus_payment_type_id')?'has-error':'' }}">
                                                        {!! Form::select('bonus_payment_type_id', $paymentMethods, $appInfo->bonus_payment_type_id, ['data-rule-maxlength'=>'40','class' => 'form-control input-md', 
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('bonus_local_amount')?'has-error':'' }}">
                                                        {!! Form::number('bonus_local_amount', $appInfo->bonus_local_amount, ['data-rule-maxlength'=>'40','class' => 'form-control input-md numberNoNegative', 'step' => '0.01', 
                                                ...
                                                <td>
                                                    <div class="{{ $errors->has('bonus_local_currency_id')?'has-error':'' }}">
                                                        {!! Form::select('bonus_local_currency_id', $currencies, $appInfo->bonus_local_currency_id, ['data-rule-maxlength'=>'40','class' => 'form-control input-md', 'id' => 'bonus_local_currency_id']) !!}
                                            ...
                                            <tr>
                                                ...
                                                <td colspan="3">
                                                    <div class="{{ $errors->has('other_benefits')?'has-error':'' }}">
                                                        {!! Form::textarea('other_benefits', $appInfo->other_benefits, ['style' => 'width: 100%;', 'class' => 'form-control input-md bigInputField', 'data-charcount-maxlength' => '250', 'size' =>'5x1','data-rule-maxlength'=>'250', 'placeholder' => 'Maximum 250 characters', 'id' => 'other_benefits']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_district_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_district_id', $districts, $appInfo->ex_office_district_id, ['class' => 'form-control input-md required', 'id' => 'ex_office_district_id','placeholder' => 'Select division first', 'onchange'=>"getThanaByDistrictId('ex_office_district_id', this.value, 'ex_office_thana_id', ". $appInfo->ex_office_thana_id .")"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_thana_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('ex_office_thana_id',[''], $appInfo->ex_office_thana_id, ['class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_address') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_address', $appInfo->ex_office_address, ['maxlength'=>'150','class' => 'bigInputField form-control input-md required']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ex_office_telephone_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ex_office_telephone_no', $appInfo->ex_office_telephone_no, ['maxlength'=>'20','class' => 'form-control input-md phone_or_mobile']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 {{$errors->has('ex_office_email') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::email('ex_office_email', $appInfo->ex_office_email, ['class' => 'form-control email input-md required']) !!}
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 {{$errors->has('nature_of_business') ? 'has-error': ''}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                {!! Form::text('nature_of_business', $appInfo->nature_of_business, ['class' => 'form-control input-md bigInputField']) !!}
                                                        ...
                                                        <div class="col-md-6 {{$errors->has('received_remittance') ? 'has-error': ''}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                {!! Form::text('received_remittance', $appInfo->received_remittance, ['class' => 'form-control input-md number']) !!}
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 {{$errors->has('nature_of_business') ? 'has-error': ''}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                {!! Form::number('auth_capital', $appInfo->auth_capital, ['class' => 'form-control input-md number']) !!}
                                                        ...
                                                        <div class="col-md-6 {{$errors->has('paid_capital') ? 'has-error': ''}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                {!! Form::number('paid_capital', $appInfo->paid_capital, ['class' => 'form-control input-md number']) !!}
                                    ...
                                    @if($appInfo->business_category == 2)
                                        {{--Spouse Information--}}
                                        <fieldset class="scheduler-border" id="spouse_information" hidden>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('emp_spouse_name') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('emp_spouse_name', $appInfo->emp_spouse_name, ['class' => 'form-control input-md']) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('emp_spouse_passport_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('emp_spouse_passport_no', $appInfo->emp_spouse_passport_no, ['class' => 'form-control input-md']) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('emp_spouse_nationality') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::select('emp_spouse_nationality', $nationality, $appInfo->emp_spouse_nationality, ['placeholder' => 'Select One',
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('work_in_bd') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            <label class="radio-inline">{!! Form::radio('emp_spouse_work_status','yes', ($appInfo->emp_spouse_work_status == 'yes' ? true : false), ['onclick' => 'isWorkInBangladesh(this.value)']) !!}
                                                                Yes</label>
                                                            <label class="radio-inline">{!! Form::radio('emp_spouse_work_status', 'no', ($appInfo->emp_spouse_work_status == 'no' ? true : false), ['onclick' => 'isWorkInBangladesh(this.value)']) !!}
                                                                No</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group" id="emp_spouse_org_name_div" hidden>
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('emp_spouse_org_name') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('emp_spouse_org_name', $appInfo->emp_spouse_org_name, ['class' => 'form-control input-md']) !!}
                        ...
                        <fieldset>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-4 {{$errors->has('arrival_date') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="datepickerFuture input-group date">
                                                        {!! Form::text('arrival_date', ((!empty($appInfo->arrival_date)) ? date('d-M-Y', strtotime($appInfo->arrival_date)) : ''), ['class' => 'form-control input-md fda_req_field date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                        <span class="input-group-addon"><span
                                                                    class="fa fa-calendar"></span></span>
                                                    </div>
                                            ...
                                            <div class="col-md-4 {{$errors->has('arrival_time') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="timepicker input-group date">
                                                        {!! Form::text('arrival_time', $appInfo->arrival_time, ['class' => 'form-control input-md fda_req_field', 'placeholder'=>'HH:mm']) !!}
                                                        <span class="input-group-addon"><span
                                            ...
                                            <div class="col-md-4 {{$errors->has('arrival_flight_no') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-12">
                                                    {!! Form::text('arrival_flight_no', $appInfo->arrival_flight_no, ['class' => 'form-control input-md fda_req_field']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-4 {{$errors->has('departure_date') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="datepickerFuture input-group date">
                                                        {!! Form::text('departure_date', ((!empty($appInfo->departure_date)) ? date('d-M-Y', strtotime($appInfo->departure_date)) : ''), ['class' => 'form-control input-md fda_req_field date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                        <span class="input-group-addon"><span
                                                                    class="fa fa-calendar"></span></span>
                                                    </div>
                                            ...
                                            <div class="col-md-4 {{$errors->has('departure_time') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="timepicker input-group date">
                                                        {!! Form::text('departure_time', $appInfo->departure_time, ['class' => 'form-control input-md fda_req_field', 'placeholder'=>'HH:mm']) !!}
                                                        <span class="input-group-addon"><span
                                                                    class="glyphicon glyphicon-time"></span></span>
                                                    </div>
                                            ...
                                            <div class="col-md-4 {{$errors->has('departure_flight_no') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-12">
                                                    {!! Form::text('departure_flight_no', $appInfo->departure_flight_no, ['class' => 'form-control input-md fda_req_field']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    {!! Form::select('visiting_service_id', $visiting_service_type, $appInfo->visiting_service_id, ['class' => 'bigInputField form-control input-md oa_req_field','placeholder' => 'Select one']) !!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="col-md-6">
                                                    {!! Form::select('visa_on_arrival_sought_id', $visa_on_arrival_sought, $appInfo->visa_on_arrival_sought_id, ['class' => 'bigInputField form-control input-md oa_req_field','placeholder' => 'Select one', 'onchange'=>"visaOnarrivalSought(this.value)"]) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="col-md-12"
                                                     id="VISA_ON_ARRIVAL_SOUGHT_OTHER_DIV" hidden>
                                                    {!! Form::textarea('visa_on_arrival_sought_other', $appInfo->visa_on_arrival_sought_other, ['data-rule-maxlength'=>'200', 'placeholder'=>'Specify others', 'class' => 'form-control bigInputField input-md maxTextCountDown','size'=>'5x2','data-charcount-maxlength'=>'200'])!!}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="panel panel-info" id="travel_history_area">
                                <div class="panel-heading"><strong>Previous Travel history of the expatriate to
                                        Bangladesh</strong></div>
                                <div class="panel-body">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('travel_history') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="radio-inline">
                                                        {!! Form::radio('travel_history','yes', ($appInfo->travel_history == 'yes') ? true : false, ['class'=>'travel_history th_req_field helpTextRadio', 'id'=>'travel_history_yes', 'onclick' => 'checkTravelHistory(this.value)']) !!}
                                                        Yes
                                                    </label>
                                                    <label class="radio-inline">
                                                        {!! Form::radio('travel_history', 'no', ($appInfo->travel_history == 'no') ? true : false, ['class'=>'travel_history th_req_field', 'id'=>'travel_history_no', 'onclick' => 'checkTravelHistory(this.value)']) !!}
                                                        No
                                                    </label>
                                                </div>
                                            </div>
                                    ...
                                    <div id="travel_employment_period" hidden>
                                        <fieldset class="scheduler-border">
                                            ...
                                            <table aria-label="Detailed Report Data Table" id="travelPeriodTable"
                                                ...
                                                @if(count($visaRecords) > 0)
                                                    ...
                                                    @foreach($visaRecords as $record)
                                                        <tr id="travelPeriodTableRow{{$inc}}" class="table-tr">
                                                            <td>
                                                                {!! Form::hidden("travel_visa_record_id[$inc]", $record->id) !!}
                                                                <div class="datepickerTraHisStart{{$inc}} input-group date">
                                                                    {!! Form::text("th_emp_duration_from[$inc]", ((!empty($record->th_emp_duration_from)) ? date('d-M-Y', strtotime($record->th_emp_duration_from)) : ''), ['class' => 'form-control input-md date which-period datepicker', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                                    <span class="input-group-addon"><span
                                                                                class="fa fa-calendar"></span></span>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="datepickerTraHisEnd{{$inc}} input-group date">
                                                                    {!! Form::text("th_emp_duration_to[$inc]", ((!empty($record->th_emp_duration_to)) ? date('d-M-Y', strtotime($record->th_emp_duration_to)) : ''), ['class' => 'form-control input-md date which-period', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                                    <span class="input-group-addon"><span
                                                                                class="fa fa-calendar"></span></span>
                                                                </div>
                                                            ...
                                                            <td>
                                                                {!! Form::select("th_visa_type_id[$inc]", $travelVisaType, $record->th_visa_type_id, ['class' => 'form-control input-md visited_req_field prev_tr_visa which-period xyz','placeholder' => 'Select one', 'onchange'=>"TravelHistoryVisaType(this.value)"]) !!}
                                                                {!! $errors->first('th_visa_type_id','<span class="help-block">:message</span>') !!}
                                                                <div class="form-group col-sm-12"
                                                                     id="TRAVEL_VISA_OTHERS" hidden>
                                                                    {!! Form::textarea("th_visa_type_others[$inc]", $record->th_visa_type_others, ['data-rule-maxlength'=>'200', 'placeholder'=>'Specify others visa type availed', 'class' => 'form-control bigInputField input-md maxTextCountDown',
                                                            ...
                                                            <td>
                                                                ...
                                                                <a class="btn btn-sm btn-primary addTableRows"
                                                                   onclick="addTableRowTraHis('travelPeriodTable', 'travelPeriodTableRow0');"><i
                                                                            class="fa fa-plus"></i></a>
                                                                <?php } else { ?>

                                                                <a href="javascript:void(0);"
                                                                   class="btn btn-sm btn-danger removeRow"
                                                                   onclick="removeTableRow('travelPeriodTable','travelPeriodTableRow{{$inc}}');">
                                                                    <i class="fa fa-times"
                                                    ...
                                                    @endforeach
                                                @else
                                                    <tr id="travelPeriodTableRow" class="table-tr">
                                                        <td>
                                                            <div class="datepickerTraHisStart0 input-group date">
                                                                {!! Form::text('th_emp_duration_from[]', '', ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                                <span class="input-group-addon"><span
                                                                            class="fa fa-calendar"></span></span>
                                                            </div>
                                                            {!! $errors->first('th_emp_duration_from','<span class="help-block">:message</span>') !!}
                                                        ...
                                                        <td>
                                                            <div class="datepickerTraHisEnd0 input-group date">
                                                                {!! Form::text('th_emp_duration_to[]', '', ['class' => 'form-control input-md date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                                <span class="input-group-addon"><span
                                                                            class="fa fa-calendar"></span></span>
                                                            </div>
                                                            {!! $errors->first('th_emp_duration_to','<span class="help-block">:message</span>') !!}
                                                        ...
                                                        <td>
                                                            {!! Form::select('th_visa_type_id[]', $travelVisaType, '', ['class' => 'form-control input-md visited_req_field xyz','placeholder' => 'Select one', 'onchange'=>"TravelHistoryVisaType(this.value)"]) !!}
                                                            {!! $errors->first('th_visa_type_id[]','<span class="help-block">:message</span>') !!}
                                                            <div class="form-group col-sm-12"
                                                                 id="TRAVEL_VISA_OTHERS" hidden>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('th_visit_with_emp_visa') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="radio-inline">
                                                        {!! Form::radio('th_visit_with_emp_visa','yes', ($appInfo->th_visit_with_emp_visa == 'yes') ? true : false, ['class'=>'visited_req_field helpTextRadio', 'id'=>'th_visit_with_emp_visa_yes', 'onclick' => 'thVisitWithEmpVisa(this.value)']) !!}
                                                        Yes
                                                    </label>
                                                    <label class="radio-inline">
                                                        {!! Form::radio('th_visit_with_emp_visa', 'no', ($appInfo->th_visit_with_emp_visa == 'no') ? true : false, ['class'=>'visited_req_field', 'id'=>'th_visit_with_emp_visa_no', 'onclick' => 'thVisitWithEmpVisa(this.value)']) !!}
                                                        No
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-12 {{$errors->has('th_emp_work_permit') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label class="radio-inline">
                                                            {!! Form::radio('th_emp_work_permit','yes', ($appInfo->th_emp_work_permit == 'yes') ? true : false, ['class'=>'th_reveived_emp_visa visited_with_emp_visa_req helpTextRadio', 'id' => 'th_emp_work_permit_yes','onclick' => 'checkReceivedWorkPermit(this.value)']) !!}
                                                            Yes
                                                        </label>
                                                        <label class="radio-inline">
                                                            {!! Form::radio('th_emp_work_permit', 'no', ($appInfo->th_emp_work_permit == 'no') ? true : false, ['class'=>'th_reveived_emp_visa visited_with_emp_visa_req', 'id' => 'th_emp_work_permit_no', 'onclick' => 'checkReceivedWorkPermit(this.value)']) !!}
                                                            No
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('th_emp_tin_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('th_emp_tin_no', $appInfo->th_emp_tin_no, ['class' => 'form-control number input-md travelFileRequired']) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('th_emp_wp_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('th_emp_wp_no', $appInfo->th_emp_wp_no, ['class' => 'form-control input-md travelFileRequired']) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('th_emp_org_name') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('th_emp_org_name', $appInfo->th_emp_org_name, ['class' => 'form-control input-md travelFileRequired bigInputField']) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('th_emp_org_address') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::textarea('th_emp_org_address', $appInfo->th_emp_org_address, ['data-rule-maxlength'=>'200', 'placeholder'=>'Contact address', 'class' => 'form-control bigInputField input-md travelFileRequired maxTextCountDown',
                                                                'size'=>'5x2','data-charcount-maxlength'=>'200']) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('th_org_district_id') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::select('th_org_district_id', $districts, $appInfo->th_org_district_id, ['class' => 'form-control input-md travelFileRequired ', 'placeholder' => 'Select One','onchange'=>"getThanaByDistrictId('th_org_district_id', this.value, 'th_org_thana_id',". $appInfo->th_org_thana_id .")"]) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('th_org_thana_id') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::select('th_org_thana_id', [], $appInfo->th_org_thana_id, ['class' => 'form-control input-md travelFileRequired ', 'placeholder' => 'Select One']) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('th_org_post_office') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('th_org_post_office', $appInfo->th_org_post_office, ['class' => 'form-control input-md travelFileRequired']) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('th_org_post_code') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('th_org_post_code', $appInfo->th_org_post_code, ['data-rule-maxlength'=>'20','class' => 'form-control post_code_bd input-md travelFileRequired ']) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{ $errors->has('th_org_telephone_no') ? 'has-error' : ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('th_org_telephone_no', $appInfo->th_org_telephone_no, ['class'=>'input-md form-control travelFileRequired th_org_telephone_no', 'data-rule-maxlength'=>'40',
                                                            ]) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('th_org_email') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::email('th_org_email', $appInfo->th_org_email, ['class' => 'form-control input-md email travelFileRequired']) !!}
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="table-responsive">
                                                        <table aria-label="Detailed Manpower of the organization" class="table table-striped table-bordered"
                                                               cellspacing="0"
                                                               width="100%">
                                                            <thead class="alert alert-info">
                                                            <tr>
                                                                <th scope="col" class="text-center text-title required-star"
                                                                    colspan="9">Manpower of
                                                                    the organization
                                                                </th>
                                                            </tr>
                                                            </thead>
                        ...
                        @if(ACL::getAccsessRight('VisaRecommendation','-E-') && $viewMode == "off" && $appInfo->status_id != 6 && Auth::user()->user_type == '5x505')
...
//            }
        ...
        // $(".countriesWithoutBD option[value='18']").each(function () {
        //     $(this).remove();
        // });


        // Set trigger and function calling for Edit/ View mode
{{--        TypeWiseDocLoad('{{$appInfo->app_type_id}}', '{{$attachment_key->attachment_key}}');--}}

        @if ($appInfo->visa_purpose_id == 5)
        $("#visa_purpose_id").trigger('change');
        @endif

        $('input[name=present_status_id]:checked').trigger('click');

        $("#type_of_office_id").trigger('change');
        $('#th_org_district_id').trigger('change');
        $('#visa_purpose_id').trigger('change');
        $('#visa_on_arrival_sought_id').trigger('change');

        // BD Office address
        $("#ex_office_division_id").trigger('change');
        $("#ex_office_district_id").trigger('change');

        $('input[name=emp_marital_status]:checked').trigger('click');
        $('input[name=emp_spouse_work_status]:checked').trigger('click');
...
//        $('input[name=th_visit_with_emp_visa]:checked').trigger('click');
        ...
        //$('#th_visa_type_id').trigger('change');
        // $('#travel_visa_type_id').trigger('change');
        @endif
        @endif

        @if ($appInfo->visa_type_id == 6)
        $('input[name=visa_on_arrival_sought_id]:checked').trigger('click');
...
<script>
    ...
    $(function () {
        var totalRosws = $('#travelPeriodTable').find('tbody').find('tr');
        $.each(totalRosws, function (index, value) {
            $('.datepickerTraHisStart' + index).datetimepicker({
                viewMode: 'days',
                format: 'DD-MMM-YYYY',
            ...
            $('.datepickerTraHisEnd' + index).datetimepicker({
                viewMode: 'days',
                format: 'DD-MMM-YYYY',
                useCurrent: false
            });

            $(".datepickerTraHisStart" + index).on("dp.change", function (e) {
                var start = $(".datepickerTraHisStart" + index).find('input').val();
                var day = moment(start, ['DD-MMM-YYYY']);
                //var minStartDate = moment(day).add(1, 'day');
                if (start != "") {
                    $(".datepickerTraHisEnd" + index).data("DateTimePicker").minDate(day);
                }
            });

            $('.datepickerTraHisStart' + index).trigger('dp.change');
        })
    ...
    function maritalStatusWiseSpouseInfoShow(maritalStatus) {
        if (maritalStatus == 'married') {
            document.getElementById('spouse_information').style.display = 'block';
        } else {
            document.getElementById('spouse_information').style.display = 'none';
        }
    }
