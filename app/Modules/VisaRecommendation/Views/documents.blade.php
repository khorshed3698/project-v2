...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <table aria-label="Detailed Necessary documents" id="attachment_table" class="table table-striped table-bordered display" style="width: 100%">
                <thead>
                <tr>
                    <th width="3%">No.</th>
                    <th width="70%">Required attachment (you may prefer to select file from recent attachment) <i class="fa fa-question-circle" style="cursor: pointer" data-toggle="tooltip" title="" data-original-title="If your present company has already attached any file while doing application previously, there will be a button as 'recent attachment' after the name of attachment" aria-describedby="tooltip"></i></th>
                    <th width="27%">Attached PDF file (Each File Max. size 2MB)</th>
                </tr>
                </thead>
                <tbody>
                <?php $i = 1; ?>
                                ...
                                @if($viewMode != 'on')
                                    <a class='btn btn-xs btn-primary' data-toggle='modal'
                                       ...
                                       data-action='{{ url('process/recent-attachment/'. \App\Libraries\Encryption::encodeId($row->id)) }}'><i
                                                class='fa fa-file-pdf'></i> Recent attachment</a>
                                @endif
                            </td>
                            <td>
                ...
                <tr>
                    <td>N.B</td>
                    <td>All documents shall have to be attested by the Chairman/ CEO / Managing dirctor/
                        Country Manager/ Chief executive of the Company/ firms.
                    </td>
                    <td>Document's must be submitted by an authorized person of the organization including
