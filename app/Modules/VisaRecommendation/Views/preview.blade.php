...
<script language="javascript">
    ...
    jQuery(function () {
        jQuery('#submitFromPreviewBtn').click(function (e) {
            window.opener.document.getElementById("VisaRecommendationForm").setAttribute("target", "_self");
            window.opener.jQuery("#VisaRecommendationForm").submit();
            window.close();
        });
    });
    ...
    window.opener.jQuery(".visa_type_box ").css({"display": "none"});
    window.opener.jQuery("#selected_visa_type ").css({"display": "block"});
    ...
    jQuery('#VisaRecommendationForm :input').attr('disabled', true);
...
//        return jQuery(this).find('option:selected').text();
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery("#VisaRecommendationForm-p-5").css({"display": "block"});
