...
<section class="content" id="applicationForm">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-10 col-md-offset-1">
                                            ...
                                            <div class="col-md-9">
                                                {!! Form::text('cosignor_company_name', $oss_user_info['companyName'],['class' => 'form-control input-md','readonly','placeholder'=>'Company Name']) !!}
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('road_company','',['class' =>'form-control input-md','id'=>'road_company']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-7 col-xs-12">
                                                        {!! Form::text('road_factory','',['class' =>'form-control input-md','id'=>'road_factory']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row col-md-12">
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-8 col-xs-12">
                                                {!! Form::file('signature', ['class'=>'form-control input-md required', 'id' => 'signature','data-height'=>'50','data-width'=>'50', 'flag'=>'img','onchange'=>"heightWidthImg(this)"]) !!}
                                                <div id="preview_signature">
                                                    {!! Form::hidden('validate_field_signature','', ['class'=>'form-control input-md', 'id' => 'validate_field_signature']) !!}
                                                </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="col-md-8 col-xs-12 ">
                                                {!! Form::file('seal', ['class'=>'form-control input-md required','flag'=>'img','data-height'=>50,'data-width'=>100, 'id' => 'seal','onchange'=>"heightWidthImg(this)"]) !!}
                                                <div id="preview_seal">
                                                    {!! Form::hidden('validate_field_seal','', ['class'=>'form-control input-md', 'id' => 'validate_field_seal']) !!}
                                                </div>
                                                <div class="col-md-4" style="position:relative;margin-top: 5px;">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::text('consignee_company_name', $oss_user_info['companyName'] ,['class' => 'form-control input-md','id'=>'consignee_company_name','placeholder'=>'Company or Firm name']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::textarea('company_address', '',['class' => 'form-control input-md','id'=>'company_address','placeholder'=>'Company address','size' =>'5x2']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::textarea('destination_address', '',['class' => 'form-control input-md','id'=>'destination_address','placeholder'=>'Destination Address','size' =>'5x2']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::textarea('particuler_transport','',['class' => 'form-control input-md','id'=>'particuler_transport','placeholder'=>'Particular of Transport','size' =>'5x4']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row col-md-12">
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::select('currency',[], '',['class' => 'form-control input-md','id'=>'currency','placeholder'=>'Select from here']) !!}
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12 table-responsive ">
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <th width="15%" class="text-center">H.S Code</th>
                                                <th width="15%" class="text-center">Weight (E.g.-1kg)</th>
                                            ...
                                            <tr id="rowCountGoodDescription_0" data-number="0">
                                                <td>{!! Form::text('marks[0]',null,['class' =>'form-control input-md  sm-screen required','id'=>'marks_0']) !!}</td>
                                                <td>{!! Form::text('quantity[0]',null,['class' =>'form-control input-md sm-screen required','id'=>'quantity_0']) !!}</td>
                                                <td>{!! Form::textarea('description[0]',null,['class' =>'form-control input-md sm-screen required','size'=>'5x1','id'=>'description_0']) !!}</td>
                                                <td>
                                                    {!! Form::text('hscode[0]',null,['class' =>'form-control input-md sm-screen hscodes required','id'=>'hscode_0','placeholder'=>'Type hscode name']) !!}
                                                    ...
                                                    {!! Form::hidden('hscodeId[0]',null,['id'=>'hscodeId_0','class' =>'hscodeId']) !!}
                                                </td>
                                                <td>{!! Form::text('weight[0]',null,['class' =>'form-control input-md sm-screen required','id'=>'weight_0']) !!}</td>
                                                <td>{!! Form::text('value[0]',null,['class' =>'form-control input-md sm-screen goodsValue onlyNumber required','id'=>'value_0']) !!}</td>
                                ...
                                <div class="row table-responsive">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {!! Form::number('print_count_original','1',['class' => 'form-control input-md onlyNumber','placeholder'=>'Number','id'=>'print_count_original']) !!}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {!! Form::text('original_total','',['class' => 'form-control input-md onlyNumber','readonly','id'=>'original_total']) !!}
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {!! Form::number('print_count_copy','0',['class' => 'form-control input-md onlyNumber','placeholder'=>'Number','id'=>'print_count_copy']) !!}
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                {!! Form::text('copy_total','',['class' => 'form-control input-md onlyNumber','readonly','id'=>'copy_total']) !!}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="3">
                                            ...
                                            <td>
                                                {!! Form::text('total_amount','',['class' => 'form-control input-md onlyNumber','readonly','id'=>'total_amount']) !!}
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
    ...
    <!-------Default Modal Initialize------->

    <div class="modal fade in" id="userInfoModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" id="body-content">
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <td>{{ $oss_user_info['userEmail'] }}</td>
                        </tr>
                        <tr>
                            <td>Applicant Mobile</td>
                            <td>{{ $oss_user_info['userMobile']}}</td>
                        </tr>
                        <tr>
                            <td>Applicant Company</td>
                            <td>{{ $oss_user_info['companyName'] }}</td>
                        </tr>

                        <tr>
                            <td>DCCI Membership</td>
                            <td>
                                {!! Form::select('dcci_member',['1'=>'Yes','2'=>'No'],null,['class' =>'form-control input-md','id'=>'dcci_member','placeholder'=>'Select from here','onchange'=>'hideShowMembership(this.value)']) !!}
                            </td>
                        </tr>
                        <tr class="member" style="display: none;">
                            <td>Membership Id</td>
                            <td>
                                {!! Form::text('membership_id','',['class' => 'form-control input-md','id'=>'membership_id']) !!}
                            </td>
                        </tr>
                        <tr class="member" style="display: none;">
                            <td>Passbook No</td>
                            <td>
                                {!! Form::text('passbook_no','',['class' => 'form-control input-md','id'=>'passbook_no']) !!}
                            </td>
                        </tr>
                ...
                <div class="modal-footer" id="body-footer">
                    <button onclick="memberRegistration()" class="btn btn-primary"><i class="fa fa-spinner fa-spin saveLoader" style="display: none;"></i> Next</button>
...
<script>
    function hideShowMembership($member) {
        if ($member == 1) {
            $('.member').css('display', '');
        } else {
    ...
    function memberRegistration() {
        let dcci_member = $('#dcci_member').val();
        let _token = $('input[name="_token"]').val();
        let membership_id = $('#membership_id').val();
        let passbook_no = $('#passbook_no').val();
        if (!dcci_member) {
            $('#dcci_member').addClass('error')
            return false;
        } else {
            $('#dcci_member').removeClass('error')
        }
        if (dcci_member == 1) {
            if (!passbook_no && !membership_id) {
                alert('Please input membership id or passbook no')
                return false;
            }
        }
        ...
        $.ajax({
            ...
            success: function (result) {
                if(result.responseCode == '2'){
                    alert('User already exist for '+ result.company_name +' company.');
                    window.location = '/dcci-cos/list/'+result.enc_id;
                }else{
                    getApi(result.user_mail);
    ...
    $(document).ready(function () {
        ...
        form.steps({
            ...
            onStepChanging: function (event, currentIndex, newIndex) {
                ...
                // $(".select2-hidden-accessible.error").each(function() {
                //     alert(1)
                //     $(this).siblings(".select2-container").css('border', '5px solid red !important');
                // });
                // $($(".select2").select2("container")).addClass("error");
