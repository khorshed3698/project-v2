...
<script language="javascript">
    ...
    jQuery(function () {
        jQuery('#submitFromPreviewBtn').click(function (e) {
            window.opener.document.getElementById("WorkPermitAmendmentForm").setAttribute("target", "_self");
            window.opener.jQuery("#WorkPermitAmendmentForm").submit();
            window.close();
        });
    });
...
//        return jQuery(this).find('option:selected').text();
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery("#WorkPermitAmendmentForm-p-4").css({"display": "block"});
