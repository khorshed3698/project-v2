                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row" id="br_ref_app_tracking_no_div">
                                                    <div class="{{$errors->has('br_ref_app_tracking_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                ...
                                                                <a href="{{ CommonFunction::getUrlByTrackingNo($appInfo->br_ref_app_tracking_no) }}" target="_blank" rel="noopener">
                                                    ...
                                                    <div class="col-md-6">
                                                            {!! Form::text('br_ref_app_approve_date', (empty($appInfo->br_ref_app_approve_date)) ? '' : date('d-M-Y', strtotime($appInfo->br_ref_app_approve_date)), ['class'=>'form-control input-md', 'id' => 'br_ref_app_approve_date', 'readonly']) !!}
                                                    </div>
                                                </div>
                                                @endif
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                <div class="row hidden" id="irc_ref_app_tracking_no_div">
                                                    <div class="{{$errors->has('irc_ref_app_tracking_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                ...
                                                                <a href="{{ CommonFunction::getUrlByTrackingNo($appInfo->irc_ref_app_tracking_no) }}" target="_blank" rel="noopener">
                                                                    <span class="label label-success"
                                                    ...
                                                    <div class="col-md-6">
                                                            {!! Form::text('irc_ref_app_approve_date', (empty($appInfo->irc_ref_app_approve_date)) ? '' : date('d-M-Y', strtotime($appInfo->irc_ref_app_approve_date)), ['class'=>'form-control input-md', 'id' => 'irc_ref_app_approve_date', 'readonly']) !!}
                                                    </div>
                                                </div>
                                    ...
                                    <div class="panel-body">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <table aria-label="detailed info" class="table table-striped table-bordered" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="required-star">Equity Amount<span class="text-danger" id="equity_amount_err"></span></th>
                                                        <th scope="col" class="required-star">Loan Amount<span class="text-danger" id="loan_amount_err"></span></th>
                                                        <th scope="col">#</th>
                                                    </tr>
                                                    </thead>
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <fieldset class="scheduler-border">
                                                ...
                                                <fieldset >
                                                    <legend class="d-none">Annual Production Capacity as per BIDA registration</legend>
                                                    <div class="panel panel-info">
                                                        <div class="table-responsive">
                                            ...
                                            <fieldset class="scheduler-border" id="annual_raw">
                                                ...
                                                <fieldset id="annual_raw">
                                                    <legend class="d-none">Recommended Annual Production Capacity as per IRC with Raw Materials. </legend>
                                                    <div class="panel panel-info">
                                                        <div class="panel-heading">
                                                            <div class="pull-left">
                                            ...
                                            <fieldset class="scheduler-border" id="annual_spare" style="display:none">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="table-responsive">
                                                            <table aria-label="detailed info" id="productionSpareTbl" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                                <thead>
                                                                <tr>
                                                            ...
                                                            <table aria-label="detailed info">
                                                                ...
                                                                <tr>
                                                                    <div class="col-md-6">
                                                                        <span class="help-text" style="margin: 5px 0;">
                                                                            Exchange Rate Ref: 
                                                                            <a href="https://www.bangladesh-bank.org/econdata/exchangerate.php" target="_blank" rel="noopener">Bangladesh Bank</a>
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <fieldset class="scheduler-border" id="existing_spare" style="display: none">
                                                ...
                                                <div class="table-responsive">
                                                    <table aria-label="detailed info" id="existingMachinesSpareTbl"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if(!empty($appInfo->ex_machine_attachment))
                                                                <a target="_blank" rel="noopener" class="Url btn btn-xs btn-primary"
                                        ...
                                        <fieldset class="scheduler-border" id="annual_amendment_info">
                                        ...
                                        <fieldset class="scheduler-border">
                                            ...
                                            <div class="table-responsive">
                                                <table aria-label="detailed info" id="otherLicenceTbl" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
                                                    <thead class="alert alert-info">
                                                    <tr>
...
<script type="text/javascript">
    ...
    function checkDuplicateRows() {
        const table = document.querySelector('#list_of_director tbody');
