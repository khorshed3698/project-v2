        ...
        <div class="box">
            <div class="box-body">
                <div class="panel panel-info">
                    ...
                    {!! Form::open(array('url' => '/company-registration-sf/save-dec-upload-form', 'method' => 'post', 'files' => true, 'role' => 'form', 'id'=> 'formId')) !!}
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12 {{$errors->has('declaration_position_id') ? 'has-error': ''}}">
                                    ...
                                    <div class="col-md-4">
                                        {!! Form::select('declaration_position_id',[], $appInfo->declaration_position_id,['class' => 'form-control input-md required','placeholder' => 'Select One']) !!}
                                ...
                                <div class="col-md-12 {{$errors->has('declaration_district_id') ? 'has-error': ''}}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                {!! Form::select('declaration_district_id',[], $appInfo->declaration_district_id,['class' => 'form-control input-md required']) !!}
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(function(){
            ...
            $('#declaration_position_id').keydown();
            $('#declaration_district_id').keydown();
        });
        $('#declaration_position_id').on('keydown', function(el){
            var key = el.which;
            ...
            var selected_value = '{{$appInfo->declaration_position_id}}'; // for callback
        ...
        $('#declaration_district_id').on('keydown', function(el){
            var key = el.which;
            if (typeof key !== "undefined") {
                return false;
            }
            ...
            var selected_value = '{{$appInfo->declaration_district_id}}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
