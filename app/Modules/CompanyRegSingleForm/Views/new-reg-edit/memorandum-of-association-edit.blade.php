...
//                ' : '' !!}
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <fieldset>
                            {!! Form::open(['url' => '/company-registration-sf/save-reg-objecive','method' => 'post','files'=>true,'enctype='> 'multipart/form-data','id'=>'objectiveform']) !!}
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="panel panel-info">
                                        ...
                                        <div class="panel-body">
                                            <span>1.Entity Name</span><span style="margin-left: 200px;">{{$appInfo->verified_company_name}} </span><br>
                                            <span>2.Entity Type</span><span style="margin-left: 200px;">{{$appInfo->entity_type_name}}</span>
                                        </div>
                                    </div>
