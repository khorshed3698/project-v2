<div class="panel panel-info">
    ...
    <div class="">
        ...
        <div class="col-md-6 text-right">
            ...
            <a href="{{ url('/company-registration-sf/new-reg-delete-subscriber/next/edit/'.\App\Libraries\Encryption::encodeId($appInfo->id).'/'.\App\Libraries\Encryption::encodeId($appInfo->entity_type_id))}}" class="btn btn-info" id="continuebtn">Save and Continue</a>
...
<div class="modal fade" id="particulars_individual" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['url' => '/company-registration-sf/subscriberStore','method' => 'post','files'=>true,'enctype='> 'multipart/form-data','id'=>'subscriberStore','name'=>'section_one_form']) !!}
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                    ...
                                    <div class="col-md-4">
                                        {!! Form::select('position', [],1,['class' => 'form-control input-md required', 'id'=>'position', 'placeholder' => 'Select One','id'=>'position_sectjion_one']) !!}
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                    ...
                                    <div class="col-md-4">
                                        {!! Form::select('original_nationality_id', [], '',['class' => 'form-control input-md','id'=> 'original_nationality_id_first_insert','placeholder' => 'Select One']) !!}
                                        {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                    </div>
                                    <div class="col-md-4"></div>
                                </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::select('show', [], '',['class' => 'form-control input-md required','placeholder' => 'Select One','id'=>'section_two_nationality']) !!}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::select('original_nationality_id', [], '',['class' => 'form-control input-md','id'=> 'original_nationality_id_second_insert','placeholder' => 'Select One']) !!}
                                            {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                        </div>
                                        <div class="col-md-4"></div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                        ...
                                        <div class="col-md-4">
                                            {!! Form::select('position', [], 1,['class' => 'form-control input-md required','placeholder' => 'Select One','id'=>'section_two_position']) !!}
                                            {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                        </div>
                                        <div class="col-md-4"></div>
                                    </div>
...
<div class="modal fade" id="particulars_individual_edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            {!! Form::open(['url' => '/company-registration-sf/subscriberStore','method' => 'post','files'=>true,'enctype='> 'multipart/form-data','id'=>'subscriberEdit']) !!}
            <div class="modal-body">
                        ...
                        <div class="form-group" id="position_edit">
                            <div class="row">
                                ...
                                <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                    {!! Form::label('','1. Position',['class'=>'col-md-4 text-left required-star']) !!}
                                    <div class="col-md-4">
                                        {!! Form::select('position', [], null,['class' => 'form-control input-md required', 'id'=>'position_section_one_edit', 'placeholder' => 'Select One']) !!}
                                        {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                    </div>
                                    <div class="col-md-4"></div>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                    {!! Form::label('','2. Nationality',['class'=>'col-md-4 text-left required-star']) !!}
                                    <div class="col-md-4">
                                        {!! Form::select('present_nationality_id', [], '',['class' => 'form-control input-md required','placeholder' => 'Select One','id'=>'nationality_section_one_edit']) !!}
                                        {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                    </div>
                                    <div class="col-md-4"></div>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                    {!! Form::label('','5. Original Nationality other than the present Nationality',['class'=>'col-md-4 text-left']) !!}
                                    <div class="col-md-4">
                                        {!! Form::select('original_nationality_id', [], '',['class' => 'form-control input-md','id'=>'original_nationality_id_first','placeholder' => 'Select One']) !!}
                                        {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                    </div>
                                    <div class="col-md-4"></div>
                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <input type="hidden" id="usual_residential_district_id_edit_input">
                                                    {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <input type="hidden" id="permanent_address_district_id_edit_input">
                                                    {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                        {!! Form::label('','9. Nationality',['class'=>'col-md-4 text-left required-star']) !!}
                                        <div class="col-md-4">
                                            {!! Form::select('present_nationality_id', [], '',['class' => 'form-control input-md required section_two_nationality1_edit', 'id'=>'present_nationality_id_edit', 'placeholder' => 'Select One']) !!}
                                            {!! Form::hidden('3', '',['class' => 'form-control  input-md required section_two_nationality1_edit','placeholder' => 'Select One','id'=>'section_two_nationality1_edit_val']) !!}
                                            {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                        </div>
                                        <div class="col-md-4"></div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                        {!! Form::label('','10. Original Nationality other than the present Nationality',['class'=>'col-md-4 text-left']) !!}
                                        <div class="col-md-4">
                                            {!! Form::select('original_nationality_id', [], '',['class' => 'form-control input-md nationality_list', 'id'=>'original_nationality_id_second_edit', 'placeholder' => 'Select One']) !!}
                                            {!! Form::hidden('original_nationality_id_second_edit_val', '',['class' => 'form-control  input-md','id'=>'original_nationality_id_second_edit_val']) !!}
                                            {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                        </div>
                                        <div class="col-md-4"></div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12 {{$errors->has('') ? 'has-error': ''}}">
                                        {!! Form::label('','13. Position',['class'=>'col-md-4 text-left required-star']) !!}
                                        <div class="col-md-4">
                                            {!! Form::select('position', [], null,['class' => 'form-control input-md required', 'id'=>'section_two_position_edit', 'placeholder' => 'Select One']) !!}
                                            <input type="hidden" id="section_two_position_edit_val">
                                            {!! $errors->first('','<span class="help-block">:message</span>') !!}
                                        </div>
                                        <div class="col-md-4"></div>
                                    </div>
...
<script>
    function callbackWithoutId(response, [calling_id, selected_value, element_id, element_name]) {
    ...
    function callbackDirector(response, [calling_id, selected_value, element_id, element_name]) {
        var option = '<option value="">Select One</option>';
        if (response.responseCode === 200) {
            $.each(response.data, function (key, row) {

                var value = row[element_name];
                var directorStatus = row['isDirector'];
                var status = 0;
                if(directorStatus == true){
                    status = 1;
                }
                var id = row[element_id] + '@' + row[element_name]+'@'+status;
                if (selected_value == row[element_id]) {
                    option += '<option selected="true" data-director="'+status+'" value="' + id + '">' + value + '</option>';
                } else {
                    option += '<option data-director="'+status+'" value="' + id + '">' + value + '</option>';
                }
            });
        }
    ...
    function loadModal(event){
        ...
        if(jQuery('input:checkbox:checked').length>0){
            ...
            $.ajax({
                url: "<?php echo url('company-registration-sf/new-reg-get-subscriber/');?>",
                method: "GET",
                data: {
                ...
                success: function (response) {
                    ...
                    $('#usual_residential_district_id_edit_input').val(data['usual_residential_district_id']);
                    ...
                    $('#permanent_address_district_id_edit_input').val(data['permanent_address_district_id']);
                    ...
                    $('#section_two_nationality1_edit_val').val(data['present_nationality_id']);
                    $('#original_nationality_id_second_edit').val(data['original_nationality_id']);
                    $('#original_nationality_id_second_edit_val').val(data['original_nationality_id']);
                    $('#dob').val(data['dob']);
                    $('#tin_no').val(data['tin_no']);
                    $('#position').val(data['position']);
                    $('#section_two_position_edit').val(data['position']);
                    $('#section_two_position_edit_val').val(data['position']);
                    if(data['digital_signature'] != ''){
                      ...
                      $('#digital_signature_edit_link').append('<a target="_blank" class="btn btn-xs btn-primary" href="'+signaturepath+'">Signature</a>');
                    }

                   if(data['subscriber_photo'] != ''){
                        $('#subscriber_photo_edit_link').empty();
                        var signaturepath ="{{asset('subscriber_photo')}}/"+data['subscriber_photo'];
                       $('#subscriber_photo_edit_link').append('<a target="_blank" class="btn btn-xs btn-primary" href="'+signaturepath+'">Subscriber Image</a>');
                    ...
                    $('#usual_residential_district_id_edit').keydown();
                    $('#permanent_address_district_id_edit').keydown();
                    $('#present_nationality_id_edit').keydown();
                    $('#original_nationality_id_second_edit').keydown();
                    $('#section_two_position_edit').keydown();
    ...
    function deleteRow(){
        if(confirm('Are you sure?')){
            var row_id= document.getElementById('checkVal').value;
            $.ajax({
                url: "<?php echo url('company-registration-sf/new-reg-delete-subscriber/');?>",
                method: "GET",
                data: {
                    token: '<?php echo csrf_token() ?>',
                    id: row_id
    ...
    $(document).ready(function () {
        $(function(){
            ...
            $('#nationality_section_one').keydown();
            $('#section_two_nationality').keydown();
            $('#original_nationality_id_first_insert').keydown();
            $('#original_nationality_id_second_insert').keydown();
            $('#usual_residential_district_id').keydown();


            $('#permanent_address_district_id').keydown();
            $('#position_sectjion_one').keydown();
            $('#section_two_position').keydown();
        ...
        $('#next_content').on('click',function () {
            ...
            var nationality_section_one_name = $('#nationality_section_one').val();
            var nationality_id = nationality_section_one_name.split('@')[0];
            var nationality_section_one = nationality_section_one_name.split('@')[0];
            var position_sectjion_one_with_name = $('#position_sectjion_one').val();
            var position_sectjion_one = position_sectjion_one_with_name.split('@')[0];
            var original_nationality_id_first_insert = $('#original_nationality_id_first_insert').val();
            var isDirector = $("#position_sectjion_one option:selected").attr('data-director');
            ...
            if(position_sectjion_one == ''){
                ...
                if (isDirector == 1  && nationality_section_one ==13) {
                    if (tin_no_section_one == '') {
                        alert('need to add tin number');
                        return false;
                    }else{
                        $('#section_two_nationality').val(nationality_section_one_name);
                        $('#original_nationality_id_second_insert').val(original_nationality_id_first_insert);
                        $('#section_two_position').val(position_sectjion_one_with_name);
                        $('#section_two_nationality1').val(nationality_section_one_name);
                        ...
                        if(tin_no_section_one !=""){
                            ...
                            $.ajax({
                                url: '/company-registration-sf/tin-store',
                                type: "POST",
                                data: {
...
//                                $('#present_nationality_id').prop('disable', true);
        ...
        $('#position_section_one_edit').change(function () {
            ...
            $.ajax({
                url: '/company-registration-sf/check-position-is-director',
                type: "POST",
                data: {
                    ...
                    success: function (response) {
                        ...
                        if (response.director_response == 1 && nationality_id==13) {
                            if (tin_no_section_one == '') {
                                ...
                                $('#original_nationality_id_second_edit').val(original_nationality_id_first);
...
//                            $('#present_nationality_id').prop('disable', true);
    ...
    $('#nationality_section_one').on('keydown', function(el){
        var key = el.which;
    ...
    $('#position_sectjion_one').on('keydown', function(el){
        var key = el.which;
        if (typeof key !== "undefined") {
            return false;
        }
        ...
        apiCallGet(e, options, apiHeaders, callbackDirector, arrays);

    });

    $('#present_nationality_id_edit').on('keydown', function(el){
        var key = el.which;
        if (typeof key !== "undefined") {
            return false;
        }
        ...
        var api_url = "{{$rjscBaseApi}}/info/country";
        var selected_value =$('#section_two_nationality1_edit_val').val(); // for callback
        var calling_id = $(this).attr('id'); // for callback
        var element_id = "id"; //dynamic id for callback
        var element_name = "nationality"; //dynamic name for callback
        var data = '';
    ...
    $('#original_nationality_id_first_insert,#original_nationality_id_second_edit').on('keydown', function(el){
        var key = el.which;
        if (typeof key !== "undefined") {
            return false;
        }
        ...
        var api_url = "{{$rjscBaseApi}}/info/country";
        var selected_value = $("#original_nationality_id_second_edit_val").val(); // for callback
        var calling_id = $(this).attr('id'); // for callback
        var element_id = "id"; //dynamic id for callback
        var element_name = "nationality"; //dynamic name for callback
        var data = '';
    ...
    $('#section_two_nationality').on('keydown', function(el){
        var key = el.which;
        if (typeof key !== "undefined") {
            return false;
        }
        ...
        var api_url = "{{$rjscBaseApi}}/info/country";
        var selected_value =$('#nationality_section_one').val(); // for callback
        var calling_id = $(this).attr('id'); // for callback
        var element_id = "id"; //dynamic id for callback
        var element_name = "nationality"; //dynamic name for callback
        var data = '';
    ...
    $('#original_nationality_id_second_insert').on('keydown', function(el){
        var key = el.which;
        if (typeof key !== "undefined") {
            return false;
        }
        ...
        var api_url = "{{$rjscBaseApi}}/info/country";
        var selected_value = $('#original_nationality_id_first_insert').val(); // for callback
        var calling_id = $(this).attr('id'); // for callback
        var element_id = "id"; //dynamic id for callback
        var element_name = "nationality"; //dynamic name for callback
        var data = '';
    ...
    $('#usual_residential_district_id,#usual_residential_district_id_edit').on('keydown', function(el){
        var key = el.which;
        if (typeof key !== "undefined") {
            return false;
        }
        ...
        var selected_value = $("#usual_residential_district_id_edit_input").val(); // for callback
        var calling_id = $(this).attr('id'); // for callback
        var element_id = "id"; //dynamic id for callback
    ...
    $('#permanent_address_district_id,#permanent_address_district_id_edit').on('keydown', function(el){
        var key = el.which;
        if (typeof key !== "undefined") {
            return false;
        }
        ...
        var api_url = "{{$rjscBaseApi}}/info/district";
        var selected_value = $("#permanent_address_district_id_edit_input").val(); // for callback
        var calling_id = $(this).attr('id'); // for callback
        var element_id = "id"; //dynamic id for callback
        var element_name = "name"; //dynamic name for callback
        var data = '';
    ...
    $('#section_two_position').on('keydown', function(el){
        var key = el.which;
        if (typeof key !== "undefined") {
            return false;
        }
        ...
        var e = $(this);
        var api_url = "{{$rjscBaseApi}}/position/"+companyType;
        var selected_value = $('#position_sectjion_one').val(); // for callback
        var calling_id = $(this).attr('id'); // for callback
        var element_id = "positionId"; //dynamic id for callback
        var element_name = "positionTitle"; //dynamic name for callback
        var data = '';
    ...
    $('#section_two_position_edit').on('keydown', function(el){
        var key = el.which;
        if (typeof key !== "undefined") {
            return false;
        }
        ...
        var e = $(this);
        var api_url = "{{$rjscBaseApi}}/position/"+companyType;
        var selected_value = $('#section_two_position_edit_val').val(); // for callback
        var calling_id = $(this).attr('id'); // for callback
        var element_id = "positionId"; //dynamic id for callback
        var element_name = "positionTitle"; //dynamic name for callback
        var data = '';
