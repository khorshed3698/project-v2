        ...
        <div class="box">
            <div class="box-body">
                <div class="row">
                    ...
                    <p><strong>{{$appInfo->verified_company_name}}</strong>, hereby gives you notice, in accordance with Section 77 of the Companies</p>
                    <p>Act, 1994 that the Registered Office of the Company</p>
                    <p>(a) is situated -</p>

                    <strong>{{ $appInfo->address_entity }}, {{$appInfo->entity_district_name}}</strong><br/><br/>
