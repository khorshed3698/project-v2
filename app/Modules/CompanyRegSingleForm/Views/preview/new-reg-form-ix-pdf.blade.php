    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-body">
                ...
                <div class="row">
                    <p>Name of the Company: <strong>{{$appInfo->verified_company_name}}</strong></p>
                    <p>Consent of act as Director/Directors of the <strong>{{$appInfo->verified_company_name}}</strong> to be</p>
                    ...
                    <p>of the <strong>{{$appInfo->verified_company_name}}</strong></p>
...
{{--                                    <td class="text-center" style="padding: 7px;border: 1px solid black;">{{ $v_dir->serial_number }}</td>--}}
                                    ...
                                    <td style="padding: 7px;border: 1px solid black;">{{ $v_dir->usual_residential_address }},
                                        @if(isset($v_dir->usual_residential_district_name))
                                            {{$v_dir->usual_residential_district_name}}
                                            @else
                                    ...
                                    <td style="padding: 7px;border: 1px solid black; text-align: center;">
                                        ...
                                        @if($path !="")
                                            @if(file_exists(public_path().'/'.$path) )
                                                <img height="100px" width="90px" src="{{$path}}"alt="subscriber_photo">
                                            @endif
                                        @endif
                                        <br>
                                        <br>
