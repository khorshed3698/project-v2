                            ...
                            <tr>
                                ...
                                <td class="text-left">
                                    ...
                                    Address:@if($subscriber->usual_residential_address !="")
                                        {{$subscriber->usual_residential_address}}{{','.$subscriber->usual_residential_district_name}}
                                        @endif
                                    <br>
                                    ...
                                    Nationality:@if($subscriber->present_nationality_id !="")
                                        {{$subscriber->present_nationality_name}}
                                    @endif
                                    <br>
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                    @if($photopath !="")
                                        @if(file_exists(public_path().'/'.$photopath) )
                                            <img height="100px" width="90px" src="{{$photopath}}" alt="subscriber_photo">
                                        @endif
                                    @endif
                                </td>
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                    @if($path !="")
                                        @if(file_exists(public_path().'/'.$path) )
                                            <img height="50px" width="90px" src="{{$path}}"alt="rjsc_newreg_digital_signature">
                                        @endif
                                    @endif
                                </td>
