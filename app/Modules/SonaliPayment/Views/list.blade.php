        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                ...
                <div class="pull-right">
                    ...
                    {{--{!! Form::button('<i class="fa fa-plus"></i><b> ' .trans('messages.new_payment').'</b>', array('type' => 'button', 'class' => 'btn btn-default')) !!}--}}
                    {{--</a>--}}
                ...
                <div class="nav-tabs-custom" style="margin-top: 15px;padding: 0px 5px;">
                    <ul  class="nav nav-tabs">
                        <li id="tab1" class="active">
                            <a data-toggle="tab" href="#all_payment" class="mydesk" aria-expanded="true">
                                <b>All Payment</b>
                            </a>
                        </li>
                        <li id="tab2" class="">
                            <a data-toggle="tab" href="#incomplete_payment" aria-expanded="false">
                                <b>Incomplete Payment</b>
                            </a>
                        </li>
                        <li id="tab3" class="">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="all_payment" class="tab-pane active" style="margin-top: 20px">
                        ...
                        <div id="incomplete_payment" class="tab-pane" style="margin-top: 20px">
                            <div class="table-responsive">
                                <table aria-label="Detailed Report Data Table" id="list_2" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                    <thead>
                                    <tr>
                                        <th>Tracking No.</th>
                                        <th>Contact Email</th>
