    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-body">
                ...
                <!--Applicent Copy-->
                <table aria-label="Detailed Applicent Copy" cellspacing="0" width="100%">
                    <tr>
                ...
                <table aria-label="Detailed Report Data Table" cellspacing="0" width="100%">
                    <tr>
                        <th aria-hidden="true" scope="col"></th>
                    </tr>
                    <tr>
                ...
                <table aria-label="Detailed Report Data Table" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td width="65%" style="text-align: right;">
                            <img src="{{ $barcode_url }}" width="200px" height="30px" alt="barcode_url"/>
                        </td>
                ...
                <table aria-label="Detailed Report Data Table" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td style="text-align: left;">
                            <p style="padding: 5px;">Bank Name : Sonali Bank PLC</p>
                        </td>
                        <td style="text-align: right;">
                ...
                <table aria-label="Detailed Report Data Table" class="table-bordered" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                    ...
                    <tr>
                        <td style="text-align: left;">
                            <span style="padding: 5px">TDS Amount</span>
                        </td>
                        <td style="text-align: center;padding: 5px">
                            <span style="padding: 5px"> {{(isset($paymentInfo->tds_amount) ? $paymentInfo->tds_amount : 0)}}</span>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: left;">
                ...
                <table aria-label="Detailed Report Data Table" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td style="text-align: left;">
                            <b style="padding: 5px;">Note: Payment could only be made through any branches of Sonali Bank PLC(Online Branch).</b>
                        </td>
                    </tr>
                </table>
