                            ...
                            @if(count($inspectionInfo) > 0 && !empty($last_inspection_id))
                                ...
                                @if((Auth::user()->user_type == '5x505' && in_array($appInfo->status_id,[25])) || in_array(Auth::user()->user_type, ['1x101','2x202', '4x404']))
                                    ...
                                    @if($appInfo->irc_purpose_id != 2)
                                        <a href="{{ url('irc-recommendation-new/production-capacity-pdf/'.Encryption::encodeId($appInfo->id)) }}" class="btn btn-sm btn-primary" title="" target="_blank" rel="noopener">Production Capacity</a>
                                    @endif

                                    <a href="{{ url('irc-recommendation-new/existing-machines-pdf/'.Encryption::encodeId($appInfo->id)) }}" class="btn btn-sm btn-primary" title="" target="_blank" rel="noopener">Existing Machinery</a>

                                    @if($appInfo->irc_purpose_id != 2)
                                        <a href="{{ url('irc-recommendation-new/entitlement-paper-pdf/'.Encryption::encodeId($last_inspection_id)) }}" class="btn btn-sm btn-primary" title="" target="_blank" rel="noopener">Entitlement Paper</a>
                                    @endif
                            ...
                            <div class="alert alert-warning" role="alert">
                                <h4 class="alert-heading">
                                    ...
                                    @if(in_array(Auth::user()->user_type, ['5x505']))
                                        <a href="{{ url('process/licence-applications/ccie/add', \App\Libraries\Encryption::encodeId(113)) }}" class="btn btn-sm btn-primary pull-right" title="" target="_blank" rel="noopener">
                                            Apply for CCI&E
                                        </a>
                                    @endif
                                </h4>
                ...
                <!-- Inspection Submission Deadline Date -->
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <fieldset class="scheduler-border">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered" cellspacing="0" width="100%" aria-label="Detailed Info">
                                                <thead>
                                                <tr>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table table-striped table-bordered table-hover" aria-label="Detailed Info">
                                        <thead>
                                        <tr>
                                            <th>No.</th>
