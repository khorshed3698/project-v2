            ...
            <div class="box-body">
                ...
                @if($viewMode == 'on' && in_array(Auth::user()->user_type,['5x505']) && in_array($appInfo->status_id, [15, 32]))
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            {!! Form::open(array('url' => 'waiver/payment','method' => 'post','id' => 'waiver','enctype'=>'multipart/form-data',
                ...
                @if($viewMode == 'on' && in_array(Auth::user()->user_type, ['5x505']) && in_array($appInfo->status_id, [17,31]))
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            {!! Form::open(array('url' => 'waiver/conditionalApproveStore','method' => 'post','id' => 'waiver','enctype'=>'multipart/form-data',
                                    'method' => 'post', 'files' => true, 'role'=>'form')) !!}
                        ...
                        <div class="pull-right">
                            ...
                            @if (isset($appInfo) && $appInfo->status_id == 25 && isset($appInfo->certificate_link) && in_array(Auth::user()->user_type, ['1x101','2x202', '4x404', '5x505']))
                                <a href="{{ url($appInfo->certificate_link) }}" class="btn show-in-view btn-md btn-info"
                                   title="Download Approval Copy" target="_blank"> <i class="fa  fa-file-pdf-o"></i> Download Approval Copy</a>
                            @endif
                            &nbsp;
                            @if(!in_array($appInfo->status_id,[-1,5,6,22]))
                                <a href="/waiver/app-pdf/{{ Encryption::encodeId($appInfo->id)}}" target="_blank"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('total_revenue', $appInfo->total_revenue, ['class' => 'form-control total_investment_item input-md number','id'=>'total_revenue' , 'onKeyUp'=>"totalRevenue(this.value)"]) !!}
                                                                            </td>
                                                                            <td>
                                                                ...
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('total_expense', $appInfo->total_expense, ['class' => 'form-control total_investment_item input-md number','id'=>'total_expense', 'onKeyUp'=>"totalExpense(this.value)"]) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('total_comprehensive_income', $appInfo->total_comprehensive_income, ['class' => 'form-control input-md number','id'=>'total_comprehensive_income', 'readonly']) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('fixed_assets', $appInfo->fixed_assets, ['class' => 'form-control input-md number']) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                            </td>
                                                                ...
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('current_assets', $appInfo->current_assets, ['class' => 'form-control input-md number']) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('bank_balance', $appInfo->bank_balance, ['data-rule-maxlength'=>'40','class' => 'form-control input-md number']) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                            </td>
                                                                ...
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('cash_balance', $appInfo->cash_balance, ['data-rule-maxlength'=>'40','class' => 'form-control input-md number']) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('fixed_liabilities', $appInfo->fixed_liabilities, ['data-rule-maxlength'=>'40','class' => 'form-control input-md number']) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                            </td>
                                                                ...
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('current_liabilities', $appInfo->current_liabilities, ['data-rule-maxlength'=>'40','class' => 'form-control input-md number']) !!}
                                                                            </td>
                                                                            <td>
                                                                                {!! Form::select("currency_name", $currencies,114, ["placeholder" => "Select One", "class" => "form-control input-md usd-def"]) !!}
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('equility', $appInfo->equility, ['data-rule-maxlength'=>'40','class' => 'form-control input-md number']) !!}
                                                                            </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <table>
                                                                        <tr>
                                                                            <td>
                                                                                {!! Form::text('acc_profit_loss', $appInfo->acc_profit_loss, ['data-rule-maxlength'=>'40','class' => 'form-control input-md number']) !!}
                                                                            </td>
...
{{--                                                </div>--}}
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 col-md-4">
                                                        <label class="center-block image-upload" for="applicant_photo">
                                                            @if(!empty($appInfo->auth_image))
                                                            <figure>
                                                                <img src="{{ \App\Libraries\UtilFunction::userProfileUrl($appInfo->auth_image, 'uploads/waiver/') }}" class="img-responsive img-thumbnail" id="applicant_photo_preview"/>
                                                            </figure>

                                                            @elseif(empty($appInfo->auth_image))
                                                                <figure>
                                                                    <img src="{{ \App\Libraries\UtilFunction::userProfileUrl(Auth::user()->user_pic, 'users/upload/') }}" class="img-responsive img-thumbnail" id="applicant_photo_preview"/>
                                                                </figure>
                                                            @endif
                        ...
                        @if(ACL::getAccsessRight('Waiver','-E-') && $viewMode != "on" && $appInfo->status_id != 6 && Auth::user()->user_type == '5x505')
...
//
    ...
    @if ($viewMode == 'on')
    $('#WaiverForm .stepHeader').hide();
    $('#WaiverForm :input').attr('disabled', true);
    $('#WaiverForm').find('.MoreInfo').attr('disabled', false);
    ...
    $('#WaiverForm :input[type=file]').hide();
    $('.addTableRows').hide();
