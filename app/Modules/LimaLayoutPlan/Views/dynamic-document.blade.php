...
<div class="table-responsive">
    <table class="table table-striped table-bordered table-hover ">
        ...
        <tr>
            ...
            <th colspan="2">Attached PDF, JPG, JPEG, PNG file
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <input name="<?php echo $row['id']; ?>"
                           id="<?php echo 'f_'.$row['id']; ?>" type="file"
                           size="20" @if($row['id'] == 'Photo') flag="img" @endif
                           onchange="uploadDocument('preview_<?php echo str_replace(" ","_",$row['id']); ?>', '<?php echo 'f_'.$row['id']; ?>', 'validate_field_<?php echo str_replace(" ","_",$row['id']); ?>', '')"/>
{{--                        @if($row['id'] == 'Photo')--}}
