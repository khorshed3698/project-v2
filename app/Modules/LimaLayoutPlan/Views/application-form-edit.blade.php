                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('factory_name_en') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('factory_name_en',!empty($app_data->factory_name_en)?$app_data->factory_name_en:'', ['class' => 'form-control input-md required','placeholder'=>'Full Name of the Factory (in English)', 'id' => 'factory_name']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('factory_name_bn') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('factory_name_bn', !empty($app_data->factory_name_bn)?$app_data->factory_name_bn:'', ['class' => 'form-control input-md required','placeholder'=>'Full Name of the Factory (in Bengali)', 'id' => 'factory_name_bn']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 {{$errors->has('correspondence_address_with_factory') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::textarea('correspondence_address_with_factory',!empty($app_data->factory_name_bn)?$app_data->correspondence_address_with_factory:'',['class'=>'form-control input-md required','id'=>'correspondence_address_with_factory', 'placeholder'=>'Postal Address to the Factory','maxlength' => 254, 'rows' => 2, 'cols' => 50]) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 {{$errors->has('owner_present_address') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::textarea('owner_present_address',!empty($app_data->owner_present_address)?$app_data->owner_present_address:'',['class'=>'form-control input-md required','id'=>'owner_present_address', 'placeholder'=>'Factory Owner’s Present Address','maxlength' => 254, 'rows' => 3, 'cols' => 50]) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('owner_permanent_address') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::textarea('owner_permanent_address',!empty($app_data->owner_permanent_address)?$app_data->owner_permanent_address:'',['class'=>'form-control input-md required','id'=>'owner_permanent_address', 'placeholder'=>'Factory Owner’s Permanent Address','maxlength' => 254, 'rows' => 3, 'cols' => 50]) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('nearest_railway_steamer_launch') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('nearest_railway_steamer_launch', !empty($app_data->nearest_railway_steamer_launch)?$app_data->nearest_railway_steamer_launch:'', ['class' => 'form-control input-md required','placeholder'=>'Name of Nearby Rail Station/SteamerGhaat/LaunchGhaat', 'id' => 'nearest_railway_steamer_launch']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('nearest_bus_stop') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('nearest_bus_stop', !empty($app_data->nearest_bus_stop)?$app_data->nearest_bus_stop:'', ['class' => 'form-control input-md','placeholder'=>'Name of Nearby Bus Stoppage', 'id' => 'nearest_bus_stop']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('notify_authority_name') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('notify_authority_name', !empty($app_data->notify_authority_name)?$app_data->notify_authority_name:'', ['class' => 'form-control input-md', 'placeholder'=>'Name of the Approval Authority', 'id' => 'notify_authority_name']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('layout_load_bearing_capacity') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('layout_load_bearing_capacity', !empty($app_data->layout_load_bearing_capacity)?$app_data->layout_load_bearing_capacity:'', ['class' => 'form-control input-md', 'placeholder'=>'Load Bearing capacity according to the Structural Design (PSF)', 'id' => 'layout_load_bearing_capacity']) !!}
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('building_plan_approval_date') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                <div class="datepicker input-group date"
                                                    ...
                                                    {!! Form::text('building_plan_approval_date', !empty($app_data->building_plan_approval_date)?$app_data->building_plan_approval_date:'', ['class'=>'form-control input-md date', 'id' => 'building_plan_approval_date', 'placeholder'=>'e.g., 21-02-1952']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('nearest_railway_steamer_launch') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('building_plan_reference_no',!empty($app_data->building_plan_reference_no)?$app_data->building_plan_reference_no:'',['class'=>'form-control input-md required','id'=>'building_plan_reference_no', 'placeholder'=>'Reference No. of Building']) !!}
                                                ...
                                                @if(count($app_data->factory_machine_type) > 0)
                                                    ...
                                                    @foreach($app_data->factory_machine_type as $key => $value)
                                                        <tr id="factoryEnvironmentTableRow_{{$inc}}" data-number="{{$inc}}">
                                                            <td>
                                                                {!! Form::text('factory_machine_type[]', !empty($app_data->factory_machine_type[$key])?$app_data->factory_machine_type[$key]:'', ['class' => 'form-control input-md', 'placeholder'=>'Types of Machines', 'id' => 'factory_machine_type_'.$key]) !!}
                                                            </td>
                                                            <td>
                                                                {!! Form::text('factory_machine_measurement[]', !empty($app_data->factory_machine_measurement[$key])?$app_data->factory_machine_measurement[$key]:'', ['class' => 'form-control input-md', 'placeholder'=>'Number of Machine', 'id' => 'factory_machine_measurement_'.$key]) !!}
                                                            </td>
                                                            <td>
                                                                {!! Form::text('factory_machine_location[]', !empty($app_data->factory_machine_location[$key])?$app_data->factory_machine_location[$key]:'', ['class' => 'form-control input-md', 'placeholder'=>'Location of Machine', 'id' => 'factory_machine_location_'.$key]) !!}
                                                            </td>
                                                            <td>
                                                                {!! Form::text('factory_machine_amount[]', !empty($app_data->factory_machine_amount[$key])?$app_data->factory_machine_amount[$key]:'', ['class' => 'form-control input-md', 'placeholder'=>'Load Amount of Machine', 'id' => 'factory_machine_amount_'.$key]) !!}
                                                            </td>
                                                            <td>
                                                                <?php if ($inc == 0) { ?>
