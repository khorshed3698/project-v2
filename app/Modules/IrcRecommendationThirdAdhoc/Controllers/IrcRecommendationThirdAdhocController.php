...
//        }
        ...
        try {
            ...
            elseif(!empty($request->get('ex_machine_attachment_file'))){
                $appData->ex_machine_attachment = $request->get('ex_machine_attachment_file');
            }
            ...
            elseif(!empty($request->get('import_attachment_file'))){
                $appData->import_attachment = $request->get('import_attachment_file');
            }
            ...
            elseif(!empty($request->get('production_attachment_file'))){
                $appData->production_attachment = $request->get('production_attachment_file');
            }
            ...
            elseif(!empty($request->get('export_attachment_file'))){
                $appData->export_attachment = $request->get('export_attachment_file');
            }
