                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 {{$errors->has('total_sales') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-8">
                                                            {!! Form::number('total_sales', Session::get('loadData.total_sales'), ['class' => 'form-control input-md number', 'id'=>'total_sales', 'readonly' => 'readonly']) !!}
                                            ...
                                            <div class="table-responsive">
                                                <table aria-label="detailed info" class="table table-striped table-bordered" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="file" name="ex_machine_attachment" value="{{Session::get('loadData.ex_machine_attachment')}}">
                                                            @if(Session::has('loadData.ex_machine_attachment'))
                                                                <a target="_blank" rel="noopener"
                                                                   class="documentUrl btn btn-xs btn-primary"
                                                                   href="{{URL::to('/uploads/'.(Session::has('loadData.ex_machine_attachment') ? Session::get('loadData.ex_machine_attachment') : ''))}}">
                                                                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                                                    Open File
                                                                </a>
                                                                <input type="hidden" name="ex_machine_attachment_file" value="{{Session::get('loadData.ex_machine_attachment')}}">
                                                            @endif
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                            ...
                                            <div class="table-responsive">
                                                <table aria-label="detailed info" class="table table-striped table-bordered" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                From {!! Form::text('import_duration_from_date', (Session::get('loadData.import_duration_from_date') ? date('d-M-Y', strtotime(Session::get('loadData.import_duration_from_date'))) : ''), ['class'=>'form-control input-md datepicker', 'id' => 'irc_date', 'placeholder'=>'Pick from datepicker']) !!}</div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                To {!! Form::text('import_duration_to_date', (Session::get('loadData.import_duration_to_date') ? date('d-M-Y', strtotime(Session::get('loadData.import_duration_to_date'))) : ''), ['class'=>'form-control input-md datepicker', 'id' => 'irc_date', 'placeholder'=>'Pick from datepicker']) !!}</div>
                                                        </td>
                                                        <td>
                                                            {!! Form::text('import_total_price_usd',Session::get('loadData.import_total_price_usd'),['class' => 'form-control input-md']) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('import_total_price_bdt',Session::get('loadData.import_total_price_bdt'),['class' => 'form-control input-md']) !!}
                                                        </td>
                                                        <td>
                                                            <input type="file" name="import_attachment" value="{{Session::get('loadData.import_attachment')}}">
                                                            @if(Session::has('loadData.import_attachment'))
                                                                <a target="_blank" rel="noopener"
                                                                   class="documentUrl btn btn-xs btn-primary"
                                                                   href="{{URL::to('/uploads/'.(Session::has('loadData.import_attachment') ? Session::get('loadData.import_attachment') : ''))}}">
                                                                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                                                    Open File
                                                                </a>
                                                                <input type="hidden" name="import_attachment_file" value="{{Session::get('loadData.import_attachment')}}">
                                                            @endif
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                            ...
                                            <div class="table-responsive">
                                                <table aria-label="detailed info" class="table table-striped table-bordered" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                From {!! Form::text('production_duration_from_date', (Session::get('loadData.production_duration_from_date') ? date('d-M-Y', strtotime(Session::get('loadData.production_duration_from_date'))) : ''), ['class'=>'form-control input-md datepicker', 'id' => 'irc_date', 'placeholder'=>'Pick from datepicker']) !!}
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                To {!! Form::text('production_duration_to_date', (Session::get('loadData.production_duration_to_date') ? date('d-M-Y', strtotime(Session::get('loadData.production_duration_to_date'))) : ''), ['class'=>'form-control input-md datepicker', 'id' => 'irc_date', 'placeholder'=>'Pick from datepicker']) !!}
                                                            </div>
                                                        </td>
                                                        <td>
                                                            {!! Form::text('production_total_quantity',Session::get('loadData.production_total_quantity'),['class' => 'form-control input-md', 'id' => 'production_total_quantity', 'onkeyup' => "calculateProductionStock()"]) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('production_total_sales',Session::get('loadData.production_total_sales'),['class' => 'form-control input-md', 'id' => 'production_total_sales','onkeyup' => "calculateProductionStock()"]) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('production_total_stock',Session::get('loadData.production_total_stock'),['class' => 'form-control input-md', 'id' => 'production_total_stock', 'readonly']) !!}
                                                        </td>
                                                        <td>
                                                            <input type="file" name="production_attachment" value="{{Session::get('loadData.production_attachment')}}">
                                                            @if(Session::has('loadData.production_attachment'))
                                                                <a target="_blank" rel="noopener"
                                                                   class="documentUrl btn btn-xs btn-primary"
                                                                   href="{{URL::to('/uploads/'.(Session::has('loadData.production_attachment') ? Session::get('loadData.production_attachment') : ''))}}">
                                                                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                                                    Open File
                                                                </a>
                                                                <input type="hidden" name="production_attachment_file" value="{{Session::get('loadData.production_attachment')}}">
                                                            @endif
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                            ...
                                            <div class="table-responsive">
                                                <table aria-label="detailed info" class="table table-striped table-bordered" cellspacing="0" width="100%" id="saleStatementTbl">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @if (Session::has('salesStatements'))
                                                            ...
                                                            <tr id="saleStatementTblRow{{$index}}" data-number="0" class="table-tr">
                                                                <td>
                                                                    {!! Form::text("sales_statement_date[$index]",  \Carbon\Carbon::parse($statement->sales_statement_date)->format('M-Y'), ['class'=>'form-control input-md monthpicker', 'id' => '', 'placeholder'=>'Pick from datepicker']) !!}
                                                                </td>
                                                                <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">{!! Form::text('sales_vat_total',Session::get('loadData.sales_vat_total'),['class' => 'form-control input-md', 'id'=>'sales_vat_total', 'readonly']) !!}</td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </fieldset>
                                            ...
                                            <div class="table-responsive">
                                                <table aria-label="detailed info" class="table table-striped table-bordered" cellspacing="0"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div>
                                                                From {!! Form::text('export_duration_from_date', (empty(Session::get('loadData.export_duration_from_date'))) ? '' :  \Carbon\Carbon::parse(Session::get('loadData.export_duration_from_date'))->format('M-Y'), ['class'=>'form-control input-md datepicker', 'id' => '', 'placeholder'=>'Pick from datepicker']) !!}
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                To {!! Form::text('export_duration_to_date', (empty(Session::get('loadData.export_duration_to_date'))) ? '' :  \Carbon\Carbon::parse(Session::get('loadData.export_duration_to_date'))->format('M-Y'), ['class'=>'form-control input-md datepicker', 'id' => '', 'placeholder'=>'Pick from datepicker']) !!}
                                                            </div>
                                                        </td>
                                                        <td>
                                                            {!! Form::text('export_total_price_usd',Session::get('loadData.export_total_price_usd'),['class' => 'form-control input-md']) !!}
                                                        </td>
                                                        <td>
                                                            {!! Form::text('export_total_price_bdt',Session::get('loadData.export_total_price_bdt'),['class' => 'form-control input-md']) !!}
                                                        </td>
                                                        <td>
                                                            <input type="file" name="export_attachment" value="{{Session::get('loadData.export_attachment')}}">
                                                            @if(Session::has('loadData.export_attachment'))
                                                                <a target="_blank" rel="noopener"
                                                                   class="documentUrl btn btn-xs btn-primary"
                                                                   href="{{URL::to('/uploads/'.(Session::has('loadData.export_attachment') ? Session::get('loadData.export_attachment') : ''))}}">
                                                                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                                                    Open File
                                                                </a>
                                                                <input type="hidden" name="export_attachment_file" value="{{Session::get('loadData.export_attachment')}}">
                                                            @endif
                                                        </td>
                                                    </tr>
                                                    </tbody>
...
{{--                                            </fieldset>--}}
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group" style="margin-top: 2px">
                                                            <div class="col-md-6 {{$errors->has('first_em_lc_total_five_percent') ? 'has-error': ''}}">
                                                                {!! Form::label('first_em_lc_total_five_percent','Value In BDT',['class'=>'text-left col-md-3 required-star']) !!}
                                                                <div class="col-md-9">
                                                            ...
                                                            <div class="col-md-6 form-group {{$errors->has('first_em_lc_total_five_percent_in_word') ? 'has-error': ''}}">
                                                                {!! Form::label('first_em_lc_total_five_percent_in_word','in word',['class'=>'col-md-2 text-left required-star']) !!}
                                                                <div class="col-md-10">
                                            ...
                                            <fieldset class="scheduler-border" id="annual_ins_both" style="display: none">
                                                ...
                                                <table aria-label="detailed info" class="table" width="100%">
                                                    ...
                                                    <tr>
                                                        <td colspan="2" class="text-right"><label class="required-star">Grand total</label></td>
                                                        <td>{!! Form::number('import_cap_grd_total','',['class' => 'form-control input-md import_cap_grd_total required-star', 'id'=>'import_cap_grd_total']) !!}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="text-right"><label class="required-star">Grand total (in words)</label></td>
                ...
                if (newIndex == 1) {
                    ...
                    if (last_irc == 'yes') {
                        ...
                        if (sessionLastIRC == 'yes') {
                            ...
                            if($('#irc_purpose_id').val() != loaded_irc_purpose_id){
                                swal({
                                    type: 'error',
                                    title: 'Oops...',
                                    text: "IRC purpose did not match with 2nd adhoc. Please change."
                                });
                                return false;
                            }
                            return true;
