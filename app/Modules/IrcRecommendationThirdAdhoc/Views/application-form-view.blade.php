                    ...
                    @if(count($inspectionInfo) > 0)
                        @if((Auth::user()->user_type == '5x505' && in_array($appInfo->status_id,[25])) || in_array(Auth::user()->user_type, ['1x101','2x202', '4x404']))
                            @if($appInfo->irc_purpose_id != 2)
                                <a href="{{ url('irc-recommendation-third-adhoc/production-capacity-pdf/'.Encryption::encodeId($appInfo->id)) }}" class="btn btn-sm btn-primary" title="" target="_blank" rel="noopener">Production Capacity</a>
                            ...
                            @if(!empty($last_inspection_id) && $appInfo->irc_purpose_id != 2)
                                <a href="{{ url('irc-recommendation-third-adhoc/entitlement-paper-pdf/'.Encryption::encodeId($last_inspection_id)) }}" class="btn btn-sm btn-primary" title="" target="_blank" rel="noopener">Entitlement Paper</a>
                            @endif
                        @endif
                    @endif
