...
<div class="content">
    ...
    <div class="row">
        <div class="col-md-12">
            <table aria-label="Detailed Report Data Table" width="100%" style="margin-bottom: 10px;">
                <thead>
                    <tr class="d-none">
            ...
            @if($lastInspectionInfo->irc_purpose != 2 && count($annualProductionCapacity) > 0)
                ...
                @foreach($annualProductionCapacity as $apc)
                    ...
                    <div class="table-responsive">
                        <table aria-label="Detailed Report Data Table" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                                <th>#</th>
                                <th>Name</th>
