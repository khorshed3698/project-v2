                                                    ...
                                                    <div class="{{$errors->has('br_ref_app_tracking_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                ...
                                                                <a href="{{ CommonFunction::getUrlByTrackingNo($appInfo->br_ref_app_tracking_no) }}" target="_blank" rel="noopener"><span
                                                    ...
                                                    <div class="{{$errors->has('irc_ref_app_tracking_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group">
                                                                ...
                                                                <a href="{{ CommonFunction::getUrlByTrackingNo($appInfo->irc_ref_app_tracking_no) }}" target="_blank" rel="noopener"><span
                                                                            class="label label-success"
...
{{--                                                    <legend class="scheduler-border">Raw Materials Details</legend>--}}
                                            ...
                                            <fieldset class="scheduler-border" id="annual_spare" style="display:none">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="table-responsive">
                                                            <table aria-label="detailed info" id="productionSpareTbl"
        ...
        form.steps({
            ...
            onStepChanging: function (event, currentIndex, newIndex) {
                ...
                if (newIndex == 1) {
                    ...
                    if($('#irc_purpose_id').val() != app_irc_purpose_id && is_dataload_from_irc_2nd == 'yes'){
                        swal({
                            type: 'error',
                            title: 'Oops...',
                ...
                if (newIndex == 2) {
                    ...
                    if($("#total_sales").val() != 100){
                        ...
                        document.getElementById('total_sales').scrollIntoView();
                        $('html, body').animate({ scrollTop: $("#total_sales").offset().top }, 500); 
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?php echo url(); ?>/irc-recommendation-third-adhoc/production-info",
                        async: false,
                        data: {
                            _token: _token,
                            application_id: application_id,
