                    ...
                    <div class="form-group col-md-12">
                        ...
                        <fieldset class="scheduler-border" style="margin-bottom: 20px;">
                            ...
                            <div class="col-md-12">
                                ...
                                <fieldset class="scheduler-border hidden" id="business_class_list_sec">
                                    ...
                                    <table aria-label="Detailed Report Other info" class="table table-striped table-bordered">
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="table-responsive">
                                <table aria-label="Detailed Report Source of finance" class="table table-striped table-bordered" cellspacing="0"
                                       width="100%">
                                ...
                                <table aria-label="Detailed Report Data Table" class="table table-striped table-bordered" cellspacing="0"
