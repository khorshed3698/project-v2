<div id="previousApplications" class="collapse">
    <div class="panel panel-success">
        <div class="panel-heading">
            <strong>Previous Applications Information</strong>
        </div>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="table-responsive">
                                <table aria-label="Previous Applications Information" class="table table-striped table-bordered dt-responsive previous-applications" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
