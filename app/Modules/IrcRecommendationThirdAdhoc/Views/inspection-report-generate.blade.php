...
<div class="col-md-12" style="text-align: center">
    <img src="uploads/logo/bida-logo_200X69.png" class="img-responsive" alt="bida-logo" />
</div>
...
<newpage>
    ...
    <div class="col-md-12">
        <table aria-label="Detailed Report পরিদর্শন প্রতিবেদন" class="table table-responsive">
            <tr>
        ...
        <table aria-label="Detailed Report প্রকল্পের তথ্য" class="table table-responsive" style="font-size: 16px">
            <tr>
                <th aria-hidden="true"  scope="col"></th>
            </tr>
            <tr>
        ...
        <table aria-label="Detailed Report শিল্প খাতের তথ্য" class="table table-responsive" style="font-size: 16px">
            <tr>
                <th aria-hidden="true"  scope="col"></th>
            </tr>
            <tr>
        ...
        <table aria-label="Detailed Report বিনিয়োগের তথ্য" class="table table-responsive" style="font-size: 16px">
            <tr>
                <th aria-hidden="true"  scope="col"></th>
            </tr>
            <tr>
        ...
        <table aria-label="Detailed Report উদ্যোক্তার তথ্য" class="table table-responsive" style="font-size: 16px">
            <tr>
                <th aria-hidden="true"  scope="col"></th>
            </tr>
            <tr>
        ...
        <table aria-label="Detailed Report  নিবন্ধনকারীর তথ্য" class="table table-responsive" style="font-size: 16px">
            <tr>
                <th aria-hidden="true"  scope="col"></th>
            </tr>
            <tr>
        ...
        <table aria-label="Detailed Report বিবিধ রেজিস্ট্রেশন নং" class="table table-responsive" style="font-size: 16px" width="100%">
            <tr>
                <th aria-hidden="true"  scope="col"></th>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding-left: 50px">
                    <table aria-label="Detailed Report Trade Lincense" class="table table-responsive" width="100%">
                        <tr>
                            <th aria-hidden="true"  scope="col"></th>
                        </tr>
                        <tr>
            ...
            <tr>
                <td style="padding-left: 50px">
                    <table aria-label="Detailed Report TIN No" class="table table-responsive">
                        <tr>
                            <th aria-hidden="true"  scope="col"></th>
                        </tr>
                        <tr>
            ...
            <tr>
                <td style="padding-left: 50px">
                    <table aria-label="Detailed Report Bank" class="table table-responsive" width="100%">
                        <tr>
                            <th aria-hidden="true"  scope="col"></th>
                        </tr>
                        <tr>
            ...
            <tr>
                <td style="padding-left: 50px">
                    <table aria-label="Detailed Report Assosiation No" class="table table-responsive" width="100%">
                        <tr>
                            <th aria-hidden="true"  scope="col"></th>
                        </tr>
                        <tr>
            ...
            <tr>
                <td style="padding-left: 50px">
                    <table aria-label="Detailed Report License No" class="table table-responsive" width="100%">
                        {{--Already have--}}
                        <tr>
                            <th aria-hidden="true"  scope="col"></th>
                        </tr>
            ...
            <tr>
                <td style="padding-left: 50px">
                    <table aria-label="Detailed Report encorporation" class="table table-responsive" width="100%">
                        <tr>
                            <th aria-hidden="true"  scope="col"></th>
                        </tr>
                        <tr>
            ...
            <tr>
                <td style="padding-left: 50px">
                    <table aria-label="Detailed Report Environment" class="table table-responsive" width="100%">
                        {{--Already have--}}
                        <tr>
                            <th aria-hidden="true"  scope="col"></th>
                        </tr>
        ...
        <table aria-label="Detailed Report Data Table" class="table table-responsive" style="font-size: 16px">
            <tr>
                <th aria-hidden="true"  scope="col"></th>
            </tr>
            <tr>
        ...
        <table aria-label="Detailed Report Data Table" class="table table-bordered table-responsive" cellspacing="0" width="100%" style="font-size: 16px;">
            <tr>
                <th aria-hidden="true"  scope="col"></th>
            </tr>
            <tr>
        ...
        <table aria-label="Detailed Report Data Table" class="table table-responsive" style="font-size: 16px" width="100%">
            <tr>
                <th aria-hidden="true"  scope="col"></th>
            </tr>
            <tr>
...
<newpage>
    <div class="col-md-12">
        <div class="table-responsive">
            <table aria-label="Detailed Report Data Table" class="table table-striped table-bordered" cellspacing="0" width="100%" style="font-size: 16px">
                <thead>
                <tr class="d-none">
                    <th aria-hidden="true"  scope="col"></th>
                </tr>
        ...
        @if($inspectionInfo->irc_purpose != 2 && count($annualProductionCapacity) > 0)
            <table aria-label="Detailed Report Data Table" class="table table-bordered dt-responsive" cellspacing="0" width="100%" style="font-size: 16px">
        ...
        @if($inspectionInfo->irc_purpose != 2 && count($inspectionAnnualProductionCapacity) > 0)
            ...
            <table aria-label="Detailed Report Data Table" class="table table-bordered dt-responsive" cellspacing="0" width="100%" style="font-size: 16px">
                ...
                <tr>
                    ...
                    <td>
                        <span>{{ $inspectionInfo->apc_half_yearly_import_other ? $inspectionInfo->apc_half_yearly_import_other : 0 }}</span>
                    </td>
                </tr>
                <tr>
                    <td colspan="4"><span class="pull-right">সর্বমোট টাকা</span></td>
                    <td>
                        <span>{{ ($inspectionInfo->apc_half_yearly_import_total ? $inspectionInfo->apc_half_yearly_import_total : 0) + ($inspectionInfo->apc_half_yearly_import_other ? $inspectionInfo->apc_half_yearly_import_other : 0) }}</span>
                    </td>
                </tr>
                </tfoot>
            </table>
