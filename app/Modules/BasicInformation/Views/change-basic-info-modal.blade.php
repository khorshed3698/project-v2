...
{!! Form::open(array('url' => '/basic-information/store-change-basic-info','method' => 'post', 'class' => 'form-horizontal smart-form','id'=>'changeBasicInfoForm',
        'enctype' =>'multipart/form-data', 'files' => 'true', 'role' => 'form')) !!}

<div class="modal-header">
    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
    <h4 class="modal-title" id="myModalLabel"><i class="fa fa-th-large"></i> Change Basic Information</h4>
</div>
...
<div class="modal-body">
    ...
    {!! Form::hidden('company_id', \App\Libraries\Encryption::encodeId($company_id)) !!}
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            ...
            <table class="table table-responsive table-bordered" aria-label="Detailed Company Info Data Table">
                <thead>
                <tr class="d-none">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="light-yellow">
                            {!! Form::text('department',(!empty($appInfo->department) ? $appInfo->department : ''), ['class'=>'form-control input-md cusReadonly', 'id'=>"department"]) !!}
                            {!! $errors->first('department','<span class="help-block">:message</span>') !!}
                        </td>
                        <td class="light-green">
                            <input type="hidden" name="caption[n_department]" value="department"/>
                            <div class="input-group">
                                {!! Form::text('n_department', '', ['class'=>'form-control input-md', 'id'=>"n_department", 'disabled' => 'disabled']) !!}
                                <span class="input-group-addon">
                                {!! Form::checkbox("toggleCheck[n_department]", 1, null, ['class' => 'field', 'id' => 'n_department_check', 'onclick' => "toggleCheckBox('n_department_check', ['n_department']);"]) !!}
                                </span>
                            </div>
                            {!! $errors->first('n_department','<span class="help-block">:message</span>') !!}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="light-yellow">
                            {!! Form::text('service_name', (!empty($appInfo->service_name) ? $appInfo->service_name : ''), ['class'=>'form-control input-md cusReadonly', 'id'=>"service_name"]) !!}
                            {!! $errors->first('service_name','<span class="help-block">:message</span>') !!}
                        </td>
                        <td class="light-green">
                            <input type="hidden" name="caption[n_service_name]" value="Name of the project"/>
                            <div class="input-group">
                                {!! Form::text('n_service_name', '', ['class'=>'form-control input-md', 'id'=>"n_service_name", 'disabled' => 'disabled']) !!}
                                <span class="input-group-addon">
                                {!! Form::checkbox("toggleCheck[n_service_name]", 1, null, ['class' => 'field', 'id' => 'n_project_name_check', 'onclick' => "toggleCheckBox('n_project_name_check', ['n_service_name']);"]) !!}
                                </span>
                            </div>
                            {!! $errors->first('n_service_name','<span class="help-block">:message</span>') !!}
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="light-green">
                            <input type="hidden" name="caption[n_major_activities]" value="Name of the project"/>
                            <div class="input-group">
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <div class="clearfix padding"></div>
            <table class="table table-responsive table-bordered" aria-label="Detailed Principal Promoter Info Data Table">
                <thead>
                <tr class="d-none">
                    <th aria-hidden="true" scope="col"></th>
                </tr>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <div class="clearfix padding"></div>
            <table class="table table-responsive table-bordered" aria-label="Detailed Office Info Data Table">
                <thead>
                <tr class="d-none">
                    <th aria-hidden="true" scope="col"></th>
                </tr>
    ...
    <div class="panel panel-info">
        ...
        <div class="panel-body">
            <div class="clearfix padding"></div>
            <table class="table table-responsive table-bordered" aria-label="Detailed Factory Info Data Table">
                <thead>
                <tr class="d-none">
                    <th aria-hidden="true" scope="col"></th>
                </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="light-green">
                            <input type="hidden" name="caption[n_factory_email]" value="Factory fax no."/>
                            <div class="input-group">
                    ...
                    <tr>
                        ...
                        <td class="light-green">
                            <input type="hidden" name="caption[n_factory_mouja]" value="Factory fax no."/>
                            <div class="input-group">
...
<div class="modal-footer" style="text-align:left;">
    ...
    <div class="pull-right">
        <button type="submit" class="btn btn-success" id="action_btn" name="actionBtn">
