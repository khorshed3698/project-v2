...
<head>
    ...
    <script src="{{ asset("assets/scripts/jquery-1.6.2.js") }}"></script>
    {{--<script src="/assets/scripts/bootstrap.min.js"></script>--}}
    <script type="application/javascript" language="javascript"> var jQuery = jQuery.noConflict(true);</script>
</head>
<body>
<div align="right">
...
<script language="javascript">
    ...
    jQuery(function () {
        jQuery('#submitFromPreviewBtn').click(function (e) {
            window.opener.document.getElementById("basicInformationForm").setAttribute("target", "_self");
            window.opener.jQuery("#basicInformationForm").submit();
            window.close();
        });
    });
...
//        return jQuery(this).find('option:selected').text();
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery("#basicInformationForm-p-3").css({"display": "block"});
