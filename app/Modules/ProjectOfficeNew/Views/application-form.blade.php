                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-6 {{$errors->has('project_name') ? 'has-error': ''}}">
                                                {!! Form::label('project_name','Name of the Project', ['class' => 'col-md-5 text-left required-star']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('project_name', '', ['placeholder' => 'Name of the Project', 'class' => 'form-control input-md required', 'id' => 'project_name']) !!}
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 {{$errors->has('project_major_activities') ? 'has-error': ''}}" style="margin-top: 10px;">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::textarea('project_major_activities', '', [
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 {{$errors->has('project_major_details') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::textarea('project_major_details', '', [
                                                                    'class' => 'form-control input-md bigInputField maxTextCountDown required',
                                                                    ...
                                                                    <div id="ref_app_tracking_no_div" class="col-md-12 hidden {{$errors->has('ref_app_tracking_no.0') ? 'has-error': ''}}">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12 {{$errors->has('ref_app_approve_date.0') ? 'has-error': ''}}">
                                                                                ...
                                                                                <div class="col-md-7">
                                                                                        {!! Form::text('ref_app_approve_date[0]', !empty(Session::get('opaInfo.approved_duration_start_date')) ? date('d-M-Y', strtotime(Session::get('opaInfo.approved_duration_start_date'))) : '', ['class'=>'form-control cusReadonly input-md date', 'id' => 'ref_app_approve_date', 'readonly']) !!}
                                                                    ...
                                                                    <div id="manually_approved_no_div" class="col-md-12 hidden {{$errors->has('manually_approved_op_no.0') ? 'has-error': ''}} ">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <div class="col-md-7">
                                                                                    <input type="file" name="approval_copy[0]" class="form-control input-md"/>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 {{$errors->has('c_company_name.0') ? 'has-error': ''}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                {!! Form::text('c_company_name[0]', $company_info->c_company_name , ['class'=>'form-control input-md required', 'data-rule-maxlength'=>'255', 'id'=>"c_company_name_0"]) !!}
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 c_city_div {{$errors->has('c_city.0') ? 'has-error': ''}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                {!! Form::text('c_city[0]', '',['class' => 'form-control input-md required', 'id' => 'c_city_0']) !!}
                                                        ...
                                                        <div class="col-md-6 {{$errors->has('c_mobile_no.0') ? 'has-error': ''}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                {!! Form::text('c_mobile_no[0]', '', ['class' => 'mobile-plugin phone_or_mobile number form-control input-md helpText15 required', 'id' => 'c_mobile_no_0']) !!}
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6 c_state_province_div {{$errors->has('c_state_province.0') ? 'has-error': ''}}">
                                                            ...
                                                            <div class="col-md-7">
                                                                {!! Form::text('c_state_province[0]', '',['class' => 'form-control input-md required', 'id' => 'c_state_province_0']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('poa_co_division_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('poa_co_division_id', $divisions, '', ['class' => 'form-control input-md required', 'id' => 'poa_co_division_id', 'onchange'=>"getDistrictByDivisionId('poa_co_division_id', this.value, 'poa_co_district_id')"]) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('poa_co_district_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('poa_co_district_id', [], '', ['class' => 'form-control input-md required','placeholder' => 'Select division first', 'onchange'=>"getThanaByDistrictId('poa_co_district_id', this.value, 'poa_co_thana_id')"]) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('poa_co_thana_id') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::select('poa_co_thana_id',[''], '', ['class' => 'form-control input-md required','placeholder' => 'Select district first']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('poa_co_post_office') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('poa_co_post_office', '', ['class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('poa_co_post_code') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('poa_co_post_code', '', ['class' => 'form-control input-md post_code_bd required']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('poa_co_address') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('poa_co_address', '', ['maxlength'=>'150','class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('poa_co_telephone_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('poa_co_telephone_no', '', ['maxlength'=>'20','class' => 'form-control input-md mobile-plugin phone_or_mobile']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('poa_co_mobile_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('poa_co_mobile_no', '', ['class' => 'form-control mobile-plugin phone_or_mobile input-md helpText15 required' ,'id' => 'poa_co_mobile_no']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('poa_co_fax_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('poa_co_fax_no', '', ['class' => 'form-control input-md']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('poa_co_email') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('poa_co_email', '', ['class' => 'form-control input-md email required']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('project_amount') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('project_amount', '', ['placeholder' => 'The contact Amount of the Project (in US $)', 'class' => 'form-control input-md number required', 'id' => 'project_amount']) !!}
                                                ...
                                                <div class="col-md-3 {{$errors->has('period_start_date') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div id="duration_start_datepicker" class="input-group date ">
                                                            {!! Form::text('period_start_date', '', ['class' => 'form-control input-md date required', 'placeholder'=>'dd-mm-yyyy', 'id' => 'period_start_date']) !!}
                                                ...
                                                <div class="col-md-3 {{$errors->has('period_end_date') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div id="duration_end_datepicker" class="input-group date ">
                                                            {!! Form::text('period_end_date', '', ['class' => 'form-control input-md date required', 'placeholder'=>'dd-mm-yyyy', 'id' => 'period_end_date']) !!}
                                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('authorized_name') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('authorized_name', '',['class' => 'form-control input-md required ', 'id'=>'authorized_name']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('authorized_designation') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('authorized_designation', '',['class' => 'form-control input-md required ', 'id'=>'authorized_designation']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('authorized_org_dep') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('authorized_org_dep', '',['class' => 'form-control input-md required ', 'id'=>'authorized_org_dep']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('authorized_address') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('authorized_address', '',['class' => 'form-control input-md required ', 'id'=>'authorized_address']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('authorized_mobile_no') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('authorized_mobile_no', '',['class' => 'mobile-plugin phone_or_mobile form-control input-md required ', 'id'=>'authorized_mobile_no']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('authorized_email') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('authorized_email', '',['class' => 'form-control input-md required ', 'id'=>'authorized_email']) !!}
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('authorized_letter') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="file" name="authorized_letter" id="authorized_letter" class="form-control input-md required">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6 {{$errors->has('ministry_name') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ministry_name', '',['class' => 'form-control input-md required ', 'id'=>'ministry_name']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('ministry_address') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        {!! Form::text('ministry_address', '',['class' => 'form-control input-md required ', 'id'=>'ministry_address']) !!}
                                                ...
                                                <div class="col-md-6 {{$errors->has('contract_signing_date') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div id="contract_signing_datepicker" class="input-group date datepicker">
                                                            {!! Form::text('contract_signing_date', null, ['class' => 'form-control input-md required', 'placeholder'=>'dd-mm-yyyy', 'id' => 'contract_signing_date']) !!}
                                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        </div>
                                                ...
                                                <div class="col-md-12" style="padding: 0">
                                                    <div class="table-responsive">
                                                        <table aria-label="Detailed Report Data Table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    {!! Form::text('local_technical', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required','id'=>'local_technical']) !!}
                                                                    {!! $errors->first('local_technical','<span class="help-block">:message</span>') !!}
                                                                </td>
                                                                <td>
                                                                    {!! Form::text('local_general', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required','id'=>'local_general']) !!}
                                                                ...
                                                                <td>
                                                                    {!! Form::text('foreign_technical', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required','id'=>'foreign_technical']) !!}
                                                                    {!! $errors->first('foreign_technical','<span class="help-block">:message</span>') !!}
                                                                </td>
                                                                <td>
                                                                    {!! Form::text('foreign_general', '', ['data-rule-maxlength'=>'40','class' => 'form-control input-md number required','id'=>'foreign_general']) !!}
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6 {{$errors->has('auth_mobile_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('auth_mobile_no', Auth::user()->user_phone, ['class' => 'mobile-plugin phone_or_mobile form-control input-sm phone_or_mobile required', 'readonly']) !!}
...
<script>
    ...
    function CategoryWiseDocLoad() {
        ...
        $.ajax({
            type: "POST",
            url: "{{ url('/project-office-new/getDocList') }}",
            dataType: "json",
