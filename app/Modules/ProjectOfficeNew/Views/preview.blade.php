...
<script language="javascript">
    ...
    jQuery(function () {
        jQuery('#submitFromPreviewBtn').click(function (e) {
            window.opener.document.getElementById("ProjectOfficeNewForm").setAttribute("target", "_self");
            window.opener.jQuery("#ProjectOfficeNewForm").submit();
            window.close();
        });
    });
...
//        return jQuery(this).find('option:selected').text();
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery("#ProjectOfficeNewForm-p-4").css({"display": "block"});
