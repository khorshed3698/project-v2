            ...
            <div class="form-group">
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <label>
                                {!! Form::checkbox('is_residential_area',1, !empty($appData->is_residential_area) ? ($appData->is_residential_area == 1 ? true : false) : false, array('id'=>'is_residential_area', 'class'=>'required')) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6 {{$errors->has('app_date') ? 'has-error': ''}}">
                            ...
                            <div class=" col-md-7">
                                <div class="datepicker input-group date"
                                    ...
                                    {!! Form::text('ceo_dob',  !empty($appData->ceo_dob) ? $appData->ceo_dob:'', ['class'=>'form-control input-md', 'id' => 'app_date', 'placeholder'=>'Pick from datepicker']) !!}
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('construction_approval_no', $appData->construction_approval_no,['class' => 'form-control onlyNumber engOnly input-md','id'=>'construction_approval_no']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6 {{$errors->has('work_completed_date') ? 'has-error': ''}}">
                            ...
                            <div class=" col-md-7">
                                <div class="datepicker input-group date"
                                     data-date-format="dd-mm-yyyy">
                                    {!! Form::text('work_completed_date', !empty($appData->work_completed_date) ? $appData->work_completed_date:'', ['class'=>'form-control input-md', 'id' => 'work_completed_date', 'placeholder'=>'Pick from datepicker']) !!}
                                    <span class="input-group-addon"><span
                                                class="fa fa-calendar"></span></span>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                {!! Form::select('city_corporation_municipality', $city_corporation, $appData->city_corporation_municipality, ['class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('b_s_no', $appData->b_s_no,['class' => 'form-control onlyNumber engOnly input-md','id'=>'b_s_no']) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            {!! Form::label('r_s_no','আর. এস. নং',['class'=>'text-left col-md-5 ']) !!}
                            <div class="col-md-7">
                                {!! Form::text('r_s_no', $appData->r_s_no,['class' => 'form-control onlyNumber engOnly input-md','id'=>'r_s_no']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-7">
                                {!! Form::text('road_name', !empty($appData->road_name) ? $appData->road_name : '',['class' => 'form-control input-md','id'=>'road_name']) !!}
                            </div>
                        </div>
                        <div class="col-md-6">
                            {!! Form::label('extent_land_plot_length_including_arms','বাহুর মাপ সহ জমি/প্লটের পরিমাণ',['class'=>'text-left col-md-5 ']) !!}
                            <div class="col-md-7">
                                {!! Form::text('extent_land_plot_length_including_arms', !empty($appData->extent_land_plot_length_including_arms) ? $appData->extent_land_plot_length_including_arms : '',['class' => 'form-control onlyNumber engOnly input-md','id'=>'extent_land_plot_length_including_arms']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-9">
                                {!! Form::textarea('existing_houses_structures_details', $appData->existing_houses_structures_details,['class' => 'form-control input-md','id'=>'existing_houses_structures_details']) !!}
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md- col-xs-12">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody id="coveredAreaDetails">
                                @if(count($appData->total_floor) > 0)
                                    ...
                                    @foreach($appData->total_floor as $key => $value)
                                        ...
                                        <tr id="coveredAreaDetailsRow_{{$inc}}">
                                            <td width="20%"> {!! Form::select('floor_no[]',[], !empty($appData->floor_no[$key]) ? $appData->floor_no[$key]:'',['class'=>'form-control floor_no_1', 'data-value'=>$appData->floor_no[$key], 'id'=>'floor_no_'.$lkey]) !!}</td>
                                            <td width="20%">{!! Form::select('usage_1[]',[], !empty($appData->usage_1[$key]) ? $appData->usage_1[$key]:'',['class' => 'form-control usage_1', 'data-value'=>$appData->usage_1[$key], 'id'=>'usage_'.$lkey ]) !!}</td>
                                            <td>{!! Form::text('partial[]',!empty($appData->partial[$key]) ? $appData->partial[$key]:'',['class' => 'form-control onlyNumber engOnly', 'id'=>'partial'.$lkey, 'onkeyup'=>"calculateTotalArea.call(this)" ]) !!}</td>
                                            <td>{!! Form::text('full_finished[]',!empty($appData->full_finished[$key]) ? $appData->full_finished[$key]:'',['class' => 'form-control  onlyNumber engOnly full_finished', 'id'=>'full_finished'.$lkey,'onkeyup'=>"calculateTotalArea.call(this)"]) !!}</td>
                                            <td>{!! Form::text('total_floor[]',!empty($appData->total_floor[$key]) ? $appData->total_floor[$key]:'',['readonly'=>'readonly','class' => 'form-control total_floor enbnNumber required', 'id'=>'total_floor_'.$lkey]) !!}</td>
                                ...
                                @else
                                    <tr id="coveredAreaDetailsRow_0">
                                        <td width="20%"> {!! Form::select('floor_no[]',[],'',['class'=>'form-control floor_no_1','id'=>'floor_no_1']) !!}</td>
                                        <td width="20%">{!! Form::select('usage_1[]',[],'',['class' => 'form-control usage_1', 'id'=>'usage_1']) !!}</td>
                                        <td>{!! Form::text('partial[]','',['class' => 'form-control onlyNumber engOnly', 'id'=>'partial', 'onkeyup'=>"calculateTotalArea.call(this)"]) !!}</td>
                                        <td>{!! Form::text('full_finished[]','',['class' => 'form-control onlyNumber engOnly full_finished', 'id'=>'full_finished','onkeyup'=>"calculateTotalArea.call(this)"]) !!}</td>
                                        <td>{!! Form::text('total_floor[]','',['readonly'=>'readonly','class' => 'form-control total_floor enbnNumber required', 'id'=>'total_floor_1']) !!}</td>
                                        <td style="vertical-align: middle; text-align: center">
                                            <a class="btn btn-sm btn-primary addTableRows"
                            ...
                            <tr>
                                ...
                                <td>
                                    {!! Form::text('building_total_floor_area', $appData->building_total_floor_area,['readonly'=>'readonly', 'class' => 'form-control input-md','id'=>'building_total_floor_area']) !!}
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#occupancy_type').on('keydown', function (el) {
            ...
            let selected_value = '{{!empty($appData->occupancy_type) ? $appData->occupancy_type:''}}'; // for callback
        ...
        $("#occupancy_type").on("change", function (el) {
            ...
            if (occupancy_type_id) {
                ...
                let selected_value = '{{!empty($appData->occupancy_sub_type) ? json_encode($appData->occupancy_sub_type):''}}'; // for callback
                let calling_id = $(this).attr('id');// for callback
        ...
        $('#block_no').on('keydown', function (el) {
            ...
            let selected_value = '{{!empty($appData->block_no) ? $appData->block_no:''}}'; // for callback
            let calling_id = $(this).attr('id');// for callback
        ...
        $('#seat_no').on('keydown', function (el) {
            ...
            let selected_value = '{{!empty($appData->seat_no) ? $appData->seat_no:''}}'; // for callback
            let calling_id = $(this).attr('id');// for callback
        ...
        $('#sector_no').on('keydown', function (el) {
            ...
            let selected_value = '{{!empty($appData->sector_no) ? $appData->sector_no:''}}'; // for callback
            let calling_id = $(this).attr('id');// for callback
