                                        ...
                                        <div class="col-md-6 {{$errors->has('date_of_registration') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-8">
                                                <div class="datepicker input-group date" data-date-format="dd-mm-yyyy">
                                                    {!! Form::text('date_of_registration', $appInfo->date_of_registration, ['class'=>'form-control input-md required', 'id' => 'date_of_registration', 'placeholder'=>'Pick from datepicker']) !!}
                                                    <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                ...
                                <table aria-label="Detailed Report Data Table" class="table table-bordered dt-responsive" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        <th class="text-center" scope="col">ক্রমিক নং</th>
                                        <th class="text-center" scope="col">পন্য/ সেবার নাম</th>
                                        <th colspan="2" class="text-center" scope="col">নির্ধারিত বার্ষিক উৎপাদন ক্ষমতা</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php $count = 1;?>
                                ...
                                <div class="panel-body">
                                    ...
                                    <table aria-label="Detailed Report Data Table" class="table table-bordered dt-responsive" cellspacing="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>{!! Form::number("apc_half_yearly_import_other", $appInfo->apc_half_yearly_import_other, ['class' => 'form-control input-md', 'id' => 'apc_half_yearly_import_other', 'onkeyup' => "calculateGrandTotal()"]) !!}</td>
                                        </tr>
                                        <tr>
