                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                                        ...
                                        <div class="col-md-6 {{$errors->has('date_of_registration') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-8">
                                                <div class="datepicker input-group date" data-date-format="dd-mm-yyyy">
                                                    {!! Form::text('date_of_registration', (empty($appInfo->date_of_registration) ? '' : date('d-M-Y', strtotime($appInfo->date_of_registration))), ['class'=>'form-control input-md required', 'id' => 'date_of_registration', 'placeholder'=>'Pick from datepicker']) !!}
                                                    <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                </div>
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                @if($appInfo->irc_purpose_id != 2 && count($ircSixMonthsImportRawMaterials) > 0)
                                    <table aria-label="Detailed Report Data Table" class="table table-bordered dt-responsive" cellspacing="0" width="100%">
                                        <thead class="alert alert-info">
                                        <tr class="d-none">
                                            <th aria-hidden="true"  scope="col"></th>
                                    ...
                                    <table aria-label="Detailed Report Data Table" class="table table-bordered dt-responsive" cellspacing="0" width="100%">
                                        ...
                                        @foreach($ircSixMonthsImportRawMaterials as $apc)
                                            <tr>
                                                <td><?php echo $count++ ?></td>
                                                <td>{!! Form::text("product_name[]", $apc->n_product_name ?: $apc->product_name, ['class' => 'form-control input-md', 'readonly']) !!}</td>
                                                <td>{!! Form::number("fixed_production[]", $apc->n_yearly_production ?: $apc->yearly_production, ['class' => 'form-control input-md required', 'onkeyup' => "calculateHalfYearlyProduction(this)"]) !!}</td>
                                                <td>{!! Form::number("half_yearly_production[]", $apc->n_half_yearly_production ?: $apc->half_yearly_production, ['class' => 'form-control input-md required', 'readonly']) !!}</td>
                                                <td>{!! Form::number("half_yearly_import[]", $apc->n_half_yearly_import ?: $apc->half_yearly_import, ['class' => 'form-control input-md apc_half_yearly_import required', 'onkeyup' => "calculateHalfYearlyImportTotal('apc_half_yearly_import', 'apc_half_yearly_import_total')"]) !!}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                        <tfoot>
                                        <tr>
                                            ...
                                            <td>{!! Form::number("apc_half_yearly_import_total", $appInfo->n_ins_apc_half_yearly_import_total ?: $appInfo->ins_apc_half_yearly_import_total , ['class' => 'form-control input-md', 'id' => 'apc_half_yearly_import_total', 'readonly']) !!}</td>
                                        </tr>
                                        <tr>
                                    ...
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12 {{$errors->has('apc_half_yearly_import_total_in_word') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-11">
                                                    {!! Form::text('apc_half_yearly_import_total_in_word', $appInfo->n_ins_apc_half_yearly_import_total_in_word ?: $appInfo->ins_apc_half_yearly_import_total_in_word , ['class' => 'form-control input-md required']) !!}
                        ...
                        <div class="panel panel-info">
                            ...
                            <div class="panel-body">
                                <table aria-label="Detailed Report Data Table" class="table table-bordered table-responsive">
                                    <thead class="alert alert-info">
                                    <tr>
...
// End of code from bida old -------------
    ...
    function calculateHalfYearlyImportTotal(className, totalShowFieldId) {
        ...
        var apc_half_yearly_import_other = $("#apc_half_yearly_import_other").val() ? parseFloat($("#apc_half_yearly_import_other").val()) : 0;
        $("#apc_half_yearly_import_grand_total").val(total_import + apc_half_yearly_import_other);
    }
