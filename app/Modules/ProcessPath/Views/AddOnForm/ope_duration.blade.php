        ...
        <div class="form-group">
            <div class="row">
                <div class="col-md-12 {{$errors->has('approved_is_remittance_allowed') ? 'has-error': ''}}">
                    ...
                    <div class="col-md-6">
                        <label class="radio-inline">{!! Form::radio('approved_is_remittance_allowed','yes', ($ope_info->approved_is_remittance_allowed == 'yes' ? true :false), ['class'=>'cusReadonly helpTextRadio','id' => 'yes']) !!}
                            Yes
                        </label>
                        <label class="radio-inline">{!! Form::radio('approved_is_remittance_allowed', 'no', ($ope_info->approved_is_remittance_allowed == 'no' ? true :false), ['class'=>'cusReadonly', 'id' => 'no']) !!}
                            No
                        </label>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-3 {{$errors->has('approved_desired_duration') ? 'has-error': ''}}">
                    ...
                    <div class="col-md-12">
                        {!! Form::text('approved_desired_duration', $ope_info->approved_desired_duration, ['class' => 'form-control input-md', 'readonly']) !!}
                ...
                <div class="col-md-3 {{$errors->has('approved_duration_amount') ? 'has-error': ''}}">
                    ...
                    <div class="col-md-12">
                        {!! Form::text('approved_duration_amount', $ope_info->approved_duration_amount, ['class' => 'form-control input-md', 'readonly']) !!}
