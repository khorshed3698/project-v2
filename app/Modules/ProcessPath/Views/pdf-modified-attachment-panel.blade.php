                            ...
                            @foreach($document as $row)
                                @if(!empty($row->doc_file_path))
                                    <div role="tabpanel" class="tab-pane <?php if ($i == 1) {
                                        ...
                                        @if(!empty($row->doc_file_path))
                                            <h4>
                                                <a href="{{ $row->doc_file_path }}" download={{ "Doc-$i" }}><i class="fa fa-download"></i>{{  "Doc-$i" }}</a>
                                            </h4>
                                            <iframe src="{{ $row->doc_file_path }}" width="100%" style="text-align: center;" title="Files"></iframe>
                                        @else
