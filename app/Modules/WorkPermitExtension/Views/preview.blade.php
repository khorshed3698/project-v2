...
<script language="javascript">
    ...
    jQuery(function () {
        jQuery('#submitFromPreviewBtn').click(function (e) {
            window.opener.document.getElementById("WorkPermitExtensionForm").setAttribute("target", "_self");
            window.opener.jQuery("#WorkPermitExtensionForm").submit();
            window.close();
        });
    });
...
//        return jQuery(this).find('option:selected').text();
    ...
    function CloseMe()
    {
        ...
        window.opener.jQuery("#WorkPermitExtensionForm-p-4").css({"display": "block"});
