    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="pull-left">
                    <strong style="line-height: 30px;"> Application for Work Permit Extension</strong>
                </div>
                <div class="pull-right">
                    ...
                    @if(!in_array($appInfo->status_id,[-1,5,6]))
                        <a href="/work-permit-extension/app-pdf/{{ Encryption::encodeId($appInfo->id)}}" target="_blank" class="btn btn-danger btn-md">
            ...
            <div class="panel-body">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-5 col-xs-9">
                                <span class="v_label">Effective date of the first Work Permit</span>
                                <span class="pull-right">&#58;</span>
                            </div>
                            <div class="col-md-7 col-xs-3">
                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <fieldset class="scheduler-border">
                            ...
                            <div class="form-group">
                                <table  class="table table-striped table-bordered table-responsive" cellspacing="10" width="100%" aria-label="Detailed Compensation and Benefit Report">
                                    <tr>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-5 col-xs-6">
                                                <label class="v_label">Remittance received during the last twelve months (USD)</label>
                                                <span class="pull-right">&#58;</span>
                                            </div>
                                            <div class="col-md-7 col-xs-6">
                        ...
                        <fieldset class="scheduler-border">
                            <legend class="scheduler-border"> Manpower of the organization</legend>
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table table-striped table-bordered" aria-label="Detailed Manpower of the organization Report" width="100%">
                                            <thead>
                                            <th class="text-center" colspan="9">Manpower of
                                                the organization
                                            </th>
                                            </thead>
                                            <tbody>
                                            <tr>
                                                <td class="text-center" style="padding: 5px;" colspan="3">Local (Bangladesh only)</td>
                                                <td class="text-center" style="padding: 5px;" colspan="3">Foreign (Abroad country)</td>
