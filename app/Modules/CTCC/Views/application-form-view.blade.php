        ...
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="pull-left">
                    <strong style="line-height: 30px;">
                        Application For New Trade License (CCC)
                    </strong>
                </div>
            ...
            <div class="panel-body">
                ...
                <ol class="breadcrumb">
                    ...
                    @if (isset($appInfo) && !empty($appInfo->ctcc_tracking_no))
                    <li><strong>CCC Tracking no. : </strong>{{ $appInfo->ctcc_tracking_no  }}</li>
                    @endif

                    @if(!empty($appInfo->tl_no) && $appInfo->status_id == 25)
                        <li><strong>CCC TL No. : </strong>{{ $appInfo->tl_no  }}</li>
                    @endif
                    ...
                    @if (isset($appInfo) && $appInfo->status_id == 25 && isset($appInfo->certificate_link))
                        <li>
{{--                            <a href="{{ url('licence-applications/ctcc/terms-condition/'. \App\Libraries\Encryption::encodeId($appInfo->ref_id)) }}"--}}
                            <a href="{{ $appInfo->certificate_link }}"
                    ...
                    <div class="panel-body">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-xs-12">
                                            <div class="col-md-5 col-xs-12">
                                                <span class="v_label">New TL Book Issue Fee </span>
                                                <span class="pull-right">&#58;</span>
                                            </div>
                                            <div class="col-md-7">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-6 col-xs-12">
                                    <div class="col-md-5 col-xs-12">
                                        <span class="v_label">Total Payable Fee/Total Assessed Fee : </span>
                                        <span class="pull-right">&#58;</span>
                                    </div>
                                    <div class="col-md-7">
