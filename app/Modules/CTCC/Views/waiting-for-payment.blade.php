...
@section('content')
            ...
            <div class="box">
                <div id="paymentPanel" class="panel panel-default" style="display: none;">
                    <div class="panel-body">
                        {!! Form::open(array('url' => '/ctcc/payment','method' => 'post','id' => 'NameClearanceForm','role'=>'form','enctype'=>'multipart/form-data')) !!}
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            checkNESCOStatus();
            countDownTimer('Connecting to CCC Server', 'Please wait to connect...', '2:02');
        });
    </script>
