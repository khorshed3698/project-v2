...
@section('content')
        ...
        <div class="col-md-12">
            ...
            <div id="loading">
                ...
                <Span class="alert alert-success" id="loding-msg"><i class="fa fa-spinner fa-spin"></i>  <span
                            id="loding-msg-text">Connecting to NESCO server.</span></Span>
            </div>
            ...
            <div class="box">
                <div id="paymentPanel" class="panel panel-default" style="display: none;">
                    <div class="panel-body">
                        ...
                        {!! Form::open(array('url' => '/new-connection-nesco/payment-demand','method' => 'post','id' => 'NameClearanceForm','role'=>'form','enctype'=>'multipart/form-data')) !!}
    ...
    <script type="text/javascript">
        ...
        function checkNescoStatus() {
            ...
            $.ajax({
                url: '/new-connection-nesco/check-payment-info-demand',
                type: "POST",
                data: {
                    enc_app_id: app_id
                },
