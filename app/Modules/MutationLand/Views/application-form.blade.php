                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 {{$errors->has('company_name_bn') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('company_name_bn', \App\Libraries\CommonFunction::getCompanyBnNameById(Auth::user()->working_company_id),['class' => 'form-control input-md required']) !!}
                                        ...
                                        <div class="col-md-6 {{$errors->has('company_name_en') ? 'has-error': ''}}">
                                            ...
                                            <div class="col-md-7">
                                                {!! Form::text('company_name_en', \App\Libraries\CommonFunction::getCompanyNameById(Auth::user()->working_company_id), ['class' =>'form-control input-md required']) !!}
...
{{--                                                </label>--}}
                                            ...
                                            <div class="col-sm-6 col-md-5">
                                                <label class="center-block" for="applicant_photo">
                                                    <figure>
                                                        <img src="{{ (!empty(Auth::user()->user_pic)? url('users/upload/'.Auth::user()->user_pic) : url('assets/images/no-image.png')) }}"
                                        ...
                                        {{--                                                         src="{{ (Auth::user()->user_pic != '' && file_exists('users/upload/'.Auth::user()->user_pic))  ? url('users/upload/'.Auth::user()->user_pic) : url('assets/images/no-image.png') }}"--}}
                                        {{--                                                         alt="photo" value="{{ Auth::user()->user_pic != '' ? Auth::user()->user_pic : ''}}">--}}
                                        {{--                                                </div>--}}
                                        {{--                                            </div>--}}
                                        {{--                                        </div>--}}
                                    </div>
