    ...
    <div class="row">
        @if($pdfCertificate)
            <div class="col-md-10 col-md-offset-1">
                                ...
                                <td>
                                    <div class="pull-left">
                                        <a href="{!! $pdfCertificate->certificate_link !!}"
                                           target="_blank" rel="noopener">{!!  str_limit($pdfCertificate->certificate_link, $limit = 40, $end = '...') !!}</a>
                                    </div>
                                    <div class="pull-right">
                                        <a download href="{{ $pdfCertificate->certificate_link }}" target="_blank" rel="noopener"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <table class="table table-bordered table-bg-white" aria-label="Detailed Report Data Table">
                            ...
                            {{--<tr>--}}
                            {{--<td>{{ (empty($pdfCertificate->applicant_hash) ? '&nbsp;' : $pdfCertificate->applicant_hash) }}</td>--}}
                            {{--</tr>--}}
                            <tr>
                ...
                {{--<tbody>--}}
                {{--<tr>--}}
                {{--<td rowspan="4" width="25%"><b>Recommender</b></td>--}}
                {{--<td>{{ isset($recommender_info->recommender_name) ? $recommender_info->recommender_name : null }}</td>--}}
                {{--</tr>--}}
                {{--<tr>--}}
                {{--<td>{{ isset($recommender_info->recommender_email) ? $recommender_info->recommender_email : null }}</td>--}}
                {{--</tr>--}}
                {{--<tr>--}}
                {{--<td style="word-break: break-all">{{ isset($recommender_info->hash_value ) ? (empty($recommender_info->hash_value) ? '&nbsp;' : $recommender_info->hash_value)  : null  }}</td>--}}
                {{--</tr>--}}
                {{--<tr>--}}
                {{--<td>{{  isset($recommender_info->updated_at ) ? date('d-M-Y h:i:s', strtotime($recommender_info->updated_at))  : null }}</td>--}}
                {{--</tr>--}}
                {{--</tbody>--}}
                {{--</table>--}}
                {{--</div>--}}
