...
<script>
    ...
    function getDoc() {
        ...
        let category = $("#application_category").val()
        let appCategory = category.split('@')[0]
        let isFreedomFighter = $( "input[type=radio][name=freedomfighter_status]:checked" ).val();
        $.ajax({
            type: "POST",
            url: '/wasa-new-connection/get-dynamic-doc',
            dataType: "json",
            data: {
                _token: _token,
                appId: appId,
