            ...
            <div class="box-body">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h5><strong>Edit application for new water connection</strong></h5>
                    </div>
                    ...
                    <fieldset>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        {!! Form::label('application_category','Application Category',['class'=>'text-left col-md-6 required-star']) !!}
                                        <div class="col-md-6">
                                            {!! Form::select('application_category',[],!empty($appData->application_category) ? $appData->application_category : '',['class' => 'form-control input-md','id'=>'application_category']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        {!! Form::label('water_connection_size','Water Connection Size',['class'=>'text-left col-md-6 required-star']) !!}
                                        <div class="col-md-6">
                                            {!! Form::select('water_connection_size',[],$appData->water_connection_size,['class' => 'form-control input-md','id'=>'water_connection_size']) !!}
                                        </div>
                                    </div>
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    ...
                                                    <div class="col-md-5" style="position:relative;">
                                                        <img id="photo_viewer_photo"
                                                             ...
                                                             src="{{  (!empty($appData->validate_field_photo)? url('/uploads/'.$appData->validate_field_photo) : url('assets/images/no-image.png')) }}"
                                                             alt="photo">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    ...
                                                    <div class="col-md-5" style="position:relative;">
                                                        <img id="freedom_photo_viewer_freedom_photo"
                                                             ...
                                                             src="{{  (!empty($appData->validate_field_freedom_photo)? url('/uploads/'.$appData->validate_field_freedom_photo) : url('assets/images/no-image.png')) }}"
                                                             alt="freedom_photo">
                                                    </div>
                                                </div>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        {!! Form::label('conn_address','Address :',['class'=>'text-left col-md-6 required-star']) !!}
                                        <div class="col-md-6">
                                            {!! Form::textarea('conn_address',isset($appData->conn_address) ? $appData->conn_address : '',['class' => 'form-control input-md','id'=>'conn_address','style'=>'height: 60px;','placeholder'=>'Type Adress']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        {!! Form::label('c_district_citycorporation','District/City Corporation :',['class'=>'text-left col-md-6']) !!}
                                        <div class="col-md-6">
                                            {!! Form::text('c_district_citycorporation',isset($appData->c_district_citycorporation) ? $appData->c_district_citycorporation : '',['class' => 'form-control input-md','id'=>'c_district_citycorporation','placeholder'=>'Type District/City Corporation']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::text('c_union_ward',isset($appData->c_union_ward) ? $appData->c_union_ward : '',['class' => 'form-control input-md','id'=>'c_union_ward','placeholder'=>'Type Union/Ward']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        {!! Form::label('c_district_city_area','District/City Corporation Area :',['class'=>'text-left col-md-6']) !!}
                                        <div class="col-md-6">
                                            {!! Form::text('c_district_city_area',isset($appData->c_district_city_area) ? $appData->c_district_city_area : '',['class' => 'form-control input-md','id'=>'c_district_city_area','placeholder'=>'Type District/City Corporation Area']) !!}
                                        </div>
                                    </div>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        {!! Form::label('present_address','Address :',['class'=>'text-left col-md-6 required-star']) !!}
                                        <div class="col-md-6">
                                            {!! Form::textarea('present_address',isset($appData->present_address) ? $appData->present_address : '',['class' => 'form-control input-md','id'=>'present_address','style'=>'height: 60px;','placeholder'=>'Type Present Address Name']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        {!! Form::label('p_district_citycorporation','District/City Corporation :',['class'=>'text-left col-md-6']) !!}
                                        <div class="col-md-6">
                                            {!! Form::text('p_district_citycorporation',isset($appData->p_district_citycorporation) ? $appData->p_district_citycorporation : '',['class' => 'form-control input-md','id'=>'p_district_citycorporation','placeholder'=>'Type District/City Corporation']) !!}
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::text('p_union_ward',isset($appData->p_union_ward) ? $appData->p_union_ward : '',['class' => 'form-control input-md','id'=>'p_union_ward','placeholder'=>'Type Union/Ward']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        {!! Form::label('p_district_city_area','District/City Corporation Area :',['class'=>'text-left col-md-6']) !!}
                                        <div class="col-md-6">
                                            {!! Form::text('p_district_city_area',isset($appData->p_district_city_area) ? $appData->p_district_city_area : '',['class' => 'form-control input-md','id'=>'p_district_city_area','placeholder'=>'Type District/City Corporation Area']) !!}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        {!! Form::label('structure_of_home','Structure of Home :',['class'=>'text-left col-md-6 required-star']) !!}
                                        <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::text('number_of_floor',isset($appData->number_of_floor) ? $appData->number_of_floor : '',['class' => 'form-control input-md onlyNumber','id'=>'number_of_floor','placeholder'=>'10']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="col-md-6" style="margin: 0px; padding: 0px;">
                                                {!! Form::text('landsize',isset($appData->landsize) ? $appData->landsize : '',['class' => 'form-control input-md onlyNumber','id'=>'landsize','placeholder'=>'10']) !!}

                                            </div>
                                            <div class="col-md-6" style="margin: 0px; padding: 0px;">

                                                {!! Form::select('landsize_type',[],isset($appData->landsize_type) ? $appData->landsize_type : '',['class' => 'form-control input-md','id'=>'landsize_type']) !!}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::text('no_of_flat',$appData->no_of_flat,['class' => 'form-control input-md onlyNumber','id'=>'no_of_flat','placeholder'=>'40']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="col-md-6" style="margin: 0px; padding: 0px;">
                                                ...
                                                {!! Form::text('house_area',$appData->house_area,['class' => 'form-control input-md onlyNumber','id'=>'house_area','placeholder'=>'40']) !!}
                                            </div>
                                            <div class="col-md-6" style="margin: 0px; padding: 0px;">
                                                {!! Form::select('house_area_type',[
                                                       ...
                                                       'Katha'=>'Katha',
                                                       'Acre'=>'Acre',
                                                       ],isset($appData->house_area_type) ? $appData->house_area_type : '',['class' => 'form-control input-md onlyNumber','id'=>'house_area_type']) !!}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::text('no_of_kitchen',$appData->no_of_kitchen,['class' => 'form-control input-md onlyNumber','id'=>'no_of_kitchen','placeholder'=>'2']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        {!! Form::label('sewer_line_status','Sewer Line Status :',['class'=>'text-left col-md-6 required-star']) !!}
                                        <div class="col-md-6">
                                            {!! Form::select('sewer_line_status',[],$appData->sewer_line_status,['class' => 'form-control input-md','id'=>'sewer_line_status']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::text('number_of_toilet',$appData->number_of_toilet,['class' => 'form-control input-md onlyNumber','id'=>'number_of_toilet','placeholder'=>'3']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        {!! Form::label('water_res_capacity','Underground Water Resv. capacity (Litre) :',['class'=>'text-left col-md-6 required-star']) !!}
                                        <div class="col-md-6">
                                            {!! Form::text('water_res_capacity',$appData->water_res_capacity,['class' => 'form-control input-md onlyNumber','id'=>'water_res_capacity','placeholder'=>'40']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        {!! Form::label('number_of_user','Number of User :',['class'=>'col-md-6']) !!}
                                        <div class="col-md-6">
                                            {!! Form::text('number_of_user', isset($appData->number_of_user) ? $appData->number_of_user : '',['class' => 'form-control
                                            input-md onlyNumber','id'=>'number_of_user','placeholder'=>'3']) !!}
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        {!! Form::label('roof_water_res_capacity','Roof Top Water Resv. capacity (Litre):',['class'=>'text-left col-md-6 required-star']) !!}
                                        <div class="col-md-6">
                                            {!! Form::text('roof_water_res_capacity',$appData->roof_water_res_capacity,['class' => 'form-control input-md onlyNumber','id'=>'roof_water_res_capacity','placeholder'=>'40']) !!}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            {!! Form::select('number_of_ex_conn',[
                                                        ...
                                                        '2'=>'2',
                                                        '3'=>'3',
                                                        ],isset($appData->number_of_ex_conn) ? $appData->number_of_ex_conn : '',['class' => 'form-control input-md','id'=>'number_of_ex_conn']) !!}
...
//          console.log(selected_value);
        ...
        $('#application_category').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->application_category) ? $appData->application_category : '' }}'; // for callback
//            console.log(selected_value);
        ...
        $('#application_category').trigger('change');
...
//            console.log(selected_value);
        ...
        $('#water_connection_size').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->water_connection_size) ? $appData->water_connection_size : '' }}'; // for callback
            if(selected_value != ''){
        ...
        $('#structure_of_home').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->structure_of_home) ? $appData->structure_of_home : '' }}'; // for callback
//
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "key"; //dynamic id for callback
            var element_name = "value"; //dynamic name for callback
        ...
        $('#landsize_type').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->landsize_type) ? $appData->landsize_type : '' }}'; // for callback
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "key"; //dynamic id for callback
            var element_name = "value"; //dynamic name for callback
            var data = '';
        ...
        $('#sewer_line_status').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->sewer_line_status) ? $appData->sewer_line_status : '' }}'; // for callback
//            console.log(selected_value);
            var calling_id = $(this).attr('id'); // for callback
            var element_id = "key"; //dynamic id for callback
            var element_name = "value"; //dynamic name for callback
    ...
    function appTypeCallBackRes(response, [calling_id, selected_value, element_id, element_name, data]) {
        ...
        if (response.responseCode === 200) {
            $.each(response.data, function (key, row) {
                ...
                if (selected_value == id) {
//                    option += '<lebel for="application_type_'+row[element_id]+'" class="radio-inline"><input type="radio" name="application_type" class="app_type" id="application_type_'+row[element_id]+'"  value="'+id+'" checked/>'+value+'</lebel>';
...
// option += '<input style="float:left;margin-left:5px" id="application_type_'+row[element_id]+'" type="radio" value="'+id+'" name="application_type" checked><label style="margin-left:5px" for="application_type_'+row[element_id]+'">'+value+'</label>';
                } else {
//                    option += '<input type="radio" name="application_type" class="app_type" id="application_type_'+row[element_id]+'"  value="'+id+'" /><lebel for="application_type_'+row[element_id]+'" class="radio-inline">'+value+'</lebel>';
