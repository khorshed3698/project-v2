...
@section('content')
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading"><h5><strong>Associated Company</strong></h5></div>
                                ...
                                @foreach($company_list as $data)
                                    @if(in_array( $data->id, $select))
                                        <option value="{{ $data->id }}" selected="true">
                                            <?php
                                            $returnData = $data->company_name;
                                            if($data->divisionName)
                                                $returnData .= ", ". $data->divisionName;
                                            if($data->districtName)
                                                $returnData .= ", ". $data->districtName;
                                            echo $returnData;
                                            ?>
