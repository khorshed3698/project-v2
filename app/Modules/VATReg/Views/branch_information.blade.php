...
<div class="panel-body">
    <p id="branchData" class="statictooltip"> Please click <a>
            <button id="branchInfo" type="button">here</button>
        </a> to provide Branch
        Information.
    </p>
    <div id="branchTable" style="display: none;">
        <table id="branch_info" class="table table-bordered table-hover">
            <thead>
            ...
            <tr id="branchInfoRow">
                ...
                <td>
                    {!! Form::select('branch_category[0]',[],'',['class' => 'form-control input-md required branch_category','placeholder' =>
                ...
                <td>
                    {!! Form::text('bin[0]','',['class' => 'col-md-7 form-control input-md required bin','id'=>'bin_1']) !!}
                </td>
                <td>
                    {!! Form::text('branch_id[0]','0001',['class' => 'col-md-7 form-control input-md required sNo','id'=>'branch_id_1','readonly'])
                    !!}
                </td>
    ...
    <p id="branchCloseData" style="display: none;"> Please click <a>
