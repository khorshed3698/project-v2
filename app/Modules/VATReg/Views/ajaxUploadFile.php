...
$valid_formats = array("pdf","doc","docx","xls","xlsx","txt","jpg","png"); //"jpg", "png", "gif", "bmp", "txt", "doc", "docx",
$validFileFlag = "";
...
?>
<input type="hidden" <?php echo $req == "" ? "" : 'class="required"'; ?> value="<?php echo $validFileFlag; ?>" id="<?php echo $validateFieldName; ?>" name="<?php echo $validateFieldName; ?>" />