...
<div class="panel-body">
    ...
    <div id="authorizedTable" style="display: none;">
        <table id="authorizedInfo" class="table table-bordered table-hover"
            ...
            <tr id="authorizedInfoRow">
                <td>
                    {!! Form::text('full_name_authorized[0]','',['class' => 'col-md-7 form-control input-md required','id'=>'full_name_authorized']) !!}
                </td>
                <td>
                    {!! Form::select('authorized_designation[0]',[],null,['class' => 'form-control input-md authorized_designation required','placeholder' => 'Select One','id'=>'authorized_designation_1']) !!}
                    {!! $errors->first('','<span class="help-block">:message</span>') !!}
                </td>
                <td>
                    {!! Form::select('identity_category_authorized[0]',[],null,['class' => 'form-control input-md identity_category_authorized required','placeholder' => 'Select One','id'=>'identity_category_authorized_1']) !!}
                    {!! $errors->first('','<span class="help-block">:message</span>') !!}
                </td>
                <td>
                    {!! Form::text('authorized_nid[0]','',['class' => ' form-control input-md authorized_nid nid required' ,'placeholder' => '', 'id'=>'authorized_nid_1','style'=>'display:none']) !!}
                </td>
                <td>
                    {!! Form::text('authorized_passport_no[0]','',['class' => ' form-control input-md authorized_passport_no required','placeholder' => '', 'id'=>'authorized_passport_no_1','style'=>'display:none']) !!}
                </td>
                <td>
                    {!! Form::select('authorized_nationality[0]',[],null,['class' => 'form-control input-md authorized_nationality required','style' => 'display:none','placeholder' => 'Select One', 'id'=>'authorized_nationality_1']) !!}
                    {!! $errors->first('','<span class="help-block">:message</span>') !!}

                </td>
                <td>
                    {!! Form::text('authorized_mobile[0]','',['class' => ' form-control input-md authorized_mobile mobile onlyNumber required',"maxlength"=>"11",'placeholder' => '','id'=>'authorized_mobile_1']) !!}
                </td>
                <td>
                    {!! Form::text('authorized_email[0]','',['class' => ' form-control input-md authorized_email email required','placeholder' => '','id'=>'authorized_email_1']) !!}
                </td>
                <td>
                    {!! Form::select('purpose[0]',[],null,['class' => 'form-control input-md purpose required','placeholder' => 'Select One','id'=>'purpose_1']) !!}
                    {!! $errors->first('','<span class="help-block">:message</span>') !!}
                </td>
    ...
    <p id="authorizedCloseData" style="display: none;"> Please click <a>
