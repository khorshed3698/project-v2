    ...
    <div class="panel panel-primary" id="inputForm">
        ...
        <fieldset>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group" style="">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                required-star']) !!}
                                <div id="reg_cagegory_div"
                                     class="col-md-8 {{$errors->has('reg_category') ? 'has-error': ''}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="display:none;" id="reRegHiddenDiv">
                        <div class="row">
                            <div class="col-md-6">
                                {!! Form::label('old_bin','Old 11-digit BIN', ['class'=>'col-md-5 required-star']) !!}
                                <div class="col-md-7 {{$errors->has('old_bin') ? 'has-error': ''}}">
                                    {!! Form::text('old_bin', '',['class' => 'form-control onlyNumber input-sm required']) !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('company_name') ? 'has-error': ''}}">
                                    {!! Form::text('company_name', '',['class' => 'form-control input-sm required']) !!}
                    ...
                    <div class="form-group" style="">
                        ...
                        <div class="col-md-12">
                            <label class="radio-inline">
                                <input type="radio" id="registeredBin_no" name="registeredBin" onclick="reg_bin_show(1)"
                                       value="1@Yes">
                        ...
                        <div id="reg_bin_num" class="col-md-8 row">
                           ...
                           required-star']) !!}
                            {!! Form::text('bin_number', null,['class' => 'col-md-6
                    ...
                    <div class="form-group" style="">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-9" id="business_please_specify" style="display:block;">
                                    {!! Form::label('please_specify','Please Specify', ['class'=>'col-md-5
                                    required-star']) !!}
                                    <div
                                            class="col-md-7 {{$errors->has('please_specify') ? 'has-error': ''}}">
                                        {!! Form::text('please_specify', null,['class' => 'form-control
                                        input-sm required']) !!}
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('tl_number') ? 'has-error': ''}}">
                                    {!! Form::text('tl_number', '',['class' => 'form-control input-sm required licence_no','id'=>'licence_no']) !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('tl_issue_date') ? 'has-error': ''}}">
                                    <div class="datepickerlicence input-group date">
                                        {!! Form::text('tl_issue_date', '',['class' => 'form-control input-sm
                                        required']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('rjsc_inc_number') ? 'has-error': ''}}">
                                    {!! Form::text('rjsc_inc_number', '',['class' => 'form-control input-sm required'])
                                    !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('rjsc_inc_issue_date') ? 'has-error': ''}}">
                                    <div class="datepickerlicence2 input-group date">
                                        {!! Form::text('rjsc_inc_issue_date', '',['class' => 'form-control input-sm
                                        required']) !!}
                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('etin') ? 'has-error': ''}}">
                                    {!! Form::text('etin', '',['class' => 'form-control input-sm required onlyNumber','id'=>'etin'])
                                    !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('etin_entity_name') ? 'has-error': ''}}">
                                    {!! Form::text('etin_entity_name', '',['class' => 'form-control input-sm required'])
                                    !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('entity_name') ? 'has-error': ''}}">
                                    {!! Form::text('entity_name', '',['class' => 'form-control input-sm required']) !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('trading_brand_name') ? 'has-error': ''}}">
                                    {!! Form::text('trading_brand_name', '',['class' => 'form-control input-sm
                                    required', 'id'=>'trading_brand_name']) !!}
                    ...
                    <div class="form-group" style="">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                required-star']) !!}
                                <div class="col-md-7 {{$errors->has('registration_type') ? 'has-error': ''}}"
                    ...
                    <div class="form-group" style="display:none;" id="local_share">
                        <div class="row">
                            <div class="col-md-offset-6 col-md-6">
                                {!! Form::label('local_shares','Local Share (%)', ['class'=>'col-md-5 required-star'])
                                !!}
                                <div class="col-md-7 {{$errors->has('local_share') ? 'has-error': ''}}">
                                    {!! Form::text('local_share', '',['class' => 'form-control input-sm required
                                    onlyNumber', 'id'=>'local_shares']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('bida_reg_number') ? 'has-error': ''}}">
                                    {!! Form::text('bida_reg_number', '',['class' => 'form-control input-sm required',
                                    'id'=>'bida_reg_number']) !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('bida_reg_issue_date') ? 'has-error': ''}}">
                                    <div class="datepickerbida input-group date">
                                        {!! Form::text('bida_reg_issue_date', '',['class' => 'form-control input-sm
                                        required']) !!}
                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('factory_address') ? 'has-error': ''}}">
                                    {!! Form::textarea('factory_address', null, ['data-rule-maxlength'=>'240', 'class'
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('land_telephone') ? 'has-error': ''}}">
                                    {!! Form::text('land_telephone', '',['class' => 'form-control input-sm required
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('mobile_telephone') ? 'has-error': ''}}">
                                    {!! Form::text('mobile_telephone', '',['class' => 'form-control input-sm required
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('email') ? 'has-error': ''}}">
                                    {!! Form::text('email', '',['class' => 'form-control input-sm required
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('fax') ? 'has-error': ''}}">
                                    {!! Form::text('fax', '',['class' => 'form-control input-sm required onlyNumber',"maxlength"=>"15","id"=>"fax"])
                                    !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('web_address') ? 'has-error': ''}}">
                                    {!! Form::text('web_address', '',['class' => 'form-control input-sm required
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('headquarter_address') ? 'has-error': ''}}">
                                    {!! Form::textarea('headquarter_address', null, ['data-rule-maxlength'=>'240',
                                    ...
                                    !!}
                                    {!! Form::checkbox('same_as_factory',1,null, array('id'=>'same_as_factory',
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('headquarter_address_outside') ? 'has-error': ''}}">
                                    {!! Form::textarea('headquarter_address_outside', null,
            ...
            <div class="panel panel-primary">
            @include('VATReg::branch_information')
            <!--/panel-body-->
            </div>
            <!--/panel-->
                                ...
                                <div id="imports_div" style="display:none;">
                                    <div class="col-md-6">
                                        ...
                                        <div
                                            ...
                                            {!! Form::text('support_document_imports', null,['class' => 'form-control
                                            input-sm required','disabled']) !!}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-7 {{$errors->has('issue_date_imports') ? 'has-error': ''}}">
                                            <div class="datepickerimports input-group date">
                                                {!! Form::text('issue_date_imports', null,['class' => 'form-control input-sm
                                                required','disabled']) !!}
                                ...
                                <div id="exports_div" style="display:none;">
                                    <div class="col-md-6">
                                        ...
                                        <div
                                            ...
                                            {!! Form::text('support_document_exports', null,['class' => 'form-control
                                            input-sm required','disabled']) !!}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-7 {{$errors->has('issue_date_exports') ? 'has-error': ''}}">
                                            <div class="datepickerexports input-group date">
                                                {!! Form::text('issue_date_exports', null,['class' => 'form-control  input-sm
                                                required','disabled']) !!}
                                                <span class="input-group-addon"><span
                                                            class="fa fa-calendar"></span></span>
                                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-8" id="please_specify_data" style="display:none;">
                                    ...
                                    <div class="col-md-7 {{$errors->has('please_specify_f') ? 'has-error': ''}}">
                                        {!! Form::text('please_specify_f', null,['class' => 'form-control input-sm
                                        required']) !!}
                    ...
                    <div class="form-group" style="">
                        <div class="row">
                            ...
                            <div id="manufacturing_area" style="display:none;">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-8" id="please_specify_G" style="display:none;">
                                        {!! Form::label('please_specify_g','Please Specify', ['class'=>'col-md-5
                                        required-star']) !!}
                                        <div class="col-md-7 {{$errors->has('please_specify_g') ? 'has-error': ''}}">
                                            {!! Form::text('please_specify_g', null,['class' => 'form-control input-sm
                                            required']) !!}
                    ...
                    <div class="form-group" style="">
                        <div class="row">
                            ...
                            <div id="services_div" style="display:none;">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-8" id="please_specify_H" style="display:none;">
                                        {!! Form::label('please_specify_h','Please Specify', ['class'=>'col-md-5
                                        required-star']) !!}
                                        <div class="col-md-7 {{$errors->has('please_specify_h') ? 'has-error': ''}}">
                                            {!! Form::text('please_specify_h', null,['class' => 'form-control input-sm
                                            required']) !!}
            ...
            <div class="panel panel-primary">
                @include('VATReg::business_classification_code')
            </div>
            <!--/panel-->

            <div class="panel panel-primary">
                @include('VATReg::bank_account')
            </div>
            <!--/panel-->

            <div class="panel panel-primary">
                @include('VATReg::owner_of_entity')
            </div>
            <!--/panel-->
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('taxable_turnover') ? 'has-error': ''}}">
                                    {!! Form::text('taxable_turnover', '',['class' => 'form-control onlyNumber input-sm required'])
                                    !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('projected_turnover') ? 'has-error': ''}}">
                                    {!! Form::text('projected_turnover', '',['class' => 'form-control input-sm
                                    required onlyNumber']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('employee_number') ? 'has-error': ''}}">
                                    {!! Form::text('employee_number', '',['class' => 'form-control input-sm required
                                    onlyNumber']) !!}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('zero_rated_supply') ? 'has-error': ''}}">
                                    <label class="radio-inline">{!! Form::radio('zero_rated_supply','1', false,
                                        ['class'=>'helpTextCheckbox zero_rated_supply required', 'id' => 'zero_rated_supply_yes']) !!}
                                        Yes</label>
                                    <label class="radio-inline">{!! Form::radio('zero_rated_supply', '2', false,
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-7 {{$errors->has('vat_extended_supply') ? 'has-error': ''}}">
                                    <label class="radio-inline">{!! Form::radio('vat_extended_supply','1', false,
                                        ['class'=>'helpTextCheckbox vat_extended_supply required', 'id' => 'vat_extended_supply_yes']) !!}
                                        Yes</label>
                                    <label class="radio-inline">{!! Form::radio('vat_extended_supply', '2', false,
                    ...
                    <div class="form-group" style="">
                        <div class="row">
                            <div id="capital_machinery" style="display:none;">
                                @include('VATReg::major_capital_machinery')
                            </div>
                            <div id="input_output_data" style="display:none;">
                                @include('VATReg::input_output_data')
                            </div>
                        </div>
                    </div>
                    <div class="clearfix"></div>
            ...
            <!--/panel-->
            <div class="panel panel-primary">
                @include('VATReg::authorized_persons_online')
            </div>
            <!--/panel-->
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                {!! Form::select('auth_designation',[], [], ['class' =>
                                'form-control required input-sm auth_designation']) !!}
        ...
        <div class="row">
            <div class="col-md-6 col-xs-12">
                <div class="pull-left">
                    <button type="submit" id="save_as_draft" class="btn btn-info btn-md cancel" value="draft"
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(document).on('keydown', '.bank_name', function (el) {
            var key = el.which;
            if (typeof key !== "undefined") {
                return false;
            }
            ...
            var selected_value = ''; // for callback
            var calling_id = 'bank_name'; // for callback
            ...
            apiCallGet(e, options, apiHeaders, selectClassCallbackResponse, arrays);

        });

        $(document).on('keydown', '.branch_category', function (el) {
            var key = el.which;
            if (typeof key !== "undefined") {
                return false;
            }
    ...
    function validateURL(textval) {
        ...
        var url = /^(http(s)?:\/\/)?(www\.)?[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$/.test(url);
...
@include('VATReg::checkbox-radiobutton-scripts')
