<style>
    ...
    .statictooltip .fa-question-circle {
...
<div class="panel-body">
    ...
    <p id="classificationData" class="statictooltip">
        Please click <a>
    ...
    <div id="classificationTable" style="display: none;">
        <table id="classification" class="table table-bordered table-hover"
            ...
            <tr id="classificationRow">
                ...
                <td>
                    {!! Form::text('hs_description[0]','',['class' => '!empty form-control input-md required','placeholder' => '', 'id'=>'hs_description_1','readonly']) !!}
                </td>
    ...
    <p id="classificationCloseData" style="display: none;"> Please click <a>
