...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.finish').on('click', function (e) {
            ...
            if (form.valid()) {
                ...
                popupWindow = window.open('<?php echo URL::to('licence-application/preview?form=TINforeigner@3'); ?>');
            } else {
                return false;
            }
        });
    ...
    $(document).ready(function () {
        ...
        $('#taxpayer_status').on('keydown', function (el) {
            ...
            var selected_value = '{{!empty($appData->taxpayer_status) ?$appData->taxpayer_status: ''}}'; // for callback
        ...
        $('#taxpayer_status').on('change', function (el) {
            ...
            var self = $(this);
            $(self).parent().find('.loading_data').hide();
            ...
            if (taxpayer_id) {
                ...
                var selected_value = '{{!empty($appData->taxpayer_status_b) ? $appData->taxpayer_status_b : ''}}';  // for callback
                var calling_id = $(this).attr('id'); // for callback
                var element_id = "fieldId"; //dynamic id for callback
                var element_name = "fieldValue"; //dynamic name for callback
                var data = '';
        ...
        $('.country_id').on('change', function (el) {
            ...
            if (country_id) {
                ...
                var selected_value =  $(this).attr("data-value2");  // for callback
                var calling_id = $(this).attr('id'); // for callback
                var element_id = "fieldId"; //dynamic id for callback
                var element_name = "fieldValue"; //dynamic name for callback
                var data = '';
                ...
                apiCallGet(e, options, apiHeaders, CountrydependantCallbackResponse, arrays);
            } else {
                $("#"+dependent_section_id).html('<option value="">Select Country First</option>')
                 $(self).parent().find('.loading_data').hide();
            }
        })
        $('.district_id').on('change', function (el) {
            ...
            if (district_id) {
                ...
                $("#"+dependent_section_id).html('<option value="">Select District First</option>')
                 $(self).parent().find('.loading_data').hide();
            }
        })
        $('#taxpayer_status_b').on('change', function (el) {
            ...
            if (incomeSource_id) {
                ...
                var selected_value = '{{!empty($appData->localtion_main_source_income) ? $appData->localtion_main_source_income : ''}}';  // for callback
                var calling_id = $(this).attr('id'); // for callback
                var element_id = "fieldId"; //dynamic id for callback
                var element_name = "fieldValue"; //dynamic name for callback
                var data = '';
        ...
        $('#localtion_main_source_income').on('change', function (el) {
            ...
            // if(incomeSource_id==3){
            //     var dependented_id = 'business_type';
            //     $('#business_type_div').removeClass('hidden');
            //     $('#business_type').removeAttr('disabled');
            //     $('#business_type').addClass('required');
            //     $('#business_type_data').removeAttr('disabled');
            //     $('#business_location_div').addClass('hidden');
            //     $('#business_location').attr('disabled','disabled');
            //     $('#business_location').removeClass('required');
            //     $('#div_select_list_name').attr('disabled','disabled');
            // }else{
            //     var dependented_id = 'business_location';
            //     $('#business_location_div').removeClass('hidden');
            //     $('#business_location').removeAttr('disabled');
            //     $('#business_location').addClass('required');
            //     $('#div_select_list_name').attr('disabled');
            //     $('#business_type_div').addClass('hidden');
            //     $('#business_type').attr('disabled','disabled');
            //     $('#business_type').removeClass('required');
            //     $('#business_type_data').attr('disabled','disabled');
            //
            // }
            ...
            if (incomeSource_id) {
                ...
                var selected_value = '{{!empty($appData->juri_select_list_no)?$appData->juri_select_list_no:''}}';  // for callback
                var calling_id = $(this).attr('id'); // for callback
                var element_id = "fieldId"; //dynamic id for callback
                var element_name = "fieldValue"; //dynamic name for callback
                var data = '';
        ...
        $('#business_location').on('change', function (el) {
            ...
            if (incomeSource_val) {
                ...
                var selected_value = '{{!empty($appData->juri_sub_list_no) ? $appData->juri_sub_list_no : ''}}';  // for callback
                var calling_id = $(this).attr('id'); // for callback
                var element_id = "fieldId"; //dynamic id for callback
                var element_name = "fieldValue"; //dynamic name for callback
                var data = '';
    ...
    function CountrydependantCallbackResponse(response, [calling_id, selected_value, element_id, element_name, dependent_section_id]) {
        var option = '<option value="">Select One</option>'
        if (response.responseCode === 200) {
            $.each(response.data, function (key, row) {
                var id = row[element_id] + '@' + row[element_name]
