            ...
            <div class="box-body">
                ...
                <div class="panel panel-info">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h5><strong>Application for Work Permit Cancellation</strong></h5>
                        </div>
                    ...
                    <div class="panel-body">
                        ...
                        <input type="hidden" name="ref_app_approve_date" value="{{ (Session::get('wpneaInfo.approved_date') ? Session::get('wpneaInfo.approved_date') : '') }}">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-md-12 {{$errors->has('last_work_permit') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    <label class="radio-inline">{!! Form::radio('last_work_permit','yes', (Session::get('wpneaInfo.last_work_permit') == 'yes' ? true :false), ['class'=>' cusReadonly helpTextRadio required', 'id'=>'last_work_permit_yes','onclick' => 'lastWorkPermit(this.value)']) !!}  Yes</label>
                                                    <label class="radio-inline">{!! Form::radio('last_work_permit', 'no', (Session::get('wpneaInfo.last_work_permit') == 'no' ? true :false), ['class'=>' cusReadonly required', 'id'=>'last_work_permit_no', 'onclick' => 'lastWorkPermit(this.value)']) !!}  No</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div id="ref_app_tracking_no_div" class="col-md-12 hidden {{$errors->has('ref_app_tracking_no') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="input-group">
                                                        {!! Form::text('ref_app_tracking_no', Session::get('wpneaInfo.ref_app_tracking_no'), ['data-rule-maxlength'=>'100', 'class' => 'form-control cusReadonly input-sm']) !!}
                                                        {!! $errors->first('ref_app_tracking_no','<span class="help-block">:message</span>') !!}
                                                        <span class="input-group-btn">
                                                            @if(Session::get('wpneaInfo'))
                                                                <button type="submit" class="btn btn-danger btn-sm" value="clean_load_data" name="actionBtn">Clear Loaded Data</button>

                                                                <a href="{{ Session::get('wpneaInfo.certificate_link') }}" target="_blank" rel="noopener" class="btn btn-success btn-sm">View Certificate</a>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div id="applicant_name_div" class="col-md-6 hidden {{$errors->has('applicant_name') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('applicant_name', Session::get('wpneaInfo.emp_name'), ['class' => 'form-control required cusReadonly textOnly input-md']) !!}
                                            ...
                                            <div id="applicant_nationality_div" class="col-md-6 hidden {{$errors->has('applicant_nationality') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::select('applicant_nationality', $nationality, Session::get('wpneaInfo.emp_nationality_id'), ['class' => 'form-control required cusReadonly input-md readonly-select','placeholder' => 'Select one']) !!}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div id="applicant_pass_no_div" class="col-md-6 hidden {{$errors->has('applicant_pass_no') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('applicant_pass_no', Session::get('wpneaInfo.emp_passport_no'), ['class' => 'form-control required cusReadonly input-md']) !!}
                                            ...
                                            <div id="applicant_position_div" class="col-md-6 hidden {{$errors->has('applicant_position') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('applicant_position', Session::get('wpneaInfo.emp_designation'), ['class' => 'form-control cusReadonly input-md']) !!}
                                        ...
                                        <div class="row">
                                            <div id="issue_date_of_last_div" class="col-md-6 hidden {{$errors->has('issue_date_of_last_wp') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    <div class="datepicker input-group date">
                                                        {!! Form::text('issue_date_of_last_wp', (Session::get('wpneaInfo.approved_date') ? date('d-M-Y', strtotime(Session::get('wpneaInfo.approved_date'))) : ''), ['class' => 'form-control cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                            ...
                                            @if($department_id == 1 || $department_id == '1')
                                                <div id="expiry_date_of_op_div" class="col-md-6 hidden {{$errors->has('expiry_date_of_op') ? 'has-error': ''}}">
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="datepicker input-group date">
                                                            {!! Form::text('expiry_date_of_op', (Session::get('wpneaInfo.expiry_date_of_op') ? date('d-M-Y', strtotime(Session::get('wpneaInfo.expiry_date_of_op'))) : ''), ['class' => 'form-control cusReadonly input-md date', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                            <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div id="date_of_cancellation_div" class="col-md-6 hidden {{$errors->has('date_of_cancellation') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    <div id="date_of_cancellation" class="input-group date">
                                                        {!! Form::text('date_of_cancellation', '', ['class' => 'form-control input-md date required', 'placeholder'=>'dd-mm-yyyy']) !!}
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                    </div>
                                            ...
                                            <div id="applicant_remarks_div" class="col-md-6 hidden {{$errors->has('applicant_remarks') ? 'has-error': ''}}">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::textarea('applicant_remarks', '', ['data-charcount-maxlength' => '200', 'data-rule-maxlength'=>'200', 'placeholder'=>'Remarks', 'class' => 'form-control bigInputField input-md maxTextCountDown',
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('ex_office_division_id') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::select('ex_office_division_id', $divisions, Session::get('wpneaInfo.ex_office_division_id'), ['class' => 'form-control cusReadonly input-md required readonly-select', 'id' => 'ex_office_division_id', 'onchange'=>"getDistrictByDivisionId('ex_office_division_id', this.value, 'ex_office_district_id', ". Session::get('wpneaInfo.ex_office_district_id') .")"]) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('ex_office_district_id') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::select('ex_office_district_id', $district_eng, Session::get('wpneaInfo.ex_office_district_id'), ['class' => 'form-control cusReadonly input-md required readonly-select','placeholder' => 'Select division first', 'onchange'=>"getThanaByDistrictId('ex_office_district_id', this.value, 'ex_office_thana_id', ". Session::get('wpneaInfo.ex_office_thana_id') .")"]) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('ex_office_thana_id') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::select('ex_office_thana_id', $thana_eng, Session::get('wpneaInfo.ex_office_thana_id'), ['class' => 'form-control cusReadonly input-md required readonly-select','placeholder' => 'Select district first']) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('ex_office_post_office') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('ex_office_post_office', Session::get('wpneaInfo.ex_office_post_office'), ['class' => 'form-control input-md cusReadonly']) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('ex_office_post_code') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('ex_office_post_code', Session::get('wpneaInfo.ex_office_post_code'), ['class' => 'form-control cusReadonly input-md post_code_bd required']) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('ex_office_address') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('ex_office_address', Session::get('wpneaInfo.ex_office_address'), ['maxlength'=>'150', 'class' => 'form-control cusReadonly input-md required']) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('ex_office_telephone_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('ex_office_telephone_no', Session::get('wpneaInfo.ex_office_telephone_no'), ['maxlength'=>'20','class' => 'form-control cusReadonly input-md phone_or_mobile']) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('ex_office_mobile_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('ex_office_mobile_no', Session::get('wpneaInfo.ex_office_mobile_no'), ['class' => 'form-control cusReadonly input-md helpText15 required' ,'id' => 'ex_office_mobile_no']) !!}
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-6 {{$errors->has('ex_office_fax_no') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('ex_office_fax_no', Session::get('wpneaInfo.ex_office_fax_no'), ['class' => 'form-control cusReadonly input-md']) !!}
                                                    ...
                                                    <div class="col-md-6 {{$errors->has('ex_office_email') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('ex_office_email', Session::get('wpneaInfo.ex_office_email'), ['class' => 'form-control cusReadonly email input-md required']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('basic_payment_type_id')?'has-error':'' }}">
                                                            {!! Form::select('basic_payment_type_id', $paymentMethods, Session::get('wpneaInfo.basic_payment_type_id'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field readonly-select']) !!}
                                                            {!! $errors->first('basic_payment_type_id','<span class="help-block">:message</span>') !!}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="{{ $errors->has('basic_local_amount')?'has-error':'' }}">
                                                            {!! Form::number('basic_local_amount', Session::get('wpneaInfo.basic_local_amount'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly basic_salary_amount input-md numberNoNegative cb_req_field', 'step' => '0.01', 'id' => 'basic_local_amount']) !!}
                                                            {!! $errors->first('basic_local_amount','<span class="help-block">:message</span>') !!}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="{{ $errors->has('basic_local_currency_id')?'has-error':'' }}">
                                                            {!! Form::select('basic_local_currency_id', $currencies, Session::get('wpneaInfo.basic_local_currency_id'), ['data-rule-maxlength'=>'40','class' => 'form-control required cusReadonly input-md cb_req_field readonly-select']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('overseas_payment_type_id')?'has-error':'' }}">
                                                            {!! Form::select('overseas_payment_type_id', $paymentMethods, Session::get('wpneaInfo.overseas_payment_type_id'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md readonly-select']) !!}
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('overseas_local_amount')?'has-error':'' }}">
                                                            {!! Form::number('overseas_local_amount', Session::get('wpneaInfo.overseas_local_amount'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md numberNoNegative cb_req_field', 'step' => '0.01']) !!}
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('overseas_local_currency_id')?'has-error':'' }}">
                                                            {!! Form::select('overseas_local_currency_id', $currencies, Session::get('wpneaInfo.overseas_local_currency_id'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md readonly-select']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('house_payment_type_id')?'has-error':'' }}">
                                                            {!! Form::select('house_payment_type_id', $paymentMethods, Session::get('wpneaInfo.house_payment_type_id'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field readonly-select']) !!}
                                                            {!! $errors->first('house_payment_type_id','<span class="help-block">:message</span>') !!}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="{{ $errors->has('house_local_amount')?'has-error':'' }}">
                                                            {!! Form::number('house_local_amount', Session::get('wpneaInfo.house_local_amount'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md numberNoNegative cb_req_field', 'step' => '0.01']) !!}
                                                            {!! $errors->first('house_local_amount','<span class="help-block">:message</span>') !!}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="{{ $errors->has('house_local_currency_id')?'has-error':'' }}">
                                                            {!! Form::select('house_local_currency_id', $currencies, Session::get('wpneaInfo.house_local_currency_id'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field readonly-select']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('conveyance_payment_type_id')?'has-error':'' }}">
                                                            {!! Form::select('conveyance_payment_type_id', $paymentMethods, Session::get('wpneaInfo.conveyance_payment_type_id'), ['data-rule-maxlength'=>'40',
                                                            'class' => 'form-control input-md cb_req_field cusReadonly readonly-select']) !!}
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('conveyance_local_amount')?'has-error':'' }}">
                                                            {!! Form::number('conveyance_local_amount', Session::get('wpneaInfo.conveyance_local_amount'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md numberNoNegative cb_req_field', 'step' => '0.01']) !!}
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('conveyance_local_currency_id')?'has-error':'' }}">
                                                            {!! Form::select('conveyance_local_currency_id', $currencies, Session::get('wpneaInfo.conveyance_local_currency_id'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field readonly-select']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('medical_payment_type_id')?'has-error':'' }}">
                                                            {!! Form::select('medical_payment_type_id', $paymentMethods, Session::get('wpneaInfo.medical_payment_type_id'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field readonly-select']) !!}
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('medical_local_amount')?'has-error':'' }}">
                                                            {!! Form::number('medical_local_amount', Session::get('wpneaInfo.medical_local_amount'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md numberNoNegative cb_req_field', 'step' => '0.01']) !!}
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('medical_local_currency_id')?'has-error':'' }}">
                                                            {!! Form::select('medical_local_currency_id', $currencies, Session::get('wpneaInfo.medical_local_currency_id'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field readonly-select']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('ent_payment_type_id')?'has-error':'' }}">
                                                            {!! Form::select('ent_payment_type_id', $paymentMethods, Session::get('wpneaInfo.ent_payment_type_id'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field readonly-select']) !!}
                                                            {!! $errors->first('ent_payment_type_id','<span class="help-block">:message</span>') !!}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="{{ $errors->has('ent_local_amount')?'has-error':'' }}">
                                                            {!! Form::number('ent_local_amount', Session::get('wpneaInfo.ent_local_amount'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md numberNoNegative cb_req_field', 'step' => '0.01']) !!}
                                                            {!! $errors->first('ent_local_amount','<span class="help-block">:message</span>') !!}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="{{ $errors->has('ent_local_currency_id')?'has-error':'' }}">
                                                            {!! Form::select('ent_local_currency_id', $currencies, Session::get('wpneaInfo.ent_local_currency_id'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field readonly-select']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="{{ $errors->has('bonus_payment_type_id')?'has-error':'' }}">
                                                            {!! Form::select('bonus_payment_type_id', $paymentMethods, Session::get('wpneaInfo.bonus_payment_type_id'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field readonly-select']) !!}
                                                            {!! $errors->first('bonus_payment_type_id','<span class="help-block">:message</span>') !!}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="{{ $errors->has('bonus_local_amount')?'has-error':'' }}">
                                                            {!! Form::number('bonus_local_amount', Session::get('wpneaInfo.bonus_local_amount'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md numberNoNegative cb_req_field', 'step' => '0.01']) !!}
                                                            {!! $errors->first('bonus_local_amount','<span class="help-block">:message</span>') !!}
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="{{ $errors->has('bonus_local_currency_id')?'has-error':'' }}">
                                                            {!! Form::select('bonus_local_currency_id', $currencies, Session::get('wpneaInfo.bonus_local_currency_id'), ['data-rule-maxlength'=>'40','class' => 'form-control cusReadonly input-md cb_req_field readonly-select']) !!}
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5">
                                                        <div class="{{ $errors->has('other_benefits')?'has-error':'' }}">
                                                            {!! Form::textarea('other_benefits', Session::get('wpneaInfo.other_benefits'), ['class' => 'form-control cusReadonly input-md bigInputField', 'size' =>'5x1','data-rule-maxlength'=>'250', 'placeholder' => 'Maximum 250 characters', 'data-charcount-maxlength'=>'250', 'id' => 'other_benefits']) !!}
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="form-group col-md-6 {{$errors->has('auth_full_name') ? 'has-error': ''}}">
                                                        ...
                                                        <div class="col-md-7">
                                                            {!! Form::text('auth_full_name', \App\Libraries\CommonFunction::getUserFullName(), ['class' => 'form-control requiredv input-md', 'readonly']) !!}
...
<script>
    ...
    var sessionLastWP = '{{ Session::get('wpneaInfo.last_work_permit') }}';
...
//        });
        ...
        // Handler for last_work_permit radio change
