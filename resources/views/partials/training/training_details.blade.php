                                                    ...
                                                    <div class="training_course_details_office">
                                                        <h5>
                                                            <a class="training_course_details_office_a" href="#">
                                                                <span>অফিসের নাম :
                                                                </span><span><u>{{ $course->training_office }}</u></span>
                                                            </a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h5 class="training_course_details_text">
                                                        ...
                                                        <span>{{ $course->course_duration_start }}</span>
                                                    </h5>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <h5 class="training_course_details_text">
                                                        ...
                                                        <span>{{ $course->enroll_deadline }}</span>
                                                    </h5>
                                                </div>
                                            </div>
                                            ...
                                            {{-- <div class="row">
                                                <div class="col-md-12">
                                                    <h5 class="training_course_details_text">
                                                        ...
                                                        <span class="input_ban"> 100 টাকা</span>
                                                    </h5>
                                                </div>
                                            </div> --}}
                                            <div class="padding_top_20"></div>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center course_coordinator_img_div">
                                                <figure>
                                                    <img src="https://ossbscic.gov.bd/uploads/users/profile-pic/2021/10/profile_pic-4559-61778475c5d007.09885389.jpeg"
                                                        class="img-responsive img-circle course_coordinator_img"
                                                        onerror="this.src=`https://ossbscic.gov.bd/assets/images/user_profile.jpg`">
                                                </figure>
                                            </div>
                                        </div>
                                        <div class="padding_top_20"></div>
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                ...
                                                <h5>প্রমোশন কর্মকর্তা</h5>
                                            </div>
                                        </div>
                                        <div class="padding_top_10"></div>
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <h5>বিডা প্রধান কার্যালয়, ঢাকা</h5>
                                            </div>
                                        </div>
                                        <div class="padding_top_10"></div>
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <h5><span>মোবাইল : </span><span class="input_ban">+8801770163167</span>
                                                </h5>
                                                <h5>
                                                    <span>ইমেইল : </span><span>yunusrafi.ruetipe13@gmail.com</span>
                                                </h5>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        <thead>
                                                            <tr>
                                                                <th style="width: 50%;" class="text-left">Date Time</th>
                                                                <th style="width: 25%;" class="text-left">Training Period</th>
                                                                <th style="width: 25%;" class="text-right">Seats</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                            @foreach ($scheduleSession as $row)
                                                                <tr>
                                                                    ...
                                                                    <td style="width: 25%;" class="text-left input_ban">
                                                                        {{ $course->duration }}
                                                                        {{ $course->duration_unit ? $course->duration_unit : '' }}
                                                                    </td>
                                                                    <td style="width: 25%;" class="text-right input_ban">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="other_location_program_title">
                        <h2>Ongoing training for {{ $course->category->category_name }}</h2>
                    </div>
                </div>
            </div><!--./row-->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="course_suggestion_office">
                                                            <span class="training_course_details_title">Office Name :</span>
                                                            <span>{{ mb_substr($row->training_office, 0, 40, 'UTF-8') }}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="course_suggestion_reg_date" style="padding-bottom: 5px;">
                                                            ...
                                                            <span>{{ date('d-m-Y', strtotime($row->course_duration_start)) }}</span>
                                                        </div>
                                                    </div>
                                                    <?php
