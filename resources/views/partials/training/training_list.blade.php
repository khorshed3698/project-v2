                        ...
                        <div class="training_data_count_section">
                            <ul class="list-inline">
                                ...
                                <li class="total_participation_li" style="background-color: #ed3f39">
                                    <p class="training_data_title">Total complition</p>
                                    <p class="input_ban training_data_value totalParticipantCompleted">0</p>
                                </li>
                    ...
                    <div class="box-body">
                        ...
                        <ul class="nav nav-tabs custom_nav col-md-8 col-md-offset-2" role="tablist">
                            ...
                            <li role="presentation">
                                <a id="allCourse" class="dynamic_tab" href="#tab_completed" aria-controls="training-course"
                                    role="tab" data-toggle="tab">Training Service</a>
                            </li>
                        </ul>
                        <br>
