...
//Creator: TengYong Ng
//Website: https://www.rainforestnet.com/datetimepicker/datetimepicker.htm
...
// pCtrl = Textbox element ID
// pFormat = date format e.g: 20-12-2019, 20-Dec-2019
// pScroller = Navigation pattern. it defines how the year and month can be changed in datepicker, by select box or arrow click.
// pShowTime = Display time in calendar
// pTimeMode = Time mode
// pShowSeconds = Show Seconds
// pEnableDateMode = Enable future date or past date
...
var CalWidth = 214;// calendar width
...
var WeekHeadColor = "#19609A"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#A5C5AF"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#A5C5AF"; //Background color of Saturday.
var WeekDayColor = "#D7E5F2"; //Background color of weekdays.
...
var YrSelColor = "#165484"; //color of font of Year selector.
var MthSelColor = "#165484"; //color of font of Month selector if "MonthSelector" is "arrow".
var HoverColor = "#E0FF38"; //color when mouse move over.
var DisableColor = "#CCD9E5"; //color of disabled cell.
...
var imageFilesPath = base_url + "/assets/images/datetime/";
...
function RenderCssCal(bNewCal)
{
	...
	vCalHeader = "<table class='table-datetime' style='background-color:"+CalBgColor+";width:200px;padding:0;margin:5px auto 5px auto'><tbody>";

	//Table for Month & Year Selector

	vCalHeader += "<tr><td colspan='7'><table class='table-datetime' width='200px' cellpadding='0' cellspacing='0'><tr>";
