...
if ($result0 = $mysqli->query("SELECT * FROM pdf_print_requests_queue WHERE job_sending_status=0 AND prepared_json=1 AND process_type_id NOT IN (12,16,17,21,22) ORDER BY id DESC LIMIT 10")) {
