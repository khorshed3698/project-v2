...
//                echo $result1;
                if($result1 == $max_processing_time - $before_reminder_day){ //before one day
...
//                dd($listOfEmails);
                ...
                insert_email_queue($listOfEmails['user_emails'], $email_content, $next_working_date, $mysqli);
...
<title>Application process</title><link href=\"https://fonts.googleapis.com/css?family=Vollkorn\" rel=\"stylesheet\" type=\"text/css\"><style type=\"text/css\">*{font-family: Vollkorn;}</style>
    ...
    <td style=\"margin-top: 20px; padding: 15px;\">
     ...
     We would like to inform you that the following pending applications from your desk will be processed automatically in the next working day at $next_working_date. <br><br>List of applications as in Table
