...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        $sql0 = "select tracking_no,desk_id,process_type_id, process_list.updated_at,process_list.submitted_at,
...
//                echo $max_processing_time - 1;
                if($result1 == $max_processing_time){ //today's
                    echo "<br>".$row1['tracking_no'].'---'.$result1.'<br>';
...
<title>Application process</title><link href=\"https://fonts.googleapis.com/css?family=Vollkorn\" rel=\"stylesheet\" type=\"text/css\"><style type=\"text/css\">*{font-family: Vollkorn;}</style>
    ...
    <td style=\"margin-top: 20px; padding: 15px;\">
     ...
     Some application will be processed today after office hour if you don’t take any action:<br><br>List of applications as in Table
     $email_content </br></br></br></span>Thanks<br/><b>BIDA</b><br/><br/>
         </td>
     </tr>
         <tr style=\"margin-top: 15px;\">
         <td style=\"padding: 1px; border-top: 1px solid rgba(0, 102, 255, 0.21);\">
         <h5 style=\"text-align:center\">All right reserved by BIDA.</h5>
         </td>
         </tr> 
     </tbody>
     </table></html>";
